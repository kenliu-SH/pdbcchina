...
Clazz.load(
  ['java.util.Hashtable', 'JV.Viewer'],
  'org.qcschema.QCSchemaUnits',
  ['java.lang.Double', 'java.util.Map'],
  function () {
    c$ = Clazz.declareType(org.qcschema, 'QCSchemaUnits');
    c$.getFactorToAU = Clazz.defineMethod(
      c$,
      'getFactorToAU',
      function (units) {
        switch (
          'cm cm^-1 cm-1 angstroms au atomic units fractional bohrs hartrees ev kj_mol kcal_mol'.indexOf(
            units.toLowerCase(),
          )
        ) {
          case 0:
    ...
    c$.getUnitConversion = Clazz.defineMethod(
      c$,
      'getUnitConversion',
    ...
    c$.getConversionFactorTo = Clazz.defineMethod(
      c$,
      'getConversionFactorTo',
      function (unitsFactor, unitsDesired) {
        try {
          var toAUDesired =
            org.qcschema.QCSchemaUnits.getFactorToAU(unitsDesired);
          var toAUActual = org.qcschema.QCSchemaUnits.getFactorToAU(
    ...
    c$.convertValue = Clazz.defineMethod(
      c$,
      'convertValue',
      function (valueUnits, toUnits) {
        return (
          org.qcschema.QCSchemaUnits.getDouble(valueUnits, 'value', null) *
          org.qcschema.QCSchemaUnits.getConversionFactor(
            valueUnits,
            'units',
            toUnits,
          )
    ...
    c$.getUnitsJSON = Clazz.defineMethod(
      c$,
      'getUnitsJSON',
      function (name, asArray) {
        ...
        return asArray
          ? Clazz.newArray(-1, [name, toAU])
          : '["' + name + '",' + toAU + ']';
      },
      '~S,~B',
    );
    c$.getConversionFactor = Clazz.defineMethod(
      c$,
      'getConversionFactor',
    ...
    c$.getDouble = Clazz.defineMethod(
      c$,
      'getDouble',
      function (map, key, toUnits) {
        var o = map.get(key);
        ...
        if (toUnits != null)
          if (Clazz.instanceOf(o, java.util.Map)) {
            ...
            conv = org.qcschema.QCSchemaUnits.getConversionFactor(
              map,
              key,
              toUnits,
            );
    ...
    c$.newList = Clazz.defineMethod(c$, 'newList', function () {
      return new JU.Lst();
    });
    c$.getDoubleArray = Clazz.defineMethod(
      c$,
      'getDoubleArray',
      function (mapOrList, key) {
    ...
    c$.getIntArray = Clazz.defineMethod(
      c$,
      'getIntArray',
      function (mapOrList, key) {
        var list = org.qcschema.QCSchemaUnits.getList(mapOrList, key);
    ...
    c$.getStringArray = Clazz.defineMethod(
      c$,
      'getStringArray',
      function (mapOrList, key) {
        var list = org.qcschema.QCSchemaUnits.getList(mapOrList, key);
    ...
    c$.version = c$.prototype.version =
      'QCJSON 0-0-0.Jmol_' + JV.Viewer.getJmolVersion().$replace(' ', '_');
    Clazz.defineStatics(
      c$,
      'UNITS_FRACTIONAL',
      'fractional',
      ...
      'cm',
      'TOAU_CM',
      1.8897261254578283e8,
      'UNITS_M',
      'm',
      'TOAU_M',
      1.889726125457828e10,
      'UNITS_ANGSTROMS',
      'angstroms',
      'TOAU_ANGSTROMS',
      1.8897261254578281,
