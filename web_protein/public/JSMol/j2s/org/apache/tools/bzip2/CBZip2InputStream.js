...
Clazz.load(
  ['java.io.InputStream', 'org.apache.tools.bzip2.BZip2Constants', '$.CRC'],
  ...
  function () {
    ...
    Clazz.defineMethod(c$, 'read', function () {
    ...
    Clazz.defineMethod(c$, 'makeMaps', function () {
    ...
    Clazz.defineMethod(c$, 'read0', function () {
    ...
    Clazz.defineMethod(
      ...
      function (isFirstStream) {
        ...
        if (blockSize < 49 || blockSize > 57) {
          throw new java.io.IOException(
            'Stream is not BZip2 formatted: illegal ' +
              'blocksize ' +
              String.fromCharCode(blockSize),
          );
        }
    ...
    Clazz.overrideMethod(c$, 'readByteAsInt', function () {
      {
        return this.in.readByteAsInt();
      }
    });
    Clazz.defineMethod(c$, 'initBlock', function () {
      var magic0;
      var magic1;
      var magic2;
      var magic3;
      ...
      while (true) {
        ...
        if (
          magic0.charCodeAt(0) != 0x17 ||
          magic1.charCodeAt(0) != 0x72 ||
          magic2.charCodeAt(0) != 0x45 ||
          magic3.charCodeAt(0) != 0x38 ||
          magic4.charCodeAt(0) != 0x50 ||
          magic5.charCodeAt(0) != 0x90
        ) {
          break;
        }
        if (this.complete()) {
      ...
      if (
        magic0.charCodeAt(0) != 0x31 ||
        magic1.charCodeAt(0) != 0x41 ||
        magic2.charCodeAt(0) != 0x59 ||
        magic3.charCodeAt(0) != 0x26 ||
        magic4.charCodeAt(0) != 0x53 ||
        magic5.charCodeAt(0) != 0x59
      ) {
        this.currentState = 0;
      ...
      if (this.data == null) {
        this.data = new org.apache.tools.bzip2.CBZip2InputStream.Data(
          this.blockSize100k,
        );
      }
    ...
    Clazz.defineMethod(c$, 'endBlock', function () {
    ...
    Clazz.defineMethod(c$, 'complete', function () {
    ...
    Clazz.defineMethod(c$, 'close', function () {
    ...
    Clazz.defineMethod(c$, 'bsGetBit', function () {
      var bsLiveShadow = this.bsLive;
      var bsBuffShadow = this.bsBuff;
      if (bsLiveShadow < 1) {
        var thech = this.readByteAsInt();
    ...
    Clazz.defineMethod(c$, 'bsGetUByte', function () {
      return String.fromCharCode(this.bsR(8));
    });
    Clazz.defineMethod(c$, 'bsGetInt', function () {
      return (
        (((((this.bsR(8) << 8) | this.bsR(8)) << 8) | this.bsR(8)) << 8) |
        this.bsR(8)
      );
    });
    c$.hbCreateDecodeTables = Clazz.defineMethod(
      c$,
    ...
    Clazz.defineMethod(c$, 'recvDecodingTables', function () {
    ...
    Clazz.defineMethod(
      ...
      function (alphaSize, nGroups) {
        ...
        for (var t = 0; t < nGroups; t++) {
          ...
          org.apache.tools.bzip2.CBZip2InputStream.hbCreateDecodeTables(
            limit[t],
            base[t],
            perm[t],
            len[t],
    ...
    Clazz.defineMethod(c$, 'getAndMoveToFrontDecode', function () {
    ...
    Clazz.defineMethod(c$, 'setupBlock', function () {
      if (this.data == null) {
        return;
      }
    ...
    Clazz.defineMethod(c$, 'setupRandPartA', function () {
      if (this.su_i2 <= this.last) {
        ...
        if (this.su_rNToGo == 0) {
          this.su_rNToGo =
            org.apache.tools.bzip2.BZip2Constants.rNums[this.su_rTPos] - 1;
    ...
    Clazz.defineMethod(c$, 'setupNoRandPartA', function () {
      if (this.su_i2 <= this.last) {
        this.su_chPrev = this.su_ch2;
        var su_ch2Shadow = this.data.ll8[this.su_tPos] & 0xff;
    ...
    Clazz.defineMethod(c$, 'setupRandPartB', function () {
    ...
    Clazz.defineMethod(c$, 'setupRandPartC', function () {
    ...
    Clazz.defineMethod(c$, 'setupNoRandPartB', function () {
      if (this.su_ch2 != this.su_chPrev) {
        this.su_count = 1;
        this.setupNoRandPartA();
      } else if (++this.su_count >= 4) {
    ...
    Clazz.defineMethod(c$, 'setupNoRandPartC', function () {
      if (this.su_j2 < this.su_z.charCodeAt(0)) {
    ...
    c$.reportCRCError = Clazz.defineMethod(c$, 'reportCRCError', function () {
