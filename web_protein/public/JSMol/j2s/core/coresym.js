(function (
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'getSymmetry', function () {
        return this.symmetry == null
      ...
      Clazz_defineMethod(c$, 'setLatticeCells', function () {
        this.latticeCells = this.acr.latticeCells;
        var isLatticeRange =
          this.latticeCells[0] <= 555 &&
          this.latticeCells[1] >= 555 &&
          (this.latticeCells[2] == 0 ||
            this.latticeCells[2] == 1 ||
            this.latticeCells[2] == -1);
        this.doNormalize =
          this.latticeCells[0] != 0 &&
          (!isLatticeRange || this.latticeCells[2] == 1);
          ...
          if (
            ...
            if (
              ...
              doApplySymmetry = readerSymmetry.createSpaceGroup(
                ...
                this.acr.sgName.indexOf('!') >= 0 ? 'P1' : this.acr.sgName,
                this.acr.unitCellParams,
                this.acr.modDim,
              );
            } else {
            ...
            if (doApplySymmetry) {
              ...
              if (readerSymmetry != null && this.filterSymop == null)
                this.setAtomSetSpaceGroupName(
                  readerSymmetry.getSpaceGroupName(),
                );
            }
          }
          if (
            ...
            for (
              var i = this.asc.getLastAtomSetAtomIndex(), n = this.asc.ac;
              i < n;
              i++
            )
      ...
      Clazz_defineMethod(c$, 'applySymmetryLattice', function () {
        if (
          !this.asc.coordinatesAreFractional ||
          this.symmetry.getSpaceGroup() == null
        )
          return;
        this.sym2 = null;
        ...
        if (this.acr.isPrimitive) {
          ...
          if (
            ...
            this.acr.primitiveToCrystal != null
          ) {
            this.asc.setCurrentModelInfo(
        ...
        if (this.acr.fillRange != null) {
          ...
          for (var i = 0; i < 4; i++)
            oabc[i] = JU.P3.newP(this.acr.fillRange[i]);
        ...
        if (isSuper) {
          ...
          if (
            oabc != null &&
            !m.equals(J.adapter.smarter.XtalSymmetry.mident)
          ) {
      ...
      Clazz_defineMethod(
        ...
        function (iAtomFirst) {
          ...
          if (this.acr.noPack) {
            for (
              var i = bs.nextSetBit(iAtomFirst);
              i >= 0;
              i = bs.nextSetBit(i + 1)
            ) {
              if (
      ...
      Clazz_defineMethod(c$, 'updateBSAtoms', function () {
        var bs = this.asc.bsAtoms;
        if (bs == null)
          bs = this.asc.bsAtoms = JU.BSUtil.newBitSet2(0, this.asc.ac);
      ...
      Clazz_defineMethod(
        ...
        function (oabc) {
          ...
          this.minXYZ = JU.P3i.new3(
            Clazz_doubleToInt(Math.min(0, Math.floor(this.rminx + 0.001))),
            Clazz_doubleToInt(Math.min(0, Math.floor(this.rminy + 0.001))),
            Clazz_doubleToInt(Math.min(0, Math.floor(this.rminz + 0.001))),
          );
          this.maxXYZ = JU.P3i.new3(
            Clazz_doubleToInt(Math.max(1, Math.ceil(this.rmaxx - 0.001))),
            Clazz_doubleToInt(Math.max(1, Math.ceil(this.rmaxy - 0.001))),
            Clazz_doubleToInt(Math.max(1, Math.ceil(this.rmaxz - 0.001))),
          );
        },
        '~A',
      );
      ...
      Clazz_defineMethod(
        ...
        function (ms, bsAtoms) {
          if (this.asc.ac == 0 || (bsAtoms != null && bsAtoms.isEmpty()))
            return;
          var n = (this.noSymmetryCount =
            this.asc.baseSymmetryAtomCount > 0
              ? this.asc.baseSymmetryAtomCount
              : bsAtoms == null
              ? this.asc.getLastAtomSetAtomCount()
              : this.asc.ac -
                bsAtoms.nextSetBit(this.asc.getLastAtomSetAtomIndex()));
          this.asc.setTensors();
          this.applySymmetryToBonds = this.acr.applySymmetryToBonds;
          this.doPackUnitCell =
            this.acr.doPackUnitCell && !this.applySymmetryToBonds;
          ...
          var excludedOps =
            this.acr.thisBiomolecule == null ? null : new JU.BS();
          ...
          if (
            ...
            this.acr.doPackUnitCell ||
            (this.symmetryRange != 0 &&
              this.maxXYZ.x - this.minXYZ.x == 1 &&
              this.maxXYZ.y - this.minXYZ.y == 1 &&
              this.maxXYZ.z - this.minXYZ.z == 1)
          ) {
            ...
            if (ms != null) {
              ...
              this.minXYZ.set(
                Clazz_floatToInt(this.minXYZ0.x),
                Clazz_floatToInt(this.minXYZ0.y),
                Clazz_floatToInt(this.minXYZ0.z),
              );
              this.maxXYZ.set(
                Clazz_floatToInt(this.maxXYZ0.x),
                Clazz_floatToInt(this.maxXYZ0.y),
                Clazz_floatToInt(this.maxXYZ0.z),
              );
            }
            switch (this.ndims) {
              case 3:
          ...
          var cartesianCount =
            this.asc.checkSpecial || this.acr.thisBiomolecule != null
              ? nsym * nCells
              : this.symmetryRange > 0
              ? nsym
              : 1;
          ...
          var atoms = this.asc.atoms;
          for (var i = 0; i < n; i++)
            atoms[this.firstAtom + i].bsSymmetry = JU.BS.newN(
              operationCount * (nCells + 1),
            );
          ...
          for (var tx = this.minXYZ.x; tx < this.maxXYZ.x; tx++) {
            for (var ty = this.minXYZ.y; ty < this.maxXYZ.y; ty++) {
              for (var tz = this.minXYZ.z; tz < this.maxXYZ.z; tz++) {
                ...
                for (pt = 0; pt < n; pt++) {
                  ...
                  if (ms != null) {
                    ...
                    if (sym !== lastSymmetry) {
                      if (sym.getSpaceGroupOperationCount() == 0)
                        this.finalizeSymmetry((lastSymmetry = sym));
                  ...
                  if (this.doPackUnitCell) {
                    ...
                    if (this.acr.fixJavaFloat)
                      JU.PT.fixPtFloats(pttemp, 100000.0);
                    if (bsAtoms == null) atom.setT(pttemp);
                    else if (atom.distance(pttemp) < 0.0001)
                ...
                cell555Count = pt = this.symmetryAddAtoms(
                  0,
                  0,
                  0,
                  0,
                  pt,
                  iCell * operationCount,
                  cartesians,
                  ms,
                  excludedOps,
                  atomMap,
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var bondAtomMin =
            this.asc.firstAtomToBond < 0 ? atomMax : this.asc.firstAtomToBond;
          ...
          var j00 =
            bsAtoms == null
              ? this.firstAtom
              : bsAtoms.nextSetBit(this.firstAtom);
          out: for (var iSym = 0; iSym < nOperations; iSym++) {
            if (
              (isBaseCell && iSym == 0) ||
              (this.latticeOnly && iSym > 0 && iSym % this.latticeOp != 0) ||
              (excludedOps != null && excludedOps.get(iSym))
            )
              continue;
            var pt0 =
              this.firstAtom +
              (checkSpecial || excludedOps != null
                ? pt
                : checkRange111
                ? baseCount
                : 0);
            ...
            for (var i = i0; i < atomMax; i++) {
              ...
              if (checkDistance) {
                ...
                for (var j = j00; j < j0; j++) {
                  ...
                  if (checkSpecial && d2 < d0) {
                    ...
                    if (
                      (special.atomName == null ||
                        special.atomName.equals(name)) &&
                      special.altLoc == id
                    )
                      break;
                    special = null;
              ...
              if (special != null) {
                ...
                if (atom1.isNegDisorder) {
                  ...
                  var key = Integer.$valueOf(
                    iSym * 1000 + atom1.altLoc.charCodeAt(0),
                  );
                  var ch = this.disorderMap.get(key);
                  if (ch == null) {
                    if (this.disorderMapMax == 0 || this.disorderMapMax == 90)
                      this.disorderMapMax = '@'.charCodeAt(0);
            ...
            if (addBonds) {
              ...
              var key;
              for (
                var bondNum = this.asc.bondIndex0;
                bondNum < this.bondCount0;
                bondNum++
              ) {
                ...
                if (
                  ia1 != ia2 &&
                  (ia1 >= bondAtomMin || ia2 >= bondAtomMin) &&
                  this.bondsFound.indexOf((key = '-' + ia1 + ',' + ia2)) < 0
                ) {
      ...
      Clazz_defineMethod(
        ...
        function (nTimes) {
          ...
          if (p != null)
            for (
              var entry, $entry = p.entrySet().iterator();
      ...
      Clazz_defineMethod(
        ...
        function (symmetry) {
          ...
          if (
            this.filterSymop != null ||
            name == null ||
            name.equals('unspecified!')
          )
            this.setAtomSetSpaceGroupName(symmetry.getSpaceGroupName());
        },
        'J.api.SymmetryInterface',
      );
      Clazz_defineMethod(c$, 'setSymmetryOps', function () {
        var operationCount = this.symmetry.getSpaceGroupOperationCount();
        if (operationCount > 0) {
          var symmetryList = new Array(operationCount);
          for (var i = 0; i < operationCount; i++)
            symmetryList[i] =
              '' + this.symmetry.getSpaceGroupXyz(i, this.doNormalize);
        ...
        this.asc.setCurrentModelInfo(
          'latticeType',
          this.acr.latticeType == null ? 'P' : this.acr.latticeType,
        );
        this.asc.setCurrentModelInfo(
          'intlTableNo',
        ...
        if (
          this.acr.sgName == null ||
          this.acr.sgName.indexOf('?') >= 0 ||
          this.acr.sgName.indexOf('!') >= 0
        )
          this.setAtomSetSpaceGroupName(
      ...
      Clazz_defineMethod(c$, 'getOverallSpan', function () {
        return this.maxXYZ0 == null
          ? JU.V3.new3(
              this.maxXYZ.x - this.minXYZ.x,
              this.maxXYZ.y - this.minXYZ.y,
              this.maxXYZ.z - this.minXYZ.z,
      ...
      Clazz_defineMethod(
        ...
        function (thisBiomolecule, applySymmetryToBonds, filter) {
          ...
          this.setLatticeCells();
          var lc =
            this.latticeCells != null && this.latticeCells[0] != 0
              ? Clazz_newIntArray(3, 0)
              : null;
          if (lc != null)
            for (var i = 0; i < 3; i++) lc[i] = this.latticeCells[i];
          ...
          var fixBMChains =
            bmChains == null
              ...
              : bmChains.length < 2
              ? 0
              : JU.PT.parseInt(bmChains.substring(1));
          if (fixBMChains == -2147483648) {
            fixBMChains = -bmChains.charAt(1).charCodeAt(0);
          }
          var particleMode =
            filter.indexOf('BYCHAIN') >= 0
              ? 1
              : filter.indexOf('BYSYMOP') >= 0
              ? 2
              : 0;
          ...
          var atoms = this.asc.atoms;
          var addBonds =
            this.bondCount0 > this.asc.bondIndex0 && applySymmetryToBonds;
          switch (particleMode) {
            case 1:
          ...
          if (filter.indexOf('#<') >= 0) {
            len = Math.min(
              len,
              JU.PT.parseInt(filter.substring(filter.indexOf('#<') + 2)) - 1,
            );
          ...
          for (var imt = biomtchains == null ? 1 : 0; imt < len; imt++) {
            ...
            var notIdentity = !mat.equals(
              J.adapter.smarter.XtalSymmetry.mident,
            );
            var chains = biomtchains == null ? null : biomtchains.get(imt);
            if (chains != null && assemblyIdAtoms != null) {
              bsAtoms = new JU.BS();
              for (
                var e, $e = assemblyIdAtoms.entrySet().iterator();
                $e.hasNext() && ((e = $e.next()) || true);
            ...
            for (var iAtom = this.firstAtom; iAtom < atomMax; iAtom++) {
              if (bsAtoms != null) {
                ...
                skipping =
                  chains.indexOf(
                    ':' + this.acr.vwr.getChainIDStr((lastID = id)) + ';',
                  ) < 0;
              }
          ...
          if (biomtchains != null) {
            ...
            if (particleMode == 0) {
              if (fixBMChains != -1) {
                ...
                for (var i = atomMax, n = this.asc.ac; i < n; i++) {
                  ...
                  if (known == null) {
                    if (assignABC && isym != 0) {
                      var pt =
                        firstNew < 200 ? bsChains.nextClearBit(firstNew) : 200;
                      if (pt < 200) {
                        bsChains.set(pt);
                        known = Integer.$valueOf(
                          this.acr.vwr.getChainID(
                            '' + String.fromCharCode(pt),
                            true,
                          ),
                        );
                        firstNew = pt;
                    ...
                    if (known == null)
                      known = Integer.$valueOf(
                        this.acr.vwr.getChainID(ch, true),
                      );
                    if (ch !== ch0) {
                      ...
                      if (bsAll != null) {
                        ...
                        knownAtomMap.put(
                          known,
                          (lastKnownAtom = Clazz_newIntArray(-1, [i, n])),
                        );
                      }
                    }
                ...
                if (this.asc.structureCount > 0) {
                  ...
                  for (
                    var e, $e = knownMap.entrySet().iterator();
                    $e.hasNext() && ((e = $e.next()) || true);
                      ...
                      if (s.bsAll != null) {
                        ...
                        System.err.println(
                          'XtalSymmetry not processing biomt chain structure ' +
                            this.acr.vwr.getChainIDStr(ch0) +
                            ' to ' +
                            this.acr.vwr.getChainIDStr(ch1),
                        );
                      }
                    }
                  }
              ...
              var vConnect = this.asc.getAtomSetAuxiliaryInfoValue(
                -1,
                'PDB_CONECT_bonds',
              );
              if (!addBonds && vConnect != null) {
                for (var i = vConnect.size(); --i >= 0; ) {
                  ...
                  if (
                    a != null &&
                    b != null &&
                    a.bondingRadius != b.bondingRadius &&
                    (bsAtoms == null ||
                      (bsAtoms.get(a.index) && bsAtoms.get(b.index))) &&
                    a.distanceSquared(b) > 25.0
                  ) {
      ...
      Clazz_defineMethod(c$, 'reset', function () {
      ...
      Clazz_defineMethod(c$, 'setTensors', function () {
        var n = this.asc.ac;
        for (var i = this.asc.getLastAtomSetAtomIndex(); i < n; i++) {
          var a = this.asc.atoms[i];
          if (a.anisoBorU == null) continue;
          a.addTensor(
            this.symmetry.getTensor(this.acr.vwr, a.anisoBorU),
            null,
            false,
          );
      ...
      Clazz_defineMethod(c$, 'setSpinVectors', function () {
      ...
      Clazz_defineMethod(c$, 'scaleFractionalVibs', function () {
      ...
      Clazz_defineMethod(c$, 'getBaseSymmetry', function () {
      ...
      Clazz_defineMethod(
        ...
        function (ptSupercell) {
          if (ptSupercell != null && this.baseUnitCell != null) {
            this.baseUnitCell[22] = Math.max(
              1,
              Clazz_floatToInt(ptSupercell.x),
            );
            this.baseUnitCell[23] = Math.max(
              1,
              Clazz_floatToInt(ptSupercell.y),
            );
            this.baseUnitCell[24] = Math.max(
              1,
              Clazz_floatToInt(ptSupercell.z),
            );
          }
        },
        'JU.P3',
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'isBio', function () {
        return this.$isBio;
      });
      Clazz_makeConstructor(c$, function () {});
      Clazz_overrideMethod(
        ...
        function (
          ...
          this.pointGroup = JS.PointGroup.getPointGroup(
            siLast == null ? null : siLast.pointGroup,
            center,
            atomset,
            bsAtoms,
            haveVibration,
      ...
      Clazz_overrideMethod(c$, 'getPointGroupName', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (modelIndex, drawID, asInfo, type, index, scale) {
          if (drawID == null && !asInfo && this.pointGroup.textInfo != null)
            ...
            drawID == null &&
            this.pointGroup.isDrawType(type, index, scale)
          )
            return this.pointGroup.drawInfo;
          else if (asInfo && this.pointGroup.info != null)
            return this.pointGroup.info;
          return this.pointGroup.getInfo(
            modelIndex,
            drawID,
            asInfo,
            type,
      ...
      Clazz_overrideMethod(
        ...
        function (doNormalize) {
          if (this.spaceGroup == null)
            this.spaceGroup = JS.SpaceGroup.getNull(true, doNormalize, false);
        },
        '~B',
      );
      Clazz_overrideMethod(
      ...
      Clazz_overrideMethod(c$, 'getSpaceGroup', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (desiredSpaceGroupIndex, name, data, modDim) {
          ...
          if (this.spaceGroup != null && JU.Logger.debugging)
            JU.Logger.debug(
      ...
      Clazz_overrideMethod(c$, 'getLatticeDesignation', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (
          ...
          if (
            name != null &&
            (name.startsWith('bio') || name.indexOf(' *(') >= 0)
          )
            this.spaceGroup.name = name;
          if (filterSymop != null) {
            var lst = new JU.Lst();
            lst.addLast(this.spaceGroup.operations[0]);
            for (var i = 1; i < this.spaceGroup.operationCount; i++)
              if (filterSymop.contains(' ' + (i + 1) + ' '))
                lst.addLast(this.spaceGroup.operations[i]);

            this.spaceGroup = JS.SpaceGroup.createSpaceGroup(
              -1,
              name + ' *(' + filterSymop.trim() + ')',
              lst,
              -1,
            );
          }
          this.spaceGroup.setFinalOperationsForAtoms(
            dim,
            atoms,
            iAtomFirst,
            noSymmetryCount,
      ...
      Clazz_overrideMethod(
        ...
        function (i) {
          return this.spaceGroup == null ||
            this.spaceGroup.operations == null ||
            i >= this.spaceGroup.operations.length
            ? null
            : this.spaceGroup.finalOperations == null
            ? this.spaceGroup.operations[i]
            : this.spaceGroup.finalOperations[i];
        },
        '~N',
      );
      Clazz_overrideMethod(
      ...
      Clazz_overrideMethod(
        ...
        function (pt, i, o, transX, transY, transZ, retPoint) {
          ...
          JS.Symmetry.newPoint(
            o == null ? this.spaceGroup.finalOperations[i] : o,
            pt,
            transX,
            transY,
            transZ,
      ...
      Clazz_overrideMethod(
        ...
        function (iop, axes, ptTemp, mTemp) {
          return iop == 0
            ? axes
            : this.spaceGroup.finalOperations[iop].rotateAxes(
                axes,
                this.unitCell,
                ptTemp,
                mTemp,
      ...
      Clazz_overrideMethod(c$, 'getLatticeOp', function () {
        return this.spaceGroup.latticeOp;
      });
      Clazz_overrideMethod(c$, 'getLatticeCentering', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (xyz, rotTransMatrix, allowScaling, modDim) {
          return JS.SymmetryOperation.getMatrixFromString(
            null,
            xyz,
            rotTransMatrix,
            allowScaling,
      ...
      Clazz_overrideMethod(c$, 'getSpaceGroupName', function () {
        return this.symmetryInfo != null
          ? this.symmetryInfo.sgName
          : this.spaceGroup != null
          ? this.spaceGroup.getName()
          : this.unitCell != null && this.unitCell.name.length > 0
      ...
      Clazz_overrideMethod(
        ...
        function (type) {
          return this.spaceGroup == null
            ? null
            : this.spaceGroup.getNameType(type, this);
        },
        '~S',
      );
      Clazz_overrideMethod(
      ...
      Clazz_overrideMethod(c$, 'getSpaceGroupOperationCount', function () {
        return this.symmetryInfo != null &&
          this.symmetryInfo.symmetryOperations != null
          ? this.symmetryInfo.symmetryOperations.length
          : this.spaceGroup != null && this.spaceGroup.finalOperations != null
          ? this.spaceGroup.finalOperations.length
          : 0;
      });
      Clazz_overrideMethod(c$, 'getLatticeType', function () {
        return this.symmetryInfo != null
      ...
      Clazz_overrideMethod(c$, 'getIntTableNumber', function () {
        return this.symmetryInfo != null
      ...
      Clazz_overrideMethod(c$, 'getCoordinatesAreFractional', function () {
        return (
          this.symmetryInfo == null ||
          this.symmetryInfo.coordinatesAreFractional
        );
      });
      Clazz_overrideMethod(c$, 'getCellRange', function () {
        return this.symmetryInfo == null ? null : this.symmetryInfo.cellRange;
      });
      Clazz_overrideMethod(c$, 'getSymmetryInfoStr', function () {
      ...
      Clazz_overrideMethod(c$, 'getSymmetryOperations', function () {
        if (this.symmetryInfo != null)
          return this.symmetryInfo.symmetryOperations;
        if (this.spaceGroup == null)
          this.spaceGroup = JS.SpaceGroup.getNull(true, false, true);
        this.spaceGroup.setFinalOperations();
        return this.spaceGroup.finalOperations;
      });
      Clazz_overrideMethod(c$, 'isSimple', function () {
        return (
          this.spaceGroup == null &&
          (this.symmetryInfo == null ||
            this.symmetryInfo.symmetryOperations == null)
      ...
      Clazz_overrideMethod(
        ...
        function (modelIndex, modelAuxiliaryInfo, unitCellParams) {
          this.symmetryInfo = new JS.SymmetryInfo();
          var params = this.symmetryInfo.setSymmetryInfo(
            modelAuxiliaryInfo,
            unitCellParams,
            null,
          );
          if (params != null) {
            this.setUnitCell(
              params,
              modelAuxiliaryInfo.containsKey('jmolData'),
            );
            this.unitCell.moreInfo = modelAuxiliaryInfo.get('moreUnitCellInfo');
            modelAuxiliaryInfo.put(
              'infoUnitCell',
              this.getUnitCellAsArray(false),
            );
            this.setOffsetPt(modelAuxiliaryInfo.get('unitCellOffset'));
            var matUnitCellOrientation = modelAuxiliaryInfo.get(
              'matUnitCellOrientation',
            );
            if (matUnitCellOrientation != null)
      ...
      Clazz_overrideMethod(c$, 'haveUnitCell', function () {
      ...
      Clazz_overrideMethod(c$, 'getUnitCellState', function () {
        if (this.unitCell == null) return '';
        return this.unitCell.getState();
      });
      Clazz_overrideMethod(c$, 'getMoreInfo', function () {
        return this.unitCell.moreInfo;
      });
      Clazz_defineMethod(c$, 'getUnitsymmetryInfo', function () {
      ...
      Clazz_overrideMethod(c$, 'getUnitCellParams', function () {
      ...
      Clazz_overrideMethod(c$, 'getUnitCellVerticesNoOffset', function () {
        return this.unitCell.getVertices();
      });
      Clazz_overrideMethod(c$, 'getCartesianOffset', function () {
        return this.unitCell.getCartesianOffset();
      });
      Clazz_overrideMethod(c$, 'getFractionalOffset', function () {
      ...
      Clazz_overrideMethod(c$, 'getUnitCellMultiplier', function () {
        return this.unitCell.getUnitCellMultiplier();
      });
      Clazz_overrideMethod(c$, 'getUnitCellMultiplied', function () {
      ...
      Clazz_overrideMethod(c$, 'isSlab', function () {
        return this.unitCell.isSlab();
      });
      Clazz_overrideMethod(c$, 'isPolymer', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (f1, f2, distance, dx, iRange, jRange, kRange, ptOffset) {
          return this.unitCell.checkDistance(
            f1,
            f2,
            distance,
            dx,
      ...
      Clazz_defineMethod(c$, 'getUnitCellVectors', function () {
      ...
      Clazz_overrideMethod(c$, 'isSupercell', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (modelSet, bsAtoms, minmax) {
          try {
            ...
            var isOneMolecule =
              molecules[moleculeCount - 1].firstAtomIndex ==
              modelSet.am[atoms[iAtom0].mi].firstAtomIndex;
            var center = new JU.P3();
            var centroidPacked = minmax[6] == 1;
            nextMol: for (
              var i = moleculeCount;
              --i >= 0 && bsAtoms.get(molecules[i].firstAtomIndex);
              ...
              if (
                centroidPacked ||
                (n > 0 && this.isNotCentroid(center, n, minmax, false))
              )
                bsDelete.or(bs);
            }
            return bsDelete;
      ...
      Clazz_defineMethod(
        ...
        function (center, n, minmax, centroidPacked) {
          ...
          if (centroidPacked)
            return (
              center.x + 0.000005 <= minmax[0] ||
              center.x - 0.000005 > minmax[3] ||
              center.y + 0.000005 <= minmax[1] ||
              center.y - 0.000005 > minmax[4] ||
              center.z + 0.000005 <= minmax[2] ||
              center.z - 0.000005 > minmax[5]
            );
          return (
            center.x + 0.000005 <= minmax[0] ||
            center.x + 0.00005 > minmax[3] ||
            center.y + 0.000005 <= minmax[1] ||
            center.y + 0.00005 > minmax[4] ||
            center.z + 0.000005 <= minmax[2] ||
            center.z + 0.00005 > minmax[5]
          );
        },
        'JU.P3,~N,~A,~B',
      );
      Clazz_defineMethod(
        ...
        function (modelSet) {
          if (modelSet == null) {
            return JS.Symmetry.nullDesc == null
      ...
      Clazz_overrideMethod(
        ...
        function (
          ...
          return this.getDesc(modelSet).getSymopInfo(
            iatom,
            xyz,
            op,
            translation,
      ...
      Clazz_overrideMethod(
        ...
        function (modelSet, sgName, modelIndex, isFull, cellParams) {
          ...
          return this.getDesc(modelSet).getSpaceGroupInfo(
            this,
            modelIndex,
            sgName,
            0,
      ...
      Clazz_overrideMethod(
        ...
        function (def, retMatrix) {
          return this.unitCell == null
            ? null
            : this.unitCell.getV0abc(def, retMatrix);
        },
        '~O,JU.M4',
      );
      Clazz_overrideMethod(
        ...
        function (abc) {
          return this.unitCell == null
            ? null
            : this.unitCell.getQuaternionRotation(abc);
        },
        '~S',
      );
      Clazz_overrideMethod(c$, 'getFractionalOrigin', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (ms, modelIndex, commands) {
          ...
          if (pt != null) {
            commands
              .append('; set unitcell ')
              .append(JU.SimpleUnitCell.escapeMultiplier(pt));
            loadUC = true;
          }
          ...
          if (isAssigned && sg != null) {
            commands.append(
              '\n UNITCELL ' +
                JU.Escape.e(ms.getUnitCell(modelIndex).getUnitCellVectors()),
            );
      ...
      Clazz_overrideMethod(
        ...
        function (toPrimitive, type, oabc, primitiveToCrystal) {
          ...
          return this.unitCell.toFromPrimitive(
            toPrimitive,
            type,
            oabc,
            primitiveToCrystal,
        ...
        function (pt0) {
          ...
          if (ops == null || this.unitCell == null) {
            ...
            for (var j = lst.size(); --j >= 0; )
              this.unitCell.toCartesian(lst.get(j), true);
          }
          return lst;
        },
        'JU.P3',
      ...
      Clazz_overrideMethod(
        ...
        function (vwr, bsAtoms) {
          ...
          var dataClass = vwr.getBoolean(603979960)
            ? 'CIPData'
            : 'CIPDataTracker';
          var data = J.api.Interface.getInterface(
            'JS.' + dataClass,
            vwr,
            'script',
          ).set(vwr, bsAtoms);
      ...
      Clazz_overrideMethod(
        ...
        function (latticeType, primitiveToCrystal) {
          return this.unitCell == null || latticeType == null
            ? null
            : this.unitCell.getConventionalUnitCell(
                latticeType,
                primitiveToCrystal,
              );
        },
      ...
      Clazz_overrideMethod(c$, 'getUnitCellInfoMap', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (sg) {
          ...
          if (Clazz_instanceOf(sg, JS.SpaceGroup)) {
            ...
            this.spaceGroup = JS.SpaceGroup.getSpaceGroupFromITAName(
              sg.toString(),
            );
          }
        },
      ...
      Clazz_overrideMethod(
        ...
        function (ms, bs, highPrec) {
          ...
          for (var i = bs.nextSetBit(0); i >= 0; i = bs.nextSetBit(i + 1)) {
            ...
            for (
              var j = bs.nextSetBit(i + 1);
              j >= 0;
              j = bs.nextSetBit(j + 1)
            ) {
              var b = atoms[j];
              if (
                type != b.getAtomicAndIsotopeNumber() ||
      ...
      Clazz_overrideMethod(
        ...
        function (pts, pt, flags) {
          var ops = this.getSymmetryOperations();
          return ops == null || this.unitCell == null
            ? null
            : this.unitCell.getEquivPoints(
                pt,
                flags,
                ops,
                pts == null ? new JU.Lst() : pts,
                0,
                0,
              );
        },
      ...
      Clazz_overrideMethod(
        ...
        function (pts, nIgnored, flags) {
          ...
          if (!tofractional) {
            for (var i = pts.size(); --i >= nIgnored; )
              this.toCartesian(pts.get(i), true);
          }
        },
        'JU.Lst,~N,~S',
      );
      ...
      Clazz_defineStatics(c$, 'nullDesc', null);
    },
  );
  Clazz_declarePackage('JS');
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'getName', function () {
        return this.name;
      });
      c$.getPointGroup = Clazz_defineMethod(
        c$,
        'getPointGroup',
        function (
          pgLast,
          ...
          pg.bsAtoms = pg.isAtoms
            ? bsAtoms
            : JU.BSUtil.newBitSet2(0, atomset.length);
      ...
      Clazz_defineMethod(
        ...
        function (pg) {
          ...
          if (
            this.linearTolerance != pg.linearTolerance ||
            this.distanceTolerance != pg.distanceTolerance ||
            this.nAtoms != pg.nAtoms ||
            this.localEnvOnly != pg.localEnvOnly ||
            this.haveVibration != pg.haveVibration ||
            this.bsAtoms == null
              ? pg.bsAtoms != null
              : !this.bsAtoms.equals(pg.bsAtoms)
          )
            return false;
          for (var i = 0; i < this.nAtoms; i++) {
            if (
              this.elements[i] != pg.elements[i] ||
              !this.points[i].equals(pg.points[i])
            )
              return false;
          }
          return true;
      ...
      Clazz_defineMethod(
        ...
        function (pgLast, atomset) {
          this.cosTolerance = Math.cos(
            (this.linearTolerance / 180) * 3.141592653589793,
          );
          ...
          try {
            ...
            if (this.nAxes[17] > 1) {
              ...
              if (n < 2) {
                ...
                (n % 2 == 1 && this.nAxes[16] > 0) ||
                (n % 2 == 0 && this.nAxes[16] > 1)
              ) {
      ...
      Clazz_defineMethod(
        ...
        function (n, nPlanes) {
          ...
          for (var i = 0; i < this.nAxes[16]; i++)
            if (
              this.isParallel(
                principalPlane.normalOrAxis,
                this.axes[16][i].normalOrAxis,
              )
            ) {
              if (i != 0) {
            ...
            for (var j = 0, nPerp = 0; j < nPlanes; j++)
              if (
                this.isPerpendicular(
                  this.axes[0][i].normalOrAxis,
                  this.axes[0][j].normalOrAxis,
                ) &&
                ++nPerp > 2
              ) {
                if (i != 0) {
      ...
      Clazz_defineMethod(
        ...
        function (atomset) {
          ...
          var atomIndexMax = 0;
          for (
            var i = this.bsAtoms.nextSetBit(0);
            i >= 0;
            i = this.bsAtoms.nextSetBit(i + 1)
          ) {
            var p = atomset[i];
            if (Clazz_instanceOf(p, JU.Node))
              atomIndexMax = Math.max(atomIndexMax, p.i);
          }
          ...
          for (
            var i = this.bsAtoms.nextSetBit(0);
            i >= 0;
            i = this.bsAtoms.nextSetBit(i + 1), this.nAtoms++
          ) {
            var p = atomset[i];
            if (Clazz_instanceOf(p, JU.Node)) {
              var bondIndex = this.localEnvOnly
                ? 1
                : 1 + Math.max(3, p.getCovalentBondCount());
              ...
              if (Clazz_instanceOf(p, JU.Point3fi))
      ...
      Clazz_defineMethod(c$, 'findInversionCenter', function () {
        this.haveInversionCenter = this.checkOperation(null, this.center, -1);
        if (this.haveInversionCenter) {
          this.axes[1] = new Array(1);
          this.axes[1][0] = Clazz_innerTypeInstance(
            JS.PointGroup.Operation,
            this,
            null,
          );
      ...
      Clazz_defineMethod(
        ...
        function (q, center, iOrder) {
          ...
          out: for (
            ...
            if (
              (q != null || isInversion) &&
              pt.distanceSquared(a1) < this.distanceTolerance2
            ) {
              nFound++;
              continue;
            }
            ...
            while (this.iter.hasMoreElements()) {
              ...
              if (
                (this.centerAtomIndex >= 0 && j == this.centerAtomIndex) ||
      ...
      Clazz_defineMethod(c$, 'getElementCounts', function () {
        for (var i = this.points.length; --i >= 0; ) {
          var e1 = this.elements[i];
        ...
        for (var i = this.points.length; --i >= 0; )
          this.eCounts[this.elements[i]]++;
      });
      Clazz_defineMethod(c$, 'findCAxes', function () {
        var v1 = new JU.V3();
        var v2 = new JU.V3();
        var v3 = new JU.V3();
        for (var i = this.points.length; --i >= 0; ) {
          ...
          for (var j = this.points.length; --j > i; ) {
            ...
            if (
              !isIntegerOrder ||
              (iOrder = iOrder + 14) >= JS.PointGroup.maxAxis
            )
              continue;
        ...
        out: for (var i = 0; i < this.points.length - 2; i++)
          if (this.elements[i] == iMin)
            for (var j = i + 1; j < this.points.length - 1; j++)
              if (this.elements[j] == iMin)
                for (var k = j + 1; k < this.points.length; k++)
                  if (this.elements[k] == iMin) {
        ...
        if (!this.haveInversionCenter)
          for (var i = 0; i < this.maxElement; i++)
            if (vs[i] != null) vs[i].scale(1 / this.eCounts[i]);

        for (var i = 0; i < this.maxElement; i++)
          if (vs[i] != null)
            for (var j = 0; j < this.maxElement; j++) {
      ...
      Clazz_defineMethod(
        ...
        'getAllAxes',
        function (v3) {
          for (var o = 16; o < JS.PointGroup.maxAxis; o++)
            if (this.nAxes[o] < JS.PointGroup.axesMaxN[o])
              this.checkAxisOrder(o, v3, this.center);
        },
        'JU.V3',
      );
      Clazz_defineMethod(c$, 'getHighestOrder', function () {
        var n = 0;
        for (n = 14; --n > 1 && this.nAxes[n] == 0; ) {}
        if (n > 1)
          return n + 14 < JS.PointGroup.maxAxis && this.nAxes[n + 14] > 0
            ? n + 14
            : n;
      ...
      Clazz_defineMethod(
        ...
        function (iOrder, v) {
          ...
          if (this.axes[iOrder] == null)
            this.axes[iOrder] = new Array(JS.PointGroup.axesMaxN[iOrder]);
          this.axes[iOrder][this.nAxes[iOrder]++] = Clazz_innerTypeInstance(
            JS.PointGroup.Operation,
            this,
            null,
            v,
      ...
      Clazz_defineMethod(
        ...
        function (iOrder, v) {
          ...
          if (this.nAxes[iOrder] > 0)
            for (var i = this.nAxes[iOrder]; --i >= 0; ) {
              if (this.isParallel(v, this.axes[iOrder][i].normalOrAxis))
                return true;
            }
          return false;
        },
      ...
      Clazz_defineMethod(c$, 'findPlanes', function () {
        var pt = new JU.P3();
        var v1 = new JU.V3();
        var v2 = new JU.V3();
        var v3 = new JU.V3();
        ...
        if (haveAxes)
          for (var i = 16; i < JS.PointGroup.maxAxis; i++)
      ...
      Clazz_defineMethod(
        ...
        function (v3) {
          if (
            !this.haveAxis(0, v3) &&
            this.checkOperation(JU.Quat.newVA(v3, 180), this.center, -1)
          )
            this.axes[0][this.nAxes[0]++] = Clazz_innerTypeInstance(
              JS.PointGroup.Operation,
              this,
              null,
              v3,
      ...
      Clazz_defineMethod(
        ...
        function (nPlanes) {
          ...
          if (
            nPlanes > 1 &&
            (Cn = nPlanes + 14) < JS.PointGroup.maxAxis &&
            this.nAxes[Cn] == 0
          ) {
            this.vTemp.cross(planes[0].normalOrAxis, planes[1].normalOrAxis);
            if (
              !this.checkAxisOrder(Cn, this.vTemp, this.center) &&
              nPlanes > 2
            ) {
      ...
      c$.getQuaternion = Clazz_defineMethod(
        c$,
        'getQuaternion',
        function (v, iOrder) {
          return JU.Quat.newVA(
            v,
            (iOrder < 14 ? 180 : 0) +
              (iOrder == 0 ? 0 : Clazz_doubleToInt(360 / (iOrder % 14))),
          );
        },
        'JU.V3,~N',
      );
      Clazz_defineMethod(
        ...
        function (modelIndex, drawID, asInfo, type, index, scaleFactor) {
          ...
          for (var i = 1; i < JS.PointGroup.maxAxis; i++)
            for (var j = this.nAxes[i]; --j >= 0; )
              nType[this.axes[i][j].type][0]++;
          ...
          if (asDraw) {
            ...
            for (var i = 2; i < JS.PointGroup.maxAxis; i++) {
              ...
              if (
                ...
                (anyProperAxis && isProper) ||
                (anyImproperAxis && !isProper)
              )
                for (var j = 0; j < this.nAxes[i]; j++) {
                  ...
                  sb.append(drawID + 'pgva')
                    ...
                    .appendF(scale)
                    .append(' ')
                    .append(JU.Escape.eP(v));
                  v.scaleAdd2(-2, op.normalOrAxis, v);
                  var isPA =
                    this.principalAxis != null &&
                    op.index == this.principalAxis.index;
                  sb.append(JU.Escape.eP(v))
                    .append('"')
                    .append(label)
                    .append(isPA ? '*' : '')
                    .append('" color ')
                    .append(isPA ? 'red' : op.type == 2 ? 'blue' : 'orange')
                    .append(';\n');
                }
            }
            if (!haveType || type.equalsIgnoreCase('Cs'))
              for (var j = 0; j < this.nAxes[0]; j++) {
                if (index > 0 && j + 1 != index) continue;
                op = this.axes[0][j];
                sb.append(drawID + 'pgvp')
                  .append(m)
                  .appendI(j + 1)
                  .append('disk scale ')
                  .appendF(scaleFactor * this.radius * 2)
                  .append(' CIRCLE PLANE ')
                  .append(JU.Escape.eP(this.center));
                v.add2(op.normalOrAxis, this.center);
                sb.append(JU.Escape.eP(v)).append(
                ...
                sb.append(JU.Escape.eP(v))
                  ...
                  .append(
                    this.principalPlane != null &&
                      op.index == this.principalPlane.index
                      ? 'red'
                      : 'blue',
                  )
                  .append(';\n');
          ...
          for (var i = JS.PointGroup.maxAxis; --i >= 0; ) {
            if (this.nAxes[i] > 0) {
              ...
              var label = this.axes[i][0].getLabel();
              if (asInfo)
                this.info.put('n' + label, Integer.$valueOf(this.nAxes[i]));
              else
                sb.append('\n\n')
                  .append(this.name)
                  .append('\tn')
      ...
      Clazz_defineMethod(
        ...
        function (type, index, scale) {
          return (
            this.drawInfo != null &&
            this.drawType.equals(type == null ? '' : type) &&
            this.drawIndex == index &&
            this.scale == scale
          );
        },
      ...
      c$.$PointGroup$Operation$ = function () {
        ...
        Clazz_defineMethod(c$, 'getLabel', function () {
          switch (this.type) {
            case 0:
              return 'Cs';
            case 2:
        ...
        Clazz_defineMethod(c$, 'getM3', function () {
      ...
      c$.mInv = c$.prototype.mInv = JU.M3.newA9(
        Clazz_newFloatArray(-1, [-1, 0, 0, 0, -1, 0, 0, 0, -1]),
      );
    },
  );
  Clazz_declarePackage('JS');
  Clazz_load(
    ...
    function () {
      ...
      c$.createSpaceGroup = Clazz_defineMethod(
        c$,
        'createSpaceGroup',
        function (desiredSpaceGroupIndex, name, data, modDim) {
          var sg = null;
          if (desiredSpaceGroupIndex >= 0) {
            ...
            if (Clazz_instanceOf(data, JU.Lst))
              sg = JS.SpaceGroup.createSGFromList(name, data);
            else sg = JS.SpaceGroup.determineSpaceGroupNA(name, data);
            if (sg == null)
              sg = JS.SpaceGroup.createSpaceGroupN(
                modDim <= 0
                  ? name
                  : 'x1,x2,x3,x4,x5,x6,x7,x8,x9'.substring(0, modDim * 3 + 8),
              );
          }
      ...
      c$.createSGFromList = Clazz_defineMethod(
        c$,
        'createSGFromList',
        function (name, data) {
        ...
        function (xyz, opId, allowScaling) {
          ...
          return xyz.indexOf('[[') < 0 &&
            ...
            (xyz.indexOf('x') < 0 ||
              ...
              xyz.indexOf('z') < 0)
            ? -1
            : this.addOperation(xyz, opId, allowScaling);
        },
        '~S,~N,~B',
      );
      Clazz_defineMethod(c$, 'setFinalOperations', function () {
      ...
      Clazz_defineMethod(
        ...
        function (dim, atoms, atomIndex, count, doNormalize) {
          ...
          if (
            ...
            !this.isBio &&
            this.name.indexOf('SSG:') < 0 &&
            this.name.indexOf('[subsystem') < 0
          ) {
          ...
          if (doOffset) {
            op = this.finalOperations[0] = new JS.SymmetryOperation(
              this.operations[0],
              0,
              true,
            );
          ...
          for (var i = 0; i < this.operationCount; i++) {
            if (i > 0 || op == null) {
              op = this.finalOperations[i] = new JS.SymmetryOperation(
                this.operations[i],
                0,
                doNormalize,
              );
      ...
      Clazz_defineMethod(c$, 'getOperationCount', function () {
      ...
      Clazz_defineMethod(
        ...
        'getXyz',
        function (i, doNormalize) {
          return this.finalOperations == null
            ? this.operations[i].getXyz(doNormalize)
            : this.finalOperations[i].getXyz(doNormalize);
        },
        '~N,~B',
      );
      c$.getInfo = Clazz_defineMethod(
        c$,
        'getInfo',
        function (sg, spaceGroup, params, asMap, andNonstandard) {
          try {
            if (sg != null && sg.index >= JS.SpaceGroup.SG.length) {
              var sgDerived = JS.SpaceGroup.findSpaceGroup(
                sg.operationCount,
                sg.getCanonicalSeitzList(),
              );
              ...
              if (sg == null) {
                if (spaceGroup.indexOf('[') >= 0)
                  spaceGroup = spaceGroup
                    .substring(0, spaceGroup.indexOf('['))
                    .trim();
            ...
            if (sg == null) {
              ...
              sgFound = JS.SpaceGroup.findSpaceGroup(
                sgFound.operationCount,
                sgFound.getCanonicalSeitzList(),
              );
            ...
            if (sg != null) {
              ...
              while (sg != null) {
                ...
                if (sg.index >= JS.SpaceGroup.SG.length || !andNonstandard)
                  break;
      ...
      Clazz_defineMethod(c$, 'dumpInfo', function () {
        ...
        if (this.hmSymbol == null || this.hmSymbolExt == null) sb.append('?');
          ...
          sb.append(this.hmSymbol).append(
            this.hmSymbolExt.length > 0 ? ':' + this.hmSymbolExt : '',
          );
        if (this.intlTableNumber != null) {
          sb.append('\ninternational table number: ')
            .append(this.intlTableNumber)
            .append(
              this.intlTableNumberExt.length > 0
            ...
            .append(' operators')
            .append(
              this.hallInfo != null && !this.hallInfo.hallSymbol.equals('--')
                ? ' from Hall symbol ' +
      ...
      Clazz_defineMethod(c$, 'dumpInfoObj', function () {
        var info = this.dumpCanonicalSeitzList();
        if (Clazz_instanceOf(info, JS.SpaceGroup)) return info.dumpInfoObj();
        var map = new java.util.Hashtable();
        var s =
          this.hmSymbol == null || this.hmSymbolExt == null
            ? '?'
            : this.hmSymbol +
              (this.hmSymbolExt.length > 0 ? ':' + this.hmSymbolExt : '');
        ...
        if (this.intlTableNumber != null) {
          map.put(
            'ita',
            Integer.$valueOf(JU.PT.parseInt(this.intlTableNumber)),
          );
        ...
        map.put(
          'HallSymbol',
          this.hallInfo == null ? '?' : this.hallInfo.hallSymbol,
        );
        return map;
      });
      Clazz_defineMethod(c$, 'getName', function () {
      ...
      Clazz_defineMethod(c$, 'getLatticeDesignation', function () {
        ...
        function (latticeParameter) {
          ...
          if (latticeParameter > 10)
            this.latticeParameter = -JS.HallTranslation.getLatticeIndex(
              JS.HallTranslation.getLatticeCode(latticeParameter),
            );
        },
        '~N',
      );
      Clazz_defineMethod(c$, 'dumpCanonicalSeitzList', function () {
        ...
        return (
          (this.index >= 0 && this.index < JS.SpaceGroup.SG.length
            ? this.hallSymbol + ' = '
            : '') + s
        );
      });
      Clazz_defineMethod(c$, 'getDerivedSpaceGroup', function () {
        if (
          (this.index >= 0 && this.index < JS.SpaceGroup.SG.length) ||
          this.modDim > 0 ||
          this.operations == null ||
          this.operations.length == 0 ||
          this.operations[0].timeReversal != 0
        )
          return this;
        if (this.finalOperations != null) this.setFinalOperations();
        var s = this.getCanonicalSeitzList();
        return s == null
          ? null
          : JS.SpaceGroup.findSpaceGroup(this.operationCount, s);
      });
      Clazz_defineMethod(c$, 'getCanonicalSeitzList', function () {
        var list = new Array(this.operationCount);
        for (var i = 0; i < this.operationCount; i++)
          list[i] = JS.SymmetryOperation.dumpSeitz(this.operations[i], true);
      ...
      c$.findSpaceGroup = Clazz_defineMethod(
        c$,
        'findSpaceGroup',
        function (opCount, s) {
          JS.SpaceGroup.getSpaceGroups();
          ...
          if (lst != null)
            for (var i = 0, n = lst.size(); i < n; i++) {
              var sg = lst.get(i);
              if (JS.SpaceGroup.getCanonicalSeitz(sg.index).indexOf(s) >= 0)
        ...
        function (asMap) {
          ...
          if (asMap) {
            ...
            for (var i = 0; i < JS.SpaceGroup.SG.length; i++)
              info.addLast(JS.SpaceGroup.SG[i].dumpInfoObj());
      ...
      c$.dumpAllSeitz = Clazz_defineMethod(c$, 'dumpAllSeitz', function () {
        JS.SpaceGroup.getSpaceGroups();
        var sb = new JU.SB();
        for (var i = 0; i < JS.SpaceGroup.SG.length; i++)
      ...
      c$.getCanonicalSeitz = Clazz_defineMethod(
        c$,
        'getCanonicalSeitz',
        function (i) {
          if (JS.SpaceGroup.canonicalSeitzList == null)
            JS.SpaceGroup.canonicalSeitzList = new Array(
              JS.SpaceGroup.SG.length,
            );
          var cs = JS.SpaceGroup.canonicalSeitzList[i];
          return cs == null
            ? (JS.SpaceGroup.canonicalSeitzList[i] = JS.SpaceGroup.SG[i]
      ...
      Clazz_defineMethod(
        ...
        function (latticeCode, isCentrosymmetric) {
          this.latticeParameter =
            JS.HallTranslation.getLatticeIndex(latticeCode);
          if (!isCentrosymmetric)
            this.latticeParameter = -this.latticeParameter;
        },
        '~S,~B',
      );
      c$.createSpaceGroupN = Clazz_defineMethod(
        c$,
        'createSpaceGroupN',
        function (name) {
          JS.SpaceGroup.getSpaceGroups();
      ...
      Clazz_defineMethod(
        ...
        function (xyz0, opId, allowScaling) {
          ...
          if (xyz0.startsWith('x1,x2,x3,x4') && this.modDim == 0) {
            ...
            this.operationCount = 0;
            this.modDim =
              JU.PT.parseInt(xyz0.substring(xyz0.lastIndexOf('x') + 1)) - 3;
      ...
      Clazz_defineMethod(
        ...
        'checkXYZlist',
        function (xyz) {
          return this.xyzList.containsKey(xyz)
            ? this.xyzList.get(xyz).intValue()
            : -1;
        },
        '~S',
      );
      Clazz_defineMethod(
        ...
        function (op, xyz0, isSpecial) {
          ...
          if (!isSpecial) {
            ...
            if (id >= 0) return id;
            if (this.latticeOp < 0) {
              var xxx = JU.PT.replaceAllCharacters(
                this.modDim > 0
                  ? JS.SymmetryOperation.replaceXn(xyz, this.modDim + 3)
                  : xyz,
                '+123/',
                '',
              );
          ...
          if (!xyz.equals(xyz0))
            this.xyzList.put(xyz0, Integer.$valueOf(this.operationCount));
        ...
        function (h) {
          if (h == null) {
            ...
            if (this.hallInfo == null || this.hallInfo.nRotations == 0)
              h = this.hallInfo = new JS.HallInfo(this.hallSymbol);
            this.setLattice(
          ...
          for (var i = 0; i < h.nRotations; i++) {
            ...
            for (var j = 1; j <= nRot; j++) {
              ...
              for (var k = 0; k < nOps; k++) {
                ...
                var xyz = JS.SymmetryOperation.getXYZFromMatrix(
                  operation,
                  true,
                  true,
                  true,
      ...
      c$.determineSpaceGroupN = Clazz_defineMethod(
        c$,
      ...
      c$.determineSpaceGroupNS = Clazz_defineMethod(
        c$,
      ...
      c$.determineSpaceGroupNA = Clazz_defineMethod(
        c$,
        'determineSpaceGroupNA',
        function (name, unitCellParams) {
          return unitCellParams == null
            ? JS.SpaceGroup.determineSpaceGroup(name, 0, 0, 0, 0, 0, 0, -1)
      ...
      c$.determineSpaceGroup = Clazz_defineMethod(
        c$,
        'determineSpaceGroup',
        function (name, a, b, c, alpha, beta, gamma, lastIndex) {
          var i = JS.SpaceGroup.determineSpaceGroupIndex(
            name,
            a,
            b,
            c,
      ...
      c$.determineSpaceGroupIndex = Clazz_defineMethod(
        c$,
        ...
        function (name, a, b, c, alpha, beta, gamma, lastIndex) {
          ...
          var nameType = name.startsWith('hall:')
            ? 5
            : name.startsWith('hm:')
            ? 3
            : 0;
          ...
          if (
            nameType != 5 &&
            !haveExtension &&
            JU.PT.isOneOf(name, JS.SpaceGroup.ambiguousNames)
          ) {
            ext = '?';
            haveExtension = true;
          }
          ...
          var s;
          if (nameType != 3 && !haveExtension)
            for (i = lastIndex; --i >= 0; ) {
              if (JS.SpaceGroup.SG[i].hallSymbol.equalsIgnoreCase(name))
                return i;
            }
          if (nameType != 5) {
            if (nameType != 3)
              for (i = lastIndex; --i >= 0; )
                if (
                  JS.SpaceGroup.SG[i].intlTableNumberFull.equalsIgnoreCase(
                    nameExt,
                  )
                )
                  return i;
            ...
            for (i = lastIndex; --i >= 0; ) {
              if (JS.SpaceGroup.SG[i].hmSymbolFull.equalsIgnoreCase(nameExt))
                return i;
            }
            for (i = lastIndex; --i >= 0; )
              if (
                (s = JS.SpaceGroup.SG[i]).hmSymbolAlternative != null &&
            ...
            if (haveExtension) {
              for (i = lastIndex; --i >= 0; )
                if (
                  (s = JS.SpaceGroup.SG[i]).hmSymbolAbbr.equalsIgnoreCase(
                    abbr,
                  ) &&
              ...
              for (i = lastIndex; --i >= 0; )
                if (
                  (s = JS.SpaceGroup.SG[i]).hmSymbolAbbrShort.equalsIgnoreCase(
                    abbr,
                  ) &&
                  s.intlTableNumberExt.equalsIgnoreCase(ext)
                )
            ...
            var uniqueAxis = JS.SpaceGroup.determineUniqueAxis(
              a,
              b,
              c,
              alpha,
          ...
          if (ext.length == 0)
            for (i = 0; i < lastIndex; i++)
              if (
                (s = JS.SpaceGroup.SG[i]).intlTableNumber.equals(nameExt) &&
                (!checkBilbao || s.isBilbao)
              )
                return i;
      ...
      c$.determineUniqueAxis = Clazz_defineMethod(
        c$,
        'determineUniqueAxis',
      ...
      Clazz_defineMethod(
        ...
        function (cifLine) {
          ...
          this.isBilbao =
            terms.length < 6 && !this.intlTableNumberFull.equals('0');
          ...
          this.crystalClass = JS.SpaceGroup.toCap(
            JU.PT.split(terms[2], '^')[0],
            1,
          );
          ...
          if (
            this.intlTableNumber.charAt(0) != '0' &&
            JS.SpaceGroup.lastInfo.equals(info)
          )
      ...
      Clazz_defineMethod(
        ...
        function (name) {
          ...
          if (pt >= 1)
            if ('admn'.indexOf(this.hmSymbol.charAt(pt - 1)) >= 0) {
              this.hmSymbolAlternative = (
                this.hmSymbol.substring(0, pt) +
                ' 3' +
                this.hmSymbol.substring(pt + 3)
              ).toLowerCase();
            }
      ...
      Clazz_defineMethod(c$, 'asString', function () {
        return (
          '' +
          this.intlTableNumberFull +
          ' HM:' +
      ...
      c$.getSpaceGroups = Clazz_defineMethod(c$, 'getSpaceGroups', function () {
        return JS.SpaceGroup.SG == null
          ? (JS.SpaceGroup.SG = JS.SpaceGroup.createSpaceGroups())
          : JS.SpaceGroup.SG;
      });
      c$.createSpaceGroups = Clazz_defineMethod(
        c$,
        'createSpaceGroups',
        function () {
      ...
      c$.getSpaceGroupFromITAName = Clazz_defineMethod(
        c$,
        ...
        function (ita) {
          ...
          for (var i = 0; i < n; i++)
            if (ita.equals(JS.SpaceGroup.SG[i].intlTableNumberFull))
              return JS.SpaceGroup.SG[i];

          for (var i = 0; i < n; i++)
            if (ita.equals(JS.SpaceGroup.SG[i].intlTableNumber))
              return JS.SpaceGroup.SG[i];
      ...
      Clazz_defineMethod(c$, 'checkHallOperators', function () {
        if (
          this.nHallOperators != null &&
      ...
      Clazz_defineStatics(
        ...
        Clazz_newArray(-1, [
          ...
          '6:b;2;cs^1;p 1 m 1;p -2y',
          '6:b;2;cs^1;p m;p -2y',
          '6:c;2;cs^1;p 1 1 m;p -2',
          '6:a;2;cs^1;p m 1 1;p -2x',
          '7:b1;2;cs^2;p 1 c 1;p -2yc',
          '7:b1;2;cs^2;p c;p -2yc',
          '7:b2;2;cs^2;p 1 n 1;p -2yac',
          '7:b2;2;cs^2;p n;p -2yac',
          '7:b3;2;cs^2;p 1 a 1;p -2ya',
          ...
          '8:b1;4;cs^3;c 1 m 1;c -2y',
          '8:b1;4;cs^3;c m;c -2y',
          '8:b2;4;cs^3;a 1 m 1;a -2y',
          '8:b3;4;cs^3;i 1 m 1;i -2y',
          ...
          '13:b1;4;c2h^4;p 1 2/c 1;-p 2yc',
          '13:b1;4;c2h^4;p 2/c;-p 2yc',
          '13:b2;4;c2h^4;p 1 2/n 1;-p 2yac',
          '13:b2;4;c2h^4;p 2/n;-p 2yac',
          '13:b3;4;c2h^4;p 1 2/a 1;-p 2ya',
          ...
          '14:b1;4;c2h^5;p 1 21/c 1;-p 2ybc',
          '14:b1;4;c2h^5;p 21/c;-p 2ybc',
          '14:b2;4;c2h^5;p 1 21/n 1;-p 2yn',
          '14:b2;4;c2h^5;p 21/n;-p 2yn',
          '14:b3;4;c2h^5;p 1 21/a 1;-p 2yab',
          ...
          '20*;8;d2^5;c 2 2 21*;c 21 2',
          '20:cab;8;d2^5;a 21 2 2;a 2a 2a',
          '20:cab*;8;d2^5;a 21 2 2*;a 2a 21',
          ...
          '26*;4;c2v^2;p m c 21*;p 21 -2',
          '26:ba-c;4;c2v^2;p c m 21;p 2c -2c',
          '26:ba-c*;4;c2v^2;p c m 21*;p 21 -2c',
          ...
          '33*;4;c2v^9;p n a 21*;p 21 -2n',
          '33:ba-c;4;c2v^9;p b n 21;p 2c -2ab',
          '33:ba-c*;4;c2v^9;p b n 21*;p 21 -2ab',
          '33:cab;4;c2v^9;p 21 n b;p -2bc 2a',
          '33:cab*;4;c2v^9;p 21 n b*;p -2bc 21',
          '33:-cba;4;c2v^9;p 21 c n;p -2n 2a',
          '33:-cba*;4;c2v^9;p 21 c n*;p -2n 21',
          ...
          '36*;8;c2v^12;c m c 21*;c 21 -2',
          '36:ba-c;8;c2v^12;c c m 21;c 2c -2c',
          '36:ba-c*;8;c2v^12;c c m 21*;c 21 -2c',
          '36:cab;8;c2v^12;a 21 m a;a -2a 2a',
          '36:cab*;8;c2v^12;a 21 m a*;a -2a 21',
          '36:-cba;8;c2v^12;a 21 a m;a -2 2a',
          '36:-cba*;8;c2v^12;a 21 a m*;a -2 21',
          ...
          '68:1;16;d2h^22;c c c e:1;c 2 2 -1ac;-b',
          ...
          '135*;16;d4h^13;p 42/m b c*;-p 42 2ab',
          ...
          '154:_2;6;d3^6;p 32 2 1;p 32 2" (0 0 4);-b',
          ...
          '193*;24;d6h^3;p 63/m c m*;-p 63 2',
          '194;24;d6h^4;p 63/m m c;-p 6c 2c',
          '194*;24;d6h^4;p 63/m m c*;-p 63 2c',
    ...
    function () {
      ...
      Clazz_makeConstructor(
        ...
        function (hallSymbol) {
          try {
            ...
            if (JS.HallTranslation.getLatticeIndex(this.latticeCode) == 0)
              return;
            ...
            if (JU.Logger.debugging)
              JU.Logger.debug('Hallinfo: ' + hallSymbol + ' ' + str);
            var prevOrder = 0;
            var prevAxisType = '\u0000';
      ...
      Clazz_defineMethod(c$, 'dumpInfo', function () {
        ...
        for (var i = 0; i < this.nRotations; i++) {
          sb.append('\n\nrotation term ')
            .appendI(i + 1)
            .append(this.rotationTerms[i].dumpInfo(this.vectorCode));
        }
        return sb.toString();
      });
      Clazz_defineMethod(c$, 'getLatticeDesignation', function () {
      ...
      Clazz_makeConstructor(
        ...
        function (hallInfo, code, prevOrder, prevAxisType) {
          ...
          switch ((c = code.charAt(1))) {
            ...
            default:
              this.axisType =
                this.order == 1
                  ? '_'
                  : hallInfo.nRotations == 0
                  ? 'z'
                  : hallInfo.nRotations == 2
                  ? '*'
                  : prevOrder == 2 || prevOrder == 4
                  ? 'x'
                  : "'";
              code = code.substring(0, 1) + this.axisType + code.substring(1);
          }
          this.primitiveCode +=
            this.axisType == '_' ? '1' : code.substring(0, 2);
          ...
          for (var i = ptr; i < len; i++) {
            ...
            var t = JS.HallTranslation.getHallTranslation(
              translationCode,
              this.order,
            );
            if (t != null) {
        ...
        function (vectorCode) {
          ...
          if (this.rotation != null)
            sb.append('\noperator: ')
              ...
              .append('\nSeitz matrix:\n')
              .append(
                JS.SymmetryOperation.dumpSeitz(this.seitzMatrix12ths, false),
              );
          return sb.toString();
        },
        '~S',
  ...
  Clazz_load(['JU.M4'], 'JS.HallRotation', null, function () {
    ...
    c$.lookup = Clazz_defineMethod(
      c$,
      'lookup',
      function (code) {
        for (var i = JS.HallRotation.getHallTerms().length; --i >= 0; )
          if (JS.HallRotation.hallRotationTerms[i].rotCode.equals(code))
            return JS.HallRotation.hallRotationTerms[i];

        return null;
      },
      '~S',
    );
    c$.getHallTerms = Clazz_defineMethod(c$, 'getHallTerms', function () {
      return JS.HallRotation.hallRotationTerms == null
        ? (JS.HallRotation.hallRotationTerms = Clazz_newArray(-1, [
    ...
    Clazz_defineStatics(c$, 'hallRotationTerms', null);
  });
  Clazz_declarePackage('JS');
  Clazz_load(null, 'JS.HallTranslation', ['JU.P3i'], function () {
    ...
    c$.getHallLatticeEquivalent = Clazz_defineMethod(
      c$,
    ...
    c$.getLatticeIndex = Clazz_defineMethod(
      c$,
      'getLatticeIndex',
      function (latt) {
        for (
          var i = 1, ipt = 3;
          i <= JS.HallTranslation.nLatticeTypes;
          i++, ipt += 3
        )
          if (JS.HallTranslation.latticeTranslationData[ipt].charAt(0) == latt)
            return i;
    ...
    c$.getLatticeCode = Clazz_defineMethod(
      c$,
      'getLatticeCode',
      function (latt) {
        if (latt < 0) latt = -latt;
        return latt == 0
          ? '\0'
          : latt > JS.HallTranslation.nLatticeTypes
          ? JS.HallTranslation.getLatticeCode(
              JS.HallTranslation.getLatticeIndex(String.fromCharCode(latt)),
            )
          : JS.HallTranslation.latticeTranslationData[latt * 3].charAt(0);
      },
      '~N',
    );
    c$.getLatticeDesignation = Clazz_defineMethod(
      c$,
      ...
      function (latt) {
        ...
        return (
          str +
          JS.HallTranslation.getLatticeCode(latt) +
          ': ' +
          (isCentrosymmetric ? 'centrosymmetric ' : '') +
          JS.HallTranslation.latticeTranslationData[latt * 3 + 1]
        );
      },
      '~N',
    );
    c$.getLatticeDesignation2 = Clazz_defineMethod(
      c$,
    ...
    c$.getLatticeExtension = Clazz_defineMethod(
      c$,
      'getLatticeExtension',
      function (latt, isCentrosymmetric) {
        for (
          ...
          if (JS.HallTranslation.latticeTranslationData[ipt].charAt(0) == latt)
            return (
              JS.HallTranslation.latticeTranslationData[ipt + 2] +
              (isCentrosymmetric ? ' -1' : '')
            );
    ...
    c$.getHallTerms = Clazz_defineMethod(c$, 'getHallTerms', function () {
      return JS.HallTranslation.hallTranslationTerms == null
        ? (JS.HallTranslation.hallTranslationTerms = Clazz_newArray(-1, [
    ...
    c$.getHallTranslation = Clazz_defineMethod(
      c$,
      'getHallTranslation',
    ...
    c$.nLatticeTypes = c$.prototype.nLatticeTypes =
      Clazz_doubleToInt(JS.HallTranslation.latticeTranslationData.length / 3) -
      1;
    Clazz_defineStatics(c$, 'hallTranslationTerms', null);
  });
  Clazz_declarePackage('JS');
  Clazz_load(
    ['JU.M4'],
    ...
    function () {
      ...
      c$.finalizeF = Clazz_defineMethod(
        c$,
        'finalizeF',
        function (m, divisor) {
          if (divisor == 0) {
      ...
      c$.finalizeD = Clazz_defineMethod(
        c$,
        'finalizeD',
        function (m, divisor) {
          if (divisor == 0) {
      ...
      Clazz_defineMethod(
        ...
        'getXyz',
        function (normalized) {
          return (normalized && this.modDim == 0) || this.xyzOriginal == null
            ? this.xyz
            : this.xyzOriginal;
        },
        '~B',
      ...
      c$.dumpSeitz = Clazz_defineMethod(
        c$,
        'dumpSeitz',
        function (s, isCanonical) {
          ...
          for (var i = 0; i < 3; i++) {
            ...
            sb.append('[\t');
            for (var j = 0; j < 3; j++)
              sb.appendI(Clazz_floatToInt(r[j])).append('\t');
            ...
            sb.append(
              JS.SymmetryOperation.twelfthsOf(
                isCanonical
                  ? JS.SymmetryOperation.normalizeTwelfths(trans / 12, 12, true)
                  : Clazz_floatToInt(trans),
              ),
            ).append('\t]\n');
          }
          return sb.toString();
      ...
      Clazz_defineMethod(
        ...
        function (xyz, modDim, allowScaling) {
          ...
          if (xyz.indexOf('[[') == 0) {
            ...
            for (var i = this.linearRotTrans.length; --i >= 0; )
            ...
            this.xyz = this.isBio
              ? (this.xyzOriginal = Clazz_superCall(
                  this,
                  JS.SymmetryOperation,
                  'toString',
                  [],
                ))
              : JS.SymmetryOperation.getXYZFromMatrix(
                  this,
                  false,
                  false,
                  false,
          ...
          var strOut = JS.SymmetryOperation.getMatrixFromString(
            this,
            xyz,
            this.linearRotTrans,
            allowScaling,
          ...
          if (mxyz != null) {
            var isProper =
              JU.M4.newA16(this.linearRotTrans).determinant3() == 1;
            this.timeReversal =
              (xyz.indexOf('-x') < 0 == mxyz.indexOf('-mx') < 0) == isProper
                ? 1
                : -1;
          }
          this.setMatrix(isReverse);
          this.xyz = isReverse
            ? JS.SymmetryOperation.getXYZFromMatrix(this, true, false, false)
            : this.doNormalize
            ? strOut
            : xyz;
      ...
      c$.setDivisor = Clazz_defineMethod(
        c$,
        'setDivisor',
        function (xyz) {
          var pt = xyz.indexOf('/');
      ...
      Clazz_defineMethod(
        ...
        function (offset, isReverse) {
          ...
          for (var i = 0; rowPt < n; i++) {
            ...
            if (isTrans) {
              var denom =
                this.divisor == 0 ? Clazz_floatToInt(v) & 255 : this.divisor;
              if (denom == 0) denom = 12;
              v = JS.SymmetryOperation.finalizeF(v, this.divisor);
              if (offset != null) {
                if (pt < offset.length) v += offset[pt++];
              }
              v = JS.SymmetryOperation.normalizeTwelfths(
                ((v < 0 ? -1 : 1) * Math.abs(v * denom)) / denom,
                denom,
                this.doNormalize,
              );
              if (this.divisor == 0)
                v = JS.SymmetryOperation.toDivisor(v, denom);
              rowPt++;
            }
          ...
          this.xyz = JS.SymmetryOperation.getXYZFromMatrix(
            this,
            true,
            false,
            false,
      ...
      c$.getMatrixFromXYZ = Clazz_defineMethod(
        c$,
        'getMatrixFromXYZ',
        function (xyz) {
          var linearRotTrans = Clazz_newFloatArray(16, 0);
          xyz = JS.SymmetryOperation.getMatrixFromString(
            null,
            '!' + xyz,
            linearRotTrans,
            false,
          ...
          return xyz == null
            ...
            : JS.SymmetryOperation.div12(
                JU.M4.newA16(linearRotTrans),
                JS.SymmetryOperation.setDivisor(xyz),
              );
        },
        '~S',
      );
      c$.getJmolCanonicalXYZ = Clazz_defineMethod(
        c$,
        'getJmolCanonicalXYZ',
        function (xyz) {
          try {
      ...
      c$.getMatrixFromString = Clazz_defineMethod(
        c$,
        'getMatrixFromString',
        function (op, xyz, linearRotTrans, allowScaling) {
          ...
          var nRows = 4 + modDim;
          var divisor =
            op == null ? JS.SymmetryOperation.setDivisor(xyz) : op.divisor;
          ...
          for (var i = 0; i < len; i++) {
            switch ((ch = xyz.charAt(i))) {
              ...
              case 'h':
                ...
                strT += JS.SymmetryOperation.plusMinus(
                  strT,
                  val,
                  myLabels[ipt],
                );
              ...
              case ',':
                ...
                iValue = JS.SymmetryOperation.normalizeTwelfths(
                  iValue,
                  denom == 0 ? 12 : divisor == 0 ? denom : divisor,
                  doNormalize,
                );
                if (linearRotTrans != null)
                  linearRotTrans[tpt0 + nRows - 1] =
                    divisor == 0 && denom > 0
                      ? (iValue = JS.SymmetryOperation.toDivisor(numer, denom))
                      : iValue;
                strT += JS.SymmetryOperation.xyzFraction12(
                  iValue,
                  divisor == 0 ? denom : divisor,
                  false,
                  true,
                );
                strOut += (strOut === '' ? '' : ',') + strT;
      ...
      c$.replaceXn = Clazz_defineMethod(
        c$,
        'replaceXn',
        function (xyz, n) {
          for (var i = n; --i >= 0; )
            xyz = JU.PT.rep(
              xyz,
              JS.SymmetryOperation.labelsXn[i],
              JS.SymmetryOperation.labelsXnSub[i],
            );
      ...
      c$.toDivisor = Clazz_defineMethod(
        c$,
        'toDivisor',
      ...
      c$.xyzFraction12 = Clazz_defineMethod(
        c$,
        'xyzFraction12',
        function (n12ths, denom, allPositive, halfOrLess) {
          ...
          var s =
            denom == 12
              ? JS.SymmetryOperation.twelfthsOf(n)
              : n == 0
              ? '0'
              : n + '/' + denom;
      ...
      c$.twelfthsOf = Clazz_defineMethod(
        c$,
        'twelfthsOf',
        function (n12ths) {
          var str = '';
      ...
      c$.plusMinus = Clazz_defineMethod(
        c$,
        'plusMinus',
        function (strT, x, sx) {
          return x == 0
            ? ''
            : (x < 0 ? '-' : strT.length == 0 ? '' : '+') +
                (x == 1 || x == -1 ? '' : '' + Clazz_floatToInt(Math.abs(x))) +
                sx;
        },
        '~S,~N,~S',
      );
      c$.normalizeTwelfths = Clazz_defineMethod(
        c$,
        'normalizeTwelfths',
      ...
      c$.getXYZFromMatrix = Clazz_defineMethod(
        c$,
        'getXYZFromMatrix',
        function (mat, is12ths, allPositive, halfOrLess) {
          ...
          for (var i = 0; i < 3; i++) {
            ...
            var term = '';
            for (var j = 0; j < 3; j++)
              if (JS.SymmetryOperation.approxF(row[j]) != 0)
                term += JS.SymmetryOperation.plusMinus(
                  term,
                  row[j],
                  JS.SymmetryOperation.labelsXYZ[j + lpt],
                );

            if (JS.SymmetryOperation.approxF(row[3]) != 0)
              term += JS.SymmetryOperation.xyzFraction12(
                is12ths ? row[3] : row[3] * denom,
                denom,
                allPositive,
                halfOrLess,
              );
      ...
      c$.fcoord = Clazz_defineMethod(
        c$,
        'fcoord',
        function (p) {
          return (
            JS.SymmetryOperation.fc(p.x) +
            ' ' +
            JS.SymmetryOperation.fc(p.y) +
            ' ' +
            JS.SymmetryOperation.fc(p.z)
          );
        },
        'JU.T3',
      );
      c$.fc = Clazz_defineMethod(
        c$,
        'fc',
        function (x) {
          var xabs = Math.abs(x);
          ...
          if (x24 / 24 == Clazz_floatToInt(x24 / 24))
            return m + Clazz_doubleToInt(x24 / 24);
          if (x24 % 8 != 0) {
          ...
          return x24 == 0
            ...
            : x24 == 24
            ? m + '1'
            : m + Clazz_doubleToInt(x24 / 8) + '/3';
        },
        '~N',
      );
      c$.approxF = Clazz_defineMethod(
        c$,
        'approxF',
        function (f) {
      ...
      c$.getXYZFromRsVs = Clazz_defineMethod(
        c$,
        'getXYZFromRsVs',
            ...
            for (var j = 0; j < d; j++) {
              ...
              if (r != 0) {
                s +=
                  ...
                  (Math.abs(r) == 1
                    ? ''
                    : '' + Clazz_doubleToInt(Math.abs(r))) +
                  'x' +
                  (j + 1);
              }
            }
            s += JS.SymmetryOperation.xyzFraction12(
              Clazz_doubleToInt(va[i][0] * (is12ths ? 1 : 12)),
              12,
              false,
              true,
            );
      ...
      Clazz_defineMethod(c$, 'toString', function () {
        return this.rsvs == null
          ? Clazz_superCall(this, JS.SymmetryOperation, 'toString', [])
          : Clazz_superCall(this, JS.SymmetryOperation, 'toString', []) +
              ' ' +
              this.rsvs.toString();
      });
      Clazz_defineMethod(c$, 'getMagneticOp', function () {
        return this.magOp == 3.4028235e38
      ...
      Clazz_defineMethod(c$, 'getCentering', function () {
      ...
      Clazz_defineMethod(c$, 'getInfo', function () {
        if (this.info == null) {
      ...
      c$.normalizeOperationToCentroid = Clazz_defineMethod(
        c$,
        ...
        function (dim, m, atoms, atomIndex, count) {
          ...
          var y = 0;
          var z = 0;
          if (JS.SymmetryOperation.atomTest == null)
      ...
      c$.getLatticeCentering = Clazz_defineMethod(
        c$,
        'getLatticeCentering',
        function (ops) {
          var list = new JU.Lst();
      ...
      c$.labelsXYZ = c$.prototype.labelsXYZ = Clazz_newArray(-1, [
        'x',
        'y',
        'z',
      ]);
      c$.labelsXn = c$.prototype.labelsXn = Clazz_newArray(-1, [
        'x1',
        'x2',
        'x3',
        'x4',
      ...
      c$.labelsXnSub = c$.prototype.labelsXnSub = Clazz_newArray(-1, [
        'x',
        'y',
        'z',
        'a',
      ...
      Clazz_defineStatics(c$, 'atomTest', null);
    },
  );
  Clazz_declarePackage('JS');
  Clazz_load(
        ...
        function (info, unitCellParams, sg) {
          ...
          if (sg == null) {
            ...
            symmetryCount = info.containsKey('symmetryCount')
              ? info.get('symmetryCount').intValue()
              : 0;
            this.symmetryOperations = info.remove('symmetryOps');
            this.coordinatesAreFractional = info.containsKey(
              'coordinatesAreFractional',
            )
              ? info.get('coordinatesAreFractional').booleanValue()
              : false;
            this.isMultiCell =
              this.coordinatesAreFractional && this.symmetryOperations != null;
            ...
            for (var i = 0; i < symmetryCount; i++) {
              ...
              if (op.isCenteringOp)
                c +=
                  ' (' +
                  JU.PT.rep(
                    JU.PT.replaceAllCharacters(op.xyz, 'xyz', '0'),
                    '0+',
                    '',
                  ) +
                  ')';
          ...
          if (unitCellParams == null)
            unitCellParams = info.get('unitCellParams');
  ...
  Clazz_load(
    ...
    function () {
      ...
      c$.getKeyType = Clazz_defineMethod(
        c$,
        'getKeyType',
        function (id) {
          if ('type'.equals(id)) id = '_type';
          for (var type = 0; type < JS.SymmetryDesc.keys.length; type++)
            if (id.equalsIgnoreCase(JS.SymmetryDesc.keys[type]))
              return -1 - type;
      ...
      c$.nullReturn = Clazz_defineMethod(
        c$,
        'nullReturn',
        function (type) {
          switch (type) {
      ...
      c$.getInfo = Clazz_defineMethod(
        ...
        function (io, type) {
          ...
          if (
            type < 0 &&
            -type <= JS.SymmetryDesc.keys.length &&
            -type <= io.length
          )
            return io[-1 - type];
          switch (type) {
      ...
      c$.getInfoBS = Clazz_defineMethod(
        c$,
        'getInfoBS',
        function (type) {
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var plane = null;
          var pta00 =
            ptFrom == null || Float.isNaN(ptFrom.x) ? new JU.P3() : ptFrom;
          if (ptTarget != null) {
          ...
          pta03.add(pta00);
          var pt0 = JS.SymmetryDesc.rotTransCart(
            op,
            uc,
            pta00,
            JS.SymmetryDesc.vtrans,
          );
          var pt1 = JS.SymmetryDesc.rotTransCart(
            op,
            uc,
            JS.SymmetryDesc.pta01,
            JS.SymmetryDesc.vtrans,
          );
          var pt2 = JS.SymmetryDesc.rotTransCart(
            op,
            uc,
            JS.SymmetryDesc.pta02,
            JS.SymmetryDesc.vtrans,
          );
          var pt3 = JS.SymmetryDesc.rotTransCart(
            op,
            uc,
            pta03,
            JS.SymmetryDesc.vtrans,
          ...
          var info = JU.Measure.computeHelicalAxis(
            pta00,
            pt0,
            JU.Quat.getQuaternionFrame(pt0, pt1, pt2).div(
          ...
          if (haveInversion && isTranslation) {
            ...
            switch (ang1) {
              ...
              case 180:
                ...
                w =
                  -JS.SymmetryDesc.vtemp.x * pa1.x -
                  JS.SymmetryDesc.vtemp.y * pa1.y -
                  JS.SymmetryDesc.vtemp.z * pa1.z;
                plane = JU.P4.new4(
                ...
                margin =
                  Math.abs(w) < 0.01 &&
                  JS.SymmetryDesc.vtemp.x * JS.SymmetryDesc.vtemp.y > 0.4
                    ? 1.3
                    : 1.05;
                isRotation = false;
                haveInversion = false;
          ...
          if (bsInfo.get(2) || bsInfo.get(15)) {
            ...
            if (isInversionOnly) {
              ...
              info1 =
                'Ci: ' +
                JS.SymmetryDesc.strCoord(op, JS.SymmetryDesc.ptemp, op.isBio);
              ...
              if (haveInversion) {
                ...
                type = info1 =
                  Clazz_doubleToInt(360 / ang) + '-fold screw axis';
          ...
          if (id != null && bsInfo.get(3)) {
            ...
            if (isRotation) {
              ...
              if (pitch1 != 0 && !haveInversion) {
                ...
                if (haveInversion) {
                  ...
                  if (pitch1 == 0 && isSpecial)
                    ptr.scaleAdd2(0.25, JS.SymmetryDesc.vtemp, ptr);
                }
              }
              ...
              var v = this.modelSet.vwr
                .getTriangulator()
                .intersectPlane(plane, uc.getCanonicalCopy(margin, true), 3);
              if (v != null)
                for (var i = v.size(); --i >= 0; ) {
                  ...
                  draw1
                    ...
                    .appendI(i)
                    .append(' ')
                    .append(JU.Escape.eP(pts[0]))
                    .append(JU.Escape.eP(pts[1]));
          ...
          if (bsInfo.get(0) || bsInfo.get(17)) {
            xyzNew = op.isBio
              ...
              : op.modDim > 0
              ? op.xyzOriginal
              : JS.SymmetryOperation.getXYZFromMatrix(m2, false, false, false);
            if (isMagnetic) xyzNew = op.fixMagneticXYZ(m2, xyzNew, true);
          }
          var ret = new Array(20);
          for (
            var i = bsInfo.nextSetBit(0);
            i >= 0;
            ...
            switch (i) {
              ...
              case 19:
                if (
                  ...
                  m2 = JU.M4.newM4(op);
                  m2.add(JS.SymmetryDesc.vtrans);
                  xyzN = JS.SymmetryOperation.getXYZFromMatrix(
                    m2,
                    false,
                    false,
                    false,
              ...
              case 6:
                ...
                break;
              case 7:
                ret[i] = JS.SymmetryDesc.approx0(
                  pa1 != null && bsInfo.get(22) ? pta00 : pa1,
                );
                break;
              case 8:
              ...
              case 11:
                ret[i] =
                  JS.SymmetryDesc.vtrans.lengthSquared() > 0
                    ? JS.SymmetryDesc.vtrans
                    : null;
                break;
              case 12:
              ...
              case 17:
                ...
                if (!op.isBio && !xyzNew.equals(op.xyzOriginal)) {
                  if (op.number > 0) {
                    var orig = JS.SymmetryOperation.getMatrixFromXYZ(
                      op.xyzOriginal,
                    );
                    orig.sub(m2);
                    cift = new JU.P3();
                ...
                ret[i] =
                  ...
                  (cift == null
                    ? ' [0 0 0]'
                    : ' [' +
                      Clazz_floatToInt(-cift.x) +
                      ' ' +
                      Clazz_floatToInt(-cift.y) +
                      ' ' +
                      Clazz_floatToInt(-cift.z) +
                      ']');
                break;
              case 18:
      ...
      c$.checkHandedness = Clazz_defineMethod(
        c$,
        'checkHandedness',
        function (uc, ax1) {
          var a;
      ...
      c$.drawLine = Clazz_defineMethod(
        ...
        function (s, id, diameter, pt0, pt1, color) {
          s.append(id)
            .append(' diameter ')
            .appendF(diameter)
            .append(JU.Escape.eP(pt0))
            .append(JU.Escape.eP(pt1))
            .append(' color ')
            .append(color);
        },
        'JU.SB,~S,~N,JU.P3,JU.P3,~S',
      );
      c$.drawFrameLine = Clazz_defineMethod(
        c$,
        'drawFrameLine',
      ...
      c$.drawVector = Clazz_defineMethod(
        c$,
        'drawVector',
      ...
      c$.setFractional = Clazz_defineMethod(
        c$,
        'setFractional',
      ...
      c$.rotTransCart = Clazz_defineMethod(
        c$,
        'rotTransCart',
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var iop = op;
          var offset =
            options == 1073742066 && (type == 1140850689 || type == 134217751)
              ? pt2
              : null;
          ...
          if (pt2 == null) {
            ...
            var i = isBio
              ? symTemp.addBioMoleculeOperation(
                  uc.getSpaceGroup().finalOperations[iop],
                  op < 0,
                )
              : symTemp.addSpaceGroupOperation(
                  (op < 0 ? '!' : '=') + xyz,
                  Math.abs(op),
                );
            ...
            if (type == 134217751 || type == 1140850689) {
              ...
              return type == 1140850689
                ? this.getAtom(uc, iModel, iatom, sympt)
                : sympt;
            }
            ...
            var ret1 = this.getSymopInfoForPoints(
              sym,
              iModel,
              op,
              translation,
            ...
            if (type == 1140850689) {
              if (
                !Clazz_instanceOf(pt, JM.Atom) &&
                !Clazz_instanceOf(pt2, JM.Atom)
              )
                iatom = -1;
              return info == null
                ? nullRet
                : this.getAtom(uc, iModel, iatom, info[7]);
            }
          }
          ...
          if (nth < 0 && op <= 0 && (type == 1275068418 || isList)) {
            if (
              type == 1275068418 &&
              info.length > 0 &&
              !Clazz_instanceOf(info[0], Array)
            )
              info = Clazz_newArray(-1, [info]);
            var lst = new JU.Lst();
            for (var i = 0; i < info.length; i++)
              lst.addLast(
                JS.SymmetryDesc.getInfo(
                  info[i],
                  returnType < 0 ? returnType : type,
                ),
              );
        ...
        function (uc, iModel, iAtom, sympt) {
          ...
          if (iAtom >= 0)
            this.modelSet.getAtomBitsMDa(
              1094715402,
              Integer.$valueOf(this.modelSet.at[iAtom].getElementNumber()),
              (bsElement = new JU.BS()),
            );
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var asString =
            bsInfo.get(21) || (bsInfo.get(3) && bsInfo.cardinality() == 3);
          bsInfo.clear(21);
          var ret = asString ? '' : null;
          var sginfo = this.getSpaceGroupInfo(
            sym,
            modelIndex,
            null,
            symOp,
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var isStandard =
            ...
            drawID == null &&
            nth <= 0 &&
            bsInfo.cardinality() >= JS.SymmetryDesc.keys.length;
          var isBio = false;
          var sgNote = null;
          ...
          if (isForModel || !haveName) {
            ...
            if (matrixOnly) {
              ...
              if (modelIndex < 0)
                modelIndex = Clazz_instanceOf(pt1, JM.Atom)
                  ? pt1.mi
                  : this.modelSet.vwr.am.cmi;
              if (modelIndex < 0) sgNote = 'no single current model';
                ...
                !(isBio =
                  ...
                  null) &&
                (cellInfo = this.modelSet.getUnitCell(modelIndex)) == null
              )
            ...
            if (ops != null) {
              if (!matrixOnly) {
                if (isBio)
                  sym.setSpaceGroupTo(
                    JS.SpaceGroup.getNull(false, false, false),
                  );
                else sym.setSpaceGroup(false);
              }
              if (ops[0].timeReversal != 0)
                sym.getSpaceGroupOperation(0).timeReversal = 1;
              ...
              for (var i = 0, nop = 0; i < ops.length && nop != nth; i++) {
                ...
                if (matrixOnly) {
                  ...
                  iop =
                    !isNewIncomm && sym.getSpaceGroupOperation(i) != null
                      ? i
                      : isBio
                      ? sym.addBioMoleculeOperation(
                          sg.finalOperations[i],
                          false,
                        )
          ...
          if (isBio) {
            ...
            data = sym.getSpaceGroupInfoObj(
              sgName,
              cellInfo == null ? null : cellInfo.getUnitCellParams(),
              isFull,
              !isForModel,
            );
      ...
      Clazz_defineMethod(
        ...
        function (uc, ops, fracA, fracB, best) {
          ...
          for (var i = 0, n = ops.length; i < n; i++) {
            ...
            JS.SymmetryDesc.ptemp.setT(JS.SymmetryDesc.pta01);
            uc.unitize(JS.SymmetryDesc.pta01);
            var d = JS.SymmetryDesc.pta01.distanceSquared(
              JS.SymmetryDesc.pta02,
            );
            if (d < 1.96e-6) {
              JS.SymmetryDesc.vtrans.sub(JS.SymmetryDesc.ptemp);
    ...
    function () {
      ...
      c$.fromOABC = Clazz_defineMethod(
        ...
        function (oabc, setRelative) {
          ...
          var parameters = Clazz_newFloatArray(-1, [
            -1,
            0,
            0,
            0,
      ...
      c$.fromParams = Clazz_defineMethod(
        c$,
        'fromParams',
      ...
      Clazz_defineMethod(
        ...
        function (pt) {
          ...
          if (
            pt4 != null ? w <= 0 || isCell555P4 : pt.x >= 100 || pt.y >= 100
          ) {
            this.unitCellMultiplier =
              pt.z == 0 && pt.x == pt.y && !isCell555P4
                ? null
                : isCell555P4
                ? JU.P4.newPt(pt4)
                : JU.P3.newP(pt);
      ...
      Clazz_defineMethod(
        ...
        function (origin) {
          ...
          if (!wasOffset && this.fractionalOffset.lengthSquared() == 0)
            this.fractionalOffset = null;
        },
        'JU.T3',
      );
      ...
      Clazz_defineMethod(c$, 'getUnitCellMultiplied', function () {
        if (
          this.unitCellMultiplier == null ||
          (this.unitCellMultiplier.z > 0 &&
            this.unitCellMultiplier.z ==
              Clazz_floatToInt(this.unitCellMultiplier.z))
        )
          return this;
      ...
      Clazz_defineMethod(c$, 'getVertices', function () {
        return this.vertices;
      });
      Clazz_defineMethod(c$, 'getCartesianOffset', function () {
        return this.cartesianOffset;
      });
      Clazz_defineMethod(c$, 'getFractionalOffset', function () {
      ...
      Clazz_defineMethod(
        ...
        function (vwr, parBorU) {
          ...
          if (ortepType == 12) {
            ...
            var dd =
              ortepType == 8 || ortepType == 9 || ortepType == 10
                ? 19.739208802178716
                : ortepType == 4 || ortepType == 5
                ? 0.25
                : ortepType == 2 || ortepType == 3
                ? Math.log(2)
                : 1;
            ...
            var B12 =
              parBorU[3] * dd * (isFractional ? this.a_ * this.b_ : 1) * cc;
            var B13 =
              parBorU[4] * dd * (isFractional ? this.a_ * this.c_ : 1) * cc;
            var B23 =
              parBorU[5] * dd * (isFractional ? this.b_ * this.c_ : 1) * cc;
            parBorU[7] = Math.pow(
              ((((B11 / 19.739208802178716 / this.a_ / this.a_) * B22) /
                19.739208802178716 /
                this.b_ /
                this.b_) *
                B33) /
            ...
            Bcart[0] =
              this.a * this.a * B11 +
              this.b * this.b * this.cosGamma * this.cosGamma * B22 +
              this.c * this.c * this.cosBeta * this.cosBeta * B33 +
              this.a * this.b * this.cosGamma * B12 +
              this.b * this.c * this.cosGamma * this.cosBeta * B23 +
              this.a * this.c * this.cosBeta * B13;
            Bcart[1] =
              this.b * this.b * this.sinGamma * this.sinGamma * B22 +
              this.c * this.c * this.cA_ * this.cA_ * B33 +
              this.b * this.c * this.cA_ * this.sinGamma * B23;
            Bcart[2] = this.c * this.c * this.cB_ * this.cB_ * B33;
            Bcart[3] =
              2 * this.b * this.b * this.cosGamma * this.sinGamma * B22 +
              2 * this.c * this.c * this.cA_ * this.cosBeta * B33 +
              this.a * this.b * this.sinGamma * B12 +
              this.b *
                this.c *
                (this.cA_ * this.cosGamma + this.sinGamma * this.cosBeta) *
                B23 +
              this.a * this.c * this.cA_ * B13;
            Bcart[4] =
              2 * this.c * this.c * this.cB_ * this.cosBeta * B33 +
              this.b * this.c * this.cosGamma * B23 +
              this.a * this.c * this.cB_ * B13;
            Bcart[5] =
              2 * this.c * this.c * this.cA_ * this.cB_ * B33 +
              this.b * this.c * this.cB_ * this.sinGamma * B23;
          }
        ...
        function (withOffset) {
          ...
          if (
            ...
            JU.SimpleUnitCell.ijkToPoint3f(
              Clazz_floatToInt(this.unitCellMultiplier.x),
              cell0,
              0,
              0,
            );
            JU.SimpleUnitCell.ijkToPoint3f(
              Clazz_floatToInt(this.unitCellMultiplier.y),
              cell1,
              0,
              0,
            );
          ...
          var scale =
            this.unitCellMultiplier == null || this.unitCellMultiplier.z == 0
              ? 1
      ...
      Clazz_defineMethod(c$, 'initUnitcellVertices', function () {
        ...
        for (var i = 8; --i >= 0; )
          this.vertices[i] = this.matrixFractionalToCartesian.rotTrans2(
            JU.BoxInfo.unitCubePoints[i],
            new JU.P3(),
          );
      });
      Clazz_defineMethod(
        ...
        function (f1, f2, distance, dx, iRange, jRange, kRange, ptOffset) {
          ...
          for (var i = -iRange; i <= iRange; i++)
            for (var j = -jRange; j <= jRange; j++)
              for (var k = -kRange; k <= kRange; k++) {
                ptOffset.set(f2.x + i, f2.y + j, f2.z + k);
                this.toCartesian(ptOffset, true);
                var d = p1.distance(ptOffset);
                if (
                  dx > 0
                    ? Math.abs(d - distance) <= dx
                    : d <= distance && d > 0.1
                ) {
                  ptOffset.set(i, j, k);
                  return true;
      ...
      Clazz_defineMethod(c$, 'getUnitCellMultiplier', function () {
      ...
      Clazz_defineMethod(c$, 'getUnitCellVectors', function () {
        ...
        return Clazz_newArray(-1, [
          ...
          JU.P3.new3(this.fix(m.m00), this.fix(m.m10), this.fix(m.m20)),
          JU.P3.new3(this.fix(m.m01), this.fix(m.m11), this.fix(m.m21)),
          JU.P3.new3(this.fix(m.m02), this.fix(m.m12), this.fix(m.m22)),
        ]);
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_defineMethod(
        ...
        function (uc) {
          if (uc.unitCellParams.length != this.unitCellParams.length)
            return false;
          for (var i = this.unitCellParams.length; --i >= 0; )
            if (
              this.unitCellParams[i] != uc.unitCellParams[i] &&
              !(
                Float.isNaN(this.unitCellParams[i]) &&
                Float.isNaN(uc.unitCellParams[i])
              )
            )
              return false;

          return this.fractionalOffset == null
            ? !uc.hasOffset()
            : uc.fractionalOffset == null
            ? !this.hasOffset()
            : this.fractionalOffset.distanceSquared(uc.fractionalOffset) == 0;
        },
        'JS.UnitCell',
      );
      Clazz_defineMethod(c$, 'hasOffset', function () {
        return (
          this.fractionalOffset != null &&
          this.fractionalOffset.lengthSquared() != 0
        );
      });
      Clazz_defineMethod(
        c$,
        ...
        function (abc) {
          ...
          abc = JU.PT.rep(
            JU.PT.rep(
              JU.PT.rep(
                JU.PT.rep(
                  JU.PT.rep(JU.PT.rep(abc, 'ab', 'A'), 'bc', 'B'),
                  'ca',
                  'C',
                ),
                'ba',
      ...
      Clazz_defineMethod(
        ...
        function (def, retMatrix) {
          ...
          if (Clazz_instanceOf(def, String)) {
            ...
            var strans = '0,0,0';
            if (sdef.indexOf('a=') == 0)
              return JU.SimpleUnitCell.setOabc(sdef, null, pts);
            ...
            if (atrans.length == 3)
              for (var j = 0; j < 3; j++) {
                ...
                if (sfpt >= 0) {
                  ftrans[j] =
                    JU.PT.parseFloat(s.substring(0, sfpt)) /
                    JU.PT.parseFloat(s.substring(sfpt + 1));
                } else {
        ...
        function (toPrimitive, type, uc, primitiveToCrystal) {
          ...
          if (type == 'r' || primitiveToCrystal == null) {
            switch (type) {
              ...
              case 'A':
                mf = JU.M3.newA9(
                  Clazz_newFloatArray(-1, [1, 0, 0, 0, 0.5, 0.5, 0, -0.5, 0.5]),
                );
                break;
              case 'B':
                mf = JU.M3.newA9(
                  Clazz_newFloatArray(-1, [0.5, 0, 0.5, 0, 1, 0, -0.5, 0, 0.5]),
                );
                break;
              case 'C':
                mf = JU.M3.newA9(
                  Clazz_newFloatArray(-1, [0.5, 0.5, 0, -0.5, 0.5, 0, 0, 0, 1]),
                );
                break;
              case 'R':
                mf = JU.M3.newA9(
      ...
      Clazz_defineMethod(
        ...
        function (latticeType, primitiveToCrystal) {
          ...
          if (!latticeType.equals('P') || primitiveToCrystal != null)
            this.toFromPrimitive(
              false,
              latticeType.charAt(0),
              oabc,
              primitiveToCrystal,
            );
          return oabc;
      ...
      c$.cloneUnitCell = Clazz_defineMethod(
        c$,
        'cloneUnitCell',
        function (uc) {
          var ucnew = null;
      ...
      Clazz_defineMethod(
        ...
        function (pt, flags, ops, list, i0, n0) {
          ...
          if (!tofractional) {
            for (var i = list.size(); --i >= n0; )
              this.toCartesian(list.get(i), true);
          }
          return list;
        },
        'JU.P3,~S,~A,JU.Lst,~N,~N',
      );
      c$.checkDuplicate = Clazz_defineMethod(
        c$,
        'checkDuplicate',
      ...
      Clazz_defineMethod(c$, 'getState', function () {
        var s = '';
        if (
          this.fractionalOffset != null &&
          this.fractionalOffset.lengthSquared() != 0
      ...
      Clazz_defineStatics(c$, 'twoP2', 19.739208802178716);
      c$.unitVectors = c$.prototype.unitVectors = Clazz_newArray(-1, [
        JV.JC.axisX,
        JV.JC.axisY,
        JV.JC.axisZ,
      ]);
