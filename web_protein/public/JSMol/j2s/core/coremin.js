(function (
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (steps, crit, bsSelected, bsFixed, bsBasis, flags, ff) {
          ...
          if (crit <= 0) {
            ...
            if (val != null && Clazz_instanceOf(val, Float))
              crit = val.floatValue();
          }
          this.crit = Math.max(crit, 0.0001);
          if (steps == 2147483647) {
            val = this.vwr.getP('minimizationSteps');
            if (val != null && Clazz_instanceOf(val, Integer))
              steps = val.intValue();
          }
          this.steps = steps;
          try {
            ...
            for (
              ...
              if (this.atoms[i].getElementNumber() == 0) {
                if (bsXx == null) {
                  ...
                  bsXx.set(i);
                  JU.Logger.info(
                    'minimize: Setting Xx to fluorine for atomIndex=' + i,
                  );
            ...
            if (
              (!sameAtoms || !JU.BSUtil.areEqual(bsFixed, this.bsFixed)) &&
            ...
            if (this.constraints != null)
              for (var i = this.constraints.size(); --i >= 0; )
                this.constraints.get(i).set(steps, this.bsAtoms, this.atomMap);
      ...
      Clazz_defineMethod(c$, 'setEnergyUnits', function () {
        var s = this.vwr.g.energyUnits;
        this.units = s.equalsIgnoreCase('kcal') ? 'kcal' : 'kJ';
      });
      Clazz_defineMethod(c$, 'setupMinimization', function () {
        this.coordSaved = null;
        ...
        for (
          var i = this.bsAtoms.nextSetBit(0), pt = 0;
          i >= 0;
          i = this.bsAtoms.nextSetBit(i + 1), pt++
        ) {
          ...
          this.minAtoms[pt] = new JM.MinAtom(
            pt,
            atom,
            Clazz_newDoubleArray(-1, [atom.x, atom.y, atom.z]),
            this.ac,
          );
      ...
      Clazz_defineMethod(c$, 'setAtomPositions', function () {
        ...
        if (this.bsFixed != null) {
          ...
          for (
            ...
            if (this.bsFixed.get(i)) this.bsMinFixed.set(pt);
        }
      });
      Clazz_defineMethod(c$, 'getBonds', function () {
        ...
        for (var i = 0; i < this.rawBondCount; i++) {
          ...
          if (
            !this.bsAtoms.get((i1 = bond.atom1.i)) ||
            !this.bsAtoms.get((i2 = bond.atom2.i))
          )
            continue;
          if (i2 < i1) {
            var ii = i1;
      ...
      Clazz_defineMethod(c$, 'getAngles', function () {
                ...
                vAngles.addLast(
                  new JM.MinAngle(
                    Clazz_newIntArray(-1, [
                      ...
                      ic,
                      i,
                      this.minAtoms[ib].getBondIndex(j),
                    ]),
                  ),
                );
                ...
                vAngles.addLast(
                  new JM.MinAngle(
                    Clazz_newIntArray(-1, [
                      ...
                      ia,
                      ib,
                      this.minAtoms[ia].getBondIndex(j),
                      i,
                    ]),
                  ),
                );
      ...
      Clazz_defineMethod(c$, 'getTorsions', function () {
                ...
                vTorsions.addLast(
                  new JM.MinTorsion(
                    Clazz_newIntArray(-1, [
                      ...
                      angle[3],
                      angle[4],
                      this.minAtoms[ic].getBondIndex(j),
                    ]),
                  ),
                );
      ...
      Clazz_defineMethod(
        ...
        function (ff) {
          ...
          if (
            this.pFF == null ||
            !ff.equals(this.ff) ||
            this.pFF.name.indexOf('2D') >= 0 != this.isQuick
          ) {
            if (ff.equals('MMFF')) {
      ...
      Clazz_defineMethod(c$, 'minimizationOn', function () {
        return this.$minimizationOn;
      });
      Clazz_defineMethod(c$, 'getThread', function () {
      ...
      Clazz_defineMethod(c$, 'getEnergyOnly', function () {
      ...
      Clazz_defineMethod(c$, 'reportEnergy', function () {
        this.vwr.setFloatProperty(
          '_minimizationEnergy',
          this.pFF.toUserUnits(this.pFF.getEnergy()),
        );
      });
      Clazz_defineMethod(c$, 'startMinimization', function () {
        try {
      ...
      Clazz_defineMethod(c$, 'stepMinimization', function () {
        if (!this.$minimizationOn) return false;
        var doRefresh =
      ...
      Clazz_defineMethod(c$, 'endMinimization', function () {
        this.updateAtomXYZ();
        this.setMinimizationOn(false);
        if (this.pFF == null) {
      ...
      Clazz_defineMethod(c$, 'saveCoordinates', function () {
        if (this.coordSaved == null)
          this.coordSaved = Clazz_newDoubleArray(this.ac, 3, 0);
        for (var i = 0; i < this.ac; i++)
          for (var j = 0; j < 3; j++)
            this.coordSaved[i][j] = this.minAtoms[i].coord[j];
      });
      Clazz_defineMethod(c$, 'restoreCoordinates', function () {
      ...
      Clazz_defineMethod(c$, 'updateAtomXYZ', function () {
        ...
        if (this.bsBasis == null) {
          ...
          for (var i = 0; i < this.ac; i++) {
            ...
            if (this.bsBasis.get((a = minAtom.atom).i)) {
              ...
              this.vwr
                .getModelkit(false)
                .moveConstrained(a.i, this.p, true, true);
            }
          }
          for (var i = 0; i < this.ac; i++) {
            var minAtom = this.minAtoms[i];
      ...
      Clazz_defineMethod(c$, 'minimizeWithoutThread', function () {
      ...
      Clazz_defineMethod(
        ...
        function (ms, bsAtoms, bsReport) {
          ...
          this.vwr.setAtomProperty(
            bsReport == null ? bsAtoms : bsReport,
            1111492619,
            0,
            0,
            null,
      ...
      Clazz_defineMethod(c$, 'getForceFieldUsed', function () {
  ...
  Clazz_overrideMethod(c$, 'toString', function () {
    return (
      ...
      ',' +
      this.data[1] +
      (this.data.length > 2 ? ',' + this.data[2] + ',' + this.data[3] : '') +
      ' ' +
  ...
  c$.getKey = Clazz_defineMethod(
    ...
    function (type, a1, a2, a3, a4) {
      return Integer.$valueOf(
        (((((((a4 << 7) + a3) << 7) + a2) << 7) + a1) << 4) + type,
      );
    },
    '~N,~N,~N,~N,~N',
  );
  c$.decodeKey = Clazz_defineMethod(
    c$,
    'decodeKey',
    function (key) {
    ...
    Clazz_defineMethod(
      ...
      function (iAtom) {
        ...
        for (var i = 0; i < this.nBonds; i++)
          if (this.bondedAtoms[i] == iAtom) return this.bonds.get(i);

        return null;
      },
      '~N',
    );
    Clazz_defineMethod(c$, 'getBondedAtomIndexes', function () {
      if (this.bondedAtoms == null) {
        this.bondedAtoms = Clazz_newIntArray(this.nBonds, 0);
        for (var i = this.nBonds; --i >= 0; )
          this.bondedAtoms[i] = this.bonds.get(i).getOtherAtom(this.index);
      }
      return this.bondedAtoms;
    });
    Clazz_defineMethod(c$, 'getIdentity', function () {
  ...
  Clazz_load(
    null,
    'JM.Util',
    ['java.lang.Double', 'java.util.Random'],
    function () {
      c$ = Clazz_declareType(JM, 'Util');
      c$.sub = Clazz_defineMethod(
        c$,
        'sub',
        function (a, b, result) {
      ...
      c$.distance2 = Clazz_defineMethod(
        c$,
        'distance2',
        function (a, b) {
          var dx = a[0] - b[0];
      ...
      c$.distance2V = Clazz_defineMethod(
        c$,
        'distance2V',
        function (a, b) {
          var dx = a.x - b.x;
      ...
      c$.getAngleRadiansABC = Clazz_defineMethod(
        c$,
        'getAngleRadiansABC',
        function (a, b, c) {
          ...
          return JM.Util.isNearZero2(ab2, 1e-3) ||
            JM.Util.isNearZero2(bc2, 1e-3)
            ? 0
            : Math.acos((ab2 + bc2 - ac2) / 2 / Math.sqrt(ab2 * bc2));
        },
        '~A,~A,~A',
      );
      c$.isApprox = Clazz_defineMethod(
        c$,
        'isApprox',
      ...
      c$.canBeSquared = Clazz_defineMethod(
        c$,
        'canBeSquared',
        function (x) {
          if (x == 0) return true;
      ...
      c$.isNegligible = Clazz_defineMethod(
        c$,
        'isNegligible',
        function (a, b) {
      ...
      c$.isNegligible3 = Clazz_defineMethod(
        c$,
        'isNegligible3',
        function (a, b, precision) {
      ...
      c$.isNearZero = Clazz_defineMethod(
        c$,
        'isNearZero',
        function (a) {
      ...
      c$.isNearZero2 = Clazz_defineMethod(
        c$,
        'isNearZero2',
        function (a, epsilon) {
      ...
      c$.canBeNormalized = Clazz_defineMethod(
        c$,
        'canBeNormalized',
        function (a) {
      ...
      c$.pointPlaneAngleRadians = Clazz_defineMethod(
        c$,
        ...
        function (a, b, c, d, v1, v2, norm, fixTheta) {
          ...
          v2.add(v1);
          v1.sub2(b, a);
          var angleA_CD = fixTheta
            ? JM.Util.vectorAngleRadians(v2, v1)
            : 3.141592653589793;
          var angleNorm = JM.Util.vectorAngleRadians(norm, v1);
          if (angleNorm > 1.5707963267948966)
            angleNorm = 3.141592653589793 - angleNorm;
          var val =
            1.5707963267948966 +
            (angleA_CD > 1.5707963267948966 ? -angleNorm : angleNorm);
          return val;
        },
        'JU.V3d,JU.V3d,JU.V3d,JU.V3d,JU.V3d,JU.V3d,JU.V3d,~B',
      );
      c$.vectorAngleRadians = Clazz_defineMethod(
        c$,
        'vectorAngleRadians',
        function (v1, v2) {
          var l1 = v1.length();
          var l2 = v2.length();
          return JM.Util.isNearZero(l1) || JM.Util.isNearZero(l2)
            ? 0
            : Math.acos(v1.dot(v2) / (l1 * l2));
        },
        'JU.V3d,JU.V3d',
      );
      c$.getTorsionAngleRadians = Clazz_defineMethod(
        c$,
      ...
      c$.restorativeForceAndDistance = Clazz_defineMethod(
        c$,
      ...
      c$.randomizeUnitVector = Clazz_defineMethod(
        c$,
        'randomizeUnitVector',
        function (v) {
      ...
      c$.restorativeForceAndAngleRadians = Clazz_defineMethod(
        c$,
      ...
      c$.restorativeForceAndOutOfPlaneAngleRadians = Clazz_defineMethod(
        c$,
        ...
        function (i, j, k, l, an, bn, cn) {
          ...
          if (
            JM.Util.isNearZero(length_ji) ||
            JM.Util.isNearZero(length_jk) ||
            JM.Util.isNearZero(length_jl)
          ) {
            i.set(0, 0, 0);
            j.set(0, 0, 0);
            k.set(0, 0, 0);
          ...
          if (
            JM.Util.isNearZero(theta) ||
            JM.Util.isNearZero(Math.abs(theta - 3.141592653589793))
          ) {
            i.set(0, 0, 0);
            j.set(0, 0, 0);
            k.set(0, 0, 0);
          ...
          if (
            cos_dl < 0.0001 ||
            JM.Util.isNearZero(dl) ||
            JM.Util.isNearZero(Math.abs(dl - 3.141592653589793))
          ) {
            i.set(0, 0, 0);
            j.set(0, 0, 0);
            k.set(0, 0, 0);
      ...
      c$.restorativeForceAndTorsionAngleRadians = Clazz_defineMethod(
        c$,
        ...
        function (i, j, k, l) {
          ...
          var len_kl = k.length();
          if (
            JM.Util.isNearZero(len_ij) ||
            JM.Util.isNearZero(len_jk) ||
            JM.Util.isNearZero(len_kl)
          ) {
            i.set(0, 0, 0);
            j.set(0, 0, 0);
            k.set(0, 0, 0);
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'setModelFields', function () {
      ...
      Clazz_defineMethod(
        ...
        function (stepMax, criterion, trustRadius) {
          ...
          this.calc.setLoggingEnabled(
            stepMax == 0 || JU.Logger.isActiveLevel(6),
          );
          var s =
            this.name +
            ' ' +
          ...
          s = JU.PT.sprintf(
            ...
            Clazz_newArray(-1, [
              ...
              Float.$valueOf(this.toUserUnits(criterion)),
            ]),
          );
      ...
      Clazz_defineMethod(c$, 'clearForces', function () {
        for (var i = 0; i < this.minAtomCount; i++)
          this.minAtoms[i].force[0] =
            this.minAtoms[i].force[1] =
            this.minAtoms[i].force[2] =
              0;
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_defineMethod(
        ...
        function (gradients, isSilent) {
          ...
          energy =
            this.energyBond(gradients) +
            this.energyAngle(gradients) +
            this.energyTorsion(gradients) +
            this.energyStretchBend(gradients) +
            this.energyOOP(gradients) +
            this.energyVDW(gradients) +
            this.energyES(gradients);
          if (!isSilent && this.calc.loggingEnabled)
            this.calc.appendLogData(
              JU.PT.sprintf(
                ...
                Clazz_newArray(-1, [
                  this.name,
                  Float.$valueOf(this.toUserUnits(energy)),
                  this.minimizer.units,
                ]),
              ),
            );
      ...
      Clazz_defineMethod(c$, 'linearSearch', function () {
            ...
            if (this.bsFixed == null || !this.bsFixed.get(i)) {
              ...
              for (var j = 0; j < 3; ++j) {
                if (JM.Util.isFinite(force[j])) {
                  ...
                  else if (tempStep < -this.trustRadius)
                    coord[j] -= this.trustRadius;
      ...
      Clazz_defineMethod(c$, 'saveCoordinates', function () {
        if (this.coordSaved == null)
          this.coordSaved = Clazz_newDoubleArray(this.minAtomCount, 3, 0);
        for (var i = 0; i < this.minAtomCount; i++)
          for (var j = 0; j < 3; j++)
            this.coordSaved[i][j] = this.minAtoms[i].coord[j];
      });
      ...
      Clazz_defineMethod(c$, 'detectExplosion', function () {
        for (var i = 0; i < this.minAtomCount; i++) {
          var atom = this.minAtoms[i];
          for (var j = 0; j < 3; j++)
            if (!JM.Util.isFinite(atom.coord[j])) return true;
        }
        for (var i = 0; i < this.minBondCount; i++) {
          var bond = this.minBonds[i];
          if (
            JM.Util.distance2(
              this.minAtoms[bond.data[0]].coord,
              this.minAtoms[bond.data[1]].coord,
            ) > 900.0
          )
            return true;
        }
      ...
      Clazz_defineMethod(c$, 'getCurrentStep', function () {
        return this.currentStep;
      });
      Clazz_defineMethod(c$, 'getEnergy', function () {
        return this.e0;
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_defineMethod(c$, 'getEnergyDiff', function () {
        return this.dE;
      });
      Clazz_defineMethod(c$, 'getLogData', function () {
        return this.calc.getLogData();
      });
      Clazz_defineMethod(c$, 'getNormalizedDE', function () {
      ...
      Clazz_defineMethod(
        ...
        function (energy, units) {
          return units.equalsIgnoreCase(this.minimizer.units)
            ? energy
            : energy *
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'getAtomTypeDescriptions', function () {
        return JM.FF.ForceFieldMMFF.getAtomTypeDescs(this.rawAtomTypes);
      });
      Clazz_defineMethod(c$, 'getPartialCharges', function () {
      ...
      Clazz_overrideMethod(c$, 'clear', function () {});
      Clazz_overrideMethod(
        c$,
        'setModel',
      ...
      Clazz_defineMethod(
        ...
        function (isQuick) {
          ...
          if (JU.Logger.debugging)
            JU.Logger.debug('reading data from ' + resourceName);
          var br = null;
          var line = null;
          try {
      ...
      Clazz_defineMethod(
        ...
        function (br, dataType, data) {
          ...
          do {
            ...
            if (JU.Logger.debugging)
              JU.Logger.debug(
                JM.MinObject.decodeKey(key) +
                  ' ' +
                  (Clazz_instanceOf(value, Float)
                    ? value
                    : JU.Escape.eAD(value)),
              );
          } while (!(this.line = br.readLine()).startsWith('$'));
      ...
      Clazz_defineMethod(
        ...
        function (i, j) {
          return Double.$valueOf(
            this.line.substring(i, j).trim(),
          ).doubleValue();
        },
        '~N,~N',
      );
      Clazz_defineMethod(c$, 'getAtomTypes', function () {
        ...
        try {
          ...
          var at;
          types.addLast(
            new JM.FF.AtomType(0, 0, 0, 0, 1, 'H or NOT FOUND', ''),
          );
      ...
      Clazz_defineMethod(
        ...
        function (bonds, bTypes, atoms, aTypes, bsAtoms, doRound) {
          ...
          for (
            ...
            partialCharges[i] = JM.FF.ForceFieldMMFF.atomTypes.get(
              Math.max(0, aTypes[i]),
            ).formalCharge;
          ...
          for (var i = bTypes.length; --i >= 0; ) {
            ...
            try {
              ...
              var key = JM.MinObject.getKey(
                bondType,
                bFactor == 1 ? type2 : type1,
                bFactor == 1 ? type1 : type2,
                127,
                124,
              );
              var bciValue = this.ffParams.get(key);
              var bci = NaN;
              var msg = JU.Logger.debugging
                ? a1 +
                  '/' +
                  a2 +
                  ' mmTypes=' +
              ...
              if (bciValue == null) {
                ...
                if (
                  (a = this.ffParams.get(
                    JM.MinObject.getKey(0, type1, 127, 127, 127),
                  )) != null &&
                  (b = this.ffParams.get(
                    JM.MinObject.getKey(0, type2, 127, 127, 127),
                  )) != null
                ) {
                  var pa = a.floatValue();
                  var pb = b.floatValue();
              ...
              dq =
                at2.fcadj * at2.formalCharge -
                at1.fcadj * at1.formalCharge +
                bci;
            } catch (e) {
              if (Clazz_exceptionOf(e, Exception)) {
                dq = NaN;
      ...
      c$.isSpecialBondType = Clazz_defineMethod(
        c$,
        'isSpecialBondType',
        function (at1, at2) {
      ...
      Clazz_defineMethod(
        ...
        function (bond, at1, at2, index1, index2) {
          return JM.FF.ForceFieldMMFF.isSpecialBondType(at1, at2) &&
            bond.getCovalentOrder() == 1 &&
            !this.isAromaticBond(index1, index2)
            ? 1
            : 0;
        },
      ...
      Clazz_defineMethod(
        ...
        function (a1, a2) {
          if (this.vRings[3] != null)
            for (var i = this.vRings[3].size(); --i >= 0; ) {
      ...
      c$.getAtomTypeDescs = Clazz_defineMethod(
        c$,
        'getAtomTypeDescs',
        function (types) {
          var stypes = new Array(types.length);
          for (var i = types.length; --i >= 0; ) {
            stypes[i] = String.valueOf(
              types[i] < 0
                ? -types[i]
                : JM.FF.ForceFieldMMFF.atomTypes.get(types[i]).mmType,
            );
          }
          return stypes;
        },
      ...
      c$.setAtomTypes = Clazz_defineMethod(
        c$,
        'setAtomTypes',
        function (atoms, bsAtoms, smartsMatcher, vRings, allowUnknowns) {
          ...
          for (
            var i = bsConnected.nextSetBit(0);
            i >= 0;
          ...
          try {
            smartsMatcher.getMMFF94AtomTypes(
              smarts,
              atoms,
              atoms.length,
              bsConnected,
          ...
          for (
            var i = bsHydrogen.nextSetBit(0);
            i >= 0;
            i = bsHydrogen.nextSetBit(i + 1)
          ) {
              ...
              JU.Logger.debug(
                'atom ' +
                  ...
                  (types[i] < 0
                    ...
                    : JM.FF.ForceFieldMMFF.atomTypes.get(types[i]).mmType +
                      '\t' +
                      JM.FF.ForceFieldMMFF.atomTypes.get(types[i]).smartsCode +
                      '\t' +
                      JM.FF.ForceFieldMMFF.atomTypes.get(types[i]).descr),
              );

          if (
            !allowUnknowns &&
            bsDone.cardinality() != bsConnected.cardinality()
          )
            return null;
          return types;
        },
      ...
      Clazz_defineMethod(c$, 'fixTypes', function () {
        for (var i = this.minAtomCount; --i >= 0; ) {
          ...
          var type =
            it < 0 ? -it : JM.FF.ForceFieldMMFF.atomTypes.get(it).mmType;
          a.ffType = type;
      ...
      Clazz_defineMethod(
        ...
        function (angle) {
          angle.type =
            this.minBonds[angle.data[3]].type +
            this.minBonds[angle.data[4]].type;
      ...
      Clazz_defineMethod(
        ...
        function (t) {
          ...
          t.type =
            this.minBonds[t.data[5]].type == 1
              ? 1
              : this.minBonds[t.data[4]].type == 0 &&
                this.minBonds[t.data[6]].type == 0
              ? 0
              : 2;
        ...
        function (v, minlist, n) {
          if (v != null)
            for (var i = v.size(); --i >= 0; ) {
              var bs = v.get(i);
              if (
                bs.get(this.minAtoms[minlist[0]].atom.i) &&
                bs.get(this.minAtoms[minlist[1]].atom.i) &&
                (n < 3 || bs.get(this.minAtoms[minlist[2]].atom.i)) &&
                (n < 4 || bs.get(this.minAtoms[minlist[3]].atom.i))
              )
                return true;
            }
          return false;
      ...
      Clazz_defineMethod(
        ...
        function (obj, type, ktype) {
          ...
          switch (ktype) {
            case 3:
              return ddata != null && ddata[0] > 0
                ? key
                : this.applyEmpiricalRules(o, ddata, 3);
            case 5:
            ...
            case 9:
              if (ddata == null) {
                if (
                  ...
                  !this.ffParams.containsKey(
                    (key = this.getTorsionKey(type, 2, 0)),
                  ) &&
                  !this.ffParams.containsKey(
                    (key = this.getTorsionKey(type, 2, 2)),
                  )
                )
              ...
              return ddata != null
                ? key
                : this.applyEmpiricalRules(o, ddata, 9);
            case 21:
          ...
          for (var i = 0; i < 3 && !haveKey; i++) {
            for (var j = 0, bit = 1; j < n; j++, bit <<= 1)
              if ((ktype & bit) == bit)
                this.typeData[j] = JM.FF.ForceFieldMMFF.getEquivalentType(
                  this.typeOf(data[j]),
                  i,
                );
            ...
            switch (ktype) {
              case 3:
                isSwapped = JM.FF.ForceFieldMMFF.fixTypeOrder(
                  this.typeData,
                  0,
                  1,
                );
          ...
          switch (ktype) {
            case 5:
              return ddata != null && ddata[0] != 0
                ? key
                : this.applyEmpiricalRules(o, ddata, 5);
          }
          return key;
        },
        '~O,~N,~N',
      ...
      Clazz_defineMethod(
        ...
        function (type, i, j) {
          return JM.MinObject.getKey(
            type,
            JM.FF.ForceFieldMMFF.getEquivalentType(this.typeData[0], i),
            this.typeData[1],
            this.typeData[2],
            JM.FF.ForceFieldMMFF.getEquivalentType(this.typeData[3], j),
          );
        },
        '~N,~N,~N',
      );
        ...
        function (o, ddata, ktype) {
          ...
          switch (ktype) {
            case 3:
              ...
              var key = JM.MinObject.getKey(
                0,
                Math.min(elemno1, elemno2),
                Math.max(elemno1, elemno2),
                127,
                123,
              );
              ddata = this.ffParams.get(key);
              ...
              var kbref = ddata[0];
              var r0ref = ddata[1];
              var r0 = JM.FF.ForceFieldMMFF.getRuleBondLength(
                a,
                b,
                o.order,
                this.isAromaticBond(o.data[0], o.data[1]),
              );
              if (r0 == 0) return null;
              rr = r0ref / r0;
              rr2 = rr * rr;
            ...
            case 5:
              ...
              var za = JM.FF.ForceFieldMMFF.getZParam(
                this.minAtoms[o.data[0]].atom.getElementNumber(),
              );
              var cb = JM.FF.ForceFieldMMFF.getCParam(
                this.minAtoms[o.data[1]].atom.getElementNumber(),
              );
              var zc = JM.FF.ForceFieldMMFF.getZParam(
                this.minAtoms[o.data[2]].atom.getElementNumber(),
              );
            ...
            case 9:
              ...
              out: while (true) {
                ...
                if (
                  (crdB != 4 && (valB > crdB || mltbB > 0)) ||
                  (crdC != 4 && (valC > crdC || mltbC > 0))
                )
                  return null;
      ...
      c$.fixTypeOrder = Clazz_defineMethod(
        c$,
        'fixTypeOrder',
        function (a, i, j) {
          if (a[i] > a[j]) {
      ...
      c$.getEquivalentType = Clazz_defineMethod(
        c$,
        'getEquivalentType',
        function (type, level) {
          return type == 0
            ...
            : level == 2
            ? 0
            : JM.FF.ForceFieldMMFF.equivalentTypes[((type - 1) << 1) + level];
        },
        '~N,~N',
      );
      c$.getZParam = Clazz_defineMethod(
        c$,
        'getZParam',
        function (elemno) {
          switch (elemno) {
      ...
      c$.getCParam = Clazz_defineMethod(
        c$,
        'getCParam',
        function (elemno) {
          switch (elemno) {
      ...
      c$.getUParam = Clazz_defineMethod(
        c$,
        'getUParam',
        function (elemno) {
          switch (elemno) {
      ...
      c$.getVParam = Clazz_defineMethod(
        c$,
        'getVParam',
        function (elemno) {
          switch (elemno) {
      ...
      c$.getCovalentRadius = Clazz_defineMethod(
        c$,
        'getCovalentRadius',
        function (elemno) {
          switch (elemno) {
      ...
      c$.getRuleBondLength = Clazz_defineMethod(
        c$,
        'getRuleBondLength',
      ...
      Clazz_defineStatics(
        ...
        'types',
        Clazz_newIntArray(-1, [0, 1, 34, 5, 546, 3, 13, 21, 37, 9, 17]),
        'sbMap',
        Clazz_newIntArray(-1, [0, 1, 3, 5, 4, 6, 8, 9, 11]),
        'equivalentTypes',
        Clazz_newIntArray(
          -1,
          [
    ...
    function () {
      ...
      Clazz_overrideMethod(
        ...
        function (bsElements, elemnoMax) {
          ...
          if (
            this.ffParams == null ||
            (JM.FF.ForceFieldUFF.atomTypes == null &&
              (JM.FF.ForceFieldUFF.atomTypes = this.getAtomTypes()) == null)
          )
            return false;
        ...
        function (bsElements, elemnoMax) {
          ...
          for (var i = 0; i < nTypes; i++) {
            ...
            if (bsElements.get(0)) bsElements.clear(0);
              ...
              for (
                var j = this.minimizer.bsAtoms.nextSetBit(0), pt = 0;
                j < this.minimizer.atoms.length && j >= 0;
                j = this.minimizer.bsAtoms.nextSetBit(j + 1), pt++
              )
                if (search.get(j)) {
      ...
      Clazz_defineMethod(
        ...
        function (smarts, elemnoMax, bsElements) {
          ...
          if (JU.Logger.debugging && bs.nextSetBit(0) >= 0)
            JU.Logger.debug(smarts + ' minimize atoms=' + bs);
          return bs;
        },
        '~S,~N,JU.BS',
      );
      Clazz_defineMethod(c$, 'getParameters', function () {
        var data = new java.util.Hashtable();
        ...
        try {
          ...
          if (Clazz_exceptionOf(e, Exception)) {
            System.err.println(
              'Exception ' + e.toString() + ' in getResource ' + resourceName,
            );
            try {
              br.close();
            } catch (ee) {
      ...
      Clazz_defineMethod(c$, 'getAtomTypes', function () {
        ...
        try {
          ...
          if (Clazz_exceptionOf(e$$, JV.JmolAsyncException)) {
            ...
            {
              System.err.println(
                'Exception ' + e.toString() + ' in getResource ' + fileName,
              );
            }
          } else {
            throw e$$;
      ...
      c$.tokenTypes = c$.prototype.tokenTypes = Clazz_newArray(-1, [
        Clazz_newArray(-1, [
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (constraints) {
          ...
          for (var type = 0; type <= 2; type++) {
            var list = lists[type];
            if (list != null)
              this.constraintsByType[type] = list.toArray(
                new Array(list.size()),
              );
          }
        },
      ...
      Clazz_defineMethod(
        ...
        function (iType, gradients, canConstrain) {
          ...
          for (var ii = 0; ii < nCalc; ii++)
            energy += this.compute(iType, this.calculations[iType].get(ii));
          ...
          if (
            ...
            this.constraintsByType[iType] != null
          )
          ...
          for (var i = constraints.length; --i >= 0; ) {
            ...
            switch (iType) {
              case 2:
                ...
                if (value < 0 && targetValue >= 1.5707963267948966)
                  value += 6.283185307179586;
                else if (value > 0 && targetValue <= -1.5707963267948966)
                  targetValue += 6.283185307179586;
                break;
              case 1:
                targetValue *= 0.017453292519943295;
                value = this.gradients
      ...
      Clazz_defineMethod(c$, 'getConstraintList', function () {
                ...
                this.appendLogData(
                  JU.PT.sprintf(
                    ...
                    Clazz_newArray(-1, [
                      ...
                      Clazz_newFloatArray(-1, [targetValue]),
                      Clazz_newIntArray(-1, [
      ...
      Clazz_defineMethod(
        ...
        function (title) {
          ...
          for (var i = 0; i < this.ac; i++) {
            ...
            sb.append(
              JU.PT.sprintf(
                '%3d %8.3f %8.3f %8.3f %-5s %2d %8.3f %8.3f %8.3f' + s + '\n',
                'sFI',
                Clazz_newArray(-1, [
                  atom.sType,
                  Clazz_newFloatArray(-1, [
          ...
          switch (iType) {
            case 0:
              return JU.PT.sprintf(
                ...
                'ssFI',
                Clazz_newArray(-1, [
                  this.minAtoms[c.ia].sType,
                  this.minAtoms[c.ib].sType,
                  Clazz_newFloatArray(-1, [
                    0,
                    c.rab,
                    c.dData[1],
                  ...
                  Clazz_newIntArray(-1, [
                    this.minAtoms[c.ia].atom.getAtomNumber(),
                    this.minAtoms[c.ib].atom.getAtomNumber(),
                  ]),
                ]),
              );
            case 1:
            case 3:
              return JU.PT.sprintf(
                ...
                Clazz_newArray(-1, [
                  this.minAtoms[c.ia].sType,
                  this.minAtoms[c.ib].sType,
                  this.minAtoms[c.ic].sType,
                  Clazz_newFloatArray(-1, [
                    c.theta * 57.29577951308232,
                    c.dData[1],
                    c.dData[0],
                    energy,
                  ]),
                  Clazz_newIntArray(-1, [
                    this.minAtoms[c.ia].atom.getAtomNumber(),
                    this.minAtoms[c.ib].atom.getAtomNumber(),
                    this.minAtoms[c.ic].atom.getAtomNumber(),
                  ]),
                ]),
              );
            case 2:
              return JU.PT.sprintf(
                ...
                Clazz_newArray(-1, [
                  ...
                  Clazz_newIntArray(-1, [
                    ...
                    this.minAtoms[c.ib].atom.getAtomNumber(),
                    this.minAtoms[c.ic].atom.getAtomNumber(),
                    this.minAtoms[c.id].atom.getAtomNumber(),
                    c.iData[4],
                  ]),
                ]),
              );
            ...
            case 5:
              return JU.PT.sprintf(
                ...
                'ssFI',
                Clazz_newArray(-1, [
                  this.minAtoms[c.iData[0]].sType,
                  this.minAtoms[c.iData[1]].sType,
                  Clazz_newFloatArray(-1, [c.rab, c.dData[0], energy]),
                  Clazz_newIntArray(-1, [
                    this.minAtoms[c.ia].atom.getAtomNumber(),
                    this.minAtoms[c.ib].atom.getAtomNumber(),
                  ]),
      ...
      Clazz_defineMethod(
        ...
        function (iType, energy) {
          ...
          return JU.PT.sprintf(
            ...
            Clazz_newArray(-1, [
              s,
              Float.$valueOf(this.ff.toUserUnits(energy)),
      ...
      Clazz_defineMethod(
        ...
        function (c) {
          if (this.gradients) {
            this.setCoords(c, 2);
            c.rab = JM.Util.restorativeForceAndDistance(
              this.da,
              this.db,
              this.dc,
            );
            ...
            c.rab = Math.sqrt(
              JM.Util.distance2(
                this.minAtoms[c.ia].coord,
                this.minAtoms[c.ib].coord,
              ),
            );
          }
      ...
      Clazz_defineMethod(
        ...
        function (c) {
          if (this.gradients) {
            this.setCoords(c, 3);
            c.theta = JM.Util.restorativeForceAndAngleRadians(
              this.da,
              this.db,
              this.dc,
            );
          } else {
            c.theta = JM.Util.getAngleRadiansABC(
              this.minAtoms[c.ia].coord,
              this.minAtoms[c.ib].coord,
              this.minAtoms[c.ic].coord,
            );
          }
      ...
      Clazz_defineMethod(
        ...
        function (c, fixTheta) {
          this.setCoords(c, 4);
          if (this.gradients) {
            c.theta = JM.Util.restorativeForceAndOutOfPlaneAngleRadians(
              this.da,
              this.db,
              this.dc,
              this.dd,
            ...
            c.theta = JM.Util.pointPlaneAngleRadians(
              this.da,
              this.db,
              this.dc,
              this.dd,
      ...
      Clazz_defineMethod(
        ...
        function (c) {
          if (this.gradients) {
            this.setCoords(c, 4);
            c.theta = JM.Util.restorativeForceAndTorsionAngleRadians(
              this.da,
              this.db,
              this.dc,
              this.dd,
            ...
            c.theta = JM.Util.getTorsionAngleRadians(
              this.minAtoms[c.ia].coord,
              this.minAtoms[c.ib].coord,
              this.minAtoms[c.ic].coord,
              this.minAtoms[c.id].coord,
              this.v1,
              this.v2,
              this.v3,
            );
    ...
    function () {
      ...
      Clazz_makeConstructor(
        ...
        function (
          ...
          Clazz_superConstructor(this, JM.FF.CalculationsMMFF, [
            ff,
            minAtoms,
            minBonds,
            minAngles,
      ...
      Clazz_overrideMethod(c$, 'getUnits', function () {
        return 'kcal';
      });
      ...
      c$.isInvertible = Clazz_defineMethod(
        c$,
        'isInvertible',
        function (a) {
          switch (a.ffType) {
      ...
      Clazz_overrideMethod(
        ...
        'getParameterObj',
        function (a) {
          return a.key == null || a.ddata != null
            ? a.ddata
      ...
      Clazz_defineStatics(c$, 'FPAR', 143.9325, 'DA_D', 'D', 'DA_DA', 133);
    },
  );
  Clazz_declarePackage('JM.FF');
  Clazz_load(
    ...
    function () {
      ...
      Clazz_makeConstructor(
        ...
        function (
          ...
          Clazz_superConstructor(this, JM.FF.CalculationsUFF, [
            ff,
            minAtoms,
            minBonds,
            minAngles,
      ...
      Clazz_overrideMethod(c$, 'setupCalculations', function () {
        ...
        for (var i = this.minTorsions.length; --i >= 0; )
          torsionCalc.setData(calc, this.minTorsions[i].data);
        ...
        for (var i = 0; i < this.ac; i++) {
          ...
          if (
            ...
            JM.FF.CalculationsUFF.isInvertible(
              (elemNo = a.atom.getElementNumber()),
            )
          )
      ...
      c$.calculateR0 = Clazz_defineMethod(
        c$,
        'calculateR0',
  ...
  Clazz_load(['JM.FF.Calculation'], 'JM.FF.MMFFAngleCalc', null, function () {
    ...
    Clazz_overrideMethod(
      ...
      function (dataIn) {
        ...
        if (t0 == 180) {
          ...
          this.energy =
            0.021922 * ka * Math.pow(dt, 2) * (1 + -0.006981317007977318 * dt);
          if (this.calcs.gradients)
            this.dE = 0.021922 * ka * dt * (2 + 3 * -0.006981317007977318 * dt);
        }
    ...
    Clazz_defineStatics(c$, 'CB', -0.006981317007977318);
  });
  Clazz_declarePackage('JM.FF');
  Clazz_load(
    ['JM.FF.Calculation'],
    'JM.FF.MMFFDistanceCalc',
    null,
    function () {
      c$ = Clazz_decorateAsClass(
        function () {
      ...
      Clazz_defineMethod(
        ...
        function (calc, bond) {
          ...
          calc.addLast(
            Clazz_newArray(-1, [
              Clazz_newIntArray(-1, [this.ia, this.ib]),
              data,
            ]),
          );
        },
      ...
      Clazz_overrideMethod(
        ...
        function (dataIn) {
          ...
          this.energy =
            ...
            this.kb *
            this.delta2 *
            (1 + -2.0 * this.delta + 2.3333333333333335 * this.delta2);
          if (this.calcs.gradients) {
            this.dE =
              71.96625 *
              this.kb *
              ...
              (2 +
                3 * -2.0 * this.delta +
                4 * 2.3333333333333335 * this.delta2);
  ...
  Clazz_load(['JM.FF.Calculation'], 'JM.FF.MMFFESCalc', null, function () {
    ...
    Clazz_overrideMethod(
      ...
      function (calc, ia, ib, d) {
        if (
          this.calcs.minAtoms[ia].partialCharge == 0 ||
          this.calcs.minAtoms[ib].partialCharge == 0
        )
          return;
        calc.addLast(
          Clazz_newArray(-1, [
            Clazz_newIntArray(-1, [ia, ib]),
            Clazz_newDoubleArray(-1, [
              this.calcs.minAtoms[ia].partialCharge,
              this.calcs.minAtoms[ib].partialCharge,
              this.calcs.minAtoms[ia].bs14.get(ib) ? 249.0537 : 332.0716,
            ]),
          ]),
        );
      },
    ...
    Clazz_overrideMethod(
      ...
      function (dataIn) {
        ...
        if (this.calcs.logging && Math.abs(this.energy) > 20)
          this.calcs.appendLogData(this.calcs.getDebugLine(6, this));
        return this.energy;
      },
      '~A',
    );
    Clazz_defineStatics(c$, 'BUFF', 0.05);
  });
  Clazz_declarePackage('JM.FF');
  Clazz_load(['JM.FF.Calculation'], 'JM.FF.MMFFOOPCalc', null, function () {
    ...
    Clazz_defineMethod(
      ...
      function (calc, i) {
        ...
        calc.addLast(
          Clazz_newArray(-1, [
            Clazz_newIntArray(-1, [indices[0], i, indices[1], indices[2]]),
            dk,
          ]),
        );
        calc.addLast(
          Clazz_newArray(-1, [
            Clazz_newIntArray(-1, [indices[1], i, indices[2], indices[0]]),
            dk,
          ]),
        );
        calc.addLast(
          Clazz_newArray(-1, [
            Clazz_newIntArray(-1, [indices[2], i, indices[0], indices[1]]),
            dk,
          ]),
        );
      },
  ...
  Clazz_load(['JM.FF.Calculation'], 'JM.FF.MMFFSBCalc', null, function () {
    ...
    Clazz_defineMethod(
      ...
      function (calc, angle) {
        ...
        var dataij = this.calcs.getParameter(
          this.calcs.minBonds[angle.data[3]],
        );
        var datajk = this.calcs.getParameter(
          this.calcs.minBonds[angle.data[4]],
        );
        if (
          data == null ||
          datakat0 == null ||
        ...
        calc.addLast(
          Clazz_newArray(-1, [
            angle.data,
            Clazz_newDoubleArray(-1, [data[0], theta0, r0ij]),
            angle.sbKey,
          ]),
        );
        calc.addLast(
          Clazz_newArray(-1, [
            ...
            Clazz_newDoubleArray(-1, [data[1], theta0, r0jk]),
            angle.sbKey,
          ]),
        );
      },
  ...
  Clazz_load(['JM.FF.Calculation'], 'JM.FF.MMFFVDWCalc', null, function () {
    ...
    Clazz_overrideMethod(
      ...
      function (calc, ia, ib, dd) {
        ...
        var eps =
          ((181.16 * G_a * G_b * alpha_a * alpha_b) /
            (Math.sqrt(alpha_a / N_a) + Math.sqrt(alpha_b / N_b))) *
          Math.pow(rs, -6.0);
        if (DA_a + DA_b == 133) {
          rs *= 0.8;
          eps *= 0.5;
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (calc, angle) {
          ...
          var preliminaryMagnification =
            this.a.sType === 'H_' && this.c.sType === 'H_' ? 10 : 1;
          ...
          if (bond.isAromatic) bondorder = 1.5;
          if (bond.isAmide) bondorder = 1.41;
          var rbc = JM.FF.CalculationsUFF.calculateR0(
            this.calcs.parB.dVal[0],
          ...
          var rac = Math.sqrt(
            this.rab * this.rab + rbc * rbc - 2.0 * this.rab * rbc * cosT0,
          );
          var ka =
            2696.8016159999997 *
            ((zi * zk) / Math.pow(rac, 5.0)) *
            (3.0 * this.rab * rbc * (1.0 - cosT0 * cosT0) - rac * rac * cosT0);
          calc.addLast(
            Clazz_newArray(-1, [
              Clazz_newIntArray(-1, [this.ia, this.ib, this.ic, coordination]),
              Clazz_newDoubleArray(-1, [
                ka,
                theta0 * 57.29577951308232,
                c0 - c2,
                c1,
                2 * c2,
                preliminaryMagnification * ka,
              ]),
            ]),
          );
        },
      ...
      Clazz_overrideMethod(
        ...
        function (dataIn) {
          ...
          if (
            ...
            (this.theta > 2.35619 || this.theta < 0.785398)
          )
            coordination = 1;
      ...
      Clazz_overrideMethod(
        ...
        function (calc, ia, ib, bondOrder) {
          this.calcs.parA = this.calcs.getParameter(
            this.calcs.minAtoms[ia].sType,
          );
          this.calcs.parB = this.calcs.getParameter(
            this.calcs.minAtoms[ib].sType,
          );
          ...
          calc.addLast(
            Clazz_newArray(-1, [
              Clazz_newIntArray(-1, [ia, ib]),
              Clazz_newDoubleArray(-1, [this.r0, this.kb, bondOrder]),
            ]),
          );
        },
        'JU.Lst,~N,~N,~N',
    ...
    Clazz_overrideMethod(
      ...
      function (calc, ib, elemNo, dd) {
        ...
        switch (elemNo) {
          case 6:
            if (
              (this.b.sType === 'C_2' && this.b.hCount > 1) ||
              this.b.sType === 'C_2+' ||
              this.a.sType === 'O_2' ||
              this.c.sType === 'O_2' ||
              this.d.sType === 'O_2'
        ...
        calc.addLast(
          Clazz_newArray(-1, [
            Clazz_newIntArray(-1, [this.ia, ib, this.ic, this.id]),
            Clazz_newDoubleArray(-1, [koop, a0, a1, a2, koop * 10]),
          ]),
        );
        calc.addLast(
          Clazz_newArray(-1, [
            Clazz_newIntArray(-1, [this.ic, ib, this.id, this.ia]),
            Clazz_newDoubleArray(-1, [koop, a0, a1, a2, koop * 10]),
          ]),
        );
        calc.addLast(
          Clazz_newArray(-1, [
            Clazz_newIntArray(-1, [this.id, ib, this.ia, this.ic]),
            Clazz_newDoubleArray(-1, [koop, a0, a1, a2, koop * 10]),
          ]),
        );
      },
    ...
    Clazz_overrideMethod(
      ...
      function (dataIn) {
        ...
        if (this.calcs.gradients) {
          this.dE =
            koop *
            (a1 * Math.sin(this.theta) +
              a2 * 2.0 * Math.sin(this.theta) * cosTheta);
          this.calcs.addForces(this, 4);
        }
        if (this.calcs.logging)
          this.calcs.appendLogData(this.calcs.getDebugLine(4, this));
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (calc, t) {
          ...
          calc.addLast(
            Clazz_newArray(-1, [
              Clazz_newIntArray(-1, [this.ia, this.ib, this.ic, this.id, n]),
              Clazz_newDoubleArray(-1, [V, cosNPhi0]),
            ]),
          );
        },
        'JU.Lst,~A',
    ...
    Clazz_overrideMethod(
      ...
      function (calc, ia, ib, dd) {
        ...
        calc.addLast(
          Clazz_newArray(-1, [
            Clazz_newIntArray(-1, [ia, ib]),
            Clazz_newDoubleArray(-1, [Xab, Dab]),
          ]),
        );
      },
      'JU.Lst,~N,~N,~N',
