(function (
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'getLastException', function () {
        return this.okMF == true
      ...
      Clazz_overrideMethod(
        ...
        function (pattern, isSmarts, isEmpirical) {
          ...
          var search = JS.SmilesParser.newSearch(
            '/nostereo/' + pattern,
            isSmarts,
            true,
          );
      ...
      Clazz_defineMethod(c$, 'clearExceptions', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (atoms, ac, bsSelected, bioComment, flags) {
          this.clearExceptions();
          return new JS.SmilesGenerator().getSmiles(
            this,
            atoms,
            ac,
            bsSelected,
      ...
      Clazz_overrideMethod(
        ...
        function (smiles1, smiles2) {
          ...
          var result = this.matchPriv(
            ...
            flags,
            2,
            JS.SmilesParser.newSearch(smiles2, false, true),
          );
        ...
        function (pattern, target, flags) {
          ...
          for (var i = array.length; --i >= 0; ) {
            ...
            for (var j = a.length; --j >= 0; )
              a[j] = search.target.nodes[a[j]].mapIndex;
          }
          return array;
        },
        '~S,~S,~N',
        ...
        function (pattern, smilesSet, flags) {
          ...
          try {
            ...
            for (var i = 0; i < smilesSet.length; i++) {
              ...
              searchTarget.setFlags(
                searchTarget.flags | JS.SmilesParser.getFlags(pattern),
              );
              try {
                this.clearExceptions();
                ret[i] =
            ...
            if (Clazz_exceptionOf(e, Exception)) {
              ...
              if (JS.InvalidSmilesException.getLastError() == null)
                this.clearExceptions();
      ...
      Clazz_overrideMethod(
        ...
        function (pattern, target, ac, bsSelected, flags) {
          ...
          return this.matchPriv(
            ...
            null,
            true,
            flags | JS.SmilesParser.getFlags(pattern.toString()),
            1,
            atoms == null ? target : null,
          );
        },
        '~O,~O,~N,JU.BS,~N',
      );
      Clazz_overrideMethod(
        ...
        function (smarts, atoms, ac, bsSelected, ret, vRings) {
          ...
          for (var i = 0; i < smarts.length; i++) {
            ...
            search.clear();
            search.subSearches[0] = sp.getSubsearch(
              search,
              JS.SmilesParser.cleanPattern(smarts[i]),
              flags,
            );
        ...
        function (center, faces, atomCount, points, flags, details) {
          ...
          for (var i = 0; i < atomCount; i++) {
            ...
            if (Clazz_instanceOf(pt, JU.Node)) {
              ...
              atoms[i].elementNumber = Clazz_instanceOf(pt, JU.Point3fi)
                ? pt.sD
                : -2;
          ...
          for (var i = 0; i < atomCount; i++) {
            ...
            if (n == 0 || n != atoms[i].bonds.length)
              atoms[i].bonds = JU.AU.arrayCopyObject(atoms[i].bonds, n);
          }
          var s = null;
          ...
          s = g.getSmiles(
            ...
            atoms,
            atomCount,
            JU.BSUtil.newBitSet2(0, atomCount),
            null,
            flags | 4096 | 16 | 32,
          );
          if ((flags & 65536) == 65536) {
            s =
              ((flags & 131072) == 0 ? '' : '//* ' + center + ' *//\t') +
              '[' +
              JU.Elements.elementSymbolFromNumber(center.getElementNumber()) +
              '@PH' +
              atomCount +
        ...
        function (
          ...
          try {
            ...
            if (searchTarget != null)
              searchTarget.setFlags(
                searchTarget.flags |
                  JS.SmilesParser.getFlags(pattern.toString()),
              );
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          if (this.okMF) {
            ...
            if (
              search.targetSet ||
              (ac != 0 && (bsSelected == null || !bsSelected.isEmpty()))
            ) {
              var is3D =
                search.targetSet || !Clazz_instanceOf(atoms[0], JS.SmilesAtom);
              search.getSelections();
      ...
      Clazz_overrideMethod(
        ...
        function (jme, at, bsAtoms) {
          try {
            ...
            var map = this.getCorrelationMaps(
              s,
              molecule.patternAtoms,
              molecule.ac,
              bs,
            ...
            var map2 = this.getCorrelationMaps(
              s,
              at,
              bsAtoms.cardinality(),
              bsAtoms,
      ...
      c$.jmeToMolecule = Clazz_defineMethod(
        c$,
        'jmeToMolecule',
        function (jme) {
          ...
          for (var i = 0; i < nAtoms; i++, pt += 3) {
            ...
            if (ic >= 0) {
              charge =
                ic == sa.length - 1 ? 1 : JU.PT.parseInt(sa.substring(ic + 1));
  ...
  Clazz_load(
    ...
    function () {
      ...
      c$.getLastError = Clazz_defineMethod(c$, 'getLastError', function () {
        return JS.InvalidSmilesException.lastError;
      });
      c$.clear = Clazz_defineMethod(c$, 'clear', function () {
        JS.InvalidSmilesException.lastError = null;
      });
      Clazz_overrideMethod(c$, 'getMessage', function () {
        return JS.InvalidSmilesException.lastError;
      });
      Clazz_makeConstructor(
        c$,
        function (message) {
          ...
          JS.InvalidSmilesException.lastError = message.startsWith(
            'Jmol SMILES',
          )
            ? message
            : 'Jmol SMILES Exception: ' + message;
        },
        '~S',
      );
      Clazz_defineStatics(c$, 'lastError', null);
    },
  );
  Clazz_declarePackage('JS');
  Clazz_load(
    ...
    function () {
      ...
      c$.isRingBond = Clazz_defineMethod(
        c$,
        'isRingBond',
      ...
      c$.addFlags = Clazz_defineMethod(
        ...
        function (flags, strFlags) {
          ...
          if (
            strFlags.indexOf('NOAROMATIC') >= 0 ||
            strFlags.indexOf('NONAROMATIC') >= 0
          )
            flags |= 16;
      ...
      Clazz_defineMethod(
        ...
        function (flags) {
          ...
          this.invertStereochemistry =
            !this.ignoreStereochemistry && (flags & 64) == 64;
      ...
      Clazz_defineMethod(c$, 'set', function () {
        if (this.patternAtoms.length > this.ac)
          this.patternAtoms = JU.AU.arrayCopyObject(this.patternAtoms, this.ac);
          ...
          for (var i = this.ac; --i >= 0; ) {
            ...
            for (var j = a.bondCount; --j >= 0; ) {
              ...
              if (
                b.isConnection &&
                b.atom2 === a &&
                (ib = b.atom1.component) != ia
              ) {
                for (var k = this.ac; --k >= 0; )
                  if (this.patternAtoms[k].component == ia)
      ...
      Clazz_defineMethod(c$, 'addAtom', function () {
      ...
      Clazz_defineMethod(c$, 'getMissingHydrogenCount', function () {
        var n = 0;
        var nH;
        for (var i = 0; i < this.ac; i++)
          if ((nH = this.patternAtoms[i].explicitHydrogenCount) >= 0) n += nH;
      ...
      Clazz_defineMethod(
        ...
        function (bsA, vRings, doProcessAromatic) {
          ...
          this.needAromatic = new Boolean(
            this.needAromatic &
              new Boolean((bsA == null) & !this.noAromatic).valueOf(),
          ).valueOf();
      ...
      Clazz_defineMethod(
        ...
        function (vRings, needRingData, doTestAromatic) {
          ...
          var doFinalize =
            this.needAromatic &&
            doTestAromatic &&
            (isStrict || isOpenNotStrict);
          var setAromatic = this.needAromatic && !this.aromaticDefined;
          var aromaticMax = 7;
          var lstAromatic =
            vRings == null ? new JU.Lst() : (vRings[3] = new JU.Lst());
          ...
          this.ringDataMax = this.target.setRingData(
            strictness,
            needRingData,
            this.ringDataMax,
          );
          ...
          var eCounts =
            doFinalize && setAromatic
              ? Clazz_newIntArray(this.target.ac, 0)
              : null;
          var justCheckBonding =
            setAromatic &&
            Clazz_instanceOf(this.target.nodes[0], JS.SmilesAtom);
          for (var i = 3; i <= max; i++) {
            ...
            if (needRingData) {
              ...
              for (var k = vR.size(); --k >= 0; ) {
                ...
                for (var j = r.nextSetBit(0); j >= 0; j = r.nextSetBit(j + 1))
                  this.target.ringCounts[j]++;
              }
            }
          }
          if (this.needAromatic) {
      ...
      Clazz_defineMethod(c$, 'search', function () {
        this.bsReturn.clearAll();
      ...
      Clazz_defineMethod(
        ...
        function (firstAtomOnly) {
          ...
          if (!this.isRingCheck && JU.Logger.debuggingHigh && !this.isSilent)
        ...
        function (atomNum, iAtom, firstAtomOnly, c) {
          ...
          if (++atomNum < this.ac) {
            ...
            if (newPatternBond == null) {
              ...
              if (newPatternAtom.notBondedIndex >= 0) {
                ...
                if (pa.isBioAtom) {
                  ...
                  for (var k = 0; k < jmolBonds.length; k++)
              ...
              j1 =
                skipGroup && j1 >= 0
                  ? this.target.nodes[j1].getOffsetResidueAtom('\0', j1)
                  : j1;
              var oldJmolComponent;
              var oldPatternComponent = (
                atomNum > 0 ? this.patternAtoms[atomNum - 1] : newPatternAtom
              ).component;
              var thisPatternComponent = newPatternAtom.component;
              var checkComponents =
                this.haveComponents && thisPatternComponent != -2147483648;
              for (
                var j = j1;
                j >= 0;
                ...
                if (!bs.get(j) && !this.bsFound.get(j)) {
                  ...
                  if (checkComponents && !this.isRingCheck) {
                    c = this.groupByModel
                      ? jmolAtom.getModelIndex()
                      : jmolAtom.getMoleculeNumber(false);
                    oldJmolComponent =
                      atomNum > 0
                        ? this.patternAtoms[atomNum - 1].matchingComponent
                        : c;
                    if (
                      (oldPatternComponent == thisPatternComponent) !=
                      (oldJmolComponent == c)
                    )
                      continue;
                  }
                ...
                if (skipGroup) {
                  j1 = this.target.nodes[j].getOffsetResidueAtom(
                    newPatternAtom.bioAtomName,
                    1,
                  );
                  if (j1 >= 0) j = j1 - 1;
                }
            ...
            switch (newPatternBond.order) {
              case 96:
                var nextGroupAtom = jmolAtom.getOffsetResidueAtom(
                  newPatternAtom.bioAtomName,
                  1,
                );
                if (nextGroupAtom >= 0) {
                  ...
                  if (
                    this.doCheckAtom(nextGroupAtom) &&
                    !this.nextTargetAtom(
                      newPatternAtom,
                      this.target.nodes[nextGroupAtom],
                      atomNum,
                      nextGroupAtom,
                      firstAtomOnly,
                      c,
            ...
            if (jmolBonds != null)
              for (var j = 0; j < jmolBonds.length; j++) {
              ...
              for (var i = 0; i < atomNum; i++)
                JU.Logger.debug(
                  'pattern atoms ' +
                    this.patternAtoms[i] +
                    ' ' +
                    this.patternAtoms[i].matchingComponent,
                );
          ...
          for (var j = 0; j < this.ac; j++) {
            ...
            if (
              !firstAtomOnly &&
              this.top.haveSelected &&
              !this.patternAtoms[j].selected
            )
              continue;
            nMatch++;
            bs.set(i);
            if (this.patternAtoms[j].isBioAtomWild)
              this.target.nodes[i].getGroupBits(bs);
            if (firstAtomOnly) break;
            if (!this.isSmarts)
              if (
                !this.setAtropicity &&
                this.patternAtoms[j].explicitHydrogenCount > 0
              ) {
          ...
          if (
            !this.isSmarts &&
            bs.cardinality() != this.target.selectedAtomCount
          )
            return true;
          if (this.bsCheck != null) {
            if (firstAtomOnly) {
          ...
          if (this.getMaps) {
            if (this.mapUnique) {
              ...
              for (var j = this.uniqueList.size(); --j >= 0; )
                if (this.uniqueList.get(j).equals(bs)) return true;
          ...
          if (this.asVector) {
            var isOK = true;
            for (var j = this.vReturn.size(); --j >= 0 && isOK; )
              isOK = !this.vReturn.get(j).equals(bs);
          ...
          if (this.isRingCheck) {
            ...
            for (var k = atomNum * 3 + 2; --k > atomNum; )
              bsRing.set(
                this.patternAtoms[
                  (k <= atomNum * 2 ? atomNum * 2 - k + 1 : k - 1) % atomNum
        ...
        function (patternAtom, jmolAtom, atomNum, iAtom, firstAtomOnly, c) {
          ...
          if (!this.isRingCheck && !this.isTopology) {
            if (patternAtom.subAtoms == null) {
              ...
              for (var i = 0; i < patternAtom.nSubAtoms; i++)
                if (!this.checkPrimitiveAtom(patternAtom.subAtoms[i], iAtom))
                  return true;
            } else {
              for (var i = 0; i < patternAtom.nSubAtoms; i++)
                if (
                  !this.nextTargetAtom(
                    patternAtom.subAtoms[i],
                    jmolAtom,
                    atomNum,
                    iAtom,
                    firstAtomOnly,
            ...
            switch (patternBond.order) {
              ...
              default:
                ...
                for (; k < jmolBonds.length; k++)
                  if (
                    (jmolBond = jmolBonds[k]).isCovalent() &&
                    (jmolBond.getAtomIndex1() == matchingAtom ||
                      jmolBond.getAtomIndex2() == matchingAtom)
                  )
                    break;
      ...
      Clazz_defineMethod(
        ...
        function (patternAtom, iTarget) {
          if (patternAtom.nSubAtoms > 0) {
            for (var i = 0; i < patternAtom.nSubAtoms; i++)
              if (this.checkPrimitiveAtom(patternAtom.subAtoms[i], iTarget))
                return true;
          ...
          while (true) {
            ...
            if (patternAtom.isBioResidue) {
              var a = targetAtom;
              if (
                patternAtom.bioAtomName != null &&
                (patternAtom.isLeadAtom()
                  ? !a.isLeadAtom()
                  : !patternAtom.bioAtomName.equals(
                      a.getAtomName().toUpperCase(),
                    ))
              )
                break;
              if (
                patternAtom.residueName != null &&
                !patternAtom.residueName.equals(
                  a.getGroup3(false).toUpperCase(),
                )
              )
                break;
              if (
                patternAtom.residueNumber != -2147483648 &&
                patternAtom.residueNumber != a.getResno()
              )
                break;
              if (
                patternAtom.insCode != '\0' &&
                patternAtom.insCode != a.getInsertionCode()
              )
                break;
              if (
                patternAtom.residueChar != null ||
              ...
              if (
                !this.noAromatic &&
                !patternAtom.aromaticAmbiguous &&
                patternAtom.isAromatic != this.target.bsAromatic.get(iTarget)
              )
                break;
              if (
                (n = patternAtom.getCharge()) != -2147483648 &&
                n != targetAtom.getFormalCharge()
              )
                break;
              n =
                patternAtom.getCovalentHydrogenCount() +
              ...
              if (
                patternAtom.degree > 0 &&
                patternAtom.degree != targetAtom.getCovalentBondCount()
              )
                break;
              if (
                patternAtom.nonhydrogenDegree > 0 &&
                patternAtom.nonhydrogenDegree !=
                  targetAtom.getCovalentBondCount() -
                    targetAtom.getCovalentHydrogenCount()
              )
                break;
              if (
                this.isSmarts &&
                patternAtom.valence > 0 &&
                patternAtom.valence != targetAtom.getTotalValence()
              )
                break;
              if (
                patternAtom.connectivity > 0 &&
                patternAtom.connectivity !=
                  targetAtom.getCovalentBondCountPlusMissingH()
              )
                break;
              if (
                patternAtom.atomNumber != -2147483648 &&
              ...
              if (!this.ignoreAtomClass || this.isSmarts) {
                if (
                  !Float.isNaN(patternAtom.atomClass) &&
                  patternAtom.atomClass !=
                    targetAtom.getFloatProperty('property_atomclass')
                )
                  break;
              }
              if (this.target.ringData != null) {
                if (patternAtom.ringSize >= -1) {
                  if (patternAtom.ringSize <= 0) {
                    if (
                      (this.target.ringCounts[iTarget] == 0) !=
                      (patternAtom.ringSize == 0)
                    )
                      break;
                  } else {
                    var rd =
                      this.target.ringData[
                        patternAtom.ringSize == 500
                          ? 5
                          : patternAtom.ringSize == 600
                          ? 6
                          : patternAtom.ringSize
                      ];
                ...
                if (patternAtom.ringMembership >= -1) {
                  if (
                    patternAtom.ringMembership == -1
                      ? this.target.ringCounts[iTarget] == 0
                      : this.target.ringCounts[iTarget] !=
                        patternAtom.ringMembership
                  )
                    break;
                }
                if (patternAtom.ringConnectivity >= 0) {
                  ...
                  if (
                    (patternAtom.ringConnectivity == -1 && n == 0) ||
      ...
      Clazz_defineMethod(
        ...
        function (patternAtom, atom1, patternBond, iAtom, matchingAtom, bond) {
          if (patternBond.bondsOr != null) {
            for (var ii = 0; ii < patternBond.nBondsOr; ii++)
              if (
                this.checkMatchBond(
                  patternAtom,
                  atom1,
                  patternBond.bondsOr[ii],
                  iAtom,
                  matchingAtom,
                  bond,
                )
          ...
          if (!this.isRingCheck && !this.isTopology)
            if (patternBond.nPrimitives == 0) {
              if (
                !this.checkPrimitiveBond(patternBond, iAtom, matchingAtom, bond)
              )
                return false;
            } else {
              for (var i = 0; i < patternBond.nPrimitives; i++) {
                var prim = patternBond.setPrimitive(i);
                if (!this.checkPrimitiveBond(prim, iAtom, matchingAtom, bond))
                  return false;
              }
            }
        ...
        function (patternBond, iAtom1, iAtom2, bond) {
          ...
          switch (patternBond.order) {
            case 96:
              return (
                patternBond.isNot !=
                (this.target.nodes[iAtom2].getOffsetResidueAtom('\0', 1) ==
                  this.target.nodes[iAtom1].getOffsetResidueAtom('\0', 0))
              );
            case 112:
              return (
                patternBond.isNot !=
                this.target.nodes[iAtom1].isCrossLinked(
                  this.target.nodes[iAtom2],
                )
              );
          }
          var isAromatic1 =
            !this.noAromatic && this.target.bsAromatic.get(iAtom1);
          var isAromatic2 =
            !this.noAromatic && this.target.bsAromatic.get(iAtom2);
          ...
          if (isAromatic1 && isAromatic2) {
            switch (patternOrder) {
              case 17:
              case 65:
                bondFound = JS.SmilesSearch.isRingBond(
              ...
              case 2:
                bondFound =
                  this.isNormalized ||
                  order == 81 ||
                  (this.aromaticDouble && (order == 2 || order == 514));
                break;
              case 65537:
              case 65538:
      ...
      Clazz_defineMethod(c$, 'checkStereochemistry', function () {
        for (var i = 0; i < this.measures.size(); i++)
          if (!this.measures.get(i).check()) return false;
        ...
        for (var k = 0; k < this.ac; k++) {
          ...
          if (this.haveSmilesTarget)
            JS.SmilesSearch.setTopoCoordinates(
              dbAtom1,
              dbAtom2,
              dbAtom1a,
              dbAtom2a,
          ...
          var d = JS.SmilesMeasure.setTorsionData(
            dbAtom1a,
            dbAtom1,
            dbAtom2,
            dbAtom2a,
          ...
          if (isAtropisomer) {
            ...
            if (JU.Logger.debugging)
              JU.Logger.info(
                'atrop dihedral ' + d + ' ' + sAtom1 + ' ' + sAtom2 + ' ' + b,
              );
            if (d < 1) return false;
          } else {
            if (this.v.vTemp1.dot(this.v.vTemp2) * dir1 * dir2 < 0)
              return false;
          }
        }
        if (this.setAtropicity) {
          this.atropKeys = '';
          for (var i = 0; i < lstAtrop.size(); i++)
            this.atropKeys += ',' + this.getAtropIndex(lstAtrop.get(i));
        }
        return true;
      });
      Clazz_defineMethod(
      ...
      c$.setTopoCoordinates = Clazz_defineMethod(
        c$,
        'setTopoCoordinates',
        function (dbAtom1, dbAtom2, dbAtom1a, dbAtom2a, bondType) {
          ...
          if (bondType != 2) {
            ...
            var ok1 =
              dbAtom1.getBondedAtomIndex(bond.atropType[0]) == dbAtom1a.index;
            var ok2 =
              dbAtom2.getBondedAtomIndex(bond.atropType[1]) == dbAtom2a.index;
          ...
          for (var k = bonds.length; --k >= 0; ) {
            ...
            var mode =
              bond.getAtomIndex2() == dbAtom1.getIndex() ? nBonds : -nBonds;
            switch (bond.order) {
              case 1025:
                dir1 = mode;
                break;
          ...
          for (var k = bonds.length; --k >= 0; ) {
            ...
            atom.set(1, nBonds++ == 0 ? 1 : -1, 0);
            var mode =
              bond.getAtomIndex2() == dbAtom2.getIndex() ? nBonds : -nBonds;
            switch (bond.order) {
              case 1025:
                dir2 = mode;
                break;
      ...
      Clazz_defineMethod(
        ...
        function (bsAro) {
          ...
          var nAtomsMissing = this.autoAddImplicitH
            ? this.getMissingHydrogenCount()
            : 0;
          ...
          for (var i = 0, ptAtom = 0; i < this.ac; i++, ptAtom++) {
            ...
            var atom = (atoms[ptAtom] = new JS.SmilesAtom().setTopoAtom(
              sAtom.component,
              ptAtom,
              sAtom.symbol,
              sAtom.getCharge(),
            ...
            atom.setBonds(bonds);
            while (--n >= 0) {
              var atomH = (atoms[++ptAtom] = new JS.SmilesAtom().setTopoAtom(
                atom.component,
                ptAtom,
                'H',
                0,
      ...
      Clazz_defineMethod(c$, 'getSelections', function () {
        ...
        for (
          ...
          if (key.startsWith('select')) {
            var bs = htNew.containsKey(key)
              ? htNew.get(key)
              : this.target.nodes[0].findAtomsLike(key.substring(6));
      ...
      Clazz_defineMethod(
        ...
        function (atom) {
          ...
          for (var i = edges.length; --i >= 0; ) {
            ...
            if (
              this.target.nodes[k].getElementNumber() == 1 &&
              !this.bsFound.get(k)
            )
              return this.target.nodes[k];
          }
          return null;
        },
        'JU.Node',
      ...
      Clazz_defineMethod(c$, 'toString', function () {
        ...
        if (this.targetSet) {
          return (
            'molecular formula: ' +
            this.target.getMolecularFormula(true, null, false)
          );
        }
      ...
      Clazz_defineMethod(c$, 'checkAromaticDefined', function () {
      ...
      Clazz_defineMethod(c$, 'getBSAromaticRings', function () {
      ...
      Clazz_defineMethod(c$, 'finalizeRingData', function () {
        for (
          ...
          for (var d = c; --d >= 0; ) {
            if (this.ringCounts[b.getBondedAtomIndex(d)] > 0)
              this.ringConnections[a]++;
          }
        }
      });
      Clazz_defineMethod(c$, 'hasDoubleBonds', function () {
        for (var a = 0; a < this.nodes.length; a++)
          if (this.bsSelected == null || this.bsSelected.get(a)) {
            var b = this.nodes[a];
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (sm, atoms, ac, bsSelected, comment, flags) {
          ...
          this.haveSmilesAtoms =
            Clazz_instanceOf(atoms[ipt], JS.SmilesAtom) &&
            atoms[ipt].definesStereo();
          this.sm = sm;
          this.flags = flags;
          this.atoms = atoms;
          this.ac = ac;
          ...
          this.flags = flags = JS.SmilesSearch.addFlags(
            flags,
          ...
          this.explicitHydrogen =
            (flags & 8192) == 8192 ? 8192 : (flags & 4096) == 4096 ? 4096 : 0;
          if (this.explicitHydrogen == 8192) {
            ...
            for (
              ...
              var a = atoms[i];
              if (
                a.getCovalentHydrogenCount() == 3 &&
                a.getCovalentBondCount() == 4
              ) {
                var doIgnore = true;
                bsHa.clearAll();
          ...
          this.noBranches = false;
          return this.getSmilesComponent(
            atoms[ipt],
            bsSelected,
            true,
            false,
      ...
      Clazz_defineMethod(
        ...
        function (bsSelected, comment, flags) {
          ...
          if (comment != null && !this.noBioComment)
            sb.append('//* Jmol bioSMILES ')
              .append(comment.$replace('*', '_'))
              .append(' *//');
            ...
            for (var i = bs.nextSetBit(0); i >= 0; i = bs.nextSetBit(i + 1)) {
              ...
              if (end != null) {
                ...
                if (bioStructureName.length > 0) {
                  ...
                  len++;
                  sb.append('~')
                    .appendC(bioStructureName.toLowerCase().charAt(0))
                    .append('~');
                } else {
              ...
              if (unknown) {
                this.addBracketedBioName(
                  sb,
                  a,
                  bioStructureName.length > 0 ? '.0' : null,
                  false,
                );
              } else {
                sb.append(ch);
              ...
              if (addCrosslinks) {
                ...
                for (var j = 0; j < vLinks.size(); j += 3) {
                  sb.append(':');
                  s = this.getRingCache(
                    vLinks.get(j).intValue(),
                    vLinks.get(j + 1).intValue(),
      ...
      Clazz_defineMethod(
        ...
        function (sb, atom, atomName, addComment) {
          ...
          if (atomName != null) {
            ...
            sb.append(
              JU.Elements.elementNameFromNumber(atom.getElementNumber()),
            );
          }
          sb.append(']');
        },
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          this.iHypervalent = -1;
          for (
            var i = this.bsSelected.nextSetBit(0);
            i >= 0 && this.iHypervalent < 0;
          ...
          if (this.explicitHydrogen == 0) {
            for (
              var j = this.bsSelected.nextSetBit(0);
              j >= 0;
              j = this.bsSelected.nextSetBit(j + 1)
            ) {
              var a = this.atoms[j];
              if (
                a.getAtomicAndIsotopeNumber() == 1 &&
                a.getBondCount() > 0 &&
                a.getBondedAtomIndex(0) != this.iHypervalent &&
                !this.isExplicitOnly(this.atoms[a.getBondedAtomIndex(0)])
              )
          ...
          var sb = new JU.SB();
          for (
            var i = this.bsToDo.nextSetBit(0);
            i >= 0;
            i = this.bsToDo.nextSetBit(i + 1)
          ) {
            if (
              this.atoms[i].getCovalentBondCount() > 4 ||
              this.isPolyhedral ||
              this.noBranches
            ) {
          ...
          if (s.indexOf('^-') >= 0) {
            var s0 = s;
            try {
              var keys = this.sm.getAtropisomerKeys(
                s,
                this.atoms,
                this.ac,
                this.bsSelected,
      ...
      Clazz_defineMethod(
        ...
        function (atom) {
          if (
            this.explicitHydrogen == 0 &&
            atom.getAtomicAndIsotopeNumber() == 1 &&
          ...
          while (true) {
            ...
            if (bonds[0].getBondType() != 2 || bonds[1].getBondType() != 2)
              break;
      ...
      Clazz_defineMethod(c$, 'generateRingData', function () {
      ...
      Clazz_defineMethod(
        ...
        function (bond, atomFrom) {
          ...
          var i = bond.index;
          var isFirst =
            atomFrom == null || bond.getAtomIndex1() == atomFrom.getIndex();
          return this.bsBondsUp.get(i)
            ? isFirst
              ? '/'
              : '\\'
            : this.bsBondsDn.get(i)
            ? isFirst
              ? '\\'
              : '/'
            : '\0';
      ...
      Clazz_defineMethod(c$, 'setBondDirections', function () {
        var bsDone = new JU.BS();
        ...
        for (
          ...
          for (var k = 0; k < bonds.length; k++) {
            ...
            for (var j = 0; j < 2 && edgeCount > 0 && edgeCount < 3; j++) {
              ...
              var explicitH =
                this.explicitHydrogen > 0 || this.isExplicitOnly(atomA);
              for (var b = 0; b < bb.length; b++) {
                var other;
                if (
                  bb[b].getCovalentOrder() != 1 ||
                  (!explicitH &&
                    (other = bb[b].getOtherNode(atomA)).getElementNumber() ==
                      1 &&
            ...
            for (var j = 0; j < 2; j++) {
              ...
              for (var jj = 0; jj < 2; jj++) {
                ...
                if (this.haveSmilesAtoms) {
                  ...
                  isOpposite = JS.SmilesStereo.isDiaxial(
                    aA,
                    aB,
                    a0,
                    a1,
                ...
                if (JU.Logger.debugging)
                  JU.Logger.debug(
                    this.getBondStereochemistry(b0, aA) +
                      ' ' +
                      a0.getIndex() +
                      ' ' +
                      a1.getIndex() +
                      ' ' +
                      this.getBondStereochemistry(b1, aB),
                  );
              }
            }
          }
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var includeHs =
            atomIndex == this.iHypervalent ||
            (this.explicitHydrogen != 0 &&
              !this.bsIgnoreHydrogen.get(atomIndex));
          ...
          if (bonds != null) {
            for (var i = 0, nb = bonds.length; i < nb; i++) {
              ...
              var isH =
                !includeHs &&
                !explicitHs &&
                atom1.getElementNumber() == 1 &&
                atom1.getIsotopeNumber() <= 0;
              if (!this.bsIncludingH.get(index1)) {
                if (
                  isH ||
                  !allowConnectionsToOutsideWorld ||
                  !this.bsSelected.get(atomIndex)
                )
                  continue;
          ...
          if (sp2Atoms == null && !isAromatic && nH <= 1)
            sp2Atoms = new Array(5);
          var strPrev = null;
          if (bondPrev != null) {
            strPrev = this.getBondOrder(
              bondPrev,
              atomIndex,
              prevIndex,
              isAromatic,
          ...
          if (allowBranches) {
            for (var i = 0; i < nBonds; i++) {
              ...
              var n =
                a.getCovalentBondCount() -
                (includeHs || this.isExplicitOnly(a)
                  ? 0
                  : a.getCovalentHydrogenCount());
              var order = bond.getCovalentOrder();
              var isEndPoint = this.htRings.containsKey(
                JS.SmilesGenerator.getRingKey(a.getIndex(), atomIndex),
              );
          ...
          if (stereoFlag < 7 && bondPrev != null) {
            if (
              havePreviousSp2Atoms &&
              bondPrev.getCovalentOrder() == 2 &&
              orderNext == 2 &&
              sp2Atoms[1] != null
            ) {
          ...
          var osclass = this.openSMILES
            ? atom.getFloatProperty('property_atomclass')
            : NaN;
              ...
              JS.SmilesAtom.getAtomLabel(
                ...
                atat != null
                  ...
                  : this.checkStereoPairs(
                      atom,
                      this.alleneStereo == null ? atomIndex : -1,
                      stereo,
                      stereoFlag,
                      prevIndex == -1,
                    ),
      ...
      Clazz_defineMethod(
        ...
        function (bondPrev, atomIndex, prevIndex, isAromatic) {
          ...
          var border = Math.max(
            bondPrev.isPartial() ? 1 : 0,
            bondPrev.getCovalentOrder(),
          );
          return !isAromatic || !this.bsAromatic.get(prevIndex)
            ? JS.SmilesBond.getBondOrderString(border)
            : border == 1 && !this.isSameAromaticRing(atomIndex, prevIndex)
            ? '-'
            : this.aromaticDouble && (border == 2 || border == 514)
            ? '='
            : '';
        },
        'JU.Edge,~N,~N,~B',
      ...
      Clazz_defineMethod(
        ...
        function (a1, a2) {
          var bs;
          for (var i = this.aromaticRings.size(); --i >= 0; )
            if ((bs = this.aromaticRings.get(i)).get(a1) && bs.get(a2))
              return true;
        ...
        function (atom, v, vTemp) {
          ...
          for (var i = 0; i < n; i++) {
            ...
            if (i == 0) s = this.addStereoCheck(0, atomIndex, a1, '', null);
              ...
              isOK &&
              this.addStereoCheck(0, atomIndex, a1, s, null) != null
            )
              isOK = false;
          ...
          return JS.SmilesStereo.getStereoFlag(
            atom,
            stereo,
            n,
            vTemp,
        ...
        function (atom, atomIndex, stereo, stereoFlag, isFirst) {
          ...
          if (this.explicitHydrogen == 0 && atomIndex >= 0 && stereoFlag == 4) {
            if (atom.getElementNumber() <= 17) {
              ...
              for (var i = 0; i < 4; i++) {
                if (
                  (s = this.addStereoCheck(
                    0,
                    atomIndex,
                    stereo[i],
                    s,
                    JU.BSUtil.newAndSetBit(atomIndex),
                  )) == null
                ) {
                  return '';
                }
          ...
          if (this.is2D) {
            ...
            for (var i = atom.getBondCount(); --i >= 0; ) {
              ...
              if (atom === b.getAtom(0)) {
                switch (b.getBondType()) {
                  case 1025:
                    c = JS.SmilesGenerator.setStereoTemp(
                      null,
                      stereo,
                      b.getAtom(1),
                      dir,
            ...
            if (c == null) return '';
            if (stereoFlag == 3) {
              stereo[stereoFlag++] = JS.SmilesGenerator.setStereoTemp(
                atom,
                stereo,
                c,
                0,
      ...
      c$.setStereoTemp = Clazz_defineMethod(
        c$,
        'setStereoTemp',
      ...
      Clazz_defineMethod(
        ...
        function (i0, i1, ht) {
          ...
          if (s == null) {
            ...
            if (JU.Logger.debugging)
              JU.Logger.debug(
                'adding for ' + i0 + ' ring key ' + this.nPairs + ': ' + key,
              );
          } else {
            ht.remove(key);
            ...
            if (
              this.bsRingKeys.nextSetBit(0) < 0 &&
              (this.nPairsMax == 2 || this.nPairsMax == 99)
            ) {
      ...
      Clazz_defineMethod(
        ...
        function (sb, ht) {
          ...
          for (
            var key, $key = ht.keySet().iterator();
            $key.hasNext() && ((key = $key.next()) || true);

          )
            JU.Logger.info('unmatched connection: ' + key);
        },
        'JU.SB,java.util.Map',
      );
      c$.getRingKey = Clazz_defineMethod(
        c$,
        'getRingKey',
        function (i0, i1) {
  ...
  Clazz_load(
    ...
    function () {
      ...
      c$.setAromatic = Clazz_defineMethod(
        c$,
        'setAromatic',
        function (
          n,
          ...
          for (var r = vR.size(); --r >= 0; ) {
            var bs = vR.get(r);
            var isOK = JS.SmilesAromatic.isSp2Ring(
              n,
              jmolAtoms,
              bsSelected,
              bs,
              justCheckBonding ? 3.4028235e38 : strictness > 0 ? 0.1 : 0.01,
              checkExplicit,
              strictness == 0,
            );
            if (!isOK) continue;
            ...
            if (doCheck) {
              ...
              switch (
                JS.SmilesAromatic.checkHueckelAromatic(
                  n,
                  jmolAtoms,
                  bsAromatic,
                  bs,
                ...
                case 1:
                  if (lstSP2 != null)
                    lstSP2.addLast(new JS.SmilesRing(n, bs, edges, isOK));
                  if (!isOK) continue;
              }
            }
            vOK.addLast(bs);
      ...
      c$.checkAromaticDefined = Clazz_defineMethod(
        c$,
      ...
      c$.isSp2Ring = Clazz_defineMethod(
        c$,
        'isSp2Ring',
        function (
          n,
          ...
          if (checkExplicit) {
            for (var i = bs.nextSetBit(0); i >= 0; i = bs.nextSetBit(i + 1))
              if (atoms[i].getCovalentBondCount() > 3) return false;
          } else {
            for (var i = bs.nextSetBit(0); i >= 0; i = bs.nextSetBit(i + 1))
              if (atoms[i].getCovalentBondCountPlusMissingH() > 3) return false;
          }
          ...
          for (var i = bs.nextSetBit(0); i >= 0; i = bs.nextSetBit(i + 1)) {
            ...
            for (var k = 0, j = i; k < 2; k++) {
              JU.Measure.getNormalThroughPoints(
                atoms[r1],
                atoms[j],
                atoms[r2],
                vNorm,
              ...
              if (!JS.SmilesAromatic.addNormal(vNorm, vMean, maxDev))
                return false;
              vNorms[nNorms++] = JU.V3.newV(vNorm);
              if ((j = iSub) < 0) break;
            }
          }
          return JS.SmilesAromatic.checkStandardDeviation(
            vNorms,
            vMean,
            nNorms,
            cutoff,
      ...
      c$.addNormal = Clazz_defineMethod(
        c$,
        'addNormal',
      ...
      c$.checkStandardDeviation = Clazz_defineMethod(
        c$,
      ...
      c$.checkHueckelAromatic = Clazz_defineMethod(
        c$,
              ...
              switch ((n = a[n])) {
                ...
                case -1:
                  ...
                  for (var j = bonds.length; --j >= 0; ) {
                    ...
                    n =
                      het.getElementNumber() == 6 ||
                      bsAromatic.get(het.getIndex())
                        ? 1
                        : strictness > 0
                        ? -100
                        : 0;
                ...
                default:
                  ...
                  if (n == 1) n1++;
                  if (JU.Logger.debuggingHigh)
                    JU.Logger.info('atom ' + atom + ' pi=' + n + ' npi=' + npi);
                  continue;
              }
            }
          }
          return (npi - 2) % 4 == 0 &&
            (strictness < 2 || nAtoms == 5 || n1 == 6)
            ? 1
            : 0;
        },
        '~N,~A,JU.BS,JU.BS,~N,~A',
      );
      c$.finalizeAromatic = Clazz_defineMethod(
        c$,
        'finalizeAromatic',
        function (
          jmolAtoms,
          ...
          if (isStrict)
            JS.SmilesAromatic.removeBridgingRings(lstAromatic, lstSP2);
      ...
      c$.removeBridgingRings = Clazz_defineMethod(
        c$,
        'removeBridgingRings',
        function (lstAromatic, lstSP2) {
          ...
          JS.SmilesAromatic.checkBridges(
            lstAromatic,
            bsBad,
            lstAromatic,
            bsBad,
          ...
          for (var i = lstAromatic.size(); --i >= 0; )
            if (bsBad.get(i)) lstAromatic.removeItemAt(i);

          for (var i = lstSP2.size(); --i >= 0; )
            if (bsBad2.get(i)) lstSP2.removeItemAt(i);
        },
        'JU.Lst,JU.Lst',
      );
      c$.checkBridges = Clazz_defineMethod(
        c$,
        'checkBridges',
        function (lst, bsBad, lst2, bsBad2, bs) {
          ...
          for (var i = lst.size(); --i >= 0; ) {
            var bs1 = lst.get(i);
            for (
              var j0 = isSameList ? i + 1 : 0, j = lst2.size();
              --j >= j0;
      ...
      c$.checkFusedRings = Clazz_defineMethod(
        c$,
        'checkFusedRings',
        function (rings, eCounts, lstAromatic) {
          ...
          for (var i = rings.size(); --i >= 0; ) {
            ...
            if (set.getElectronCount(eCounts) % 4 == 2)
              for (var j = set.size(); --j >= 0; )
                if (!(r = set.get(j)).isOK) lstAromatic.addLast(r);
      ...
      Clazz_defineStatics(
        ...
        'OS_PI_COUNTS',
        Clazz_newArray(-1, [
          Clazz_newIntArray(-1, [-2, 1, 0]),
          Clazz_newIntArray(-1, [1, 2, 1, -1]),
          Clazz_newIntArray(-1, [2, 1, 2, 1, 1]),
          Clazz_newIntArray(-1, [2, 1]),
          Clazz_newIntArray(-1, [-2, 1, 2, 1, -2]),
          Clazz_newIntArray(-1, [2, 1, 2, 2]),
        ]),
      );
    },
  );
  ...
  Clazz_load(['JU.BS'], 'JS.SmilesRing', null, function () {
    ...
    Clazz_defineMethod(
      ...
      'addEdges',
      function (htEdgeMap) {
        for (var i = this.edges.size(); --i >= 0; )
          htEdgeMap.put(JS.SmilesRing.getKey(this.edges.get(i)), this.$set);
      },
      'java.util.Hashtable',
    );
    c$.getSetByEdge = Clazz_defineMethod(
      c$,
      'getSetByEdge',
  ...
  Clazz_load(['JU.Lst', '$.BS'], 'JS.SmilesRingSet', null, function () {
    ...
    Clazz_defineMethod(
      ...
      function (eCounts) {
        var eCount = 0;
        for (
          var j = this.bs.nextSetBit(0);
          j >= 0;
          j = this.bs.nextSetBit(j + 1)
        )
          eCount += eCounts[j];
  ...
  Clazz_load(
    ...
    function () {
      ...
      c$.allowSmilesUnbracketed = Clazz_defineMethod(
        c$,
      ...
      Clazz_overrideMethod(c$, 'getAtomType', function () {
        return this.atomType == null ? this.bioAtomName : this.atomType;
      });
      Clazz_defineMethod(c$, 'getChiralClass', function () {
        return this.stereo == null
          ? -2147483648
          : this.stereo.getChiralClass(this);
      });
      Clazz_defineMethod(c$, 'isDefined', function () {
        return (
          this.hasSubpattern ||
          this.iNested != 0 ||
          this.isBioAtom ||
      ...
      Clazz_defineMethod(c$, 'setHydrogenCount', function () {
        ...
        var count = JS.SmilesAtom.getDefaultHCount(
          this.elementNumber,
          this.isAromatic,
          charge == -2147483648 ? 0 : charge,
        );
        if (count < 0) {
          this.missingHydrogenCount = 0;
          return count == -1;
        ...
        if (this.elementNumber == 7 && this.isAromatic && this.bondCount == 2) {
          if (
            this.bonds[0].getBondType() == 1 &&
            this.bonds[1].getBondType() == 1
          )
            count++;
        }
      ...
      c$.getDefaultHCount = Clazz_defineMethod(
        c$,
        'getDefaultHCount',
      ...
      Clazz_overrideMethod(c$, 'getIndex', function () {
        return this.index;
      });
      Clazz_defineMethod(
        c$,
        ...
        function (symbol) {
          ...
          this.elementNumber = JU.Elements.elementNumberFromSymbol(
            symbol,
            true,
          );
      ...
      Clazz_overrideMethod(c$, 'getElementNumber', function () {
        return this.elementNumber;
      });
      Clazz_defineMethod(c$, 'getAtomicMass', function () {
        return this.atomicMass;
      });
      Clazz_overrideMethod(c$, 'getAtomNumber', function () {
      ...
      Clazz_defineMethod(c$, 'getCharge', function () {
        return this.charge;
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_defineMethod(c$, 'getMatchingAtomIndex', function () {
        return this.matchingIndex;
      });
      Clazz_defineMethod(c$, 'getMatchingAtom', function () {
      ...
      Clazz_overrideMethod(c$, 'getModelIndex', function () {
      ...
      Clazz_overrideMethod(c$, 'getAtomSite', function () {
        return this.atomSite;
      });
      Clazz_overrideMethod(c$, 'getFormalCharge', function () {
        return this.charge;
      });
      Clazz_overrideMethod(c$, 'getIsotopeNumber', function () {
        return this.atomicMass;
      });
      Clazz_overrideMethod(c$, 'getAtomicAndIsotopeNumber', function () {
        return JU.Elements.getAtomicAndIsotopeNumber(
          this.elementNumber,
          this.atomicMass,
        );
      });
      Clazz_overrideMethod(c$, 'getAtomName', function () {
      ...
      Clazz_defineMethod(c$, 'setBondArray', function () {
      ...
      Clazz_overrideMethod(c$, 'getEdges', function () {
      ...
      Clazz_defineMethod(
        ...
        function (number) {
          return this.parent != null
            ? this.parent.getBond(number)
            : number >= 0 && number < this.bondCount
            ? this.bonds[number]
            : null;
        },
        '~N',
      );
      Clazz_overrideMethod(c$, 'getCovalentBondCount', function () {
        return this.getBondCount();
      });
      Clazz_overrideMethod(c$, 'getBondCount', function () {
        return this.parent != null
          ? this.parent.getBondCount()
          : this.bondCount;
      });
      Clazz_overrideMethod(c$, 'getCovalentBondCountPlusMissingH', function () {
        return (
          this.getBondCount() +
          (this.isTopoAtom ? 0 : this.missingHydrogenCount)
        );
      });
      Clazz_overrideMethod(c$, 'getTotalHydrogenCount', function () {
        return (
          this.getCovalentHydrogenCount() +
          (this.isTopoAtom ? 0 : this.missingHydrogenCount)
        );
      });
      Clazz_overrideMethod(c$, 'getImplicitHydrogenCount', function () {
        return this.implicitHydrogenCount;
      });
      Clazz_overrideMethod(c$, 'getExplicitHydrogenCount', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (j) {
          return this.parent != null
            ? this.parent.getBondedAtomIndex(j)
            : this.bonds[j].getOtherAtom(this).index;
        },
        '~N',
      );
      Clazz_overrideMethod(c$, 'getCovalentHydrogenCount', function () {
        ...
        for (var k = 0; k < this.bonds.length; k++)
          if (this.bonds[k].getOtherAtom(this).elementNumber == 1)
            this.covalentHydrogenCount++;

        return this.covalentHydrogenCount;
      });
      Clazz_overrideMethod(c$, 'getValence', function () {
      ...
      Clazz_overrideMethod(c$, 'getTotalValence', function () {
        return (
      ...
      Clazz_overrideMethod(c$, 'isLeadAtom', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (name, offset) {
          if (this.isBioAtom) {
            ...
            for (var k = 0; k < this.bonds.length; k++)
              if (
                this.bonds[k].getAtomIndex1() == this.index &&
                this.bonds[k].getBondType() == 96
              )
                return this.bonds[k].getOtherAtom(this).index;
          }
          return -1;
        },
        '~S,~N',
      ...
      Clazz_overrideMethod(
        ...
        function (vLinks, crosslinkCovalent, crosslinkHBond) {
          ...
          for (var k = 0; k < this.bonds.length; k++)
            if (this.bonds[k].order == 112) {
              if (vLinks == null) return true;
              vLinks.addLast(Integer.$valueOf(this.index));
              vLinks.addLast(
                Integer.$valueOf(this.bonds[k].getOtherAtom(this).index),
              );
              vLinks.addLast(
                Integer.$valueOf(this.bonds[k].getOtherAtom(this).index),
              );
      ...
      Clazz_overrideMethod(c$, 'getBioStructureTypeName', function () {
        return null;
      });
      Clazz_overrideMethod(c$, 'getInsertionCode', function () {
        return this.insCode;
      });
      Clazz_overrideMethod(c$, 'getResno', function () {
        return this.residueNumber;
      });
      Clazz_overrideMethod(c$, 'getChainID', function () {
        return 0;
      });
      Clazz_overrideMethod(c$, 'getChainIDStr', function () {
        return '';
      });
      c$.getAtomLabel = Clazz_defineMethod(
        c$,
        'getAtomLabel',
        function (
          atomicNumber,
          ...
          var norm = JS.SmilesAtom.getDefaultHCount(
            atomicNumber,
            false,
            charge == -2147483648 ? 0 : charge,
          );
          ...
          return simple && norm == valence
            ...
            : '[' +
                ...
                (stereo == null ? '' : stereo) +
                (nH > 1 ? 'H' + nH : nH == 1 ? 'H' : '') +
                (charge == -2147483648 || charge == 0
                  ? ''
                  : charge < 0
                  ? '' + charge
                  : '+' + charge) +
                (Float.isNaN(osclass) ? '' : ':' + Clazz_floatToInt(osclass)) +
                ']';
        },
        '~N,~N,~N,~N,~N,~N,~B,~S,~B',
      );
      Clazz_overrideMethod(c$, 'getBioSmilesType', function () {
        return this.bioType;
      });
      Clazz_defineMethod(c$, 'isNucleic', function () {
        return (
          this.bioType == 'n' || this.bioType == 'r' || this.bioType == 'd'
        );
      });
      ...
      Clazz_overrideMethod(c$, 'isPyrimidine', function () {
        return (
          this.residueChar != null &&
          this.isNucleic() &&
          'CTUI'.indexOf(this.residueChar) >= 0
        );
      });
      Clazz_overrideMethod(c$, 'isDeleted', function () {
        return false;
      });
      Clazz_overrideMethod(
        c$,
      ...
      Clazz_overrideMethod(c$, 'toString', function () {
        var s =
          this.residueChar != null || this.residueName != null
            ? (this.residueChar == null ? this.residueName : this.residueChar) +
              '.' +
              this.bioAtomName
            : this.bioAtomName != null && this.atomNumber != -2147483648
            ? null
        ...
        var s2 = '';
        for (var i = 0; i < this.bondCount; i++)
          s2 += this.bonds[i].getOtherAtom(this).index + ', ';
        ...
        return (
          ...
          '.' +
          this.index +
          (this.matchingIndex >= 0 ? '(' + this.matchingNode + ')' : '') +
          ']->' +
          s2 +
          '(' +
          this.x +
      ...
      Clazz_overrideMethod(c$, 'getMass', function () {
        return this.atomicMass;
      });
      Clazz_overrideMethod(
        c$,
      ...
      Clazz_overrideMethod(c$, 'getCIPChiralityCode', function () {
        return this.cipChirality;
      });
      Clazz_overrideMethod(c$, 'getXYZ', function () {
        return this;
      });
      Clazz_defineMethod(c$, 'getStereo', function () {
        return this.stereo;
      });
      Clazz_defineMethod(c$, 'getPatternIndex', function () {
        return this.patternIndex;
      });
      Clazz_overrideMethod(c$, 'modelIsRawPDB', function () {
        return false;
      });
      Clazz_defineMethod(c$, 'definesStereo', function () {
        return false;
      });
      Clazz_defineMethod(
        c$,
  ...
  Clazz_load(
    ...
    function () {
      ...
      c$.getBondOrderString = Clazz_defineMethod(
        c$,
        'getBondOrderString',
        function (order) {
          switch (order) {
      ...
      c$.getBondTypeFromCode = Clazz_defineMethod(
        c$,
        'getBondTypeFromCode',
        function (code) {
          switch (code) {
      ...
      Clazz_defineMethod(c$, 'getAtom1', function () {
        return this.atom1;
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_defineMethod(
        ...
        'setAtropType',
        function (nn) {
          this.atropType = Clazz_newIntArray(-1, [
            Clazz_doubleToInt(nn / 10) - 1,
            (nn % 10) - 1,
          ]);
        },
        '~N',
      ...
      Clazz_defineMethod(c$, 'addBondOr', function () {
      ...
      Clazz_defineMethod(c$, 'addPrimitive', function () {
      ...
      c$.isBondType = Clazz_defineMethod(
        c$,
        'isBondType',
        function (ch, isSearch, isBioSequence) {
          ...
          if (!isSearch && '-=#$:/\\.~^`'.indexOf(ch) < 0)
            throw new JS.InvalidSmilesException(
              'SMARTS bond type ' + ch + ' not allowed in SMILES',
            );
          switch (ch) {
            case '~':
      ...
      Clazz_defineMethod(c$, 'getValence', function () {
        return this.order & 7;
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_overrideMethod(c$, 'getAtomIndex1', function () {
        return this.atom1.index;
      });
      Clazz_overrideMethod(c$, 'getAtomIndex2', function () {
        return this.atom2.index;
      });
      Clazz_overrideMethod(c$, 'getCovalentOrder', function () {
      ...
      Clazz_overrideMethod(
        ...
        'getOtherNode',
        function (atom) {
          return atom === this.atom1
            ? this.atom2
            : atom === this.atom2 || atom == null
            ? this.atom1
            : null;
        },
        'JU.SimpleNode',
      );
      Clazz_overrideMethod(c$, 'isCovalent', function () {
        return this.order != 112;
      });
      Clazz_overrideMethod(c$, 'isPartial', function () {
        return false;
      });
      Clazz_overrideMethod(c$, 'isHydrogen', function () {
        return this.order == 112;
      });
      Clazz_defineMethod(c$, 'switchAtoms', function () {
        var a = this.atom1;
      ...
      Clazz_defineMethod(c$, 'getRealCovalentOrder', function () {
        switch (this.order & 131071) {
          case 65537:
          case 65538:
          case 1025:
      ...
      Clazz_defineMethod(c$, 'getMatchingBond', function () {
  ...
  Clazz_load(null, 'JS.SmilesMeasure', ['JU.PT'], function () {
    ...
    Clazz_makeConstructor(
      ...
      function (search, index, type, isNot, minmax) {
        ...
        this.isNot = isNot;
        this.minmax = minmax;
        for (var i = minmax.length - 2; i >= 0; i -= 2)
    ...
    Clazz_defineMethod(
      ...
      function (index) {
        ...
        if (this.nPoints == 0)
          for (var i = 1; i < this.type; i++) this.indices[i] = index + i;
    ...
    Clazz_defineMethod(c$, 'check', function () {
      for (var i = 0; i < this.type; i++) {
        var iAtom =
          this.search.patternAtoms[this.indices[i]].getMatchingAtomIndex();
      ...
      switch (this.type) {
        ...
        case 3:
          ...
          break;
        case 4:
          d = JS.SmilesMeasure.setTorsionData(
            this.points[0],
            this.points[1],
            this.points[2],
            this.points[3],
      ...
      for (var i = this.minmax.length - 2; i >= 0; i -= 2)
        if (d >= this.minmax[i] && d <= this.minmax[i + 1]) return !this.isNot;

      return this.isNot;
    });
    c$.setTorsionData = Clazz_defineMethod(
      c$,
      'setTorsionData',
      function (pt1a, pt1, pt2, pt2a, v, withDihedral) {
        ...
        return (
          (v.vTemp1.angle(v.vTemp2) / 0.017453292) *
    ...
    Clazz_overrideMethod(c$, 'toString', function () {
      var s =
        ...
        ') for';
      for (var i = 0; i < this.type; i++)
        s += ' ' + (i >= this.nPoints ? '?' : '' + this.indices[i]);
  ...
  Clazz_load(
    ...
    function () {
      ...
      c$.newSearch = Clazz_defineMethod(
        c$,
        'newSearch',
        ...
        function (pattern) {
          ...
          for (var i = 0; i < patterns.length; i++) {
            ...
            if (toDo.indexOf(key) < 0) {
              search.subSearches[i] = this.getSubsearch(
                search,
                patterns[i],
                this.flags,
              );
              ...
              case '|':
                if (nParen > 0) {
                  ...
                  if (pattern.charAt(i + 1) == '|') {
                    pattern =
                      pattern.substring(0, i) + pattern.substring(i + 1);
                    len--;
                  }
                }
                break;
          ...
          if (pattern.indexOf('||') >= 0) {
            ...
            while ((pt = pattern.indexOf('[$', pt + 1)) >= 0) {
              ...
              if (repeat.indexOf(':') >= 0 && repeat.indexOf('|') < 0) {
                ...
                if (ptColon > 0)
                  repeat =
                    repeat.substring(0, ptColon) +
                    '(' +
                    repeat.substring(ptColon, n) +
                    ')' +
                    repeat.substring(n);
              }
              if (min == -2147483648) {
                ...
                if (ptOr >= 0)
                  return this.parseVariableLength(
                    pattern.substring(0, pt0) +
                      '[$1' +
                      pattern.substring(pt2, pt2 + ptOr + 1) +
                      ')]' +
                      pattern.substring(pt1) +
                      '||' +
                      pattern.substring(0, pt0) +
                      '[$1(' +
                      pattern.substring(pt2 + ptOr + 2) +
                      pattern.substring(pt1),
                  );
                continue;
              }
            ...
            if (!isOK)
              throw new JS.InvalidSmilesException(
                'bad variable expression: ' + bracketed,
              );
          }
          return haveInternalOr
            ? this.parseVariableLength(sout.substring(2))
            : sout.length() < 2
            ? pattern
            : sout.substring(2);
        },
      ...
      Clazz_defineMethod(
        ...
        function (search, atom, flags) {
          ...
          for (var i = 0; i < atom.nSubAtoms; i++)
      ...
      Clazz_defineMethod(
        ...
        function (search, pattern, currentAtom, isBranchAtom) {
          ...
          loop: while (pattern != null && pattern.length != 0) {
            ...
            if (ch == '(') {
              var subString = JS.SmilesParser.getSubPattern(
                pattern,
                index,
                '(',
              );
              var isMeasure =
                JS.SmilesParser.getChar(pattern, index + 1) == '.';
              if (currentAtom == null) {
                ...
                if (
                  !haveOpen &&
                  (haveOpen = this.checkBrace(search, ch, '{')) == true
                )
                  ch = JS.SmilesParser.getChar(
                    (pattern = pattern.substring(1)),
                    0,
            ...
            if (ch != '\0') {
                ...
                switch (
                  ...
                  case -1:
                    if (
                      !(
                        (JU.PT.isDigit(
                          JS.SmilesParser.getChar(pattern, ++index),
                        ) && index++ > 0
                          ? JU.PT.isDigit(
                              JS.SmilesParser.getChar(pattern, index++),
                            )
              ...
              if (haveOpen && bond.order != -1)
                ch = JS.SmilesParser.getChar(pattern, (index = pt));
              ...
              if (isConnect) {
                ...
                switch (ch) {
                  case '[':
                  case '_':
                    var subPattern = JS.SmilesParser.getSubPattern(
                      pattern,
                      index,
                      ch,
                    );
                  ...
                  default:
                    var ch2 =
                      !this.isBioSequence && JU.PT.isUpperCase(ch)
                        ? JS.SmilesParser.getChar(pattern, index + 1)
                        : '\0';
                    if (ch != 'X' || ch2 != 'x')
                      if (
                        !JU.PT.isLowerCase(ch2) ||
                        JU.Elements.elementNumberFromSymbol(
                          pattern.substring(index, index + 2),
                          true,
                        ) == 0
                      )
                        ch2 = '\0';
                    ...
                    var size =
                      JU.PT.isUpperCase(ch) && JU.PT.isLowerCase(ch2) ? 2 : 1;
                    currentAtom = this.parseAtom(
                      search,
                      null,
                      pattern.substring(index, index + size),
                      currentAtom,
                      bond,
                      false,
                      false,
      ...
      Clazz_defineMethod(
        ...
        function (search, ringNum, currentAtom, bond) {
          ...
          if (
            (bond0.order != -1 && bond0.order != bond.order) ||
            currentAtom === bond0.atom1 ||
            bond0.atom1.getBondTo(currentAtom) != null
          )
            throw new JS.InvalidSmilesException('Bad connection type or atom');
          bond0.set(bond);
      ...
      Clazz_defineMethod(
        ...
        function (bond, a1, a2, search) {
          ...
          if (
            ...
            bond.atom1 != null &&
            bond.atom2 != null &&
            bond.atom1.isAromatic &&
            bond.atom2.isAromatic &&
            (this.flags & 512) == 0
          )
            search.setFlags((this.flags = this.flags | 512));
        },
        'JS.SmilesBond,JS.SmilesAtom,JS.SmilesAtom,JS.SmilesSearch',
      );
      c$.getRingNumber = Clazz_defineMethod(
        c$,
        'getRingNumber',
          ...
          switch (ch) {
            case '%':
              if (JS.SmilesParser.getChar(pattern, index + 1) == '(') {
                ...
                if (ret[0] < 0)
                  throw new JS.InvalidSmilesException(
                    'Invalid number designation: ' + subPattern,
                  );
              } else {
                if (index + 3 <= pattern.length)
                  index = JS.SmilesParser.getDigits(
                    pattern.substring(0, index + 3),
                    index + 1,
                    ret,
                  );
                if (ret[0] < 10)
      ...
      Clazz_defineMethod(
        ...
        function (pattern, index) {
          ...
          if (this.isBioSequence) {
            ...
            if (
              ch == '~' &&
              ((ch = pattern.charAt(1)) == '*' || JU.PT.isLowerCase(ch))
            ) {
              this.bioType = ch;
              index = 3;
            }
          ...
          while (pt != 0) {
            ...
            try {
              if (pt > 0) {
                ...
                else if (index == 0 && JU.Logger.debugging)
                  JU.Logger.debug('measure created: ' + m);
              } else {
        ...
        function (search, pattern, prefix) {
          ...
          while ((index = pattern.lastIndexOf(prefix)) >= 0) {
            ...
            if (
              ...
              prefix.length == 2 &&
              (pt = pattern.length) > 1 &&
              ',;&!['.indexOf(pattern.substring(pt - 1)) < 0
            )
              op = '&';
      ...
      Clazz_defineMethod(
        ...
        function (pattern) {
          ...
          while ((index = pattern.indexOf('$', ipt)) >= 0) {
            ...
            if (
              ipt <= index + 1 ||
              JS.SmilesParser.getChar(pattern, ipt + 1) != '"'
            )
              break;
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          if (
            ...
            while (ch != '\0' && isNewAtom) {
              ...
              if (JU.PT.isDigit(ch)) {
                ...
                switch (ch) {
                  ...
                  case '_':
                    index =
                      JS.SmilesParser.getDigits(pattern, index + 1, ret) + 1;
                    if (ret[0] == -2147483648)
                      throw new JS.InvalidSmilesException(
                        'Invalid SEARCH primitive: ' + pattern.substring(index),
                      );
                    ...
                    if (this.isBioSequence && index != pattern.length)
                      throw new JS.InvalidSmilesException(
                        'invalid characters: ' + pattern.substring(index),
                      );
                    break;
                  case '=':
                  ...
                  case '@':
                    if (search.stereo == null)
                      search.stereo = JS.SmilesStereo.newStereo(search);
                    index = JS.SmilesStereo.checkChirality(
                      search,
                      pattern,
                      index,
                  ...
                  default:
                    ...
                    var len =
                      index +
                      (JU.PT.isLowerCase(nextChar) &&
                      (!isBracketed ||
                        !JU.PT.isDigit(
                          JS.SmilesParser.getChar(pattern, index + 2),
                        ))
                        ? 2
                        : 1);
                    ...
                    if (checkForPrimitive) {
                      if (!isNot && (isAND ? atomSet : newAtom).hasSymbol) {
                        ...
                        mustBeSymbol =
                          pattern.length == 1 || !JU.PT.isDigit(nextChar);
                      } else if (JU.PT.isDigit(nextChar)) {
                        mustBeSymbol = false;
                      } else if (!symbol.equals('A') && !symbol.equals('Xx')) {
                        mustBeSymbol =
                          (ch == 'h' ? len == 2 : true) &&
                          JU.Elements.elementNumberFromSymbol(symbol, true) > 0;
                        if (!mustBeSymbol && len == 2) {
                          sym2 = '';
                          symbol = symbol.substring(0, 1);
                          mustBeSymbol =
                            JU.Elements.elementNumberFromSymbol(symbol, true) >
                            0;
                        }
                      }
                    }
                    if (mustBeSymbol) {
                      if (
                        (!isBracketed &&
                          !this.isSmarts &&
                          !this.isBioSequence &&
                          !JS.SmilesAtom.allowSmilesUnbracketed(symbol)) ||
                        !newAtom.setSymbol((symbol = ch + sym2))
                      )
                        throw new JS.InvalidSmilesException(
                          'Invalid atom symbol: ' + symbol,
                        );
                      ...
                      switch (ch) {
                        ...
                        case 'D':
                          ...
                          break;
                        case 'd':
                          newAtom.setNonhydrogenDegree(
                            val == -2147483648 ? 1 : val,
                          );
                          break;
                        case 'H':
            ...
            if (hydrogenCount == -2147483648 && isBracketed)
              hydrogenCount = -2147483647;
            newAtom.setExplicitHydrogenCount(hydrogenCount);
            search.patternAtoms[newAtom.index].setExplicitHydrogenCount(
              hydrogenCount,
            );
          }
          ...
          if (atom != null && bond.order != 0) {
            if (bond.order == -1)
              bond.order =
                this.isBioSequence && isBranchAtom
                  ? 112
                  : this.isSmarts || (atom.isAromatic && newAtom.isAromatic)
                  ? 81
                  : 1;
            if (!isBracketed) this.setBondAtom(bond, null, newAtom, search);
            if (
              this.branchLevel == 0 &&
              (bond.getBondType() == 17 || bond.order == 112)
            )
              this.branchLevel++;
          }
        ...
        function (
            ...
            switch ((ch = pattern.charAt(0))) {
              ...
              case '.':
                if (bond == null && bondSet == null) {
                  this.isBioSequence =
                    JS.SmilesParser.getChar(pattern, 1) == '~';
            ...
            bondSet == null
              ? bond == null
                ? new JS.SmilesBond(
                    currentAtom,
                    null,
                    this.isBioSequence && currentAtom != null
                      ? isBranchAtom
                        ? 112
                        : 96
                      : -1,
          ...
          if (
            ...
            switch (bondType) {
              ...
              case 65538:
                if (
                  (len = pattern.length) < (isBondNot ? 3 : 2) ||
                  pattern.charAt(len - 1) != '-'
                ) {
                  len = 0;
                } else {
          ...
          if (len == -1)
            throw new JS.InvalidSmilesException('invalid bond:' + ch);
          return newBond;
        },
          ...
          out: while (true) {
            ...
            if (haveOr) {
              ...
              while ((pt = pattern.indexOf(',', index)) > 0 && pt <= len) {
                ...
                if (s.length == 0)
                  throw new JS.InvalidSmilesException(
                    'missing ' + (bond == null ? 'atom' : 'bond') + ' token',
                  );
                if (bond == null)
                  this.parseAtom(
                    search,
              ...
              (pt = pattern.indexOf(and)) >= 0 ||
              (bond != null && len > 1 && !isAND)
            ) {
              ...
              while ((pt = pattern.indexOf(and, index)) > 0 && pt <= len) {
                ...
                if (bond == null)
                  ...
                  this.parseBond(
                    search,
                    this.isSmarts ? bond : null,
                    s,
                    this.isSmarts ? null : bond,
                    currentAtom,
                    true,
                    false,
                    s.length,
      ...
      c$.getSubPattern = Clazz_defineMethod(
        c$,
        'getSubPattern',
      ...
      c$.getDigits = Clazz_defineMethod(
        c$,
        'getDigits',
      ...
      c$.skipTo = Clazz_defineMethod(
        ...
        function (pattern, index, ch0) {
          ...
          var ch;
          while (
            (ch = JS.SmilesParser.getChar(pattern, ++pt)) != ch0 &&
            ch != '\0'
          ) {}
          return ch == '\0' ? -1 : pt;
        },
      ...
      c$.cleanPattern = Clazz_defineMethod(
        c$,
        'cleanPattern',
        function (pattern) {
      ...
      c$.extractFlags = Clazz_defineMethod(
        c$,
        'extractFlags',
        function (pattern, ret) {
          ...
          while (pattern.startsWith('/')) {
            var strFlags = JS.SmilesParser.getSubPattern(
              pattern,
              0,
              '/',
            ).toUpperCase();
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          try {
            ...
            var mapFirst = maps[0];
            for (var i = 0; i < mapFirst.length; i++)
            ...
            if (bestMap || !asMap) {
              ...
              for (var i = 0; i < maps.length; i++) {
                ...
                var stddev =
                  ptsB.size() == 1
                    ? 0
                    : JU.Measure.getTransformMatrix4(ptsA, ptsB, m, null);
              ...
              ptsB.clear();
              for (var i = 0; i < mapBest.length; i++)
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          if (
            ...
            try {
              return this.e.vwr.getSmilesOpt(
                ...
                0,
                flags |
                  (pattern.equals('H2') ? 8192 : 0) |
                  (pattern.equals('H') ? 4096 : 0) |
                  (pattern.equals('top') ? 16384 : 0) |
                  (pattern.equalsIgnoreCase('NOAROMATIC') ? 16 : 0),
          ...
          if (bsMatch3D == null) {
            try {
              if (smiles == null) {
                b = this.e.vwr.getSubstructureSetArray(
                  pattern,
                  bsSelected,
                  flags,
                );
                ...
                flags =
                  (isSmarts ? 2 : 1) |
                  (firstMatchOnly ? 8 : 0) |
                  (ignoreElements ? 16384 : 0);
                if (!Clazz_instanceOf(smiles, String)) {
                  return this.e.vwr
                    .getSmilesMatcher()
                    .hasStructure(pattern, smiles, flags);
                }
                var map = this.e.vwr
                  .getSmilesMatcher()
                  .find(pattern, smiles, flags);
                if (!asOneBitset)
                  return !firstMatchOnly
                    ? map
                    : map.length == 0
                    ? Clazz_newIntArray(0, 0)
                    : map[0];
                var bs = new JU.BS();
            ...
            var stddev = this.getSmilesCorrelation(
              bsMatch3D,
              bsSelected,
              pattern,
              null,
            ...
            if (Float.isNaN(stddev))
              return asOneBitset ? new JU.BS() : Clazz_newArray(-1, []);
      ...
      Clazz_defineMethod(
        ...
        function (bs1, bs2, smiles1, isSmarts) {
          ...
          var bondMap2 =
            bondMap1 == null ? null : this.e.vwr.ms.getDihedralMap(mapSet[1]);
      ...
      c$.getTorsions = Clazz_defineMethod(
        c$,
        'getTorsions',
        function (atoms, bondMap, diff, pt) {
          for (var i = bondMap.length; --i >= 0; ) {
            var map = bondMap[i];
            var v = JU.Measure.computeTorsion(
              atoms[map[0]],
              atoms[map[1]],
              atoms[map[2]],
              atoms[map[3]],
