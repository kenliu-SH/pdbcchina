                ...
                return (
                  ...
                  u
                    ? this.each(function () {
                        ...
                        if (r !== i && r !== t)
                          return (
                            (f = r && r.jquery ? f.pushStack(r.get()) : r), !1
                          );
                      })
                    : this.each(function () {
                        var t = e.data(this, s);
                      ...
                      (u = function (e) {
                        var n = v.left - C.left,
                          ...
                          h = {
                            ...
                            horizontal:
                              s < 0 ? 'left' : n > 0 ? 'right' : 'center',
                            vertical:
                              u < 0 ? 'top' : o > 0 ? 'bottom' : 'middle',
                          };
              ...
              flip: {
                ...
                top: function (e, t) {
                  ...
                  a < 0
                    ...
                    : f > 0 &&
                      ((d =
                        e.top - t.collisionPosition.marginTop + c + h + p - o),
                      e.top + c + h + p > f &&
                        (d > 0 || i(d) < f) &&
                        (e.top += c + h + p));
                },
...
*/
	...
	.jmolPopupMenu .ui-state-disabled .ui-icon{filter:Alpha(Opacity=35)}'
      ...
      Swing.setMenu = function (menu) {
        ...
        Swing.__getMenuStyle &&
          Jmol.$after(
            'head',
            '<style>' + Swing.__getMenuStyle(menu.applet) + '</style>',
          );
        ...
        Jmol.$after(
          'body',
          '<ul id="' + menu.id + '" class="jmolPopupMenu"></ul>',
        );
      ...
      Swing.showMenu = function (menu, x, y) {
        ...
        if (Jmol._showMenuCallback) Jmol._showMenuCallback(menu, x, y);
        if (menu.tainted) {
      ...
      Swing.disposeMenu = function (menu) {
        // called by org.jmol.awtjs.swing.JPopupMenu
        if (Jmol._persistentMenu) return;
        Swing.hideMenu(menu);
      ...
      Swing.bindMenuActionCommands = function (menu, isBind) {
        ...
        if (isBind) {
          Jmol.$documentOn('click', menu.id, function (event) {
            var name = '' + menu.name;
            var dohide =
              name.indexOf('Persist') < 0 || name.indexOf('!Persist') >= 0;
            if (menu.itemListener) {
              menu.selected =
                menu.btnType == 2 /*J.awtjs.swing.JMenuItem.TYPE_CHECKBOX*/
                  ? Jmol.$prop(menu.id + '-cb', 'checked')
                  : true;
              if (dohide)
                delayHide(menu, function () {
                  menu.itemListener.itemStateChanged({
                    getSource: function () {
                      return menu;
                    },
                  });
              ...
              if (dohide)
                delayHide(menu, function () {
                  menu.actionListener.actionPerformed({
                    getSource: function () {
                      return menu;
                    },
          ...
          Jmol.$documentOn(
            ...
            function (event) {
              if (menu.mouseListener && menu.mouseListener.handleEvent) {
                menu.mouseListener.handleEvent({
                  jqevent: event,
                  getID: function () {
                    return event.type;
                  },
  ...
  Clazz_load(
    ...
    function () {
        ...
        function (parentId, key, menu, popupResourceBundle) {
          ...
          while (st.hasMoreTokens()) {
            ...
            if (item.indexOf('Menu') >= 0) {
              ...
              newItem = this.menuCreateCheckboxItem(
                menu,
                label,
                basename + ':' + script,
                id + '.' + item,
      ...
      Clazz_defineMethod(c$, 'updateSignedAppletItems', function () {
        for (var i = this.SignedOnly.size(); --i >= 0; )
          this.menuEnable(this.SignedOnly.get(i), this.allowSignedFeatures);
      });
      Clazz_defineMethod(
        c$,
        'checkKey',
        function (key) {
          return (
            key.indexOf(this.isApplet ? 'JAVA' : 'APPLET') < 0 &&
            (!this.isWebGL || key.indexOf('NOGL') < 0)
          );
        },
        '~S',
      );
        ...
        function (item, what, TF) {
          ...
          if (what.indexOf('##') < 0) {
            ...
            if ((pt = what.indexOf('|')) >= 0)
              what = (
                TF ? what.substring(0, pt) : what.substring(pt + 1)
              ).trim();
      ...
      Clazz_defineMethod(
        ...
        function (menu, entry, basename, id, state, isRadio) {
          var jmi = isRadio
            ? this.helper.getRadio(entry)
            : this.helper.getCheckBox(entry);
      ...
      Clazz_defineMethod(
        ...
        function (menu, indexFrom) {
          if (indexFrom <= 0) menu.removeAll();
            ...
            for (var i = menu.getComponentCount(); --i >= indexFrom; )
              menu.remove(i);
      ...
      Clazz_defineMethod(
        ...
        function (item) {
          ...
          for (i = p.getComponentCount(); --i >= 0; )
            if (this.helper.getSwingComponent(p.getComponent(i)) === item)
              break;
      ...
      Clazz_defineMethod(c$, 'updateCheckBoxesForShow', function () {
        for (
          var entry, $entry = this.htCheckbox.entrySet().iterator();
          ...
          for (var i = 0; i < subMenus.length; i++) {
            ...
            switch (type) {
              ...
              default:
                ...
                script = this.getScriptForCallback(
                  source,
                  source.getName(),
            ...
            J.popup.GenericPopup.addItemText(
              sb,
              key,
              level,
              name,
            ...
            if (type == 2)
              this.menuGetAsText(
                sb,
                level + 1,
                this.helper.getSwingComponent(source.getPopupMenu()),
                name,
              );
          }
        },
      ...
      c$.addItemText = Clazz_defineMethod(
        c$,
        'addItemText',
      ...
      c$.convertToMegabytes = Clazz_defineMethod(
        c$,
        'convertToMegabytes',
        function (num) {
      ...
      Clazz_overrideMethod(c$, 'jpiDispose', function () {
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (vwr, bundle, title) {
          ...
          this.initSwing(
            title,
            bundle,
            vwr.isJSNoAWT ? vwr.html5Applet : null,
            vwr.isJSNoAWT,
      ...
      Clazz_defineMethod(c$, 'showFrankMenu', function () {
        return true;
      });
      Clazz_defineMethod(c$, 'jpiDispose', function () {
        this.vwr = null;
        Clazz_superCall(this, J.popup.JmolGenericPopup, 'jpiDispose', []);
      });
      Clazz_overrideMethod(c$, 'jpiGetMenuAsObject', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (item, basename, script, TF) {
          ...
          if (basename.indexOf('mk') >= 0 || basename.indexOf('??') >= 0) {
            script = this.getUnknownCheckBoxScriptToRun(
              item,
              basename,
              script,
              TF,
            ...
            if (!TF) return true;
            script =
              'set picking ' + basename.substring(0, basename.length - 2);
          }
          if (script != null) this.appRunScript(script);
          return true;
        },
      ...
      Clazz_overrideMethod(c$, 'appRestorePopupMenu', function () {
        this.thisPopup = this.popupMenu;
      });
      Clazz_overrideMethod(
        c$,
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_prepareFields(c$, function () {
        ...
        this.noZapped = Clazz_newArray(-1, [
          'surfaceMenu',
          'measureMenu',
          'pickingMenu',
          'computationMenu',
      ...
      Clazz_overrideMethod(c$, 'showFrankMenu', function () {
        this.getViewerData();
      ...
      Clazz_overrideMethod(c$, 'jpiUpdateComputedMenus', function () {
      ...
      Clazz_defineMethod(c$, 'updateMenus', function () {
        ...
        if (this.updateMode == 0) {
          ...
          for (var i = this.Special.size(); --i >= 0; )
            this.updateSpecialMenuItem(this.Special.get(i));
        }
      });
      Clazz_overrideMethod(
        c$,
      ...
      Clazz_defineMethod(
        ...
        function (id) {
          ...
          this.currentFrankId = id;
          this.nFrankList = 0;
          this.frankList[this.nFrankList++] = Clazz_newArray(-1, [
            null,
            null,
            null,
          ]);
          if (id != null)
            for (var i = id.indexOf('.', 2) + 1; ; ) {
              ...
              this.frankList[this.nFrankList++] = Clazz_newArray(-1, [
                ...
                menu,
                Integer.$valueOf(
                  this.vwr.isJSNoAWT ? 0 : this.menuGetListPosition(menu),
                ),
              ]);
      ...
      Clazz_defineMethod(
        ...
        function (key) {
          return (
            this.modelSetInfo != null &&
            this.modelSetInfo.get(key) === Boolean.TRUE
          );
        },
        '~S',
      );
      Clazz_defineMethod(c$, 'getViewerData', function () {
        ...
        this.modelSetRoot = this.modelSetFileName.substring(
          0,
          i < 0 ? this.modelSetFileName.length : i,
        );
      ...
      Clazz_overrideMethod(c$, 'appUpdateForShow', function () {
        if (this.updateMode == -1) return;
        this.isTainted = true;
        this.getViewerData();
        this.updateMode = 2;
      ...
      Clazz_defineMethod(c$, 'updateFileMenu', function () {
        ...
        if (ignore) {
          ...
          this.menuSetLabel(
            menu,
            J.i18n.GT.o(J.i18n.GT.$(text), this.modelSetFileName),
          );
      ...
      Clazz_defineMethod(c$, 'updateSelectMenu', function () {
      ...
      Clazz_defineMethod(
        ...
        function (elementsPresentBitSet) {
          ...
          for (
            var i = elementsPresentBitSet.nextSetBit(0);
            i >= 0;
      ...
      Clazz_defineMethod(c$, 'updateSpectraMenu', function () {
        ...
        var isOK = new Boolean(
          this.setSpectraMenu(menuh, this.hnmrPeaks) |
            this.setSpectraMenu(menuc, this.cnmrPeaks),
        ).valueOf();
        if (isOK) {
          ...
          for (var i = 0; i < n; i++) {
            ...
            if (atoms != null)
              this.menuCreateItem(
                menu,
                title,
                'select visible & (@' + JU.PT.rep(atoms, ',', ' or @') + ')',
                'Focus' + i,
              );
          }
          this.menuEnable(menu, true);
      ...
      Clazz_defineMethod(
        ...
        function (htHetero) {
          ...
          var n = 0;
          for (
            var hetero, $hetero = htHetero.entrySet().iterator();
            $hetero.hasNext() && ((hetero = $hetero.next()) || true);
        ...
        function (moData) {
          ...
          for (var i = nOrb; --i >= 0; ) {
            if (pt >= 0 && pt++ % nmod == 0) {
              ...
              var id = 'mo' + pt + 'Menu';
              subMenu = this.menuNewSubMenu(
                Math.max(i + 2 - nmod, 1) + '...' + (i + 1),
                this.menuGetId(menu) + '.' + id,
              );
              this.menuAddSubMenu(menu, subMenu);
      ...
      Clazz_defineMethod(c$, 'updateFileTypeDependentMenus', function () {
        for (var i = this.NotPDB.size(); --i >= 0; )
          this.menuEnable(this.NotPDB.get(i), !this.isPDB);

        for (var i = this.PDBOnly.size(); --i >= 0; )
          this.menuEnable(this.PDBOnly.get(i), this.isPDB);

        for (var i = this.UnitcellOnly.size(); --i >= 0; )
          this.menuEnable(this.UnitcellOnly.get(i), this.isUnitCell);

        for (var i = this.FileUnitOnly.size(); --i >= 0; )
          this.menuEnable(
            this.FileUnitOnly.get(i),
            this.isUnitCell || this.fileHasUnitCell,
          );

        for (var i = this.FileMolOnly.size(); --i >= 0; )
          this.menuEnable(
            this.FileMolOnly.get(i),
            this.isUnitCell || this.fileHasUnitCell,
          );

        for (var i = this.SingleModelOnly.size(); --i >= 0; )
          this.menuEnable(this.SingleModelOnly.get(i), this.isLastFrame);

        for (var i = this.FramesOnly.size(); --i >= 0; )
          this.menuEnable(this.FramesOnly.get(i), this.isMultiFrame);

        for (var i = this.VibrationOnly.size(); --i >= 0; )
          this.menuEnable(this.VibrationOnly.get(i), this.isVibration);

        for (var i = this.SymmetryOnly.size(); --i >= 0; )
          this.menuEnable(
            this.SymmetryOnly.get(i),
            this.hasSymmetry && this.isUnitCell,
          );

        for (var i = this.ChargesOnly.size(); --i >= 0; )
          this.menuEnable(this.ChargesOnly.get(i), this.haveCharges);

        for (var i = this.TemperatureOnly.size(); --i >= 0; )
          this.menuEnable(this.TemperatureOnly.get(i), this.haveBFactors);

        this.updateSignedAppletItems();
      });
      Clazz_defineMethod(c$, 'updateSceneComputedMenu', function () {
        ...
        for (var i = 0; i < scenes.length; i++)
          this.menuCreateItem(
            menu,
            scenes[i],
            'restore scene ' + JU.PT.esc(scenes[i]) + ' 1.0',
            null,
          );

        this.menuEnable(menu, true);
      });
      Clazz_defineMethod(c$, 'updatePDBResidueComputedMenus', function () {
        var haveMenu = false;
        ...
        this.group3Counts =
          lists == null ? null : this.modelSetInfo.get('group3Counts')[n];
        if (this.group3List == null) return;
        var nItems = 0;
        var groupList = JM.Group.standardGroupList;
        if (menu3 != null) {
          for (var i = 1; i < 24; ++i)
            nItems += this.updateGroup3List(
              menu3,
        ...
        if (menu1 != null) {
          ...
          var dssr =
            nItems > 0 && this.modelIndex >= 0
              ? this.vwr.ms.getInfo(this.modelIndex, 'dssr')
              : null;
          if (dssr != null)
            this.setSecStrucMenu(this.htMenus.get('aaStructureMenu'), dssr);
        }
        if (menu2 != null) {
      ...
      Clazz_defineMethod(
        ...
        function (menu, name) {
          ...
          var n =
            this.group3Counts[
              Clazz_doubleToInt(this.group3List.indexOf(name) / 6)
            ];
          name = name.trim();
          var script = null;
          if (n > 0) {
          ...
          var item = this.menuCreateItem(
            menu,
            name,
            script,
            this.menuGetId(menu) + '.' + name,
          );
      ...
      Clazz_defineMethod(c$, 'updateSYMMETRYComputedMenus', function () {
        this.updateSYMMETRYSelectComputedMenu();
        this.updateSYMMETRYShowComputedMenu();
      });
      Clazz_defineMethod(c$, 'updateSYMMETRYShowComputedMenu', function () {
        ...
        this.menuSetLabel(
          menu,
          name == null ? J.i18n.GT.$('Space Group') : name,
        );
        var subMenu = menu;
        ...
        for (var i = 0; i < infolist.length; i++) {
          if (pt >= 0 && pt++ % 25 == 0) {
            ...
            subMenu = this.menuNewSubMenu(
              i + 1 + '...' + Math.min(i + 25, infolist.length),
              this.menuGetId(menu) + '.' + id,
            );
            this.menuAddSubMenu(menu, subMenu);
            this.htMenus.put(id, subMenu);
      ...
      Clazz_defineMethod(c$, 'updateSYMMETRYSelectComputedMenu', function () {
      ...
      Clazz_defineMethod(c$, 'updateFRAMESbyModelComputedMenu', function () {
        ...
        for (var i = 0; i < this.modelCount; i++) {
          if (pt >= 0 && pt++ % 25 == 0) {
            ...
            subMenu = this.menuNewSubMenu(
              i + 1 + '...' + Math.min(i + 25, this.modelCount),
              this.menuGetId(menu) + '.' + id,
            );
            this.menuAddSubMenu(menu, subMenu);
            this.htMenus.put(id, subMenu);
      ...
      Clazz_defineMethod(c$, 'updateConfigurationComputedMenu', function () {
        ...
        this.menuCreateCheckboxItem(
          ...
          script,
          null,
          this.updateMode == 1 && this.configurationSelected.equals(script),
          false,
        );
      ...
      Clazz_defineMethod(c$, 'updateModelSetComputedMenu', function () {
        var menu = this.htMenus.get('modelSetMenu');
        if (menu == null) return;
        this.menuRemoveAll(menu, 0);
        this.menuSetLabel(menu, this.nullModelSetName);
        this.menuEnable(menu, false);
        for (var i = this.noZapped.length; --i >= 0; )
          this.menuEnable(this.htMenus.get(this.noZapped[i]), !this.isZapped);
        ...
        if (this.isPDB) {
          ...
          this.addMenuItem(
            ...
            this.gti(
              'chainsText',
              this.vwr.ms.getChainCountInModelWater(this.modelIndex, false),
            ),
          );
          this.addMenuItem(
            menu,
          ...
          if (submenu == null) {
            submenu = this.menuNewSubMenu(
              ...
              this.menuGetId(menu) + '.biomolecules',
            );
            this.menuAddSubMenu(menu, submenu);
          }
          ...
          if (
            this.modelIndex >= 0 &&
            (biomolecules = this.vwr.ms.getInfo(
              this.modelIndex,
              'biomolecules',
            )) != null
          ) {
            ...
            for (var i = 0; i < nBiomolecules; i++) {
              var script = this.isMultiFrame
                ? ''
                : 'save orientation;load "" FILTER "biomolecule ' +
                  (i + 1) +
                  '";restore orientation;';
              var nAtoms = biomolecules.get(i).get('atomCount').intValue();
              var entryName = this.gto(
                this.isMultiFrame ? 'biomoleculeText' : 'loadBiomoleculeText',
                Clazz_newArray(-1, [
                  Integer.$valueOf(i + 1),
      ...
      Clazz_defineMethod(c$, 'updateAboutSubmenu', function () {
        if (this.isApplet) this.setText('APPLETid', this.vwr.appletName);
        {
        }
      });
      Clazz_defineMethod(c$, 'updateLanguageSubmenu', function () {
      ...
      Clazz_defineMethod(
        ...
        function (name, text) {
          ...
          if (name.indexOf('captureLooping') >= 0)
            info =
              this.vwr.am.animationReplayMode == 1073742070 ? 'ONCE' : 'LOOP';
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'getMenuName', function () {
        return 'popupMenu';
      });
      Clazz_overrideMethod(
        c$,
        ...
        function (menuStructure) {
          ...
          if (menuStructure != null)
            this.setStructure(menuStructure, new J.i18n.GT());
        },
        '~S',
      );
      c$.Box = Clazz_defineMethod(
        c$,
        'Box',
        function (cmd) {
          return (
      ...
      Clazz_overrideMethod(c$, 'getWordContents', function () {
        ...
        var words = Clazz_newArray(-1, [
          ...
          J.i18n.GT.$('Zoom'),
          'vector005',
          J.i18n.GT.o(ang, '0.05'),
          'bond100',
          J.i18n.GT.o(ang, '0.10'),
          'hbond100',
          null,
          'ssbond100',
          null,
          ...
          null,
          'bond150',
          J.i18n.GT.o(ang, '0.15'),
          'hbond150',
          null,
          'ssbond150',
          null,
          'bond200',
          J.i18n.GT.o(ang, '0.20'),
          'hbond200',
          null,
          'ssbond200',
          null,
          ...
          null,
          'bond300',
          J.i18n.GT.o(ang, '0.30'),
          'hbond300',
          null,
          'ssbond300',
          null,
          '50a',
          J.i18n.GT.o(ang, '0.50'),
          '100a',
          J.i18n.GT.o(ang, '1.0'),
          '1p',
          J.i18n.GT.i(pxl, 1),
          ...
          J.i18n.GT.i(vdw, 75),
          'SIGNEDNOGLwriteIdtf',
          J.i18n.GT.o(exm, 'IDTF'),
          'SIGNEDNOGLwriteMaya',
          J.i18n.GT.o(exm, 'Maya'),
          'SIGNEDNOGLwriteVrml',
          J.i18n.GT.o(exm, 'VRML'),
          'SIGNEDNOGLwriteX3d',
          J.i18n.GT.o(exm, 'X3D'),
          'SIGNEDNOGLwriteSTL',
          J.i18n.GT.o(exm, 'STL'),
          ...
          J.i18n.GT.o(exi, 'PNG+JMOL'),
          'SIGNEDNOGLwritePovray',
          J.i18n.GT.o(exi, 'POV-Ray'),
          'FILEUNITnineRestricted',
          J.i18n.GT.o(
            J.i18n.GT.$('Reload {0} + Display {1}'),
            Clazz_newArray(-1, ['{444 666 1}', '555']),
          ),
          'FILEMOLload',
          J.i18n.GT.o(rld, '(molecular)'),
          'FILEUNITone',
          J.i18n.GT.o(rld, '{1 1 1}'),
          'FILEUNITnine',
          J.i18n.GT.o(rld, '{444 666 1}'),
          'vectorScale02',
          J.i18n.GT.o(scl, '0.2'),
          'vectorScale05',
          J.i18n.GT.o(scl, '0.5'),
        ...
        for (var i = 1, n = words.length; i < n; i += 2)
          if (words[i] == null) words[i] = words[i - 2];
      ...
      Clazz_defineStatics(c$, 'MENU_NAME', 'popupMenu');
      c$.menuContents = c$.prototype.menuContents = Clazz_newArray(-1, [
        Clazz_newArray(-1, [
          '@COLOR',
        ...
        Clazz_newArray(-1, [
          '@AXESCOLOR',
          'gray salmon maroon olive slateblue gold orchid',
        ]),
        Clazz_newArray(-1, [
          'popupMenu',
        ...
        Clazz_newArray(-1, [
          '[color_bonds]Menu',
          'none - @COLOR - opaque translucent',
        ]),
        Clazz_newArray(-1, ['[color_hbonds]Menu', null]),
        Clazz_newArray(-1, ['[color_ssbonds]Menu', null]),
        Clazz_newArray(-1, ['[color_labels]Menu', null]),
        Clazz_newArray(-1, ['[color_vectors]Menu', null]),
        Clazz_newArray(-1, [
          '[color_backbone]Menu',
          'none - schemeMenu - @COLOR - opaque translucent',
        ]),
        Clazz_newArray(-1, ['[color_cartoon]sMenu', null]),
        Clazz_newArray(-1, ['[color_ribbon]sMenu', null]),
        Clazz_newArray(-1, ['[color_rockets]Menu', null]),
        Clazz_newArray(-1, ['[color_strands]Menu', null]),
        Clazz_newArray(-1, ['[color_trace]Menu', null]),
        Clazz_newArray(-1, ['[color_background]Menu', '@COLOR']),
        Clazz_newArray(-1, [
          '[color_isosurface]Menu',
          '@COLOR - opaque translucent',
        ]),
        Clazz_newArray(-1, ['[color_axes]Menu', '@AXESCOLOR']),
        Clazz_newArray(-1, ['[color_boundbox]Menu', null]),
        Clazz_newArray(-1, ['[color_UNITCELL]Menu', null]),
        Clazz_newArray(-1, [
          'colorPDBStructuresMenu',
        ...
        Clazz_newArray(-1, ['[color_]schemeMenu', null]),
        Clazz_newArray(-1, [
          'zoomMenu',
        ...
        Clazz_newArray(-1, ['spectraMenu', 'hnmrMenu cnmrMenu']),
        Clazz_newArray(-1, [
          'FRAMESanimateMenu',
        ...
        Clazz_newArray(-1, ['computationMenu', 'minimize modelkit']),
        Clazz_newArray(-1, [
          'showMenu',
        ...
        Clazz_newArray(-1, ['[set_spin_X]Menu', 's0 s5 s10 s20 s30 s40 s50']),
        Clazz_newArray(-1, ['[set_spin_Y]Menu', null]),
        Clazz_newArray(-1, ['[set_spin_Z]Menu', null]),
        Clazz_newArray(-1, ['[set_spin_FPS]Menu', null]),
        Clazz_newArray(-1, ['animModeMenu', 'onceThrough palindrome loop']),
        Clazz_newArray(-1, [
          'surfaceMenu',
        ...
        Clazz_newArray(-1, ['[set_boundbox]Menu', null]),
        Clazz_newArray(-1, ['[set_UNITCELL]Menu', null]),
        Clazz_newArray(-1, ['byPixelMenu', '1p 3p 5p 10p']),
        Clazz_newArray(-1, ['byAngstromMenu', '10a 20a 25a 50a 100a']),
        Clazz_newArray(-1, ['aboutMenu', 'jmolMenu systemMenu']),
        Clazz_newArray(-1, [
          'jmolMenu',
      ...
      c$.structureContents = c$.prototype.structureContents = Clazz_newArray(
        -1,
        [
          Clazz_newArray(-1, ['jmolorg', 'show url "http://www.jmol.org"']),
          Clazz_newArray(-1, ['help', 'help']),
          Clazz_newArray(-1, [
            'mouse',
          ...
          Clazz_newArray(-1, ['colorrasmolCB', '']),
          Clazz_newArray(-1, [
            'hideNotSelectedCB',
            'set hideNotSelected true | set hideNotSelected false; hide(none)',
          ]),
          Clazz_newArray(-1, ['perspectiveDepthCB', '']),
          Clazz_newArray(-1, [
            'showAxesCB',
            'set showAxes true | set showAxes false;set axesMolecular',
          ]),
          Clazz_newArray(-1, ['showBoundBoxCB', '']),
          Clazz_newArray(-1, ['showHydrogensCB', '']),
          Clazz_newArray(-1, ['showMeasurementsCB', '']),
          Clazz_newArray(-1, ['showSelectionsCB', '']),
          Clazz_newArray(-1, ['showUNITCELLCB', '']),
          Clazz_newArray(-1, ['selectAll', 'SELECT all']),
          Clazz_newArray(-1, ['selectNone', 'SELECT none']),
          Clazz_newArray(-1, ['invertSelection', 'SELECT not selected']),
          Clazz_newArray(-1, ['allProtein', 'SELECT protein']),
          Clazz_newArray(-1, [
            'proteinBackbone',
          ...
          Clazz_newArray(-1, [
            'proteinSideChains',
            'SELECT protein and not backbone',
          ]),
          Clazz_newArray(-1, ['polar', 'SELECT protein and polar']),
          Clazz_newArray(-1, ['nonpolar', 'SELECT protein and not polar']),
          Clazz_newArray(-1, ['positiveCharge', 'SELECT protein and basic']),
          Clazz_newArray(-1, ['negativeCharge', 'SELECT protein and acidic']),
          Clazz_newArray(-1, [
            'noCharge',
            'SELECT protein and not (acidic,basic)',
          ]),
          Clazz_newArray(-1, ['allCarbo', 'SELECT carbohydrate']),
          Clazz_newArray(-1, ['allNucleic', 'SELECT nucleic']),
          Clazz_newArray(-1, ['DNA', 'SELECT dna']),
          Clazz_newArray(-1, ['RNA', 'SELECT rna']),
          Clazz_newArray(-1, [
            'nucleicBackbone',
          ...
          Clazz_newArray(-1, [
            'nucleicBases',
            'SELECT nucleic and not backbone',
          ]),
          Clazz_newArray(-1, ['atPairs', 'SELECT a,t']),
          Clazz_newArray(-1, ['gcPairs', 'SELECT g,c']),
          Clazz_newArray(-1, ['auPairs', 'SELECT a,u']),
          Clazz_newArray(-1, ['A', 'SELECT a']),
          Clazz_newArray(-1, ['C', 'SELECT c']),
          Clazz_newArray(-1, ['G', 'SELECT g']),
          Clazz_newArray(-1, ['T', 'SELECT t']),
          Clazz_newArray(-1, ['U', 'SELECT u']),
          Clazz_newArray(-1, ['allHetero', 'SELECT hetero']),
          Clazz_newArray(-1, ['Solvent', 'SELECT solvent']),
          Clazz_newArray(-1, ['Water', 'SELECT water']),
          Clazz_newArray(-1, [
            'nonWaterSolvent',
            'SELECT solvent and not water',
          ]),
          Clazz_newArray(-1, ['exceptWater', 'SELECT hetero and not water']),
          Clazz_newArray(-1, ['Ligand', 'SELECT ligand']),
          Clazz_newArray(-1, [
            'PDBnoneOfTheAbove',
            'SELECT not(hetero,protein,nucleic,carbohydrate)',
          ]),
          Clazz_newArray(-1, ['best', 'rotate best -1.0']),
          Clazz_newArray(-1, [
            'front',
          ...
          Clazz_newArray(-1, ['axisA', 'moveto axis a']),
          Clazz_newArray(-1, ['axisB', 'moveto axis b']),
          Clazz_newArray(-1, ['axisC', 'moveto axis c']),
          Clazz_newArray(-1, ['axisX', 'moveto axis x']),
          Clazz_newArray(-1, ['axisY', 'moveto axis y']),
          Clazz_newArray(-1, ['axisZ', 'moveto axis z']),
          Clazz_newArray(-1, [
            'renderCpkSpacefill',
          ...
          Clazz_newArray(-1, ['atomNone', 'cpk off']),
          Clazz_newArray(-1, ['atom15', 'cpk 15%']),
          Clazz_newArray(-1, ['atom20', 'cpk 20%']),
          Clazz_newArray(-1, ['atom25', 'cpk 25%']),
          Clazz_newArray(-1, ['atom50', 'cpk 50%']),
          Clazz_newArray(-1, ['atom75', 'cpk 75%']),
          Clazz_newArray(-1, ['atom100', 'cpk on']),
          Clazz_newArray(-1, ['bondNone', 'wireframe off']),
          Clazz_newArray(-1, ['bondWireframe', 'wireframe on']),
          Clazz_newArray(-1, ['bond100', 'wireframe .1']),
          Clazz_newArray(-1, ['bond150', 'wireframe .15']),
          Clazz_newArray(-1, ['bond200', 'wireframe .2']),
          Clazz_newArray(-1, ['bond250', 'wireframe .25']),
          Clazz_newArray(-1, ['bond300', 'wireframe .3']),
          Clazz_newArray(-1, ['hbondCalc', 'hbonds calculate']),
          Clazz_newArray(-1, ['hbondNone', 'hbonds off']),
          Clazz_newArray(-1, ['hbondWireframe', 'hbonds on']),
          Clazz_newArray(-1, ['PDBhbondSidechain', 'set hbonds sidechain']),
          Clazz_newArray(-1, ['PDBhbondBackbone', 'set hbonds backbone']),
          Clazz_newArray(-1, ['hbond100', 'hbonds .1']),
          Clazz_newArray(-1, ['hbond150', 'hbonds .15']),
          Clazz_newArray(-1, ['hbond200', 'hbonds .2']),
          Clazz_newArray(-1, ['hbond250', 'hbonds .25']),
          Clazz_newArray(-1, ['hbond300', 'hbonds .3']),
          Clazz_newArray(-1, ['ssbondNone', 'ssbonds off']),
          Clazz_newArray(-1, ['ssbondWireframe', 'ssbonds on']),
          Clazz_newArray(-1, ['PDBssbondSidechain', 'set ssbonds sidechain']),
          Clazz_newArray(-1, ['PDBssbondBackbone', 'set ssbonds backbone']),
          Clazz_newArray(-1, ['ssbond100', 'ssbonds .1']),
          Clazz_newArray(-1, ['ssbond150', 'ssbonds .15']),
          Clazz_newArray(-1, ['ssbond200', 'ssbonds .2']),
          Clazz_newArray(-1, ['ssbond250', 'ssbonds .25']),
          Clazz_newArray(-1, ['ssbond300', 'ssbonds .3']),
          Clazz_newArray(-1, [
            'structureNone',
          ...
          Clazz_newArray(-1, [
            'trace',
            'restrict not selected;select not selected;trace 0.3',
          ]),
          Clazz_newArray(-1, ['vibrationOff', 'vibration off']),
          Clazz_newArray(-1, ['vibrationOn', 'vibration on']),
          Clazz_newArray(-1, ['vibration20', 'vibrationScale *= 2']),
          Clazz_newArray(-1, ['vibration05', 'vibrationScale /= 2']),
          Clazz_newArray(-1, ['vectorOff', 'vectors off']),
          Clazz_newArray(-1, ['vectorOn', 'vectors on']),
          Clazz_newArray(-1, ['vector3', 'vectors 3']),
          Clazz_newArray(-1, ['vector005', 'vectors 0.05']),
          Clazz_newArray(-1, ['vector01', 'vectors 0.1']),
          Clazz_newArray(-1, ['vectorScale02', 'vector scale 0.2']),
          Clazz_newArray(-1, ['vectorScale05', 'vector scale 0.5']),
          Clazz_newArray(-1, ['vectorScale1', 'vector scale 1']),
          Clazz_newArray(-1, ['vectorScale2', 'vector scale 2']),
          Clazz_newArray(-1, ['vectorScale5', 'vector scale 5']),
          Clazz_newArray(-1, ['stereoNone', 'stereo off']),
          Clazz_newArray(-1, ['stereoRedCyan', 'stereo redcyan 3']),
          Clazz_newArray(-1, ['stereoRedBlue', 'stereo redblue 3']),
          Clazz_newArray(-1, ['stereoRedGreen', 'stereo redgreen 3']),
          Clazz_newArray(-1, ['stereoCrossEyed', 'stereo -5']),
          Clazz_newArray(-1, ['stereoWallEyed', 'stereo 5']),
          Clazz_newArray(-1, ['labelNone', 'label off']),
          Clazz_newArray(-1, ['labelSymbol', 'label %e']),
          Clazz_newArray(-1, ['labelName', 'label %a']),
          Clazz_newArray(-1, ['labelNumber', 'label %i']),
          Clazz_newArray(-1, ['labelCentered', 'set labeloffset 0 0']),
          Clazz_newArray(-1, ['labelUpperRight', 'set labeloffset 4 4']),
          Clazz_newArray(-1, ['labelLowerRight', 'set labeloffset 4 -4']),
          Clazz_newArray(-1, ['labelUpperLeft', 'set labeloffset -4 4']),
          Clazz_newArray(-1, ['labelLowerLeft', 'set labeloffset -4 -4']),
          Clazz_newArray(-1, ['zoom50', 'zoom 50']),
          Clazz_newArray(-1, ['zoom100', 'zoom 100']),
          Clazz_newArray(-1, ['zoom150', 'zoom 150']),
          Clazz_newArray(-1, ['zoom200', 'zoom 200']),
          Clazz_newArray(-1, ['zoom400', 'zoom 400']),
          Clazz_newArray(-1, ['zoom800', 'zoom 800']),
          Clazz_newArray(-1, ['zoomIn', 'move 0 0 0 40 0 0 0 0 1']),
          Clazz_newArray(-1, ['zoomOut', 'move 0 0 0 -40 0 0 0 0 1']),
          Clazz_newArray(-1, ['spinOn', 'spin on']),
          Clazz_newArray(-1, ['spinOff', 'spin off']),
          Clazz_newArray(-1, ['s0', '0']),
          Clazz_newArray(-1, ['s5', '5']),
          Clazz_newArray(-1, ['s10', '10']),
          Clazz_newArray(-1, ['s20', '20']),
          Clazz_newArray(-1, ['s30', '30']),
          Clazz_newArray(-1, ['s40', '40']),
          Clazz_newArray(-1, ['s50', '50']),
          Clazz_newArray(-1, ['onceThrough', 'anim mode once#']),
          Clazz_newArray(-1, ['palindrome', 'anim mode palindrome#']),
          Clazz_newArray(-1, ['loop', 'anim mode loop#']),
          Clazz_newArray(-1, ['play', 'anim play#']),
          Clazz_newArray(-1, ['pause', 'anim pause#']),
          Clazz_newArray(-1, ['resume', 'anim resume#']),
          Clazz_newArray(-1, ['stop', 'anim off#']),
          Clazz_newArray(-1, ['nextframe', 'frame next#']),
          Clazz_newArray(-1, ['prevframe', 'frame prev#']),
          Clazz_newArray(-1, ['playrev', 'anim playrev#']),
          Clazz_newArray(-1, ['rewind', 'anim rewind#']),
          Clazz_newArray(-1, ['restart', 'anim on#']),
          Clazz_newArray(-1, ['animfps5', 'anim fps 5#']),
          Clazz_newArray(-1, ['animfps10', 'anim fps 10#']),
          Clazz_newArray(-1, ['animfps20', 'anim fps 20#']),
          Clazz_newArray(-1, ['animfps30', 'anim fps 30#']),
          Clazz_newArray(-1, ['animfps50', 'anim fps 50#']),
          Clazz_newArray(-1, [
            'measureOff',
          ...
          Clazz_newArray(-1, ['measureDelete', 'measure delete']),
          Clazz_newArray(-1, ['measureList', 'console on;show measurements']),
          Clazz_newArray(-1, [
            'distanceNanometers',
            'select *; set measure nanometers',
          ]),
          Clazz_newArray(-1, [
            'distanceAngstroms',
            'select *; set measure angstroms',
          ]),
          Clazz_newArray(-1, [
            'distancePicometers',
            'select *; set measure picometers',
          ]),
          Clazz_newArray(-1, ['distanceHz', 'select *; set measure hz']),
          Clazz_newArray(-1, ['pickOff', 'set picking off']),
          Clazz_newArray(-1, ['pickCenter', 'set picking center']),
          Clazz_newArray(-1, ['pickIdent', 'set picking ident']),
          Clazz_newArray(-1, ['pickLabel', 'set picking label']),
          Clazz_newArray(-1, ['pickAtom', 'set picking atom']),
          Clazz_newArray(-1, ['PDBpickChain', 'set picking chain']),
          Clazz_newArray(-1, ['pickElement', 'set picking element']),
          Clazz_newArray(-1, ['modelKitMode', 'set modelKitMode']),
          Clazz_newArray(-1, ['PDBpickGroup', 'set picking group']),
          Clazz_newArray(-1, ['pickMolecule', 'set picking molecule']),
          Clazz_newArray(-1, ['SYMMETRYpickSite', 'set picking site']),
          Clazz_newArray(-1, ['pickSpin', 'set picking spin']),
          Clazz_newArray(-1, ['SYMMETRYpickSymmetry', 'set picking symmetry']),
          Clazz_newArray(-1, ['showConsole', 'console']),
          Clazz_newArray(-1, ['JSConsole', 'JSCONSOLE']),
          Clazz_newArray(-1, ['showFile', 'console on;show file']),
          Clazz_newArray(-1, [
            'showFileHeader',
            'console on;getProperty FileHeader',
          ]),
          Clazz_newArray(-1, ['showHistory', 'console on;show history']),
          Clazz_newArray(-1, ['showIsosurface', 'console on;show isosurface']),
          Clazz_newArray(-1, ['showMeasure', 'console on;show measure']),
          Clazz_newArray(-1, ['showMo', 'console on;show mo']),
          Clazz_newArray(-1, ['showModel', 'console on;show model']),
          Clazz_newArray(-1, ['showOrient', 'console on;show orientation']),
          Clazz_newArray(-1, ['showSpacegroup', 'console on;show spacegroup']),
          Clazz_newArray(-1, ['showState', 'console on;show state']),
          Clazz_newArray(-1, ['reload', 'load ""']),
          Clazz_newArray(-1, ['SIGNEDloadPdb', 'load ?PdbId?']),
          Clazz_newArray(-1, ['SIGNEDloadFile', 'load ?']),
          Clazz_newArray(-1, ['SIGNEDloadUrl', 'load http://?']),
          Clazz_newArray(-1, ['SIGNEDloadFileUnitCell', 'load ? {1 1 1}']),
          Clazz_newArray(-1, ['SIGNEDloadScript', 'script ?.spt']),
          Clazz_newArray(-1, [
            'SIGNEDJAVAcaptureRock',
          ...
          Clazz_newArray(-1, ['SIGNEDJAVAcaptureBegin', "capture '?Jmol.gif'"]),
          Clazz_newArray(-1, ['SIGNEDJAVAcaptureEnd', "capture ''"]),
          Clazz_newArray(-1, ['SIGNEDJAVAcaptureOff', 'capture off']),
          Clazz_newArray(-1, ['SIGNEDJAVAcaptureOn', 'capture on']),
          Clazz_newArray(-1, [
            'SIGNEDJAVAcaptureFpsSPECIAL',
          ...
          Clazz_newArray(-1, [
            'SIGNEDNOGLwriteGif',
            'write image "?FILEROOT?.gif"',
          ]),
          Clazz_newArray(-1, [
            'SIGNEDNOGLwriteJpg',
            'write image "?FILEROOT?.jpg"',
          ]),
          Clazz_newArray(-1, [
            'SIGNEDNOGLwritePng',
            'write image "?FILEROOT?.png"',
          ]),
          Clazz_newArray(-1, [
            'SIGNEDNOGLwritePngJmol',
            'write PNGJ "?FILEROOT?.png"',
          ...
          Clazz_newArray(-1, [
            'SIGNEDNOGLwritePovray',
            'write POVRAY "?FILEROOT?.pov"',
          ]),
          Clazz_newArray(-1, [
            'SIGNEDNOGLwriteVrml',
            'write VRML "?FILEROOT?.wrl"',
          ]),
          Clazz_newArray(-1, [
            'SIGNEDNOGLwriteX3d',
            'write X3D "?FILEROOT?.x3d"',
          ]),
          Clazz_newArray(-1, [
            'SIGNEDNOGLwriteSTL',
            'write STL "?FILEROOT?.stl"',
          ]),
          Clazz_newArray(-1, [
            'SIGNEDNOGLwriteIdtf',
            'write IDTF "?FILEROOT?.idtf"',
          ]),
          Clazz_newArray(-1, [
            'SIGNEDNOGLwriteMaya',
            'write MAYA "?FILEROOT?.ma"',
          ]),
          Clazz_newArray(-1, [
            'SYMMETRYshowSymmetry',
            'console on;show symmetry',
          ]),
          Clazz_newArray(-1, ['UNITCELLshow', 'console on;show unitcell']),
          Clazz_newArray(-1, [
            'extractMOL',
            'console on;getproperty extractModel "visible" ',
          ]),
          Clazz_newArray(-1, ['minimize', 'minimize']),
          Clazz_newArray(-1, ['modelkit', 'set modelkitmode']),
          Clazz_newArray(-1, ['surfDots', 'dots on']),
          Clazz_newArray(-1, [
            'surfVDW',
          ...
          Clazz_newArray(-1, ['surfOpaque', 'mo opaque;isosurface opaque']),
          Clazz_newArray(-1, [
            'surfTranslucent',
            'mo translucent;isosurface translucent',
          ]),
          Clazz_newArray(-1, [
            'surfOff',
          ...
          Clazz_newArray(-1, ['1p', 'on']),
          Clazz_newArray(-1, ['3p', '3']),
          Clazz_newArray(-1, ['5p', '5']),
          Clazz_newArray(-1, ['10p', '10']),
          Clazz_newArray(-1, ['10a', '0.1']),
          Clazz_newArray(-1, ['20a', '0.20']),
          Clazz_newArray(-1, ['25a', '0.25']),
          Clazz_newArray(-1, ['50a', '0.50']),
          Clazz_newArray(-1, ['100a', '1.0']),
        ],
      );
    },
  );
  ...
  Clazz_load(
    ...
    function () {
          ...
          try {
            while ((line = br.readLine()) != null) {
              ...
              if (label != null && label.length > 0)
                this.words.setProperty(
                  name,
                  gt == null ? label : gt.translate(label),
                );
            }
          } catch (e) {
      ...
      Clazz_defineMethod(c$, 'dumpWords', function () {
        var wordContents = this.getWordContents();
        var s = new JU.SB();
        for (var i = 0; i < wordContents.length; i++) {
          var key = wordContents[i++];
          if (this.structure.getProperty(key) == null)
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(
        ...
        function (item) {
          if (item == null) {
            if (
              this.buttonGroup != null &&
              this.buttonGroup.getButtonCount() > 0
            )
              this.buttonGroup = null;
            return;
          }
      ...
      Clazz_overrideMethod(c$, 'getButtonGroup', function () {
