...
if (!window['java.registered']) window['java.registered'] = false;
...
(function (ClazzLoader) {
  ...
  ClazzLoader.jarClasspath(base + 'corescriptcmd.z.js', ['JS.CmdExt']);

  ClazzLoader.jarClasspath(base + 'corescriptmath.z.js', ['JS.MathExt']);
