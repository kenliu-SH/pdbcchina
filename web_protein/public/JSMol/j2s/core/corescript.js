(function (
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'run', function () {
      ...
      Clazz_overrideMethod(c$, 'run1', function (mode) {}, '~N');
      Clazz_defineStatics(c$, 'commandDelay', 50);
    },
  );
  Clazz_declarePackage('JS');
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (fileName, fileName0, data, myData) {
          ...
          if (fileName0 != null) {
            this.vwr.cachePut(
              this.vwr.fm.getFilePath(fileName, true, false),
              data,
            );
          }
          this.run1(-2);
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          sc.isEditor =
            this.scriptExtensions != null &&
            this.scriptExtensions.indexOf('\u0001## ISEDITOR') >= 0;
      ...
      c$.addContextVariable = Clazz_defineMethod(
        c$,
        'addContextVariable',
      ...
      Clazz_defineMethod(
        ...
        function (ident) {
          for (var i = this.vPush.size(); --i >= 0; ) {
            ...
            if (
              ct.contextVariables != null &&
              ct.contextVariables.containsKey(ident)
            )
              return true;
          }
          return this.thisFunction != null
            ? this.thisFunction.isVariable(ident)
            : this.contextVariables != null &&
                this.contextVariables.containsKey(ident);
        },
        '~S',
      );
      Clazz_defineMethod(
        ...
        function (script) {
          ...
          if (pt >= 0) {
            this.allowMissingEnd =
              script.indexOf('\u0001##NOENDCHECK', pt) >= 0;
          ...
          if (this.isStateScript) {
            ...
            if (this.ptSemi >= this.ichToken)
              JS.ScriptManager.setStateScriptVersion(
                ...
                this.script
                  .substring(
                    this.ichToken + '# Jmol state version '.length,
                    this.ptSemi,
                  )
                  .trim(),
              );
                ...
                switch (this.endOfLine ? 0 : this.lookingAtComment()) {
                  ...
                  case 1:
                    ...
                    this.comment = this.script
                      .substring(this.ichToken, this.ichToken + this.cchToken)
                      .trim();
                    break;
                }
                this.isEndOfCommand =
              ...
              if (this.isEndOfCommand) {
                ...
                if (this.flowContext != null) {
                  ...
                  while (this.flowContext != null) {
                    ...
                    if (
                      !this.haveENDIF &&
                      this.flowContext.checkForceEndIf(0)
                    ) {
                      ...
                      return this.errorStr(
                        11,
                        this.flowContext.$function == null
                  ...
                  this.lltoken.addLast(
                    Clazz_newArray(-1, [JS.T.o(0, '// end of script')]),
                  );
                }
                this.setAaTokenCompiled();
                return true;
      ...
      Clazz_defineMethod(c$, 'setAaTokenCompiled', function () {
        this.aatokenCompiled = this.lltoken.toArray(
          new Array(this.lltoken.size()),
        );
      });
      Clazz_defineMethod(c$, 'lookingAtLeadingWhitespace', function () {
      ...
      Clazz_defineMethod(
        ...
        function (ichT, checkMathop) {
          var isEscaped =
            (ichT + 2 < this.cchScript &&
              this.script.charAt(ichT) == '\\' &&
              this.nCharNewLine(ichT + 1) > 0) ||
            (!this.isShowScriptOutput &&
              checkMathop &&
              this.lookingAtMathContinuation(ichT));
      ...
      Clazz_defineMethod(
        ...
        function (ichT) {
          var n;
          if (
            (n = this.nCharNewLine(ichT)) == 0 ||
            this.lastToken.tok == 1073742332
          )
            return false;
          ...
          switch (this.tokCommand) {
            ...
            case 102402:
              ...
              return false;
            case 36867:
              if (this.nTokens > 1 && this.ltoken.get(1).tok == 537022465)
                return false;
            case 36865:
            case 36869:
              break;
      ...
      Clazz_defineMethod(c$, 'lookingAtEndOfLine', function () {
        if (this.ichToken >= this.cchScript) {
          this.ichEnd = this.cchScript;
          return true;
        }
        return (
          (this.cchToken = this.nCharNewLine((this.ichEnd = this.ichToken))) > 0
        );
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_defineMethod(c$, 'lookingAtTerminator', function () {
      ...
      Clazz_defineMethod(c$, 'lookingAtComment', function () {
        ...
        if (
          ...
          ch == '$' &&
          (this.isShowScriptOutput || this.ichToken == 0)
        ) {
          ...
          switch (this.script.charAt(++ichT)) {
            ...
            case '*':
              ...
              this.incrementLineCount(
                this.script.substring(this.ichToken, ichT),
              );
        ...
        if (
          isSharp &&
          this.nTokens == 0 &&
          this.cchScript - ichFirstSharp >= 3 &&
          this.script.charAt(ichFirstSharp + 1) == 'j' &&
          this.script.charAt(ichFirstSharp + 2) == 'c'
        ) {
          this.cchToken = ichT - this.ichToken;
          return 2;
        }
        ...
        if (
          ...
          this.script.charAt(this.ichToken + 1) == 'j' &&
          this.script.charAt(this.ichToken + 2) == 'x' &&
        ...
        if (
          !isSharp &&
          this.cchToken == 10 &&
          this.script.substring(this.ichToken, ichT).equals('//@private')
        ) {
        ...
        function (iLine, doCompile) {
          ...
          if (n > 0 || this.comment != null) {
            ...
            if (
              this.isNewSet &&
              n > 2 &&
              this.tokAt(2) == 1073742336 &&
              (this.tokAt(3) == 1275068444 ||
                this.tokAt(3) == 1140850693 ||
                this.tokAt(3) == 1275335685 ||
                this.tokAt(3) == 1275334681)
            ) {
            ...
            if (n == 1 && this.braceCount == 1) {
              if (this.lastFlowCommand == null) {
                ...
                if (
                  this.lastFlowCommand.tok != 102439 &&
                  this.tokAt(0) == 1073742332
                )
                  this.ltoken.removeItemAt(0);
                this.lastFlowCommand = null;
            ...
            if (
              ...
              this.setBraceCount > 0 ||
              this.parenCount > 0 ||
              (this.braceCount == 1 && !this.checkFlowStartBrace(true))
            ) {
              this.error(n == 1 ? 2 : 4);
              return 4;
            }
              ...
              switch (this.tokAt(2)) {
                ...
                default:
                  ...
                  this.ltoken.add(
                    ...
                    JS.T.o(
                      4,
                      t.tok == 2 ? '' + t.intValue : t.value.toString(),
                    ),
                  );
              }
            }
            if (this.ltoken.size() > 0) {
              ...
              switch (this.tokCommand) {
                ...
                case 102409:
                  doEval =
                    this.atokenInfix.length > 0 &&
                    this.atokenInfix[0].intValue != 2147483647;
                  break;
              }
              if (doEval) {
          ...
          var isOneLine =
            this.flowContext != null && this.flowContext.addLine == 0;
          var isEndFlow =
            (this.endOfLine || !isOneLine) &&
            !this.haveENDIF &&
            this.flowContext != null &&
      ...
      Clazz_defineMethod(c$, 'wasImpliedScript', function () {
        if (
          this.checkImpliedScriptCmd &&
          this.nTokens >= 2 &&
          (this.tokCommand == 134222850 || this.tokCommand == 4124)
        ) {
          var s =
            this.nTokens == 2
      ...
      Clazz_defineMethod(c$, 'compileCommand', function () {
        ...
        if (size == 1 && JS.T.tokAttr(this.tokCommand, 524288))
        ...
        this.atokenInfix = this.ltoken.toArray(
          new Array((size = this.ltoken.size())),
        );
        ...
        function (token) {
          ...
          if (token == null) {
            ...
            this.isMathExpressionCommand =
              this.tokCommand == 1073741824 ||
              JS.T.tokAttr(this.tokCommand, 36864);
            this.isSetOrDefine =
              this.tokCommand == 36867 || this.tokCommand == 12290;
      ...
      Clazz_defineMethod(c$, 'getPrefixToken', function () {
        ...
        if (
          (this.nTokens == 1 &&
            (this.tokCommand == 134320141 ||
              this.tokCommand == 102436 ||
              this.tokCommand == 36868)) ||
          (this.nTokens != 0 && isUserVar) ||
          (!this.isDotDot &&
            this.isUserFunction(this.identLC) &&
            (preserveCase = this.ident) != null &&
            (this.thisFunction == null ||
          ...
          if (
            (this.theToken = JS.T.getTokenFromName(this.ident)) == null &&
            (this.theToken = JS.T.getTokenFromName(this.identLC)) != null
          )
        ...
        if (this.theToken == null) {
          this.theToken = JS.SV.newSV(
            this.identLC.indexOf('property_') == 0 ? 1715472409 : 1073741824,
            2147483647,
            this.ident,
          ).setName(myName);
        }
      ...
      Clazz_defineMethod(c$, 'checkSpecialParameterSyntax', function () {
        if (this.lookingAtString(!this.implicitString)) {
          if (this.cchToken < 0) return this.ERROR(4);
          var str = this.getUnescapedStringLiteral(
            this.lastToken != null &&
              !this.iHaveQuotedString &&
              this.lastToken.tok != 1073741984 &&
              ((this.tokCommand == 36867 &&
                this.nTokens == 2 &&
                this.lastToken.tok == 545259546) ||
                this.tokCommand == 134223363 ||
                this.tokCommand == 1610616835 ||
                this.tokCommand == 134222850 ||
                this.tokCommand == 4124),
          );
          this.iHaveQuotedString = true;
          if (
            ((this.tokCommand == 134223363 || this.tokCommand == 135174) &&
              this.lastToken.tok == 134221834) ||
            (this.tokCommand == 134221834 && str.indexOf('@') < 0)
          ) {
            if (!this.getData(str)) {
        ...
        if (this.nTokens == this.ptNewSetModifier) {
          ...
          if (
            ...
            if (
              (JS.T.tokAttr(this.tokCommand, 536870912) && ch == '=') ||
              ((this.isNewSet || this.isSetBrace) && isOperation)
            ) {
              this.setCommand(
                isAndEquals
                  ? JS.T.tokenSet
                  : (ch == '[' && !this.isSetBrace) || (ch == '.' && ch2 == '.')
                  ? JS.T.tokenSetArray
        ...
        out: switch (this.tokCommand) {
          ...
          case 1275072526:
              ...
              case 134223363:
                ...
                if (
                  ...
                  if (
                    ...
                    break out;
                  var isDataBase = JV.Viewer.isDatabaseCode(
                    this.charAt(this.ichToken),
                  );
                  if (this.lookingAtLoadFormat(isDataBase)) {
                    var strFormat = this.script.substring(
                      this.ichToken,
                      this.ichToken + this.cchToken,
                    );
            ...
            if (
              ...
              this.lookingAtImpliedString(
                this.tokCommand == 134222350,
                this.tokCommand == 134223363,
                this.nTokens > 1 ||
                  (this.tokCommand != 134222850 && this.tokCommand != 4124),
              )
            ) {
              var str = this.script.substring(
                this.ichToken,
                this.ichToken + this.cchToken,
              );
          ...
          case 4156:
            if (this.nTokens == 1 && this.lookForSyncID()) {
              var ident = this.script.substring(
                this.ichToken,
                this.ichToken + this.cchToken,
              );
              var iident = JU.PT.parseInt(ident);
              if (iident == -2147483648 || Math.abs(iident) < 1000)
                this.addTokenToPrefix(JS.T.o(1073741824, ident));
        ...
        if (
          ...
          if (
            this.tokCommand == 1825200146 &&
            JU.PT.isOneOf(str.toLowerCase(), ';on;off;hide;display;')
          )
            this.addTokenToPrefix(JS.T.getTokenFromName(str.toLowerCase()));
        ...
        if (this.lookingAtDecimal()) {
          value = Float.$valueOf(
            this.script.substring(this.ichToken, this.ichToken + this.cchToken),
          );
          var intValue = JU.Edge.getFloatEncodedInt(
            this.script.substring(this.ichToken, this.ichToken + this.cchToken),
          );
        ...
        if (this.lookingAtSeqcode()) {
          ...
          try {
            ...
            var insertionCode = this.script.charAt(
        ...
        if (val != 2147483647) {
          var intString = this.script.substring(
            this.ichToken,
            this.ichToken + this.cchToken,
          );
          if (this.tokCommand == 102407 || this.tokCommand == 102408) {
            ...
            var f =
              this.flowContext == null
                ? null
                : this.flowContext.getBreakableContext((val = Math.abs(val)));
        ...
        if (
          (!this.isMathExpressionCommand && this.parenCount == 0) ||
          (this.lastToken.tok != 1073741824 &&
          ...
          if (bs != null) {
            this.addTokenToPrefix(
              JS.T.o(10, isBondOrMatrix ? JM.BondSet.newBS(bs, null) : bs),
            );
            return 2;
          }
          if (isBondOrMatrix) {
            ...
            if (Clazz_instanceOf(m, JU.M34)) {
              this.addTokenToPrefix(
                JS.T.o(Clazz_instanceOf(m, JU.M4) ? 12 : 11, m),
              );
              return 2;
            }
          }
      ...
      Clazz_defineMethod(c$, 'lookingAtMatrix', function () {
        var ipt;
        var m;
        if (
          ...
          (ipt = this.script.indexOf(']]', this.ichToken)) < 0 ||
          (m = JU.Escape.unescapeMatrix(
            this.script.substring(this.ichToken, ipt + 2),
          )) == null
        )
          return null;
      ...
      Clazz_defineMethod(c$, 'parseKnownToken', function () {
        ...
        if (
          this.flowContext != null &&
          this.flowContext.token.tok == 102410 &&
          this.flowContext.$var != null &&
          tok != 102411 &&
          tok != 102413 &&
          this.lastToken.tok != 102410
        )
          return this.ERROR(1, this.ident);
        if (
          this.lastToken.tok == 12290 &&
          tok != 1073742332 &&
          this.nTokens != 1
        ) {
          this.addTokenToPrefix(
            tok == 12290 ? this.lastToken : JS.T.o(4, this.ident),
          );
          return 2;
        }
        switch (tok) {
          ...
          case 268435650:
            ...
            if (
              ...
              this.addTokenToPrefix(token);
              this.addTokenToPrefix(
                tok == 268435649 ? JS.T.tokenMinus : JS.T.tokenPlus,
              );
          ...
          case 1073742336:
            if (
              ...
              this.ichToken < this.setEqualPt &&
              this.ltoken.size() > 1 &&
              this.ltoken.get(1).tok == 1073742332
            ) {
          ...
          case 1073742332:
            if (
              ++this.braceCount == 1 &&
              this.parenCount == 0 &&
              this.checkFlowStartBrace(false)
            ) {
              this.isEndOfCommand = true;
              var f =
                (this.flowContext != null && this.flowContext.addLine == 0) ||
          ...
          case 268435472:
            ...
            if (
              this.nTokens > 1 &&
              (this.lastToken.tok == 1275082241 ||
                this.lastToken.tok == 134320648 ||
                this.lastToken.tok == 134320649)
            )
              this.nSemiSkip += 2;
            break;
          case 1073742338:
        ...
        switch (tok) {
          ...
          case 102409:
            if (
              this.tokCommand == 135174 ||
              (this.tokCommand == 4103 && this.nTokens == 1)
            )
              return 0;
      ...
      Clazz_defineMethod(c$, 'checkNewSetCommand', function () {
        ...
        function (iLine, isFull) {
          ...
          switch (this.tokCommand) {
            case 0:
              ...
              if (this.logMessages)
                JU.Logger.info('compiling ' + this.theToken);
              ...
              switch (this.theTok) {
                ...
                case 102402:
                  this.fixFlowAddLine(this.flowContext);
                  if (
                    this.lltoken.get(this.iCommand - 1)[0].tok == 102409 &&
                    this.forceFlowContext != null &&
                    this.forceFlowContext.forceEndIf &&
                    this.forceFlowContext.addLine > 0 &&
            ...
            case 134320141:
              ...
              if (this.nTokens % 2 == 0) {
                if (this.theTok != 268435504 && this.theTok != 268435473)
            ...
            case 364547:
              ...
              if (
                this.nTokens != 1 ||
                (this.theTok != 134320649 && this.theTok != 1073742332)
              )
                return this.ERROR(0);
              this.replaceCommand(
            ...
            case 134320648:
              ...
              if (
                (this.nTokens == 3 || this.nTokens == 4) &&
                this.theTok == 1275068432
              ) {
                this.nSemiSkip -= 2;
                this.forPoint3 = 2;
                this.addTokenToPrefix(this.theToken);
            ...
            case 36867:
              if (this.theTok == 1073742332) this.setBraceCount++;
                ...
                if (
                  this.isSetBrace &&
                  this.setBraceCount == 0 &&
                  this.ptNewSetModifier == 2147483647
                )
              ...
              if (this.nTokens == this.ptNewSetModifier) {
                ...
                if (
                  this.theTok == 268435472 ||
                  this.isUserFunction(token.value.toString())
                ) {
                  this.ltoken.set(
                    0,
                    this.setCommand(JS.T.tv(1073741824, 0, token.value)),
                  );
                  this.setBraceCount = 0;
                  break;
                }
                ...
                if (
                  this.nTokens == 1 &&
                  (this.lastToken.tok == 268435650 ||
                    this.lastToken.tok == 268435649)
                ) {
                  this.replaceCommand(JS.T.tokenSet);
            ...
            case 134223363:
              if (
                this.theTok == 12290 &&
                (this.nTokens == 1 ||
                  this.lastToken.tok == 1073741940 ||
                  this.lastToken.tok == 134217764)
              ) {
      ...
      Clazz_defineMethod(
        ...
        function (isSetBrace, ident) {
          ...
          this.ptNewSetModifier = this.isNewSet
            ...
            : 2147483647;
          return isSetBrace ||
            this.theToken.tok == 268435472 ||
            this.theToken.tok == 536870918 ||
            this.theToken.tok == 268435650 ||
            this.theToken.tok == 268435649
            ? this.theToken
            : JS.T.o(1073741824, ident);
        },
        '~B,~S',
      );
      Clazz_defineMethod(c$, 'checkUnquotedFileName', function () {
        var ichT = this.ichToken;
        var ch;
        while (
          ++ichT < this.cchScript &&
          !JU.PT.isWhitespace((ch = this.script.charAt(ichT))) &&
          ch != '#' &&
          ch != ';' &&
          ch != '}'
        ) {}
        var name = this.script
          .substring(this.ichToken, ichT)
          .$replace('\\', '/');
        this.cchToken = ichT - this.ichToken;
      ...
      Clazz_defineMethod(c$, 'checkFlowEndBrace', function () {
        if (
          this.iBrace <= 0 ||
          this.vBraces.get(this.iBrace - 1).tok != 1073742338
        )
          return 0;
        ...
        if (token.tok == 1275335685) {
          ...
          this.addTokenToPrefix(
            this.setCommand(JS.ContextToken.newContext(false)),
          );
          this.isEndOfCommand = true;
          return 2;
        }
      ...
      Clazz_defineMethod(
        ...
        function (token) {
          ...
          if (!this.checkFlowEnd(token.tok, token.value, this.ichBrace, false))
            return 4;
          switch (token.tok) {
            case 134320141:
            case 102436:
      ...
      c$.isBreakableContext = Clazz_defineMethod(
        c$,
        'isBreakableContext',
        function (tok) {
          return (
      ...
      Clazz_defineMethod(
        ...
        function (ident) {
          ...
          switch (this.tokCommand) {
            ...
            case 102413:
              if (
                this.flowContext == null ||
                (this.flowContext.token.tok != 102410 &&
                  this.flowContext.token.tok != 102411 &&
                  (this.tokCommand == 102413
                    ? this.flowContext.ptDefault > 0
                    : this.flowContext.token.tok != 102413))
              ) {
                this.errorStr(1, ident);
                return 4;
              }
          ...
          var ct = JS.ContextToken.newCmd(
            this.tokCommand,
            this.tokenCommand.value,
          );
      ...
      Clazz_defineMethod(
        ...
        function (tok, ident, pt1, isExplicitEnd) {
          ...
          if (this.flowContext == null || tok != this.flowContext.tok0)
            return this.errorStr(1, 'end ' + ident);
          var pt = this.lltoken.size();
          this.flowContext.token.intValue =
            this.tokCommand == 102412 ? -pt : pt;
          switch (tok) {
            case 134320649:
            case 102410:
              break;
      ...
      Clazz_defineMethod(
        ...
        function (key) {
          ...
          var i =
            this.script.indexOf(
              this.chFirst + key + this.chFirst,
              this.ichToken,
            ) - 4;
          if (
            i < 0 ||
            !this.script.substring(i, i + 4).equalsIgnoreCase('END ')
          )
            return false;
      ...
      c$.isSpaceOrTab = Clazz_defineMethod(
        c$,
        'isSpaceOrTab',
        function (ch) {
          return ch == ' ' || ch == '\t';
      ...
      Clazz_defineMethod(c$, 'lookingAtSetBraceSyntax', function () {
        var ichT = this.ichToken;
        var nParen = 1;
      ...
      Clazz_defineMethod(
        ...
        function (isFileName) {
          ...
          return JS.ScriptCompiler.unescapeString(
            this.script,
            this.ichToken + 1,
            this.cchToken - 2,
          );
      ...
      c$.unescapeString = Clazz_defineMethod(
        c$,
        'unescapeString',
      ...
      Clazz_defineMethod(
        ...
        function (allchar) {
          ...
          var ch;
          while (
            (JU.PT.isLetterOrDigit((ch = this.charAt(ichT))) &&
              (allchar || JU.PT.isLetter(ch))) ||
            (allchar && !this.eol(ch) && !JU.PT.isWhitespace(ch))
          )
            ++ichT;

          if (
            (!allchar && ichT == this.ichToken) ||
            !JS.ScriptCompiler.isSpaceOrTab(ch)
          )
            return false;
          this.cchToken = ichT - this.ichToken;
          return true;
      ...
      Clazz_defineMethod(
        ...
        function (allowSpace, allowEquals, allowSptParen) {
          ...
          var passVariableToString =
            JS.T.tokAttr(this.tokCommand, 20480) && (this.tokCommand & 1) == 1;
          var isVariable = ch == '@';
          var isMath =
            isVariable &&
            ichT + 3 < this.cchScript &&
            this.script.charAt(ichT + 1) == '{';
              ...
              case '(':
                if (!allowSptParen) {
                  if (
                    this.tokCommand == 4124 ||
                    (ichT >= 5 &&
                      (this.script.substring(ichT - 4, ichT).equals('.spt') ||
                        this.script.substring(ichT - 4, ichT).equals('.png') ||
                        this.script.substring(ichT - 5, ichT).equals('.pngj')))
                  ) {
                    isOK = false;
                    continue;
                  }
          ...
          if (
            isVariable &&
            (!allowSpace ||
              (ptSpace < 0 && parenpt <= 0 && ichT - this.ichToken > 1))
          ) {
            return false;
          }
      ...
      Clazz_defineMethod(c$, 'lookingAtExponential', function () {
      ...
      Clazz_defineMethod(c$, 'lookingAtDecimal', function () {
        ...
        if (!JS.ScriptCompiler.isSpaceOrTab(ch1) && !this.eol(ch1)) {
          if (JU.PT.isLetter(ch1) || ch1 == '?' || ch1 == '*' || ch1 == '_')
            return false;
          if (JU.PT.isLetter((ch1 = this.charAt(ichT + 1))) || ch1 == '?')
            return false;
        }
        while (JU.PT.isDigit(this.charAt(ichT))) {
          ++ichT;
      ...
      Clazz_defineMethod(c$, 'lookingAtSeqcode', function () {
        var ichT = this.ichToken;
        var ch;
        ...
        if (ch != ' ' && ch != '*' && ch != '?' && !JU.PT.isLetter(ch))
          return false;
        this.cchToken = ichT - this.ichToken;
        return true;
      });
      Clazz_defineMethod(c$, 'lookingAtInteger', function () {
      ...
      Clazz_defineMethod(c$, 'lookingAtBitset', function () {
        ...
        if (
          this.ichToken + 4 > this.cchScript ||
          this.script.charAt(this.ichToken + 1) != '{' ||
          (ichT = this.script.indexOf('}', this.ichToken)) < 0 ||
          ichT + 1 == this.cchScript
        )
          return null;
      ...
      Clazz_defineMethod(c$, 'lookingAtObjectID', function () {
          ...
          switch ((ch = this.script.charAt(ichT++))) {
            ...
            case '?':
              ...
              while (
                ...
                (ch == '^' &&
                  ichT > ichT0 &&
                  JU.PT.isDigit(this.charAt(ichT - 1)))
              )
                ++ichT;
      ...
      Clazz_defineMethod(c$, 'lookForSyncID', function () {
        var ch;
        if ((ch = this.charAt(this.ichToken)) == '"' || ch == '@' || ch == '\0')
          return false;
        var ichT = this.ichToken;
        while (
          !JS.ScriptCompiler.isSpaceOrTab((ch = this.charAt(ichT))) &&
          ch != '#' &&
          ch != '}' &&
          !this.eol(ch)
        )
  ...
  Clazz_load(
    ...
    function () {
            ...
            switch (mode) {
              case -1:
                ...
                if (!this.doPopPush) this.millis = -this.millis;
                  ...
                  (delayMax = this.vwr.getDelayMaximumMs()) > 0 &&
      ...
      Clazz_defineStatics(c$, 'PAUSE_DELAY', -100);
    },
  );
  Clazz_declarePackage('JS');
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'getErrorMessage', function () {
        return this.errorMessage;
      });
      Clazz_overrideMethod(c$, 'getErrorMessageUntranslated', function () {
        return this.errorMessageUntranslated == null
          ? this.errorMessage
          : this.errorMessageUntranslated;
      });
      ...
      Clazz_defineMethod(c$, 'bad', function () {
        this.error(2);
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_defineMethod(
        ...
        function (iError, value, more, more2, warningOnly) {
          var strError = this.ignoreError
            ? null
            : JS.ScriptError.errorString(iError, value, more, more2, true);
          var strUntranslated =
            this.ignoreError || !J.i18n.GT.getDoTranslate()
              ? null
              : JS.ScriptError.errorString(iError, value, more, more2, false);
      ...
      c$.errorString = Clazz_defineMethod(
        c$,
        'errorString',
        function (iError, value, more, more2, translated) {
          var doTranslate = false;
          if (!translated && (doTranslate = J.i18n.GT.getDoTranslate()) == true)
          ...
          switch (iError) {
            ...
            case 11:
              msg = J.i18n.GT.$(
                '{x y z} or $name or (atom expression) required',
              );
              break;
            case 12:
      ...
      c$.getErrorLineMessage = Clazz_defineMethod(
        c$,
        'getErrorLineMessage',
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'getAllowJSThreads', function () {
      ...
      Clazz_defineMethod(c$, 'doReport', function () {
        return (
          !this.tQuiet && this.scriptLevel <= JS.ScriptEval.scriptReportingLevel
        );
      });
      Clazz_overrideMethod(c$, 'isStateScript', function () {
      ...
      Clazz_overrideMethod(c$, 'getScript', function () {
        return this.script;
      });
      Clazz_makeConstructor(c$, function () {
      ...
      Clazz_overrideMethod(c$, 'setCompiler', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (filename, tQuiet) {
          ...
          return (
            script != null &&
            this.compileScript(filename, script, this.debugScript)
          );
        },
        '~S,~B',
      );
      Clazz_overrideMethod(
        ...
        function (
          ...
          this.setAllowJSThreads(
            new Boolean(
              allowThreads & !this.vwr.getBoolean(603979892),
            ).valueOf(),
          );
          ...
          if (this.vwr.hasSelected && this.isGUI)
            this.vwr.setStatusSelect(null);
          this.vwr.hasSelected = false;
        },
        '~B,~B,~B,~B,JU.SB,~B',
      );
      Clazz_defineMethod(c$, 'useThreads', function () {
        return (
          !this.chk &&
          !this.vwr.headless &&
          !this.vwr.autoExit &&
        ...
        function (isTry, reportCompletion) {
            ...
            if (Clazz_exceptionOf(e$$, Error)) {
              var er = e$$;
              {
                ...
                this.setErrorMessage(
                  '' + er + ' ' + this.vwr.getShapeErrorState(),
                );
              ...
              {
                if (
                  Clazz_instanceOf(e, JS.ScriptInterruption) &&
                  (!isTry || !e.isError)
                ) {
                  return -1;
                }
                ...
                this.vwr.notifyError(
                  this.errorMessage != null &&
                    this.errorMessage.indexOf('java.lang.OutOfMemoryError') >= 0
                    ? 'Error'
                    : 'ScriptException',
                  this.errorMessage,
                  this.errorMessageUntranslated,
          ...
          if (haveError || !this.isJS || !this.allowJSThreads) {
            ...
            this.vwr.popHoldRepaint(
              'executeCommands' +
                ' ' +
                (this.scriptLevel > 0 ? '\u0001## REPAINT_IGNORE ##' : ''),
            );
          }
      ...
      Clazz_overrideMethod(
        ...
        function (sco) {
          ...
          this.thisContext = sc;
          if (sc.scriptLevel > 0 && sc.why !== 'getEvalContextAndHoldQueue')
          ...
          switch (
            this.executeCommands(
              this.thisContext != null && this.thisContext.isTryCatch,
              this.scriptLevel <= 0,
            )
          ) {
            case -1:
      ...
      c$.getContextTrace = Clazz_defineMethod(
        c$,
        'getContextTrace',
          ...
          sb.append(
            JS.ScriptError.getErrorLineMessage(
              ...
              JS.ScriptEval.statementAsString(
                vwr,
                sc.statement,
                isTop ? sc.iToken : 9999,
                false,
              ),
            ),
          );
          if (sc.parentContext != null)
            JS.ScriptEval.getContextTrace(vwr, sc.parentContext, sb, false);
          return sb;
        },
        'JV.Viewer,JS.ScriptContext,JU.SB,~B',
      );
      Clazz_overrideMethod(c$, 'setDebugging', function () {
        this.debugScript = this.vwr.getBoolean(603979825);
        this.debugHigh = this.debugScript && JU.Logger.debugging;
      });
      Clazz_overrideMethod(c$, 'haltExecution', function () {
        if (this.isEmbedded) {
      ...
      Clazz_overrideMethod(c$, 'stepPausedExecution', function () {
        this.executionStepping = true;
        this.executionPaused = false;
      });
      Clazz_overrideMethod(c$, 'resumePausedExecution', function () {
        this.executionPaused = false;
        this.executionStepping = false;
        if (!this.tQuiet)
          this.vwr.setScriptStatus(
      ...
      Clazz_overrideMethod(c$, 'isExecuting', function () {
        return this.executing && !this.executionStopped;
      });
      Clazz_overrideMethod(c$, 'isPaused', function () {
        return this.executionPaused;
      });
      Clazz_overrideMethod(c$, 'isStepping', function () {
        return this.executionStepping;
      });
      Clazz_overrideMethod(c$, 'isStopped', function () {
        return (
          this.executionStopped ||
          (!this.isJS && this.currentThread !== Thread.currentThread())
        );
      });
      Clazz_overrideMethod(c$, 'getNextStatement', function () {
          ...
          if (allThisLine) {
            ...
            for (var i = 0; i < this.lineNumbers.length; i++) {
              if (this.lineNumbers[i] == this.lineNumbers[pc]) {
                ...
                this.lineNumbers[i] > this.lineNumbers[pc]
              ) {
                break;
              }
            }
            ...
            return pt0 >= len || pt1 < pt0 || pt1 < 0
              ? ''
              : s.substring(Math.max(pt0, 0), Math.min(len, pt1));
          }
        ...
        function (st, ifLevel) {
          ...
          if (this.debugHigh) {
            ...
            for (var i = 1; i < st.length; ++i)
              if (st[i] != null) JU.Logger.debug(st[i].toString());

            var strbufLog = new JU.SB();
            var s =
              ifLevel > 0
                ? '                          '.substring(0, ifLevel * 2)
                : '';
            strbufLog
              .append(s)
              .append(
      ...
      c$.runUserAction = Clazz_defineMethod(
        c$,
        'runUserAction',
          ...
          try {
            if (Clazz_instanceOf(expr, String)) {
              if (
                this.compileScript(
                  null,
                  (compileOnly ? 'w_h_e_r_e' : 'e_x_p_r_e_s_s_i_o_n') +
                    ' = ' +
                    expr,
                  false,
                )
                ...
                return asVariable
                  ? this.parameterExpressionList(2, -1, false).get(0)
                  : this.parameterExpressionString(2, 0);
              }
            } else if (
              Clazz_instanceOf(expr, Array) &&
              Clazz_instanceOf(expr[0], Array)
            ) {
              this.setStatement(expr[0], 1);
              return asVariable
                ? this.parameterExpressionList(0, -1, false).get(0)
                : this.parameterExpressionString(0, -1);
            } else if (Clazz_instanceOf(expr, Array)) {
              var bs = this.atomExpression(
                expr,
                0,
                0,
                true,
      ...
      Clazz_defineMethod(
        ...
        function (filename, strScript, debugCompiler) {
          ...
          var sc = this.compiler.compile(
            ...
            false,
            false,
            debugCompiler && JU.Logger.debugging,
            false,
          );
          ...
          this.forceNoAddHydrogens =
            this.$isStateScript && this.script.indexOf('pdbAddHydrogens') < 0;
          var s = this.script;
          ...
          if (
            ...
            strScript.indexOf('\u0001## EDITOR_IGNORE ##') < 0
          )
      ...
      Clazz_defineMethod(c$, 'setScriptExtensions', function () {
        ...
        if (pt < 0) return 0;
        pt = JU.PT.parseInt(
          extensions.substring(pt + '\u0001##SCRIPT_START'.length),
        );
        if (pt == -2147483648) return 0;
        for (this.pc = 0; this.pc < this.lineIndices.length; this.pc++) {
          if (
            this.lineIndices[this.pc][0] > pt ||
            this.lineIndices[this.pc][1] >= pt
          )
            break;
        }
        if (
      ...
      Clazz_defineMethod(
        ...
        function (filename, localPath, remotePath, scriptPath) {
          ...
          if (!this.vwr.fm.getFileDataAsString(data, -1, false, true, false)) {
            this.setErrorMessage(
              'io error reading ' + data[0] + ': ' + data[1],
            );
            return null;
          }
          var movieScript = '';
          if (('\n' + data[1]).indexOf('\nJmolManifest.txt\n') >= 0) {
            var path;
            if (
              filename.endsWith('.all.pngj') ||
              filename.endsWith('.all.png')
            ) {
              path = '|state.spt';
              filename += '|';
            } else {
              if (data[1].indexOf('movie.spt') >= 0) {
                ...
                if (
                  this.vwr.fm.getFileDataAsString(data, -1, false, true, false)
                ) {
                  movieScript = data[1];
                }
              }
            ...
            if (path != null && path.length > 0) {
              data[0] = filename =
                filename.substring(0, filename.lastIndexOf('|')) + path;
              if (
                !this.vwr.fm.getFileDataAsString(data, -1, false, true, false)
              ) {
                this.setErrorMessage(
          ...
          return (
            JV.FileManager.setScriptFileReferences(
              script,
              localPath,
              remotePath,
              scriptPath,
      ...
      Clazz_overrideMethod(
        ...
        function (func, params, values) {
          try {
            ...
            var f = func;
            return JS.SV.fValue(
              this.runFunctionAndRet(f, f.name, p, null, true, false, false),
            );
          } catch (e) {
            if (Clazz_exceptionOf(e, Exception)) {
              return NaN;
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var v = getReturn
            ? this.getContextVariableAsVariable('_retval', false)
            : null;
          this.popContext(false, false);
          return v;
        },
      ...
      Clazz_defineMethod(
        ...
        function (cv) {
          ...
          if (
            ...
            this.aatoken[this.pc + 1][0].tok == 102412
          ) {
            var ct = this.aatoken[this.pc + 1][0];
            if (ct.contextVariables != null && ct.name0 != null)
              ct.contextVariables.put(ct.name0, JS.SV.newS(errMsg));
      ...
      Clazz_defineMethod(
        ...
        function (pt) {
          if (pt < 0) {
            this.getContextVariableAsVariable('_breakval', false).intValue =
              -pt;
            this.pcEnd = this.pc;
            return;
          }
      ...
      Clazz_defineMethod(c$, 'clearDefinedVariableAtomSets', function () {
        this.vwr.definedAtomSets.remove('# variable');
      });
      Clazz_defineMethod(c$, 'defineSets', function () {
        if (!this.vwr.definedAtomSets.containsKey('# static')) {
          for (var i = 0; i < JV.JC.predefinedStatic.length; i++)
            this.defineAtomSet(JV.JC.predefinedStatic[i]);

          this.defineAtomSet('# static');
        }
        if (this.vwr.definedAtomSets.containsKey('# variable')) return;
        for (var i = 0; i < JV.JC.predefinedVariable.length; i++)
          this.defineAtomSet(JV.JC.predefinedVariable[i]);

        for (var i = JU.Elements.elementNumberMax; --i >= 0; ) {
          var definition = ' elemno=' + i;
          this.defineAtomSet(
            '@' + JU.Elements.elementNameFromNumber(i) + definition,
          );
          this.defineAtomSet(
            '@_' + JU.Elements.elementSymbolFromNumber(i) + definition,
          );
        }
        for (var i = 4; --i >= 0; ) {
          var definition =
            '@' +
            JU.Elements.altElementNameFromIndex(i) +
            ' _e=' +
            JU.Elements.altElementNumberFromIndex(i);
      ...
      Clazz_defineMethod(
        ...
        function (script) {
          ...
          if (statement.length <= 2) {
            this.vwr.scriptStatus(
              'JmolConstants.java ERROR: bad predefinition length:' + script,
            );
            return;
          }
          ...
          if (!JS.T.tokAttr(tok, 1073741824) && !JS.T.tokAttr(tok, 2097152)) {
            this.vwr.scriptStatus(
              'JmolConstants.java ERROR: invalid variable name:' + script,
            );
            return;
          }
      ...
      Clazz_overrideMethod(
        ...
        function (bsDeleted) {
          for (
            var entry, $entry = this.vwr.definedAtomSets.entrySet().iterator();
      ...
      Clazz_overrideMethod(c$, 'getThisContext', function () {
        ...
        function (token, why) {
          ...
          if (token == null) {
            ...
            if (token.contextVariables != null)
              for (
                var key, $key = token.contextVariables.keySet().iterator();
                $key.hasNext() && ((key = $key.next()) || true);

              )
                JS.ScriptCompiler.addContextVariable(
          ...
          if (this.debugHigh || this.isCmdLine_c_or_C_Option)
            JU.Logger.info(
              '--<<------------'.substring(
                ...
                isFlowCommand +
                ' thisContext=' +
                (this.thisContext == null ? '' : '' + this.thisContext.id) +
                ' pc=' +
                this.pc +
                '-->' +
                this.pc +
                ' path=' +
                (this.thisContext == null ? '' : this.thisContext.contextPath),
            );
        },
        '~B,~B',
      );
      Clazz_defineMethod(
        ...
        function (context, isPopContext, isFlowCommand, statementOnly) {
          ...
          if (context.privateFuncs != null)
            this.privateFuncs = context.privateFuncs;
          ...
          if (isPopContext) {
            ...
            var pt =
              this.contextPath == null ? -1 : this.contextPath.indexOf(' >> ');
      ...
      Clazz_defineMethod(
        ...
        function (sx, msg, untranslated) {
          ...
          var s = JS.ScriptEval.getContextTrace(
            this.vwr,
          ...
          if (
            ...
            this.thisContext != null ||
            this.chk ||
            msg.indexOf('NOTE: file recognized as a script file: ') >= 0
          )
            return;
      ...
      c$.statementAsString = Clazz_defineMethod(
        c$,
        'statementAsString',
        function (vwr, statement, iTok, doLogMessages) {
          ...
          switch (tok) {
            ...
            case 102409:
              if (
                statement.length == 2 &&
                (statement[1].tok == 134320141 || statement[1].tok == 102436)
              )
                return statement[1].value.toString();
          }
          var useBraces = true;
          var inBrace = false;
          ...
          var setEquals =
            ...
            (statement[0].intValue == 61 || statement[0].intValue == 35) &&
            statement[1].tok != 1073742325;
          ...
          for (var i = 0; i < len; ++i) {
            ...
            if (i == 2 && setEquals) {
              if (
                (setEquals = token.tok != 268435860) ||
                statement[0].intValue == 35
              ) {
                sb.append(setEquals ? '= ' : '== ');
            ...
            switch (token.tok) {
              ...
              case 1073742363:
                if (token.intValue != 2147483647) sb.appendI(token.intValue);
                  ...
                  sb.append(
                    JM.Group.getSeqcodeStringFor(
                      JS.ScriptExpr.getSeqCode(token),
                    ),
                  );
                token = statement[++i];
                sb.appendC(' ');
              ...
              case 1073742361:
                ...
                sb.append(
                  JM.Group.standardGroupList.substring(ptr, ptr + 3).trim(),
                );
                sb.appendC(']');
                continue;
              case 1073742360:
              ...
              case 268435861:
                ...
                } else if (token.intValue != 2147483647)
                  sb.append(JS.T.nameOf(token.intValue)).append(' ');
                break;
              case 364558:
                continue;
              case 102409:
                ...
                continue;
              default:
                if (JS.T.tokAttr(token.tok, 1073741824) || !doLogMessages)
                  break;
      ...
      Clazz_defineMethod(
        ...
        'appendBuffer',
        function (str, mustDo) {
          if (mustDo || this.isFuncReturn || JU.Logger.isActiveLevel(4))
      ...
      Clazz_defineMethod(c$, 'checkContinue', function () {
      ...
      Clazz_defineMethod(
        ...
        function (millis) {
          ...
          if (this.vwr.captureParams != null && millis > 0) {
            this.vwr.captureParams.put(
              'captureDelayMS',
              Integer.$valueOf(millis),
            );
          }
      ...
      Clazz_defineMethod(
        ...
        function (prefix, filename, i, doClear) {
          ...
          if (fullPathNameOrError[1] != null)
            this.errorStr(17, filename + ':' + fullPathNameOrError[1]);
          ...
          if (cacheName != null && cacheName.length > 0) {
            ...
            this.vwr.queueOnHold = false;
            if (
              '#CANCELED#'.equals(cacheName) ||
              '#CANCELED#'.equals(this.vwr.fm.cacheGet(cacheName, false))
            )
          ...
          this.fileLoadThread = new JS.FileLoadThread(
            this,
            this.vwr,
            filename,
            key,
      ...
      Clazz_defineMethod(c$, 'cancelFileThread', function () {
        this.fileLoadThread = null;
        if (
          this.thisContext != null &&
          this.thisContext.why === 'loadFileAsync'
        ) {
          this.popContext(false, false);
        }
      });
      Clazz_defineMethod(
        ...
        function (msg, isData) {
          ...
          for (var i = 0; i < modelCount; i++) {
            ...
            sb.appendI(moData.get('mos').size())
              .append(' molecular orbitals in model ')
              .append(this.vwr.getModelNumberDotted(i))
              .append('\n');
          }
      ...
      Clazz_overrideMethod(c$, 'notifyResumeStatus', function () {
        if (
          !this.chk &&
          !this.executionStopped &&
          ...
          this.vwr.scriptStatus(
            'script execution ' + (isInterrupt ? 'interrupted' : 'resumed'),
          );
        }
      });
      Clazz_defineMethod(
      ...
      Clazz_overrideMethod(c$, 'stopScriptThreads', function () {
      ...
      Clazz_defineMethod(c$, 'getErrorLineMessage2', function () {
      ...
      Clazz_defineMethod(
        ...
        function (allowJSInterrupt) {
          ...
          if (this.debugScript && this.debugHigh && !this.chk) {
            for (
              var i = this.pc;
              i < this.aatoken.length && i < this.pcEnd;
              i++
            ) {
          ...
          for (
            ...
            if (allowJSInterrupt) {
              if (
                !this.executionPaused &&
                System.currentTimeMillis() - lastTime > 1000000
              ) {
                this.pc--;
                this.doDelay(-1);
              }
            ...
            if (
              !this.chk &&
              (!this.executionStepping || !isFirst) &&
              !this.checkContinue()
            )
              break;
            isFirst = false;
            ...
            if (
              ...
              if (
                ...
                (this.theToken.tok == 134320141 ||
                  this.theToken.tok == 102436 ||
                  !JS.T.tokAttr(this.theToken.tok, 102400))
              )
                this.vwr.addCommand((lastCommand = cmdLine));
            }
            ...
            this.iToken = 0;
            if (
              (this.listCommands || (!this.chk && this.scriptLevel > 0)) &&
              !this.isJS
            ) {
            ...
            if (this.chk) {
              ...
              if (
                this.slen == 1 &&
                this.st[0].tok != 134320141 &&
                this.st[0].tok != 102436
              )
                continue;
            } else {
      ...
      Clazz_defineMethod(
        ...
        function (pc) {
          this.vwr.notifyScriptEditor(
            (this.lineIndices[pc][0] << 16) | this.lineIndices[pc][1],
            null,
          );
        },
        '~N',
      ...
      Clazz_defineMethod(
        ...
        function (tok) {
          ...
          switch (tok) {
            case 0:
              if (!this.chk && this.vwr.getBoolean(603979879))
                this.vwr
                  .getChimeMessenger()
      ...
      Clazz_defineMethod(c$, 'cmdAnimation', function () {
        var animate = false;
        switch (this.getToken(1).tok) {
          ...
          case 1610625028:
            this.iToken = 2;
            var bs =
              this.tokAt(2) == 1073742327 ? null : this.atomExpressionAt(2);
          ...
          case 1073742024:
            ...
            if (!this.chk)
              this.vwr.am.setAnimationReplayMode(
                animationMode,
                startDelay,
                endDelay,
              );
      ...
      Clazz_defineMethod(
        ...
        'setFrameSet',
        function (i) {
          var frames = this.expandFloatArray(
            this.floatParameterSet(i, 0, 2147483647),
            1,
            false,
          );
          this.checkLength(this.iToken + 1);
      ...
      Clazz_defineMethod(
        ...
        function (index) {
          ...
          if (
            this.slen == index + 1 &&
            JU.PT.isOneOf(type, ';window;unitcell;molecular;')
          ) {
          ...
          switch (tok) {
            ...
            case 12289:
              this.setShapeProperty(
                34,
                'origin',
                this.centerParameter(index + 1, null),
              );
              this.checkLast(this.iToken);
              return;
            case 1140850696:
            ...
            case 536875009:
              this.setFloatProperty(
                'axesScale',
                this.floatParameter(this.checkLast(++index)),
              );
              return;
            case 1825200146:
          ...
          if (type.equals('position')) {
            ...
            if (this.tokAt(++index) == 1073742334) {
              ...
              this.setShapeProperty(
                34,
                'axes2',
                this.tokAt(index + 1) == 4
                  ? this.stringParameter(++index)
                  : null,
              );
            }
          ...
          if (this.theTok == 4120) {
            ...
            switch (this.tokAt(++i)) {
              ...
              default:
                ...
                o = file.startsWith(';base64,')
                  ? new JU.BArray(JU.Base64.decodeBase64(file))
                  : file;
            }
      ...
      Clazz_defineMethod(c$, 'cmdBondorder', function () {
        ...
        switch (this.getToken(1).tok) {
          ...
          case 3:
            if (
              (order = JU.Edge.getBondOrderFromFloat(this.floatParameter(1))) ==
              131071
            )
              this.invArg();
            break;
          default:
            if (
              (order = JU.Edge.getBondOrderFromString(this.paramAsStr(1))) ==
              131071
            )
              this.invArg();
            if (order == 33 && this.tokAt(2) == 3) {
              order = JU.Edge.getPartialBondOrderFromFloatEncodedInt(
                this.st[2].intValue,
              );
            }
        }
        ...
        function (index) {
          ...
          if (this.isCenterParameter(index)) {
            ...
            if (byCorner || this.isCenterParameter(index)) {
              var pt2 = byCorner
                ? this.centerParameter(index, ret)
                : this.getPoint3f(index, true, true);
              index = this.iToken + 1;
              ...
              if (this.chk) return;
              var bbox = this.getObjectBoundingBox(
                this.objectNameParameter(++index0),
              );
      ...
      Clazz_defineMethod(c$, 'cmdCD', function () {
        if (this.chk) return;
      ...
      Clazz_defineMethod(c$, 'cmdColor', function () {
        var i = 1;
        ...
        if (this.isColorParam(1)) {
          ...
          switch (tok) {
            ...
            case 4:
              ...
              if (this.isArrayParameter(i)) {
                strColor = strColor +=
                  '=' +
                  JS.SV.sValue(
                    JS.SV.getVariableAS(this.stringParameterSet(i)),
                  ).$replace('\n', ' ');
                i = this.iToken + 1;
              }
            ...
            case 1611141172:
              ...
              this.setShapeProperty(
                8,
                tok == 1611141172 ? 'argbSelection' : 'argbHighlight',
            ...
            case 1612709900:
              ...
              this.checkLast(this.iToken);
              if (
                str.equalsIgnoreCase('axes') ||
                JV.StateManager.getObjectIdFromName(str) >= 0
              ) {
      ...
      Clazz_defineMethod(c$, 'cmdDefine', function () {
        if (this.slen < 3 || !Clazz_instanceOf(this.getToken(1).value, String))
          this.invArg();
        ...
        if (isDynamic || isSite) {
          ...
          this.vwr.definedAtomSets.put(
            '!' + (isSite ? setName : setName.substring(8)),
            code,
          );
        } else {
          ...
          if (!this.chk)
            this.vwr.g.setUserVariable('@' + setName, JS.SV.newV(10, bs));
        }
      });
      Clazz_defineMethod(c$, 'cmdDelay', function () {
        var millis = 0;
        switch (this.getToken(1).tok) {
          case 1073742335:
            millis = 1;
      ...
      Clazz_defineMethod(c$, 'cmdDelete', function () {
        ...
        var bs =
          this.slen == 1
            ? null
            : this.atomExpression(this.st, 1, 0, true, false, null, false);
        if (this.chk) return;
        if (bs == null) bs = this.vwr.getAllAtoms();
        var nDeleted = this.vwr.deleteAtoms(bs, false);
        if (this.doReport())
          this.report(
            J.i18n.GT.i(J.i18n.GT.$('{0} atoms deleted'), nDeleted),
            false,
          );
      });
      Clazz_defineMethod(
        ...
        function (isDisplay) {
          ...
          switch (tok) {
            ...
            case 0:
              break;
            default:
              if (this.slen == 4 && this.tokAt(2) == 1677721602)
                bs = JM.BondSet.newBS(
      ...
      Clazz_defineMethod(
        ...
        function (iShape) {
            ...
            switch (this.getToken(ipt).tok) {
              ...
              case 1073741976:
                this.setShapeProperty(
                  iShape,
                  'ignore',
                  this.atomExpressionAt(ipt + 1),
                );
                ipt = this.iToken + 1;
                continue;
              case 3:
                isOnly =
                  this.tokAt(ipt + 1) == 1073742072 ||
                  this.floatParameter(ipt) < 0;
                break;
              case 2:
                ...
                if (this.tokAt(ipt + 1) == 1665140738) {
                  ...
                  this.setShapeProperty(
                    iShape,
                    'atom',
                    Integer.$valueOf(dotsParam),
                  );
                  this.setShapeProperty(
                    iShape,
                    'radius',
                    Float.$valueOf(this.floatParameter(++ipt)),
                  );
                  if (this.tokAt(++ipt) == 1765808134) {
                    this.setShapeProperty(
                      iShape,
                      'colorRGB',
                      Integer.$valueOf(this.getArgbParam(++ipt)),
                    );
                    ipt++;
                  }
          ...
          var rd = Float.isNaN(value)
            ? this.encodeRadiusParameter(ipt, isOnly, true)
            : new J.atomdata.RadiusData(null, value, type, J.c.VDW.AUTO);
          if (rd == null) return;
      ...
      Clazz_defineMethod(
        ...
        function (index) {
          ...
          if (
            ...
            text != null &&
            !text.startsWith('%SCALE')
          )
            this.showString(this.vwr.formatText(text));
        },
        '~N',
      );
      Clazz_defineMethod(c$, 'cmdFile', function () {
        var file = this.intParameter(this.checkLast(1));
        if (this.chk) return;
        var modelIndex = this.vwr.ms.getModelNumberIndex(
          file * 1000000 + 1,
          false,
          false,
        );
        var modelIndex2 = -1;
        if (modelIndex >= 0) {
          modelIndex2 = this.vwr.ms.getModelNumberIndex(
            (file + 1) * 1000000 + 1,
            false,
            false,
          );
      ...
      Clazz_defineMethod(c$, 'cmdFixed', function () {
        ...
        function (tok, isForCheck) {
          ...
          if (isForCheck && forVars != null) {
            ...
            if (forVal.tok == 2) {
              ...
              if (isOK)
                forVar.intValue = bsOrList[0] = i1 + (isMinusMinus ? -1 : 1);
              j = -1;
              ...
              switch ((tok = this.tokAt(i))) {
                ...
                case 1073741952:
                  ...
                  if (this.isAtomExpression(++i)) {
                    ...
                    if (this.isBondSet)
                      bsOrList = JM.BondSet.newBS(bsOrList, null);
                    ...
                    switch ((inTok = vl.tok)) {
                      ...
                      case 7:
                        ...
                        if (isOK && tok == 1073741952) {
                          var i12 = Clazz_newIntArray(-1, [
                            JS.SV.iValue(v.get(0)),
                            JS.SV.iValue(v.get(j - 1)),
                          ]);
            ...
            if (isOK)
              if (tok == 1275068432) {
                ...
                if (
                  vtok != 1073742339 &&
                  (JS.T.tokAttr(vtok, 1073741824) ||
                    (forVal = this.getContextVariableAsVariable(key, false)) !=
                      null)
                ) {
                  if (!isMinusMinus && this.getToken(++j).tok != 268435860)
                    this.invArg();
                  if (isMinusMinus) j -= 2;
                ...
                isOK =
                  pts[0] + 1 == pts[1] ||
                  this.parameterExpressionBoolean(pts[0] + 1, pts[1]);
              }
          }
            ...
            case 102409:
              switch (this.getToken(this.checkLast(1)).tok) {
                ...
                case 102410:
                  if (
                    pt > 0 &&
                    this.cmdFlowSwitch(this.aatoken[pt][0], 0) == -1
                  ) {
                    for (; pt < this.pc; pt++)
                      if (
                        (tok = this.aatoken[pt][0].tok) != 102413 &&
                        tok != 102411
                      )
                        break;
      ...
      Clazz_defineMethod(
        ...
        function (shapeType, fontsize) {
            ...
            case 6:
              ...
              if (scaleAngstromsPerPixel >= 5)
                scaleAngstromsPerPixel =
                  ...
                  scaleAngstromsPerPixel /
                  this.vwr.getScalePixelsPerAngstrom(false);
            case 5:
          ...
          if (shapeType == -1)
            shapeType = isScale ? 31 : this.getShapeType(this.getToken(1).tok);
          if (shapeType == 5) {
            if (
              fontsize < 0 ||
              (fontsize >= 1 && (fontsize < 6 || fontsize > 63))
            ) {
            ...
            if (!this.chk)
              this.setShapeProperty(
                5,
                'setDefaults',
                fontsize == 0 ? this.vwr.slm.noneSelected : Boolean.FALSE,
              );
          }
          if (this.chk) return;
          var value;
      ...
      Clazz_defineMethod(c$, 'cmdFunc', function () {
        ...
        var params =
          this.slen == 1 ||
          (this.slen == 3 &&
            this.tokAt(1) == 268435472 &&
            this.tokAt(2) == 268435473)
            ? null
            : this.parameterExpressionList(1, -1, false);
        if (this.chk) return;
        this.runFunctionAndRet(null, name, params, null, false, true, true);
      });
      Clazz_defineMethod(c$, 'cmdGetProperty', function () {
        if (this.chk) return;
        var retValue = '';
        ...
        switch (this.tokAt(2)) {
          ...
          case 10:
            ...
            if (
              property.equalsIgnoreCase('bondInfo') &&
              this.isAtomExpression(++this.iToken)
            )
              param = Clazz_newArray(-1, [
                param,
        ...
        if (property.length > 0 && propertyID < 0) {
          ...
          if (
            (param = this.vwr.getDefaultPropertyParam(propertyID)).equals(
              '(visible)',
            )
          )
      ...
      Clazz_defineMethod(c$, 'cmdHbond', function () {
        if (this.slen == 2 && this.getToken(1).tok == 4102) {
          if (this.chk) return;
          var n = this.vwr.autoHbond(null, null, false);
          this.report(
            J.i18n.GT.i(J.i18n.GT.$('{0} hydrogen bonds'), Math.abs(n)),
            false,
          );
          return;
        }
      ...
      Clazz_defineMethod(c$, 'cmdHelp', function () {
        if (this.chk) return;
        var what = this.optParameterAsString(1).toLowerCase();
        var pt = 0;
        if (
          what.startsWith('mouse') &&
          (pt = what.indexOf(' ')) >= 0 &&
          pt == what.lastIndexOf(' ')
        ) {
        ...
        if (JS.T.tokAttr(JS.T.getTokFromName(what), 4096))
          what = '?command=' + what;
      ...
      Clazz_defineMethod(c$, 'cmdHover', function () {
        if (this.chk) return;
          ...
          switch (this.getToken(index).tok) {
            ...
            case 1610625028:
              this.setShapeProperty(
                5,
                'display',
                this.theTok == 1610625028 ? Boolean.TRUE : Boolean.FALSE,
              );
              return;
            case 7:
      ...
      Clazz_defineMethod(c$, 'cmdLoad', function () {
        ...
        var filter = null;
        var modelCount0 =
          this.vwr.ms.mc - (this.vwr.fm.getFileName().equals('zapped') ? 1 : 0);
            ...
            case 1094717454:
              ...
              if (this.isPoint3f(i)) {
                ...
                htParams.put(
                  'firstLastStep',
                  Clazz_newIntArray(-1, [
                    Clazz_floatToInt(pt.x),
                    Clazz_floatToInt(pt.y),
                    Clazz_floatToInt(pt.z),
                  ]),
                );
        ...
        if (this.slen == i + 1) {
          if (
            ...
            (i == 0 ||
              (filenames == null &&
                (filename = this.paramAsStr(filePt)).length == 0))
          )
            filename = this.getFullPathName(true);
          ...
          if (filenames != null)
            for (var j = 0; j < nFiles; j++)
              loadScript.append(' /*file*/').append(JU.PT.esc(filenames[j]));
        } else if (this.isLoadOption(this.getToken(i + 1).tok)) {
          if (
            filename == null &&
            (filename = this.paramAsStr(filePt)).length == 0 &&
            (filename = this.getFullPathName(true)) == null
          ) {
            this.cmdZap(false);
            return;
          }
          ...
          if (i == 1) {
            if (
              this.tokAt(i + 1) == 268435617 ||
              this.tokAt(i + 1) == 268435616
            ) {
              modelName = 'files';
            } else {
              i++;
          ...
          if (isInline) {
            ...
            filename =
              ...
              this.checkFileExists(
                'LOAD' + (isAppend ? '_APPEND_' : '_'),
                isAsync,
                filename,
                filePt,
                !isAppend && this.pc != this.pcResume,
              );
        ...
        if (localName != null) {
          ...
          if (
            localName.length == 0 ||
            this.vwr.fm
              .getFilePath(localName, false, false)
              .equalsIgnoreCase(this.vwr.fm.getFilePath(filename, false, false))
          )
            this.invArg();
          ...
          if (out == null)
            JU.Logger.error(
              'Could not create output stream for ' + fullPath[0],
            );
          ...
          if (isVariable || isInline) {
            ...
            if (!filename.equals('String[]'))
              loadScript
                .append('/*file*/')
                .append(
                  localName != null ? JU.PT.esc(localName) : '$FILENAME$',
                );
          }
          if (
            !isConcat &&
            ...
            if ((pt = filename.indexOf('.')) >= 0)
              filename = filename.substring(0, pt);
            if (
              ';dssr;rna3d;dom;val;'.indexOf(';' + ext + ';') >= 0 ||
              ext.startsWith('dssr--')
            ) {
              if (filename.startsWith('=')) filename += '.cif';
              filenames = ext.equals('all')
                ? Clazz_newArray(-1, [filename, '*dom/' + id, '*val/' + id])
                : Clazz_newArray(-1, [filename, '*' + ext + '/' + id]);
              filename = 'fileSet';
              loadScript = null;
              isVariable = false;
              filecat = '-';
        ...
        errMsg = this.vwr.loadModelFromFile(
          null,
          filename,
          filenames,
          null,
        ...
        if (out != null) {
          ...
          JU.Logger.info(
            J.i18n.GT.o(J.i18n.GT.$('file {0} created'), localName),
          );
          this.showString(
            this.vwr.fm.getFilePath(localName, false, false) + ' created',
          );
          out.closeChannel();
        }
        if (tokType > 0) {
        ...
        if (errMsg != null && !this.isCmdLine_c_or_C_Option) {
          if (errMsg.indexOf('NOTE: file recognized as a script file: ') == 0) {
            filename = errMsg
              .substring('NOTE: file recognized as a script file: '.length)
              .trim();
            if (
      ...
      Clazz_defineMethod(
        ...
        function (prefix, isAsync, filename, i, doClear) {
          ...
          if (
            ...
            this.vwr.apiPlatform.forceAsyncLoad(filename)
          ) {
      ...
      Clazz_defineMethod(
        ...
        function (loadScript, key, htParams, i) {
          ...
          var strModel =
            ptVar >= 0
              ? '' + this.getParameter(key.substring(ptVar + 1), 4, true)
              : this.paramAsStr(++i);
          strModel = JV.Viewer.fixInlineString(
            strModel,
            this.vwr.getInlineChar(),
          );
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          if (
            ...
            !isAppend &&
            (isConcat || nFiles < 2) &&
            (msg = this.vwr.ms.getInfoM('modelLoadNote')) != null
          ) {
            this.showString(msg);
          }
          ...
          if (
            ...
            (embeddedScript = info.remove('jmolscript')) != null &&
      ...
      Clazz_defineMethod(c$, 'cmdLog', function () {
      ...
      Clazz_defineMethod(c$, 'cmdLoop', function () {
        if (this.vwr.headless) return;
        if (!this.chk) this.pc = -1;
        this.cmdDelay();
      });
      Clazz_defineMethod(c$, 'cmdMessage', function () {
        ...
        function (offset) {
          ...
          if (this.slen == 1 && offset == 1) {
            ...
            if (
              !this.chk &&
              modelIndex >= 0 &&
              (m = this.vwr.ms.getJmolDataSourceFrame(modelIndex)) >= 0
            )
              this.vwr.setCurrentModelIndex(m == modelIndex ? -2147483648 : m);
            return;
          }
          switch (this.tokAt(1)) {
            case 1073877010:
              if (!this.chk && isFrame && this.slen == 2) {
                while (++modelIndex < this.vwr.ms.mc) {
                  if (
                    !this.vwr.ms.am[modelIndex].auxiliaryInfo.containsKey(
                      'moData',
                    )
                  )
                    continue;
            ...
            case 1073742077:
              if (this.tokAt(2) == 3 && this.tokAt(3) == 12) {
                modelIndex = this.vwr.ms.getModelNumberIndex(
            ...
            case 1073741832:
              ...
              var bs =
                this.slen == 2 || isNone ? null : this.atomExpressionAt(2);
          ...
          if (this.getToken(offset).tok == 268435616) {
            ++offset;
            if (
              this.getToken(this.checkLast(offset)).tok != 2 ||
              this.intParameter(offset) != 1
            )
              this.invArg();
              ...
              switch (this.getToken(i).tok) {
                ...
                case 4:
                  ...
                  if (
                    this.theTok == 3 &&
                    haveFileSet &&
                    fFrame == Clazz_floatToInt(fFrame)
                  )
                    iFrame = Clazz_floatToInt(fFrame) * 1000000;
                  ...
                  if (iFrame >= 1000 && iFrame < 1000000 && haveFileSet)
                    iFrame =
                      Clazz_doubleToInt(iFrame / 1000) * 1000000 +
                      (iFrame % 1000);
          ...
          if (haveFileSet) useModelNumber = false;
            ...
            for (var i = 0; i < nFrames; i++)
              if (frameList[i] >= 0) frameList[i] %= 1000000;
          ...
          if ((isPlay && nFrames == 2) || isRange || isHyphen) {
            ...
            this.vwr.setCurrentModelIndexClear(
              isHyphen && !isRange ? -1 : modelIndex >= 0 ? modelIndex : 0,
              false,
            );
          }
      ...
      Clazz_defineMethod(
        ...
        function (modelIndex, data) {
          ...
          this.showString(
            this.vwr.getAnnotationParser(true).fixDSSRJSONMap(map),
          );
          this.vwr.ms.setInfo(modelIndex, 'dssr', map);
        },
        '~N,~S',
      );
      Clazz_defineMethod(c$, 'cmdMove', function () {
        this.checkLength(-11);
        var dRot = JU.V3.new3(
        ...
        if (floatSecondsTotal > 0 && this.isJS)
          throw new JS.ScriptInterruption(this, 'move', 1);
      });
      Clazz_defineMethod(c$, 'cmdMoveto', function () {
        ...
        if (this.slen == 2 && this.isFloatParameter(1)) {
          ...
          if (this.isJS && floatSecondsTotal > 0 && this.vwr.g.waitForMoveTo)
        ...
        var center = null;
        var i = 1;
        floatSecondsTotal = this.isFloatParameter(i)
              ...
              default:
                ...
                if (uc == null) {
                  uc = this.vwr
                    .getSymTemp()
                    .setUnitCell(
                      Clazz_newFloatArray(-1, [1, 1, 1, 90, 90, 90]),
                      false,
                    );
                }
        ...
        if (q != null) {
          ...
          degrees =
            (isMolecular ? -1 : 1) * ((aa.angle * 180.0) / 3.141592653589793);
        }
        ...
        if (this.isFloatParameter(i) && !this.isCenterParameter(i)) {
          ...
          if (
            !isChange &&
            Math.abs(xTrans - this.vwr.tm.getTranslationXPercent()) >= 1
          )
            isChange = true;
          if (
            !isChange &&
            Math.abs(yTrans - this.vwr.tm.getTranslationYPercent()) >= 1
          )
            isChange = true;
        }
        ...
        if (center != null) {
          if (
            !isChange &&
            center.distance(this.vwr.tm.fixedRotationCenter) >= 0.1
          )
            isChange = true;
          ...
          if (!this.isCenterParameter(i)) {
            if (
              (rotationRadius == 0 || Float.isNaN(rotationRadius)) &&
              (zoom == 0 || Float.isNaN(zoom))
            ) {
              var newZoom = Math.abs(
                this.getZoom(0, i, bsCenter, zoom == 0 ? 0 : zoom0),
              );
              i = this.iToken + 1;
              zoom = newZoom;
            } else {
              if (
                !isChange &&
                Math.abs(rotationRadius - this.vwr.getFloat(570425388)) >= 0.1
              )
                isChange = true;
            }
          }
          ...
          if (i != this.slen) {
            ...
            if (i != this.slen) {
              ...
              if (
                !isChange &&
                Math.abs(cameraDepth - this.vwr.tm.getCameraDepth()) >= 0.01
              )
                isChange = true;
            }
            if (i + 1 < this.slen) {
              ...
              if (!isChange && Math.abs(cameraX - this.vwr.tm.camera.x) >= 0.01)
                isChange = true;
              if (!isChange && Math.abs(cameraY - this.vwr.tm.camera.y) >= 0.01)
                isChange = true;
            }
          }
        }
      ...
      Clazz_defineMethod(c$, 'cmdPause', function () {
        ...
        msg =
          msg.length == 0
            ? ': RESUME to continue.'
            : ': ' + this.vwr.formatText(msg);
        this.pauseExecution(true);
        this.vwr.scriptStatusMsg(
          'script execution paused' + msg,
          'script paused for RESUME',
        );
        return true;
      });
      Clazz_defineMethod(c$, 'cmdPrint', function () {
        if (this.slen == 1) {
      ...
      Clazz_defineMethod(c$, 'cmdPrompt', function () {
        var msg = null;
        if (this.slen == 1) {
          if (!this.chk)
            msg = JS.ScriptEval.getContextTrace(
              this.vwr,
      ...
      Clazz_defineMethod(c$, 'cmdReset', function () {
        ...
        switch (this.tokAt(1)) {
          ...
          case 1639976963:
            ...
            this.runScript(
              this.vwr.ms.getDefaultStructure(this.vwr.bsA(), bsModified),
            );
      ...
      Clazz_defineMethod(c$, 'resetError', function () {
        this.vwr.g.removeParam('_errormessage');
      });
      Clazz_defineMethod(c$, 'cmdRestrict', function () {
      ...
      Clazz_defineMethod(
        ...
        function (isSpin, isSelected) {
          ...
          for (var i = 1; i < this.slen; ++i) {
            switch ((tok = this.getToken(i).tok)) {
              ...
              case 1073742330:
                ...
                var pt1 = this.centerParameterForModel(
                  i,
                  this.vwr.am.cmi,
                  null,
                );
                if (
                  !this.chk &&
                  tok == 1073742330 &&
                  this.tokAt(i + 2) != 268435520
                ) {
                  isMolecular = true;
                  var data = Clazz_newArray(-1, [
                    this.objectNameParameter(++i),
                    Integer.$valueOf(this.vwr.am.cmi),
                    null,
                  ]);
                  rotAxis = this.getShapePropertyData(22, 'getSpinAxis', data)
                    ? data[2]
                    : null;
                }
                points[nPoints++] = pt1;
              ...
              case 3:
                ...
                if (
                  i == this.slen - 2 &&
                  (this.tokAt(i + 1) == 1073741824 || this.tokAt(i + 1) == 4)
                ) {
              ...
              case 1111492631:
                ...
                rotAxis.set(
                  0,
                  0,
                  axesOrientationRasmol && !isMolecular
                    ? -direction
                    : direction,
                );
                continue;
              ...
              case 134217750:
                ...
                if (this.paramAsStr(i + 1).equalsIgnoreCase('picked')) {
                  ...
                  pts = new Array(3);
                  for (var j = 0; j < 3; j++)
                    pts[j] = this.vwr.ms.getAtomSetCenter(
                      JS.SV.getBitSet(lst.get(n - 3 + j), false),
                    );
                ...
                n = pts.length;
                if (n < 3) return;
                q = JU.Quat.getQuaternionFrame(
                  pts[n - 3],
                  pts[n - 2],
                  pts[n - 1],
                );
                q = JU.Quat.new4(1, 0, 0, 0).mulQ(
                  q.inv().div(this.vwr.tm.getRotationQ()),
                );
                rotAxis.setT(q.getNormal());
                endDegrees = q.getTheta();
                break;
              ...
              case 1073742328:
                ...
                if (this.isArrayParameter(++i)) {
                  ...
                  var iAtom2 = this.atomExpressionAt(++this.iToken).nextSetBit(
                    0,
                  );
              ...
              case 1296041985:
                ...
                var info = this.vwr
                  .getSymTemp()
                  .getSpaceGroupInfo(this.vwr.ms, null, -1, false, null);
              ...
              case 134221831:
                ...
                var stddev = this.chk
                  ? 0
                  : JU.Measure.getTransformMatrix4(ptsA, ptsB, m4, points[0]);
          ...
          var rate =
            degreesPerSecond == 1.4e-45
              ? 10
              : endDegrees == 3.4028235e38
              ? degreesPerSecond
              : isDegreesPerSecond
              ? degreesPerSecond
              : isSeconds
              ...
              : degreesPerSecond < 0 == (q == null ? endDegrees > 0 : true)
              ? -endDegrees / degreesPerSecond
              : degreesPerSecond;
          ...
          if (q != null) {
            if (nPoints == 0 && translation != null && !is4x4)
              points[0] = this.vwr.ms.getAtomSetCenter(
                bsAtoms != null
                  ? bsAtoms
                  : isSelected
                  ? this.vwr.bsA()
            ...
            if (isSpin && m4 == null)
              m4 = JS.ScriptMathProcessor.getMatrix4f(
                q.getMatrix(),
                translation,
              );
          ...
          var requiresThread =
            isSpin && (!this.vwr.headless || endDegrees == 3.4028235e38);
          ...
          if (!checkModelKit && nPoints < 2 && dihedralList == null) {
            if (!isMolecular) {
              ...
              if (
                this.vwr.rotateAxisAngleAtCenter(
                  this,
                  points[0],
                  rotAxis,
                  rate,
          ...
          if (checkModelKit) {
            ...
            var na = this.vwr
              .getModelkit(false)
              .cmdRotateAtoms(bsAtoms, points, endDegrees);
            if (this.doReport())
              this.report(
                J.i18n.GT.i(J.i18n.GT.$('{0} atoms rotated'), na),
                false,
              );
            return;
          }
          ...
          if (
            ...
            rate =
              degreesPerSecond == 1.4e-45
                ...
                : degreesPerSecond < 0
                ? -endDegrees / degreesPerSecond
                : (degreesPerSecond * 0.01) / translation.length();
      ...
      Clazz_defineMethod(c$, 'cmdRestore', function () {
        if (this.slen > 1) {
          ...
          switch (tok) {
            ...
            case 1073742139:
              var floatSecondsTotal =
                this.slen > 3 ? this.floatParameter(3) : 0;
              ...
              switch (tok) {
                case 1073742077:
                  type = 'Orientation';
                  this.vwr.stm.restoreOrientation(
                    saveName,
                    floatSecondsTotal,
                    true,
                  );
              ...
              if (
                ...
                throw new JS.ScriptInterruption(this, 'restore' + type, 1);
              return;
          }
          this.checkLength23();
          switch (tok) {
      ...
      Clazz_defineMethod(c$, 'cmdSave', function () {
        if (this.slen > 1) {
          var saveName = this.optParameterAsString(2);
          switch (this.tokAt(1)) {
            case 1677721602:
      ...
      Clazz_defineMethod(
        ...
        function (tok, filename, theScript) {
          ...
          if (filename == null && theScript == null) {
            ...
            if (filename.equalsIgnoreCase('applet')) {
              ...
              if (filename.equalsIgnoreCase('inline')) {
                filename = null;
                theScript = this.parameterExpressionString(
                  ++i,
                  doStep ? this.slen - 1 : 0,
                );
                i = this.iToken;
              } else {
                while (
                  filename.equalsIgnoreCase('localPath') ||
              ...
              if (tok == 1073741998 || tok == 1140850692) {
                ...
                if (this.checkToken(i)) {
                  if (this.getToken(i).tok == 268435616)
          ...
          if (theScript == null) {
            theScript = this.getScriptFileInternal(
              filename,
              localPath,
              remotePath,
              scriptPath,
          ...
          if (
            this.compileScript(
              filename,
              theScript,
              filename != null && this.debugScript,
            )
          ) {
            this.pcEnd = pcEnd;
            this.lineEnd = lineEnd;
            while (
              pc < this.lineNumbers.length &&
              this.lineNumbers[pc] < lineNumber
            )
              pc++;
            ...
            this.contextVariables.put(
              '_arguments',
              params == null
                ? JS.SV.getVariableAI(Clazz_newIntArray(-1, []))
                : JS.SV.getVariableList(params),
            );
            this.contextVariables.put(
              '_argcount',
              JS.SV.newI(params == null ? 0 : params.size()),
            );
      ...
      Clazz_defineMethod(
        ...
        function (i) {
          ...
          switch (tok) {
            case 10:
              if (
                Clazz_instanceOf(this.getToken(2).value, JM.BondSet) ||
                (tok == 1677721602 && this.getToken(3).tok == 10)
              ) {
            ...
            case 1677721602:
              if (this.slen == 5 && this.tokAt(3) == 10) {
                ...
                bs = new JU.BS();
                var a = this.expandFloatArray(
                  this.floatParameterSet(4, 0, 2147483647),
                  0,
                  false,
                );
                for (var ii = a.length; --ii >= 0; )
                  if (a[ii] >= 0) bs.set(a[ii]);
              }
              this.checkLast(this.iToken);
              if (this.chk) return;
          ...
          if (this.isBondSet) {
            ...
            this.vwr.slm.noneSelected = Boolean.$valueOf(
              this.slen == 4 && this.tokAt(2) == 1073742333,
            );
          }
        },
        '~N',
      ...
      Clazz_defineMethod(c$, 'cmdSet', function () {
        if (this.slen == 1) {
        ...
        if (isJmolSet && this.slen == 2 && key.indexOf('?') >= 0) {
          this.showString(
            this.vwr.getAllSettings(key.substring(0, key.indexOf('?'))),
          );
          return;
        }
        var tok = this.getToken(1).tok;
        ...
        switch (tok) {
          ...
          case 536870920:
            ...
            this.setShapeProperty(
              8,
              'highlight',
              this.tokAt(2) == 1073742334 ? null : this.atomExpressionAt(2),
            );
            return;
          case 1610625028:
          case 1611141172:
          ...
          case 536870932:
            ...
            if (Clazz_instanceOf(o, String)) {
              if (this.vwr.fm.loadImage(o, '\0windowImage', !this.useThreads()))
          ...
          case 536870917:
            if (this.chk) return;
            var iLevel =
              this.tokAt(2) == 1073742334 ||
              (this.tokAt(2) == 2 && this.intParameter(2) == 0)
                ? 4
                : tok == 536870917
                ? 6
                : 5;
          ...
          case 1610612738:
            this.cmdFont(
              5,
              this.checkLength23() == 2 ? 0 : this.floatParameter(2),
            );
            return;
          case 1613238294:
            var bool = false;
            ...
            switch ((tok = this.tokAt(this.checkLast(2)))) {
              ...
              case 3:
                ...
                if (mad10 != 2147483647)
                  this.setShapeSizeBs(
                    6,
                    tok == 3 ? Clazz_doubleToInt(mad10 / 10) : mad10,
                    null,
                  );
                return;
            }
          ...
          case 553648188:
            if (this.isFloatParameter(2)) {
              ...
              this.setIntProperty(
                'zSlab',
                Clazz_floatToInt(this.floatParameter(2)),
              );
              pt = null;
            } else {
            ...
            if (!this.chk)
              this.vwr.tm.zSlabPoint = pt == null ? null : JU.P3.newP(pt);
            return;
        }
        var justShow = true;
        switch (tok) {
          ...
          case 1648363544:
            ...
            if (
              this.slen > 2 &&
              'probe'.equalsIgnoreCase(this.getSettingStr(2, false))
            ) {
              this.runScript(
          ...
          case 545259555:
            if (this.slen > 2) {
              ...
              if (
                this.slen == 3 &&
                J.c.VDW.getVdwType(sval) == null &&
                J.c.VDW.getVdwType((sval = this.getSettingStr(2, false))) ==
                  null
              )
                this.invArg();
          ...
          case 545259545:
            if (this.slen > 2) {
              if (
                (this.theTok = this.tokAt(2)) == 1073741991 ||
                this.theTok == 1073742116
              ) {
        ...
        var isContextVariable =
          !justShow &&
          !isJmolSet &&
          this.getContextVariableAsVariable(key, false) != null;
          ...
          switch (tok) {
            ...
            case 1611141175:
              ...
              if (!this.chk)
                this.vwr.setSpin(
                  sval,
                  Clazz_floatToInt(this.floatParameter(this.checkLast(3))),
                );
              justShow = true;
              break;
          }
        ...
        if (newTok != 0) {
          ...
          if (
            key.length == 0 ||
            (key.charAt(0) == '_' && this.tokAt(2) != 268435520)
          )
            this.error(56);
          var lckey = key.toLowerCase();
          if (
            lckey.indexOf('label') == 0 &&
            JU.PT.isOneOf(
              lckey.substring(5),
          ...
          if (isJmolSet && lckey.indexOf('shift_') == 0) {
            ...
            if (!this.chk)
              this.vwr
                .getNMRCalculation()
                .setChemicalShiftReference(lckey.substring(6), f);
            return;
          }
        ...
        function (pt) {
          ...
          switch (this.tokAt(pt)) {
            ...
            case 1073742335:
              ...
              break;
            default:
              var units = JM.Measurement.fixUnits(
                this.optParameterAsString(pt),
              );
        ...
        function (i) {
          ...
          if (!this.chk) {
            ...
            if (id != null) {
              ...
              this.setShapeProperty(
                31,
                propertyName == null ? 'target' : propertyName,
                id,
              );
            }
          }
            ...
            switch (this.getToken(pt++).tok) {
              ...
              case 554176526:
                ...
                propertyValue = Integer.$valueOf(
                  Clazz_floatToInt(this.floatParameter(pt++)),
                );
                break;
              case 1610625028:
              case 2097192:
              ...
              case 1073742066:
                ...
                if (this.isPoint3f(pt)) {
                  ...
                  propertyValue = Clazz_newFloatArray(-1, [
                    -1,
                    pt3.x,
                    pt3.y,
                    pt3.z,
              ...
              case 134217751:
                propertyName = 'point';
                propertyValue = this.isCenterParameter(pt)
                  ? this.centerParameter(pt, null)
                  : null;
                pt = this.iToken + 1;
                break;
              default:
        ...
        function (str) {
          ...
          while (true) {
            ...
            if (
              str.equals('offset') ||
              (isAbsolute =
                str.equals('offsetabsolute') || str.equals('offsetexact'))
            ) {
              str = 'offset';
              if (this.isPoint3f(2)) {
                ...
                propertyValue = Integer.$valueOf(
                  JV.JC.getOffset(xOffset, yOffset, isAbsolute),
                );
              }
              break;
            }
            ...
            if (str.equals('toggle')) {
              this.iToken = 1;
              var bs =
                this.slen == 2 ? this.vwr.bsA() : this.atomExpressionAt(2);
              this.checkLast(this.iToken);
              if (this.chk) return true;
      ...
      Clazz_defineMethod(c$, 'cmdSetPicking', function () {
        if (this.slen == 2) {
      ...
      Clazz_defineMethod(c$, 'cmdSetPickingStyle', function () {
        if (this.slen > 4 || this.tokAt(2) == 4) {
        ...
        if (JV.ActionManager.getPickingStyleIndex(str) < 0)
          ...
          if (this.isCenterParameter(1) || this.tokAt(1) == 9)
            ...
            switch (this.getToken(1).tok) {
              case 2:
                ...
                if (!this.chk)
                  if (isDepth) this.vwr.tm.depthToPercent(percent);
              ...
              case 268435616:
                ...
                if (str.equalsIgnoreCase('hkl'))
                  plane = this.hklParameter(3, null, true);
                else if (str.equalsIgnoreCase('plane'))
                  plane = this.planeParameter(2, false);
              ...
              case 134219777:
                plane =
                  this.getToken(2).tok == 1073742333
                    ? null
                    : this.hklParameter(2, null, true);
                break;
              case 1073742118:
                return;
              default:
      ...
      Clazz_defineMethod(c$, 'cmdSsbond', function () {
        var mad = this.getMadParameter();
        if (mad == 2147483647) return;
      ...
      Clazz_defineMethod(c$, 'cmdStructure', function () {
      ...
      Clazz_defineMethod(c$, 'cmdSubset', function () {
        var bs = null;
        if (!this.chk) this.vwr.slm.setSelectionSubset(null);
        if (
          this.slen != 1 &&
          (this.slen != 4 || !this.getToken(2).value.equals('off'))
        )
          bs = this.atomExpressionAt(1);
        if (!this.chk) this.vwr.slm.setSelectionSubset(bs);
      });
      Clazz_defineMethod(c$, 'cmdSync', function () {
        var text = '';
        var applet = '';
        ...
        if (port == -2147483648) {
          ...
          switch (this.slen) {
            ...
            case 2:
              ...
              if (
                applet.indexOf('jmolApplet') == 0 ||
                JU.PT.isOneOf(applet, ';*;.;^;')
              ) {
                text = 'ON';
            ...
            case 3:
              applet = this.paramAsStr(1);
              text =
                this.tokAt(2) == 528443 ? 'GET_GRAPHICS' : this.paramAsStr(2);
              break;
          }
        } else {
          var v = null;
      ...
      Clazz_defineMethod(c$, 'cmdThrow', function () {
        if (this.chk) return;
        var pt = this.tokAt(1) == 14 ? 2 : 1;
        var v =
          pt == 1
            ? this.setVariable(1, this.slen, 'thrown_value', false)
            : this.vwr.g.setUserVariable(
                'thrown_value',
        ...
        if (
          info.length == 0 &&
          (info = this.optParameterAsString(1)).length == 0
        )
          info = 'context';
        if (pt == 2) {
          ...
          if (this.doReport())
            this.report(
              J.i18n.GT.o(J.i18n.GT.$('to resume, enter: &{0}'), info),
              false,
            );
        ...
        function (isSelected) {
          ...
          switch (this.tokAt(++i)) {
            ...
            case 1073742325:
              ...
              break;
            default:
              type = (this.optParameterAsString(i).toLowerCase() + '\0').charAt(
                0,
              );
          }
      ...
      Clazz_defineMethod(c$, 'cmdUnbind', function () {
        ...
        if (
          name == null &&
          mouseAction != null &&
          JV.ActionManager.getActionFromName(mouseAction) >= 0
        ) {
          name = mouseAction;
          mouseAction = null;
        }
        ...
        function (iModel, originABC, name) {
          ...
          try {
            this.vwr.ms.setModelCage(
              ...
              originABC == null
                ? null
                : sym.getUnitCell(originABC, false, name),
            );
          } catch (e) {
            if (Clazz_exceptionOf(e, Exception)) {
            } else {
      ...
      Clazz_defineMethod(c$, 'cmdVector', function () {
        ...
        switch ((this.iToken = this.slen)) {
          ...
          case 2:
            switch (this.getToken(1).tok) {
              ...
              case 3:
                ...
                if (Float.isNaN((value = this.floatParameterRange(1, 0, 3))))
                  return;
                break;
              default:
                this.error(6);
          ...
          case 3:
            switch (this.tokAt(1)) {
              ...
              case 536875009:
                if (
                  !Float.isNaN((value = this.floatParameterRange(2, -100, 100)))
                )
        ...
        this.setShapeSize(
          18,
          new J.atomdata.RadiusData(null, value, type, null),
        );
      });
      Clazz_defineMethod(c$, 'cmdVibration', function () {
        this.checkLength(-3);
        var period = 0;
        switch (this.getToken(1).tok) {
          case 1073742335:
          ...
          case 3:
            ...
            break;
          case 536875009:
            if (!Float.isNaN((period = this.floatParameterRange(2, -100, 100))))
      ...
      Clazz_defineMethod(c$, 'cmdWireframe', function () {
        var mad = -2147483648;
      ...
      Clazz_defineMethod(
        ...
        function (isZapCommand) {
          ...
          if (
            bs.nextSetBit(0) < 0 &&
            this.slen == 4 &&
            this.tokAt(2) == 1073742359
          ) {
            var iModel = this.vwr.ms.getModelNumberIndex(
              this.getToken(2).intValue,
              false,
              true,
            );
      ...
      Clazz_defineMethod(
        ...
        function (isZoomTo) {
          ...
          var center = null;
          var i = 1;
          var floatSecondsTotal = isZoomTo
            ? this.isFloatParameter(i)
              ? this.floatParameter(i++)
              : 1
            : 0;
      ...
      Clazz_defineMethod(
        ...
        function (shapeType, index, isBackground) {
          ...
          else if ((isBackground = tok == 1610616835) == true)
            this.getToken(++index);
          ...
          if (
            !this.chk &&
            (shapeType == 27 || shapeType == 28) &&
            this.getIsoExt().dispatch(shapeType, true, this.st) != null
          )
            return;
          ...
          var isColor =
            index < this.slen &&
            this.tokAt(index) != 1073742335 &&
            this.tokAt(index) != 1073742334;
          if (isColor) {
            tok = this.getToken(index).tok;
            if (
              (!isIsosurface || this.tokAt(index + 1) != 1073742170) &&
              this.isColorParam(index)
            ) {
              var argb = this.getArgbParamOrNone(index, false);
              colorvalue = argb == 0 ? null : Integer.$valueOf(argb);
              if (
                this.tokAt((index = this.iToken + 1)) != 0 &&
                translucency == null
              ) {
                this.getToken(index);
              ...
              var pal =
                isColorIndex || isIsosurface
                  ? J.c.PAL.PROPERTY
                  : tok == 1112152075
                  ? J.c.PAL.CPK
                  : J.c.PAL.getPalette(name);
              if (
                pal === J.c.PAL.UNKNOWN ||
                ((pal === J.c.PAL.TYPE || pal === J.c.PAL.ENERGY) &&
                  shapeType != 2)
              )
                this.invArg();
              var data = null;
              var bsSelected =
                (pal !== J.c.PAL.PROPERTY && pal !== J.c.PAL.VARIABLE) ||
              ...
              if (pal === J.c.PAL.PROPERTY) {
                if (isColorIndex) {
                  if (!this.chk) {
                    data = this.getCmdExt().getBitsetPropertyFloat(
                      bsSelected,
                      (isByElement ? 1094715402 : 1094713356) | 256,
                      null,
                      NaN,
                      NaN,
                    );
                  ...
                  if (
                    ...
                    !JS.T.tokAttr(tok, 1086324736)
                  ) {
                    tok = this.getToken(index).tok;
                    var type =
                      tok == 1111490587
                        ? this.getToken(++index).value.toString()
                        : null;
                    if (!this.chk) {
                      data = this.getCmdExt().getBitsetPropertyFloat(
                        bsSelected,
              ...
              if (pal === J.c.PAL.PROPERTY) {
                ...
                if (this.tokAt(index) == 4) {
                  ...
                  if (this.isArrayParameter(index)) {
                    scheme +=
                      '=' +
                      JS.SV.sValue(
                        JS.SV.getVariableAS(this.stringParameterSet(index)),
                      ).$replace('\n', ' ');
                    index = this.iToken + 1;
                  }
                ...
                if (scheme != null && !isIsosurface) {
                  this.setStringProperty(
                    'propertyColorScheme',
                    (isTranslucent && translucentLevel == 3.4028235e38
                      ? 'translucent '
                      : '') + scheme,
                  );
                  isColorIndex =
                    scheme.indexOf('byelement') == 0 ||
                    scheme.indexOf('byresidue') == 0;
                }
                var min = 0;
                var max = 3.4028235e38;
                if (
                  !isColorIndex &&
                  (this.tokAt(index) == 1073741826 ||
                    this.tokAt(index) == 1073742114)
                ) {
                ...
                if (isIsosurface) {
                  ...
                  var ce =
                    scheme == null
                      ? this.getShapeProperty(shapeType, 'colorEncoder')
                      : null;
                  if (
                    ce == null &&
                    (ce = this.vwr.cm.getColorEncoder(scheme)) == null
                  )
                    return;
                  ce.isTranslucent =
                    isTranslucent && translucentLevel == 3.4028235e38;
                  ...
                  this.showString(
                    this.getShapeProperty(shapeType, 'dataRangeStr').$replace(
                      '\n',
                      ' ',
                    ),
                  );
          ...
          if (isColor) {
            ...
            if (
              ...
              this.setShapeProperty(
                shapeType,
                'colorPhase',
                Clazz_newArray(-1, [colorvalue1, colorvalue]),
              );
            else if (bs == null)
              this.setShapeProperty(shapeType, prefix + 'color', colorvalue);
            else
              this.setShapePropertyBs(
                shapeType,
                prefix + 'color',
                colorvalue,
                bs,
        ...
        function (index, isOnly, allowAbsolute) {
          ...
          switch (tok) {
            ...
            case 1648363544:
              ...
              vdwType =
                tok == 1648363544
                  ? null
                  : J.c.VDW.getVdwType2(JS.T.nameOf(tok));
          ...
          switch (tok) {
            ...
            case 3:
              ...
              value = this.floatParameterRange(
                index,
                isOnly || !allowAbsolute ? -max : 0,
                max,
              );
          ...
          if (vdwType == null) {
            vdwType = J.c.VDW.getVdwType(
              this.optParameterAsString(++this.iToken),
            );
            if (vdwType == null) {
              this.iToken = index;
      ...
      Clazz_defineMethod(
        ...
        function (i) {
          ...
          var nColors =
            this.tokAt(this.iToken + 1) == 2
              ? this.intParameter(++this.iToken)
              : 0;
          return JU.ColorEncoder.getColorSchemeList(
            JU.ColorEncoder.getPaletteAtoB(color1, color2, nColors),
          );
        },
        '~N',
      );
        ...
        function (withType) {
          var filename =
            !this.chk || this.isCmdLine_C_Option
              ? this.vwr.fm.getFullPathName(true)
              : 'test.xyz';
      ...
      Clazz_defineMethod(
        ...
        function (id) {
          ...
          return this.getShapePropertyData(24, 'getBoundingBox', data) ||
            this.getShapePropertyData(29, 'getBoundingBox', data) ||
            this.getShapePropertyData(25, 'getBoundingBox', data) ||
            this.getShapePropertyData(28, 'getBoundingBox', data) ||
            this.getShapePropertyData(27, 'getBoundingBox', data)
            ? data[2]
            : null;
        },
        '~S',
      ...
      Clazz_defineMethod(
        ...
        function (axisID, index, modelIndex) {
          ...
          return this.getShapePropertyData(22, 'getCenter', data) ||
            this.getShapePropertyData(24, 'getCenter', data) ||
            this.getShapePropertyData(29, 'getCenter', data) ||
            this.getShapePropertyData(25, 'getCenter', data) ||
            this.getShapePropertyData(28, 'getCenter', data) ||
            this.getShapePropertyData(27, 'getCenter', data)
            ? data[2]
            : null;
        },
        '~S,~N,~N',
        ...
        function (index) {
          ...
          switch (this.getToken(this.checkLast(index)).tok) {
            ...
            case 3:
              ...
              return Float.isNaN(angstroms)
                ? 2147483647
                : Clazz_doubleToInt(Math.floor(angstroms * 10000 * 2));
          }
      ...
      Clazz_defineMethod(
        ...
        function (pt) {
          return pt >= this.slen
            ? NaN
            : JS.SV.fValue(this.parameterExpressionToken(pt));
        },
        '~N',
      );
      Clazz_defineMethod(
        ...
        function (pt) {
          return pt >= this.slen
            ? -2147483648
            : this.parameterExpressionToken(pt).asInt();
        },
        '~N',
      );
      Clazz_defineMethod(
        ...
        function (pt, isJmolSet) {
          return isJmolSet && this.slen == pt + 1
            ? this.paramAsStr(pt)
            : this.parameterExpressionToken(pt).asString();
        },
        '~N,~B',
      );
      Clazz_defineMethod(
        ...
        function (shapeType, propertyName) {
          return this.sm.getShapePropertyIndex(
            shapeType,
            propertyName,
            -2147483648,
          );
          ...
          if (zoom == 0 || currentZoom == 0) {
            ...
            if (bs == null) {
              switch (this.tokAt(ptCenter)) {
                ...
                case 1073742330:
                  var bbox = this.getObjectBoundingBox(
                    this.objectNameParameter(ptCenter + 1),
                  );
      ...
      Clazz_defineMethod(
        ...
        function (str, argb) {
          ...
          for (var i = JU.Elements.elementNumberMax; --i >= 0; ) {
            if (
              str.equalsIgnoreCase('_' + JU.Elements.elementSymbolFromNumber(i))
            ) {
              if (!this.chk) this.vwr.setElementArgb(i, argb);
              return true;
            }
          ...
          for (var i = JU.Elements.altElementMax; --i >= 4; ) {
            if (
              str.equalsIgnoreCase(
                '_' + JU.Elements.altElementSymbolFromIndex(i),
              )
            ) {
              if (!this.chk)
                this.vwr.setElementArgb(
            ...
            if (
              str.equalsIgnoreCase(
                '_' + JU.Elements.altIsotopeSymbolFromIndex(i),
              )
            ) {
              if (!this.chk)
                this.vwr.setElementArgb(
      ...
      Clazz_defineMethod(
        ...
        function (shape, i, tok) {
          ...
          if (this.tokAt(this.iToken + 1) != 0) {
            if (!this.setMeshDisplayProperty(shape, ++this.iToken, 0))
              --this.iToken;
          }
          return true;
        },
              ...
              switch (tokCommand) {
                ...
                case 1610625028:
                  this.setShapeProperty(
                    iShape,
                    'hidden',
                    tokCommand == 1610625028 ? Boolean.FALSE : Boolean.TRUE,
                  );
                  break;
                case 134222350:
      ...
      Clazz_defineMethod(c$, 'setObjectProperty', function () {
        var id = this.setShapeNameParameter(2);
        return this.chk
          ? ''
          : this.setObjectProp(id, this.tokAt(0), this.iToken);
      });
      Clazz_defineMethod(
        c$,
          ...
          if (isWild) {
            switch (this.tokAt(i + 1)) {
              ...
              case 12291:
                break;
              default:
                if (this.setMeshDisplayProperty(-1, 0, this.tokAt(i + 1)))
                  break;
      ...
      Clazz_defineMethod(
        ...
        function (shapeType, prefix, translucency, translucentLevel, bs) {
          if (translucentLevel == 3.4028235e38)
            translucentLevel = this.vwr.getFloat(570425353);
          this.setShapeProperty(
            shapeType,
            'translucentLevel',
      ...
      Clazz_defineMethod(
        ...
        function (shape, scale) {
          ...
          switch (tok) {
            ...
            case 2:
              isOnly =
                this.floatParameter(1) < 0 &&
                (tok == 3 || this.tokAt(2) == 268435634);
            default:
        ...
        function (iShape) {
          ...
          switch (this.getToken(1).tok) {
            ...
            case 1073741922:
              ...
              break;
            case 2:
              if ((mad = this.intParameterRange(1, 0, 1000) * 8) == 2147483647)
                return;
              break;
            case 3:
      ...
      Clazz_defineMethod(
        ...
        function (units, tok) {
          if (
            ...
            tok == 545259558 &&
            JU.PT.isOneOf(units.toLowerCase(), ';kcal;kj;')
          ) {
      ...
      Clazz_defineMethod(c$, 'toString', function () {
        var str = new JU.SB();
        str.append('Eval\n pc:');
        str.appendI(this.pc);
        str.append('\n');
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'getCmdExt', function () {
        return this.cmdExt == null
          ? (this.cmdExt = this.getExt('Cmd').init(this))
          : this.cmdExt;
      });
      Clazz_defineMethod(c$, 'getIsoExt', function () {
        return this.isoExt == null
          ? (this.isoExt = this.getExt('Iso').init(this))
          : this.isoExt;
      });
      Clazz_defineMethod(c$, 'getMathExt', function () {
        return this.mathExt == null
          ? (this.mathExt = this.getExt('Math')).init(this)
          : this.mathExt;
      });
      Clazz_defineMethod(c$, 'getSmilesExt', function () {
        return this.smilesExt == null
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var ptWithin = -1;
          var rpn = new JS.ScriptMathProcessor(
            this,
            isSpecialAssignment,
            isArrayItem,
            asVector,
          ...
          out: for (var i = pt; i < ptMax; i++) {
            ...
            if (isImplicitAtomProperty && this.tokAt(i + 1) != 1073742336) {
              var token =
                localVars != null && localVars.containsKey(this.theToken.value)
                  ? null
                  : this.getBitsetPropertySelector(i, 10);
              if (token != null) {
                rpn.addX(localVars.get(localVar));
                if (
                  !rpn.addOpAllowMath(token, this.tokAt(i + 1) == 268435472, 0)
                )
                  this.invArg();
                if (
                  (token.intValue == 134320141 || token.intValue == 102436) &&
                  this.tokAt(this.iToken + 1) != 268435472
                ) {
            ...
            switch (tok) {
              case 12290:
                if ((tok = this.tokAt(++i)) == 1073742325) {
                  ...
                  v = this.vwr.ms.getAtoms(
                    1094715393,
                    Integer.$valueOf(this.st[i].intValue),
                  );
                  break;
                } else if (tok == 12290 && this.tokAt(i + 1) == 2) {
                  v = this.vwr.ms.getAtomsFromAtomNumberInFrame(
                    this.st[++i].intValue,
                  );
                  break;
                } else {
                  v = this.getParameter(
                    JS.SV.sValue(this.st[i]),
                    1073742190,
                    true,
                  );
                }
              ...
              case 1275082241:
                ...
                if (isFunctionOfX) {
                  if (
                    this.getToken(++i).tok != 268435472 ||
                    !JS.T.tokAttr(this.getToken(++i).tok, 1073741824)
                  )
                    this.invArg();
                ...
                var bsAtoms = v;
                i = this.iToken;
                if (isFunctionOfX && this.getToken(i++).tok != 1073742339)
                  this.invArg();
              ...
              case 2:
                if (
                  this.tokAt(this.iToken + 1) == 1073742336 &&
                  ((tok = this.tokAt(this.iToken + 2)) == 805306401 ||
                    tok == 268435633)
                ) {
              ...
              case 134217750:
                if (this.tokAt(this.iToken + 1) == 268435472) {
                  if (!rpn.addOpAllowMath(this.theToken, true, 0))
                    this.invArg();
                  break;
                }
              case 1073742335:
              ...
              case 1073742330:
                if (
                  this.tokAt(i + 2) == 1073742336 &&
                  this.tokAt(i + 3) == 1275072526
                ) {
              ...
              case 1073742332:
                if (this.tokAt(i + 1) == 4) {
                  if (this.tokAt(i + 2) == 1073742338) {
                    v = this.chk
                      ? new JU.BS()
                      : this.getAtomBitSet(this.stringParameter(i + 1));
                    i += 2;
                    break;
                  }
              ...
              case 1073742325:
                if (this.tokAt(i + 1) == 1073742326) {
                  ...
                  this.tokAt(i + 1) == 1073742327 &&
                  this.tokAt(i + 2) == 1073742326
                ) {
                  tok = 1073742327;
                  this.iToken += 2;
                }
                ...
                if (this.tokAt(this.iToken + 1) == 1073742336) {
                  switch (tok2) {
                    case 1073742327:
                      tok2 = 480;
                      if (
                        this.tokAt(this.iToken + 3) == 1073742336 &&
                        this.tokAt(this.iToken + 4) == 1275068420
                      )
                        tok2 = 224;
                    case 1275068725:
                    case 32:
              ...
              default:
                if (
                  this.theTok == 268435520 &&
                  this.tokAt(i + 2) == 268435490
                ) {
                  v = this.getAssocArray(i);
                  i = this.iToken;
                  break;
                ...
                if (
                  ...
                  if (!haveParens)
                    if (this.chk) {
                      ...
                      localVars == null ||
                      ((v = JU.PT.getMapValueNoCase(localVars, name)) == null &&
                        allContext)
                    ) {
                  ...
                  if (v == null) {
                    if (
                      JS.T.tokAttr(this.theTok, 1073741824) &&
                      this.isFunction(name)
                    ) {
                      if (
                        !rpn.addOp(JS.SV.newV(134320141, this.theToken.value))
                      )
                        this.invArg();
                      if (!haveParens) {
                        rpn.addOp(JS.T.tokenLeftParen);
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          expression_loop: for (var pc = pcStart; pc < pcStop; ++pc) {
            ...
            switch (instruction.tok) {
              ...
              case 1073742332:
                ...
                break;
              case 1073742338:
                if (pc > 0 && code[pc - 1].tok == 1073742332)
              ...
              case 6:
                rpn.addXBs(
                  this.vwr.ms.getAtoms(1086324744, instruction.asString()),
                );
                break;
              case 134219777:
              ...
              case 4:
                ...
                if (s.equals('hkl')) {
                  rpn.addX(
                    JS.SV.newV(9, this.hklParameter(pc + 2, null, true)),
                  );
                  pc = this.iToken;
                }
                break;
              ...
              case 2097192:
                rpn.addXBs(
                  JU.BSUtil.copyInvert(this.vwr.slm.getHiddenSet(), ac),
                );
                break;
              case 2097200:
              ...
              case 2097198:
                rpn.addXBs(
                  this.chk
                    ? new JU.BS()
                    : JU.BSUtil.copy(this.vwr.ms.getVisibleSet(!refreshed)),
                );
                refreshed = true;
                break;
              case 2097190:
                ...
                rpn.addXBs(
                  this.chk
                    ? new JU.BS()
                    : this.vwr.ms.getClickableSet(!allowRefresh),
                );
                allowRefresh = false;
                break;
              case 1073742356:
                if (this.vwr.ms.mc != 1 || this.vwr.ms.haveBioModels) {
                  ...
                  if (atomID > 0) {
                    ...
                    if (atomID == 2)
                      bs.or(this.compareInt(1086326789, 268435860, 20));
                    rpn.addXBs(bs);
                  } else {
              ...
              case 1073742359:
                ...
                if (iModel == 2147483647 && Clazz_instanceOf(value, Integer)) {
                  ...
                  if (!this.vwr.haveFileSet()) {
                    rpn.addXBs(
                      this.getAtomBits(1073742358, Integer.$valueOf(iModel)),
                    );
                    break;
                  }
              ...
              case 1073742362:
                if (isInMath) rpn.addXNum(instruction);
                  ...
                  rpn.addXBs(
                    this.getAtomBits(
                      1073742362,
                      Integer.$valueOf(JS.ScriptExpr.getSeqCode(instruction)),
                    ),
                  );
                break;
              case 1073742363:
                ...
                var chainID =
                  pc + 3 < code.length &&
                  code[pc + 2].tok == 268435584 &&
                  code[pc + 3].tok == 1073742357
                    ? code[pc + 3].intValue
                    : -1;
                rpn.addXBs(
                  this.getAtomBits(
                    1073742363,
                    Clazz_newIntArray(-1, [
                      JS.ScriptExpr.getSeqCode(instruction),
                      JS.ScriptExpr.getSeqCode(code[++pc]),
                      chainID,
                    ]),
                  ),
                );
              ...
              case 268435862:
                ...
                if (tokWhat == 1715472409) {
                  ...
                  if (!this.chk)
                    data = this.vwr.getDataObj(code[++pc].value, null, 1);
                }
                if (++pc == code.length) this.invArg();
                rpn.addXBs(
                  this.chk
                    ? new JU.BS()
                    : this.getComparison(code[pc], tokWhat, tok, value, data),
                );
                break;
              case 3:
              case 2:
              ...
              default:
                ...
                if (
                  Clazz_instanceOf(val, String) ||
                  Clazz_instanceOf(val, JU.Lst)
                )
                  val = this.getStringObjectAsVariable(val);
                if (Clazz_instanceOf(val, String))
                  val = this.lookupIdentifierValue(value);
                rpn.addXObj(val);
                break;
            }
          }
          ...
          if (
            Clazz_instanceOf(exp, String) &&
            (ret == null || exp.startsWith('({'))
          ) {
          ...
          if (
            !this.isBondSet &&
            (bs = this.vwr.slm.excludeAtoms(bs, ignoreSubset)).length() >
              this.vwr.ms.ac
          )
            bs.clearAll();
      ...
      Clazz_defineMethod(
        ...
        function (t, tokWhat, tokOp, strOp, data) {
          ...
          var isFloatProperty =
            JS.T.tokAttr(tokWhat, 1111490560) ||
            (tokWhat & 1136656384) == 1077936128;
          var isIntOrFloat = isIntProperty && isFloatProperty;
          var isStringProperty =
            !isIntProperty && JS.T.tokAttr(tokWhat, 1086324736);
          if (tokWhat == 1086326789)
          ...
          if (JS.T.tokAttr(tokValue, 1073741824)) {
            if ('_modelNumber'.equalsIgnoreCase(val)) {
              ...
              val = Integer.$valueOf(
                (comparisonInt =
                  modelIndex < 0 ? 0 : this.vwr.getModelFileNumber(modelIndex)),
              );
            } else {
              var v = this.getParameter(val, 1073742190, false);
              if (v != null) {
                if (v.tok == 7)
                  return this.getComparison(v, tokWhat, tokOp, strOp, data);
            ...
            if (tokWhat == 1765808134) {
              ...
              if (
                ...
                isStringProperty = !(isIntProperty =
                  comparisonInt != 2147483647);
              else val = JS.SV.nValue(t);
              if (Clazz_instanceOf(val, Integer))
                comparisonFloat = comparisonInt = val.intValue();
              else if (Clazz_instanceOf(val, Float) && isModel)
                comparisonInt = JM.ModelSet.modelFileNumberFromFloat(
                  val.floatValue(),
                );
            }
          }
          ...
          return isIntProperty
            ? this.compareInt(tokWhat, tokOp, comparisonInt)
            : isStringProperty
            ? this.compareString(tokWhat, tokOp, val)
            : this.compareFloatData(tokWhat, data, tokOp, comparisonFloat);
        },
        'JS.T,~N,~N,~S,~A',
      );
      Clazz_defineMethod(
      ...
      Clazz_defineMethod(
        ...
        function (i) {
          ...
          for (i = i + 1; i < this.slen; i++) {
            ...
            var v = this.parameterExpression(
              i,
              0,
              null,
              false,
        ...
        function (tokWhat, data, tokOperator, comparisonFloat) {
          ...
          for (var i = ac; --i >= 0; ) {
            ...
            if (isProp) {
              ...
              propertyFloat = atom.atomPropertyFloat(
                this.vwr,
                tokWhat,
                this.ptTemp,
              );
            }
            match = this.compareFloat(
              tokOperator,
              propertyFloat,
              comparisonFloat,
            );
      ...
      Clazz_defineMethod(
        ...
        function (tokWhat, tokOperator, comparisonString) {
          ...
          var ac = this.vwr.ms.ac;
          var isCaseSensitive =
            tokOperator == 268435862 ||
            (tokWhat == 1086326788 && this.vwr.getBoolean(603979822));
          if (!isCaseSensitive)
      ...
      Clazz_defineMethod(
        ...
        function (tokOperator, propertyValue, comparisonValue) {
          switch (tokOperator) {
            ...
            case 268435861:
              return (
                JU.PT.isMatch(propertyValue, comparisonValue, true, true) ==
                (tokOperator == 268435860)
              );
            case 268435862:
            ...
            case 1094713347:
              try {
                switch (tokOperator) {
                  ...
                  case 268435860:
                    return ival < ac
                      ? JU.BSUtil.newBitSet2(ival, ival + 1)
                      : new JU.BS();
                  case 268435861:
                  default:
            ...
            switch (tokWhat) {
              ...
              case 1094717448:
                return JU.BSUtil.copy(
                  this.vwr.ms.getConformation(-1, ival - 1, false, null),
                );
              case 1296041985:
                ...
                if (bitsetBaseValue >= 200) {
                  ...
                  if (symop < 0) {
                    ...
                    nOps == 0 ||
                    (symop >= 0 && !(match = propertyBitSet.get(symop)))
                  ) {
                    continue;
                  }
                  ...
                  if (ival > nOps) {
                    if (
                      bitsetComparator != 268435859 &&
                      bitsetComparator != 268435858
                    )
                      continue;
                  }
        ...
        function (i, xTok) {
          ...
          switch (tok) {
            ...
            case 1715472409:
              break;
            default:
              if (JS.T.tokAttrOr(tok, 1077936128, 1140850688) || xTok == 6)
                break;
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var isAtoms =
            haveIndex ||
            (!Clazz_instanceOf(tokenValue, JM.BondSet) &&
              !Clazz_instanceOf(bs, JM.BondSet));
          ...
          switch (tok) {
            case 1275068446:
              return this.vwr
                .getModelSetAuxiliaryInfoForAtoms(bs)
                .get('models');
            case 1145047050:
            case 1145047055:
            case 1145047051:
            ...
            default:
              isInt =
                JS.T.tokAttr(tok, 1094713344) && !JS.T.tokAttr(tok, 1111490560);
              isString = !isInt && JS.T.tokAttr(tok, 1086324736);
          }
          var pt = isPt || !isAtoms ? new JU.P3() : null;
          if (
            isExplicitlyAll ||
            (isString && !haveIndex && minmaxtype != 256 && minmaxtype != 32)
          )
          ...
          switch (tok) {
            ...
            case 1677721602:
              ...
              bsNew =
                tok == 1140850689
                  ? isAtoms
                    ? bs
                    : this.vwr.ms.getAtoms(1677721602, bs)
                  : isAtoms
                  ? JM.BondSet.newBS(
                      this.vwr.getBondsForSelectedAtoms(bs),
                      null,
                    )
                  : bs;
              var i;
            ...
            case 1086324745:
              switch (minmaxtype) {
                case 0:
                case 1073742327:
                  return this.getCmdExt().getBitsetIdent(
                    bs,
                    null,
                    tokenValue,
                    useAtomMap,
          ...
          if (isAtoms) {
            ...
            for (
              var i = i0;
              i >= 0 && i < i1;
              i = haveBitSet ? bs.nextSetBit(i + 1) : i + 1
            ) {
              n++;
              var atom;
              if (pts == null) {
              ...
              switch (mode) {
                case 0:
                  ...
                  switch (tok) {
                    ...
                    case 1275069443:
                      if (planeRef != null)
                        fv = JU.Measure.distanceToPlane(planeRef, atom);
                      else
                        fv =
                          pts != null
                            ? JS.SV.ptValue(pts.get(i)).distance(ptRef)
                            : atom !== ptRef || minmaxtype != 32
                            ? atom.distance(ptRef)
                            : NaN;
                      break;
                    default:
                  ...
                  if (
                    fv == 3.4028235e38 ||
                    (Float.isNaN(fv) && minmaxtype != 1073742327)
                  ) {
                    n--;
                    continue;
                  }
                ...
                case 3:
                  ...
                  switch (minmaxtype) {
                    ...
                    case 1073742327:
                      vout.addLast(
                        t == null ? Integer.$valueOf(-1) : JU.P3.newP(t),
                      );
                      break;
                    default:
                      if (t == null) n--;
              ...
              switch (tok) {
                ...
                case 1765808134:
                  JU.CU.colorPtFromInt(
                    this.vwr.gdata.getColorArgbOrGray(bond.colix),
                    ptT,
                  );
                  switch (minmaxtype) {
                    case 1073742327:
          ...
          if (isPt)
            return n == 0
              ? Integer.$valueOf(-1)
              : JU.P3.new3(pt.x / n, pt.y / n, pt.z / n);
          if (isHash) return new java.util.Hashtable();
          if (n == 0 || (n == 1 && minmaxtype == 192))
            return Float.$valueOf(NaN);
          if (isInt) {
            switch (minmaxtype) {
              case 32:
              ...
              default:
                if (sum / n == Clazz_doubleToInt(sum / n))
                  return Integer.$valueOf(Clazz_doubleToInt(sum / n));
        ...
        function (m) {
          ...
          if (pt == 0) {
            ...
            var model2 =
              m == 0
                ? modelCount
                : this.vwr.ms.getModelNumberIndex(m + 1000001, false, false);
            if (model1 < 0) model1 = 0;
            if (model2 < 0) model2 = modelCount;
            if (this.vwr.ms.isTrajectory(model1)) model2 = model1 + 1;
            for (var j = model1; j < model2; j++)
              bs.or(this.vwr.getModelUndeletedAtomsBitSet(j));
          } else {
            var modelIndex = this.vwr.ms.getModelNumberIndex(m, false, true);
            if (modelIndex >= 0)
              bs.or(this.vwr.getModelUndeletedAtomsBitSet(modelIndex));
          }
          return bs;
        },
        '~N',
      ...
      Clazz_defineMethod(
        ...
        function (tokType, specInfo) {
          return this.chk
            ? new JU.BS()
            : this.vwr.ms.getAtoms(tokType, specInfo);
        },
        '~N,~O',
      );
      c$.getSeqCode = Clazz_defineMethod(
        c$,
        'getSeqCode',
        function (instruction) {
          return instruction.intValue == 2147483647
            ? instruction.value.intValue()
            : JM.Group.getSeqcodeFor(instruction.intValue, ' ');
        },
        'JS.T',
      );
      Clazz_defineMethod(
        ...
        function (pt, ptMax, key, isSet) {
          ...
          var isExpression =
            this.tokAt(1) == 1073742325 || this.tokAt(1) == 268435472;
          var t = settingData
            ? null
            : key.length == 0
            ? new JS.SV()
            : this.getContextVariableAsVariable(key, false);
                  ...
                  case 0:
                    if (propertyName.startsWith('property_')) {
                      ...
                      if (tv.tok == 7) {
                        ...
                        obj =
                          JS.SV.getArrayDepth(tv) > 1
                            ? JS.SV.fflistValue(tv, nmin)
                            : JS.SV.flistValue(tv, nmin);
                      } else {
                        obj = tv.asString();
                      }
                      this.vwr.setData(
                        ...
                        0,
                        0,
                        tv.tok == 7 ? 2147483647 : -2147483648,
                        0,
                      );
                      break;
                    }
          ...
          var needVariable =
            ...
            (isThrown ||
              !(
                Clazz_instanceOf(tv.value, String) ||
                tv.tok == 2 ||
                Clazz_instanceOf(tv.value, Integer) ||
                Clazz_instanceOf(tv.value, Float) ||
                Clazz_instanceOf(tv.value, Boolean)
              ));
          if (needVariable && key != null) {
            if (
              key.startsWith('_') ||
              (t = this.vwr.g.getAndSetNewVariable(key, true)) == null
            )
              this.errorStr(22, key);
          }
      ...
      Clazz_defineMethod(
        ...
        function (bs, tok, iValue, fValue, tokenValue) {
              ...
              switch (tokenValue.tok) {
                ...
                case 7:
                  ...
                  this.vwr.setAtomCoords(
                    bs,
                    tok,
                    this.getPointArray(-1, nValues, true),
                  );
                  break;
              }
              return;
              ...
              switch (tokenValue.tok) {
                case 7:
                  ...
                  for (var i = nValues; --i >= 0; ) {
                    ...
                    if (values[i] == 0)
                      this.errorStr2(50, 'ARRAY', svi.asString());
                  }
                  value = values;
                  prop = 'colorValues';
                  break;
                case 8:
                  value = Integer.$valueOf(
                    JU.CU.colorPtToFFRGB(tokenValue.value),
                  );
                  break;
                case 4:
          ...
          switch (tokenValue.tok) {
            ...
            case 4:
              if (sValue == null)
                list = JU.PT.getTokens(JS.SV.sValue(tokenValue));
              break;
          }
          if (list != null) {
            nValues = list.length;
            if (!isStrProperty) {
              ...
              for (var i = nValues; --i >= 0; )
                fvalues[i] =
                  tok == 1086326789
                    ? JU.Elements.elementNumberFromSymbol(list[i], false)
                    : JU.PT.parseFloat(list[i]);
            }
          ...
          for (i = pt0; i < this.slen; i++) {
            ...
            switch ((tok = this.getToken(i).tok)) {
              ...
              case 12290:
                ...
                var isSetAt =
                  pt0 == 1 && j == 1 && this.st[0] === JS.T.tokenSetCmd;
                if (isClauseDefine) {
                ...
                tok = this.tokAt(0);
                forceString = new Boolean(
                  forceString | (JS.T.tokAttr(tok, 20480) || tok == 134222850),
                ).valueOf();
                if (v == null) {
                  ...
                  if (Clazz_instanceOf(v, JS.SV)) {
                    ...
                    if (isExpression && !forceString) {
                      fixed[j] =
                        s.indexOf('|') >= 0 ||
                        JS.T.tokAttr(fixed[j - 1].tok, 268435712)
                          ? JS.T.o(4, s)
                          : JS.T.o(10, this.getAtomBitSet(s));
                    } else {
                      tok = isSetAt
                        ? JS.T.getTokFromName(s)
                        : isClauseDefine ||
                          forceString ||
                          s.length == 0 ||
                          s.indexOf('.') >= 0 ||
                  ...
                  fixed[j] = JS.SV.newV(
                    Clazz_instanceOf(v, JU.M4) ? 12 : 11,
                    v,
                  );
                } else if (
                  Clazz_instanceOf(v, java.util.Map) ||
                  (Clazz_instanceOf(v, JS.ScriptContext) &&
                    (v = v.getFullMap()) != null)
                ) {
                  fixed[j] = JS.SV.newV(
                    6,
                    isExpression ? v : JS.SV.deepCopy(v, true, true),
                  );
                ...
                if (isSetAt && !JS.T.tokAttr(fixed[j].tok, 536870912))
                  this.invArg();
                break;
            }
            j++;
  ...
  Clazz_load(null, 'JS.ScriptFlowContext', ['JS.ScriptCompiler'], function () {
    ...
    Clazz_defineMethod(
      ...
      function (nLevelsUp) {
        ...
        while (
          f != null &&
          (!JS.ScriptCompiler.isBreakableContext(f.token.tok) ||
            nLevelsUp-- > 0)
        )
          f = f.parent;
    ...
    Clazz_defineMethod(
      ...
      function (offset) {
        ...
        var test =
          ...
          this.ptLine + (this.addLine == 0 ? 0 : this.addLine + offset) ==
    ...
    Clazz_defineMethod(c$, 'setLine', function () {
    ...
    Clazz_defineMethod(c$, 'path', function () {
      var s = '';
      var f = this;
      while (f != null) {
        s = f.ident + '-' + s;
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (contextVariables, params) {
          ...
          for (var i = this.names.size(); --i >= 0; ) {
            ...
            var $var =
              i < this.nParameters && i < nParams ? params.get(i) : null;
            if ($var != null && $var.tok != 7) $var = JS.SV.newT($var);
            contextVariables.put(
              name,
              $var == null ? JS.SV.newS('').setName(name) : $var,
            );
          }
          if (this.tok != 364558) {
            contextVariables.put(
          ...
          contextVariables.put(
            '_retval',
            JS.SV.newI(this.tok == 364558 ? 2147483647 : 0),
          );
        },
      ...
      c$.setFunction = Clazz_defineMethod(
        c$,
        'setFunction',
        function (
          $function,
          ...
          for (var i = 0; i < nCommands; i++) {
            ...
            $function.lineIndices[i] = Clazz_newIntArray(-1, [
              lineIndices[cmdpt0 + i][0] - chpt0,
              lineIndices[cmdpt0 + i][1] - chpt0,
            ]);
            aatoken[i] = lltoken.get(cmdpt0 + i);
            if (aatoken[i].length > 0) {
              var tokenCommand = aatoken[i][0];
              if (JS.T.tokAttr(tokenCommand.tok, 102400))
                tokenCommand.intValue -=
                  tokenCommand.intValue < 0 ? -cmdpt0 : cmdpt0;
            }
          }
      ...
      Clazz_overrideMethod(c$, 'getSignature', function () {
      ...
      Clazz_overrideMethod(c$, 'geTokens', function () {
        return this.aatoken;
      });
      Clazz_overrideMethod(c$, 'getName', function () {
        return this.name;
      });
      Clazz_overrideMethod(c$, 'getTok', function () {
        return this.tok;
      });
    },
  );
    ...
    function () {
      ...
      Clazz_makeConstructor(
        ...
        function (eval, why, millis) {
          Clazz_superConstructor(this, JS.ScriptInterruption, [
            eval,
            why,
            '!',
            millis == -2147483648 || eval.vwr.autoExit,
          ]);
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'getScriptQueue', function () {
        return this.scriptQueue;
      });
      Clazz_overrideMethod(c$, 'isScriptQueued', function () {
      ...
      Clazz_defineMethod(c$, 'newScriptEvaluator', function () {
        return J.api.Interface.getInterface(
          'JS.ScriptEval',
          this.vwr,
          'setOptions',
      ...
      Clazz_overrideMethod(c$, 'clearQueue', function () {
        this.scriptQueue.clear();
      });
      Clazz_overrideMethod(c$, 'waitForQueue', function () {
      ...
      Clazz_overrideMethod(c$, 'isQueueProcessing', function () {
        ...
        function (command) {
          for (var i = this.scriptQueue.size(); --i >= 0; ) {
            ...
            if (strScript.indexOf(command) == 0) {
              ...
              if (JU.Logger.debugging)
                JU.Logger.debug(
                  this.scriptQueue.size() + ' scripts; removed: ' + strScript,
                );
            }
          }
        },
      ...
      Clazz_defineMethod(
        ...
        function (startedByCommandWatcher) {
          ...
          this.queueThreads[pt] = new JS.ScriptQueueThread(
            this,
            this.vwr,
            startedByCommandWatcher,
            pt,
          );
      ...
      Clazz_defineMethod(c$, 'interruptQueueThreads', function () {
        for (var i = 0; i < this.queueThreads.length; i++) {
          if (this.queueThreads[i] != null) this.queueThreads[i].interrupt();
        }
      });
      Clazz_defineMethod(c$, 'clearCommandWatcherThread', function () {
        if (this.commandWatcherThread == null) return;
      ...
      Clazz_defineMethod(c$, 'runScriptNow', function () {
      ...
      Clazz_overrideMethod(
        ...
        function (strFilename) {
          ...
          if (ptWait >= 0) {
            return this.evalStringWaitStatusQueued(
              'String',
              'script ' + JU.PT.esc(strFilename.substring(0, ptWait)),
              '',
              false,
              false,
            );
      ...
      Clazz_overrideMethod(
        ...
        function (returnType, strScript, statusList, isQuiet, isQueued) {
          ...
          var outputBuffer =
            statusList == null || statusList.equals('output')
              ? new JU.SB()
              : null;
      ...
      Clazz_overrideMethod(
        ...
        function (strScript, isQuiet, allowSyncScript) {
          ...
          if (this.eval.isPaused() && strScript.charAt(0) != '!')
            strScript = '!' + JU.PT.trim(strScript, '\n\r\t ');
          ...
          if (
            this.vwr.isScriptExecuting() &&
            (isInsert || this.eval.isPaused())
          ) {
          ...
          return this.addScript(
            strScript,
            isQuiet && !this.vwr.getBoolean(603979879),
          );
        },
        '~S,~B,~B',
      );
      Clazz_overrideMethod(
        ...
        function (str, isInsert) {
          ...
          JU.Logger.info(
            this.vwr.isSyntaxCheck
              ? haltType + ' -- stops script checking'
      ...
      Clazz_overrideMethod(
        ...
        function (eval, atomExpression) {
          ...
          return this.vwr.slm.excludeAtoms(
            eval.getAtomBitSet(atomExpression),
            false,
          );
        },
      ...
      Clazz_overrideMethod(
        ...
        function (strScript, returnContext) {
          ...
          return returnContext || sc.errorMessage == null
            ? sc
            : sc.errorMessage;
        },
        '~S,~B',
          ...
          try {
            ...
            if (fname.endsWith('jvxl')) {
              ...
              if (type == null) {
                try {
                  ...
                  type = JV.FileManager.determineSurfaceFileType(
                    JU.Rdr.getBufferedReader(bis, 'ISO-8859-1'),
                  );
                  if (type == null) {
                    cmd = 'script ' + JU.PT.esc(fname);
                    return;
              ...
              if (type.equals('spt::')) {
                cmd =
                  'script ' +
                  JU.PT.esc(
                    fname.startsWith('spt::') ? fname.substring(5) : fname,
                  );
                return;
              }
              if (type.equals('dssr')) {
                ...
                if (
                  cmd.toLowerCase().startsWith('zap') &&
                  (isCached || isAppend)
                )
                  cmd = cmd.substring(3);
                if (isAppend) {
            ...
            if (cmd == null && !noScript && this.vwr.scriptEditorVisible)
              this.vwr.showEditor(
                Clazz_newArray(-1, [
                  fname,
                  this.vwr.getFileAsString3(fname, true, null),
                ]),
              );
      ...
      Clazz_defineMethod(
        ...
        function (fname) {
          try {
            var data = this.vwr.fm.getEmbeddedFileState(
              fname,
              false,
              'state.spt',
            );
      ...
      Clazz_defineMethod(
        ...
        function (fileName) {
          ...
          var br = this.vwr.fm.getUnzippedReaderOrStreamFromName(
            fileName,
            null,
            true,
            false,
          ...
          if (this.vwr.fm.isZipStream(br)) {
            ...
            modelType = this.vwr
              .getModelAdapter()
              .getFileTypeName(JU.Rdr.getBR(zipDirectory));
          } else if (
            Clazz_instanceOf(br, java.io.BufferedReader) ||
            Clazz_instanceOf(br, java.io.BufferedInputStream)
          ) {
      ...
      c$.setStateScriptVersion = Clazz_defineMethod(
        c$,
          ...
          if (version != null) {
            ...
            try {
              ...
              if (main != -2147483648 && sub != -2147483648) {
                var ver = (vwr.stateScriptVersionInt =
                  main * 10000 + sub * 100 + minor);
                vwr.setBooleanProperty('legacyautobonding', ver < 110924);
                vwr.setBooleanProperty('legacyHAddition', ver < 130117);
                if (!vwr.getBoolean(603979831))
                  vwr.setBooleanProperty(
                    'legacyjavafloat',
      ...
      Clazz_overrideMethod(
        ...
        function (bsAtoms, vConnections, pts, htParams) {
          ...
          var modelIndex =
            iatom < 0 ? this.vwr.am.cmi : this.vwr.ms.at[iatom].mi;
          ...
          for (
            var i = 0, atomIndex = this.vwr.ms.ac;
            i < vConnections.size();
            i++, atomIndex++
          ) {
      ...
      Clazz_defineStatics(c$, 'prevCovalentVersion', 0);
    },
  );
  Clazz_declarePackage('JS');
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'endAssignment', function () {
        this.assignLeft = false;
        return (this.doSelections = false);
      });
      Clazz_defineMethod(c$, 'getResult', function () {
        var isOK = true;
        ...
        if (isOK) {
          if (this.asVector) {
            if (
              this.isAssignment &&
              ((this.xPt > 0 && this.oPt < 0) ||
                (this.oPt >= 0 && this.oStack[this.oPt] != null))
            )
              this.eval.invArg();
            var result = new JU.Lst();
            for (var i = 0; i <= this.xPt; i++)
              result.addLast(
                this.isSpecialAssignment
                  ? this.xStack[i]
                  : JS.SV.selectItemVar(this.xStack[i]),
              );
          ...
          if (this.xPt == 0) {
            ...
            if (
              ...
              x = JS.SV.selectItemVar(x);
            if (this.asBitSet && x.tok == 7)
              x = JS.SV.newV(10, JS.SV.unEscapeBitSetArray(x.value, false));
            return x;
          }
        }
      ...
      c$.isOpFunc = Clazz_defineMethod(
        c$,
        'isOpFunc',
        function (op) {
          return (
            op != null &&
            ((JS.T.tokAttr(op.tok, 134217728) &&
              op !== JS.T.tokenArraySquare) ||
              (op.tok == 268435665 && JS.T.tokAttr(op.intValue, 134217728)))
          );
        },
        'JS.T',
      );
      ...
      Clazz_defineMethod(
        ...
        function (op, allowMathFunc, tokNext) {
          ...
          this.skipping =
            this.ifPt >= 0 &&
            (this.ifStack[this.ifPt] == 'F' || this.ifStack[this.ifPt] == 'X');
          ...
          if (this.oPt >= 1 && op.tok != 268435472 && tok0 == 134217750)
          ...
          switch (op.tok) {
            ...
            case 268435649:
            case 268435650:
              if (this.wasX && op.intValue == -1 && this.addOp(JS.T.tokenComma))
            ...
            case 480:
              ...
              if (
                !this.wasX ||
                !(tok == 268435665 || tok == 1677721602 || tok == 1140850689)
              )
                return false;
          ...
          while (
            this.oPt >= 0 &&
            tok0 != 268435490 &&
            ((op.tok != 268435649 && op.tok != 268435650) || this.wasX) &&
            (!isLeftOp ||
              (tok0 == 268435665 &&
                (op.tok == 268435665 || op.tok == 268435520))) &&
            JS.T.getPrecedence(tok0) >= JS.T.getPrecedence(op.tok) &&
            (tok0 != 268435648 || op.tok != 268435648)
          ) {
          ...
          switch (op.tok) {
            ...
            case 268435665:
              this.wasX =
                !allowMathFunc || !JS.T.tokAttr(op.intValue, 134217728);
              break;
            case 1073742332:
              this.braceCount++;
              this.wasX = false;
            ...
            case 268435536:
              ...
              if (
                !this.wasSyntaxCheck &&
                this.xStack[this.xPt].tok != 10 &&
                this.xStack[this.xPt].tok != 7
              ) {
                ...
                if (tf == (op.tok == 268435536)) {
                  this.chk = true;
                  op =
                    op.tok == 268435536 ? JS.T.tokenOrTRUE : JS.T.tokenAndFALSE;
                }
              }
              this.wasX = false;
              break;
          ...
          switch (op.tok) {
            case 268435665:
              return (op.intValue & -481) == 134320141 &&
                op.intValue != 134320141
      ...
      Clazz_defineMethod(c$, 'doSelection', function () {
        if (this.xPt < 0 || (this.xPt == 0 && !this.isArrayItem)) {
          return false;
        }
        var var1 = this.xStack[this.xPt--];
        var $var = this.xStack[this.xPt];
        if (($var.tok == 7 || $var.tok == 15) && $var.intValue != 2147483647)
          if (var1.tok == 4 || (this.assignLeft && this.squareCount == 1)) {
            this.xStack[this.xPt] = $var = JS.SV.selectItemTok(
              $var,
              -2147483648,
            );
          }
        ...
        switch ($var.tok) {
          ...
          case 12:
            if (
              this.doSelections ||
              ($var.tok == 7 && $var.intValue == 2147483647)
            ) {
      ...
      Clazz_defineMethod(
        ...
        function (message) {
          ...
          for (var i = 0; i <= this.xPt; i++)
            JU.Logger.debug('x[' + i + ']: ' + this.xStack[i]);

          JU.Logger.debug('\n');
          for (var i = 0; i <= this.oPt; i++)
            JU.Logger.debug(
              'o[' +
                i +
                ']: ' +
                ...
                (this.oStack[i] == null
                  ? '--'
                  : '' + JS.T.getPrecedence(this.oStack[i].tok)),
            );
      ...
      Clazz_defineMethod(c$, 'getX', function () {
      ...
      Clazz_defineMethod(c$, 'getXTok', function () {
      ...
      Clazz_defineMethod(c$, 'operate', function () {
        var op = this.oStack[this.oPt--];
        var pt;
        var m;
        var m4;
              ...
              case 10:
                return this.addXBs(
                  JU.BSUtil.copyInvert(
                    x2.value,
                    Clazz_instanceOf(x2.value, JM.BondSet)
            ...
            switch (iv) {
              ...
              case 1073741824:
                return (
                  ...
                  (this.chk
                    ? this.addXStr('')
                    : this.getAllProperties(x2, op.value))
                );
              case 1140850696:
              ...
              case 1275068425:
              case 1140850694:
                if (iv == 1140850691 && Clazz_instanceOf(x2.value, JM.BondSet))
                  break;
              ...
              case 1765808134:
                switch (x2.tok) {
                  ...
                  case 7:
                    return this.addXPt(
                      JU.CU.colorPtFromString(JS.SV.sValue(x2)),
                    );
                  case 2:
                  case 3:
                    return this.addXPt(
                      this.vwr.getColorPointForPropertyValue(JS.SV.fValue(x2)),
                    );
                  case 8:
                    return this.addXStr(
                      JU.Escape.escapeColor(JU.CU.colorPtToFFRGB(x2.value)),
                    );
                  default:
                }
                break;
        ...
        x1 = this.getX();
        if (this.chk) {
          if (op === JS.T.tokenAndFALSE || op === JS.T.tokenOrTRUE)
            this.chk = false;
        ...
        function (op, x1, x2) {
          ...
          switch (op.tok) {
            ...
            case 268435538:
              ...
              return this.addXBs(
                JU.BSUtil.toggleInPlace(JU.BSUtil.copy(x1.value), x2.value),
              );
            case 268435858:
              return this.addXBool(
                x1.tok == 2 && x2.tok == 2
                  ? x1.intValue <= x2.intValue
                  : (x1.isNaN() && x2.isNaN()) || x1.asFloat() <= x2.asFloat(),
              );
            case 268435857:
              return this.addXBool(
                x1.tok == 2 && x2.tok == 2
            ...
            case 268435617:
              switch (x1.tok) {
                ...
                case 2:
                  if (!this.isDecimal(x2))
                    return this.addXInt(x1.intValue + x2.asInt());
                  break;
                case 4:
                  return this.addX(
                    JS.SV.newS(JS.SV.sValue(x1) + JS.SV.sValue(x2)),
                  );
                case 8:
                  ...
                  switch (x2.tok) {
                    ...
                    default:
                      f = x2.asFloat();
                      return this.addXPt(
                        JU.P3.new3(pt.x + f, pt.y + f, pt.z + f),
                      );
                  }
                case 11:
                  switch (x2.tok) {
                    ...
                    case 8:
                      return this.addXM4(
                        JS.ScriptMathProcessor.getMatrix4f(x1.value, x2.value),
                      );
                  }
                  break;
                case 12:
                ...
                case 9:
                  ...
                  switch (x2.tok) {
                    ...
                    case 9:
                      return this.addXPt4(
                        q1.mulQ(JU.Quat.newP4(x2.value)).toPoint4f(),
                      );
                  }
                case 7:
            ...
            case 268435616:
              switch (x1.tok) {
                case 2:
                  ...
                  break;
                case 4:
                  if (!this.isDecimal(x2) && !this.isDecimal(x1))
            ...
            case 1275068930:
              if (x1.tok == 8 && x2.tok == 8) {
                ...
                var pt2 = x2.value;
                return this.addXPt(
                  JU.P3.new3(pt.x * pt2.x, pt.y * pt2.y, pt.z * pt2.z),
                );
              }
            case 268435633:
              switch (x1.tok) {
                case 2:
                  return this.isDecimal(x2)
                    ? this.addXFloat(x1.intValue * x2.asFloat())
                    : this.addXInt(x1.intValue * x2.asInt());
                case 4:
                  return this.isDecimal(x2) || this.isDecimal(x1)
                    ? this.addXFloat(x1.asFloat() * x2.asFloat())
                    : this.addXInt(x1.asInt() * x2.asInt());
              }
              pt =
                x1.tok == 11 || x1.tok == 12
                  ? this.ptValue(x2, null)
                  : x2.tok == 11
                  ? this.ptValue(x1, null)
                  : null;
              pt4 =
                x1.tok == 12
                  ? this.eval.planeValue(x2)
                  : x2.tok == 12
                  ? this.eval.planeValue(x1)
                  : null;
              switch (x2.tok) {
                case 11:
                  if (pt != null) {
                    ...
                    return x1.tok == 7
                      ? this.addX(
                          JS.SV.getVariableAF(
                            Clazz_newFloatArray(-1, [pt1.x, pt1.y, pt1.z]),
                          ),
                        )
                      : this.addXPt(pt1);
                  }
              ...
              switch (x1.tok) {
                ...
                case 9:
                  if (x2.tok == 9)
                    return this.addXPt4(
                      JU.Quat.newP4(x1.value)
                        .mulQ(JU.Quat.newP4(x2.value))
                        .toPoint4f(),
                    );
                  return this.addXPt4(
                    JU.Quat.newP4(x1.value).mul(x2.asFloat()).toPoint4f(),
                  );
              }
              return this.addXFloat(x1.asFloat() * x2.asFloat());
            case 268435632:
              ...
              switch (x1.tok) {
                case 2:
                  if (x2.tok == 2 && x2.intValue != 0)
                    return this.addXInt(
                      Clazz_doubleToInt(x1.intValue / x2.intValue),
                    );
                  var n = this.isDecimal(x2) ? 0 : x2.asInt();
                  if (n != 0)
                    return this.addXInt(Clazz_doubleToInt(x1.intValue / n));
                  break;
                case 4:
                  var i2;
                  if (
                    ...
                    return this.addXInt(Clazz_doubleToInt(x1.asInt() / i2));
                  break;
                case 8:
                  pt = JU.P3.newP(x1.value);
                  return this.addXPt(
                    (f2 = x2.asFloat()) == 0
                      ...
                      : JU.P3.new3(pt.x / f2, pt.y / f2, pt.z / f2),
                  );
                case 9:
                  return this.addXPt4(
                    x2.tok == 9
                      ? JU.Quat.newP4(x1.value)
                          .div(JU.Quat.newP4(x2.value))
                          .toPoint4f()
                      : (f2 = x2.asFloat()) == 0
            ...
            case 268435635:
              ...
              if (x1.tok == 9) {
                return f == 0
                  ...
                  ? this.addXPt4(
                      JU.Quat.newP4(x1.value)
                        .divLeft(JU.Quat.newP4(x2.value))
                        .toPoint4f(),
                    )
                  : this.addXPt4(
                      JU.Quat.newP4(x1.value)
              ...
              return this.addXInt(
                f == 0
                  ? 0
                  : Clazz_doubleToInt(Math.floor(x1.asFloat() / x2.asFloat())),
              );
            case 268435651:
              f = Math.pow(x1.asFloat(), x2.asFloat());
              return x1.tok == 2 && x2.tok == 2
                ? this.addXInt(Clazz_floatToInt(f))
                : this.addXFloat(f);
            case 268435634:
              s = null;
              var n = x2.asInt();
              switch (x1.tok) {
                ...
                case 4:
                  ...
                  return this.addXStr(
                    n == 0
                      ...
                      ? s.toLowerCase()
                      : n > 0
                      ? JU.PT.formatS(s, n, n, false, false)
                      : JU.PT.formatS(s, n, n - 1, true, false),
                  );
                case 7:
                  ...
                  for (var i = 0; i < list.length; i++) {
                    if (n == 0) list[i] = list[i].trim();
                      ...
                      list[i] = JU.PT.formatS(list[i], n, n, true, false);
                ...
                case 9:
                  ...
                  if (x2.tok == 8)
                    return this.addXPt(
                      JU.Quat.newP4(pt4).transform2(x2.value, new JU.P3()),
                    );
                  if (x2.tok == 9) {
                    ...
                    case -6:
                      ...
                      return this.addXPt4(
                        JU.P4.new4(
                          ...
                          ax.y,
                          ax.z,
                          (ax.angle * 180) / 3.141592653589793,
                        ),
                      );
                    case -9:
      ...
      Clazz_defineMethod(
        ...
        function (x) {
          ...
          return (
            x.tok == 3 ||
            (x.tok == 4 &&
              ((s = JS.SV.sValue(x).trim()).indexOf('.') >= 0 ||
                s.indexOf('+') > 0 ||
                s.lastIndexOf('-') > 0))
          );
        },
        ...
        function (x, bsRestrict) {
          ...
          switch (x.tok) {
            ...
            case 7:
              pt = JU.Escape.uP(
                '{' +
                  JS.SV.sValue(x).$replace(']', ' ').$replace('[', ' ') +
                  '}',
              );
              if (Clazz_instanceOf(pt, JU.P3)) return pt;
              break;
        ...
        function (x) {
          ...
          switch (tok) {
            ...
            case 1073742334:
              return 'boolean';
            case 10:
              return Clazz_instanceOf(x.value, JM.BondSet)
                ? 'bondset'
                : 'bitset';
            case 2:
            case 3:
      ...
      Clazz_defineMethod(
        ...
        function (x2, abbr) {
          ...
          if (
            n == 0 ||
            !abbr.endsWith('?') ||
            (tokens = JS.T.getAtomPropertiesLike(
      ...
      c$.getMatrix4f = Clazz_defineMethod(
        c$,
        'getMatrix4f',
        function (matRotate, vTranslate) {
          return JU.M4.newMV(
            matRotate,
            vTranslate == null ? new JU.V3() : JU.V3.newV(vTranslate),
          );
        },
        'JU.M3,JU.T3',
      );
        ...
        function (op, x2) {
          switch (x2.tok) {
              ...
              switch (op.intValue) {
                ...
                case 1275068725:
                  return this.addXObj(
                    this.eval
                      .getMathExt()
                      .getMinMax(x2.getList(), op.intValue, true),
                  );
                case 1275334681:
                ...
                case 1140850693:
                  return this.addX(
                    x2.sortOrReverse(
                      op.intValue == 1140850693 ? -2147483648 : 1,
                    ),
                  );
              }
              var list2 = new Array(x2.getList().size());
              for (var i = 0; i < list2.length; i++) {
                var v = JS.SV.unescapePointOrBitsetAsVariable(
                  x2.getList().get(i),
                );
                if (
                  !Clazz_instanceOf(v, JS.SV) ||
                  !this.getPointOrBitsetOperation(op, v)
                )
                  return false;
            ...
            case 8:
              switch (op.intValue) {
                ...
                case 1145047051:
                  ...
                  return op.intValue == 1145047051
                    ? this.addXPt(ptf)
                    : this.addXFloat(
                        op.intValue == 1111492612
                          ? ptf.x
                          : op.intValue == 1111492613
                          ? ptf.y
                          : ptf.z,
                      );
                case 1111492615:
                ...
                case 1145047053:
                  ...
                  return op.intValue == 1145047053
                    ? this.addXPt(ptfu)
                    : this.addXFloat(
                        op.intValue == 1111492615
                          ? ptfu.x
                          : op.intValue == 1111492616
                          ? ptfu.y
                          : ptfu.z,
                      );
                case 1111490577:
                ...
                case 1145045006:
                  ...
                  return op.intValue == 1145045006
                    ? this.addXPt(ptu)
                    : this.addXFloat(
                        op.intValue == 1111490577
                          ? ptu.x
                          : op.intValue == 1111490578
                          ? ptu.y
                          : ptu.z,
                      );
              }
            ...
            case 10:
              ...
              if (!isAtoms && Clazz_instanceOf(x2.value, JM.BondSet))
                return this.addX(x2);
              var bs = x2.value;
              if (isAtoms && bs.cardinality() == 1 && (op.intValue & 480) == 0)
                op.intValue |= 32;
              var val = this.eval.getBitsetProperty(
                bs,
                null,
                op.intValue,
                null,
              ...
              return isAtoms
                ...
                : this.addX(
                    JS.SV.newV(
                      10,
                      JM.BondSet.newBS(val, this.vwr.ms.getAtomIndices(bs)),
                    ),
                  );
          }
          return false;
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function ($var, isLocal) {
          ...
          $var = $var.toLowerCase();
          return this.contextVariables != null &&
            this.contextVariables.containsKey($var)
            ? this.contextVariables.get($var)
            : isLocal || this.thisContext == null
            ? null
            : this.thisContext.getVariable($var);
        },
        '~S,~B',
      );
      Clazz_defineMethod(
      ...
      Clazz_defineMethod(
        ...
        'stringParameter',
        function (index) {
          if (!this.checkToken(index) || this.getToken(index).tok != 4)
            this.error(41);
        ...
        function (i, ret) {
          switch (this.getToken(i).tok) {
            ...
            case 1073742325:
              ...
              if (bs == null) {
                if (ret == null || !Clazz_instanceOf(ret[0], JU.P3))
                  this.invArg();
                return ret[0];
              }
              if (ret != null) {
              ...
              return bs.cardinality() == 1
                ? this.vwr.ms.at[bs.nextSetBit(0)]
            ...
            switch (this.getToken(i).tok) {
              ...
              case 1073742330:
                ...
                if (this.tokAt(i + 1) == 268435520) {
                  index = this.parameterExpressionList(-i - 1, -1, true)
                    .get(0)
                    .asInt();
                  if (this.getToken(--this.iToken).tok != 268435521)
                    this.invArg();
                }
                if (this.chk) return new JU.P3();
                if (
                  this.tokAt(i + 1) == 1073742336 &&
                  (this.tokAt(i + 2) == 1140850691 ||
                    this.tokAt(i + 2) == 1140850694)
                ) {
                  index = 2147483647;
                  this.iToken = i + 2;
                }
                if (
                  (center = this.getObjectCenter(id, index, modelIndex)) == null
                )
                  this.errorStr(12, id);
                break;
              case 10:
          ...
          try {
            if (i < this.slen) {
              switch (this.getToken(i).tok) {
                ...
                case 1073742325:
                  if (isBest) {
                    ...
                    if (this.getToken(++this.iToken).tok == 268435504)
                      ++this.iToken;
                    pt2 = this.atomCenterOrCoordinateParameter(
                      this.iToken,
                      null,
                    );
                    if (this.getToken(++this.iToken).tok == 268435504)
                    ...
                    if (this.isFloatParameter(this.iToken)) {
                      ...
                      pt3 = this.atomCenterOrCoordinateParameter(
                        this.iToken,
                        null,
                      );
                      i = this.iToken;
              ...
              if (isBest) {
                ...
                plane = new JU.P4();
                var norm = new JU.P3();
                var w = JU.Measure.getNormalThroughPoints(
                  pt1,
                  pt2,
                  pt3,
                  norm,
              ...
              if (!this.chk && JU.Logger.debugging)
                JU.Logger.debug(' defined plane: ' + plane);
            }
          } catch (e) {
            if (Clazz_exceptionOf(e, Exception)) {
              plane = null;
        ...
        function (t) {
          ...
          for (var j = 0; j < pts.size(); j++) {
            if ((pt = JS.SV.ptValue(pts.get(j))) != null) {
              ...
              data.addLast(
                bs.cardinality() == 1
                  ? JU.P3.newP(this.vwr.ms.at[bs.nextSetBit(0)])
                  : this.vwr.ms.getAtomSetCenter(bs),
              );
            } else {
              this.invArg();
      ...
      Clazz_defineMethod(
        ...
        function (i, pts, allowOffset) {
          ...
          if (!this.chk && JU.Logger.debugging)
            JU.Logger.debug('defined plane: ' + p);
          return p;
        },
        '~N,JU.Lst,~B',
      );
      Clazz_defineMethod(
        ...
        function (pt, offset, pts) {
          ...
          var v3 = new JU.V3();
          var plane = JU.Measure.getPlaneThroughPoints(
            pt1,
            pt2,
            pt3,
            new JU.V3(),
          ...
          try {
            ...
            out: for (var i = index; i < this.slen; i++) {
              switch (this.getToken(i).tok) {
                ...
                case 2:
                case 1073742362:
                  if (n == 6 || this.theToken.intValue == 2147483647)
                    this.invArg();
                ...
                case 1073742358:
                  ...
                  if (
                    Clazz_instanceOf(this.theToken.value, Integer) ||
                    this.theTok == 2
                  ) {
                    coord[n++] /=
                      this.theToken.intValue == 2147483647
      ...
      Clazz_defineMethod(
        ...
        function (i) {
          ...
          if (
            (isOK = itok == 8) ||
            itok == 9 ||
            (this.isFloatParameter(i + 1) &&
              this.isFloatParameter(i + 2) &&
              this.isFloatParameter(i + 3) &&
              this.isFloatParameter(i + 4))
          )
            return isOK;
          this.ignoreError = true;
          var t = this.iToken;
      ...
      Clazz_defineMethod(
        ...
        function (i, allowFractional, throwE) {
          return this.getPointOrPlane(
            i,
            3 | 32 | (allowFractional ? 16 : 0) | (throwE ? 0 : 128),
          );
        },
        '~N,~B,~B',
      );
      ...
      Clazz_defineMethod(
        ...
        function (index) {
          if (this.checkToken(index))
            if (this.getToken(index).tok == 2) return this.theToken.intValue;
          this.error(20);
          return 0;
        },
        '~N',
          ...
          switch (tok) {
            case 7:
              ...
              for (var j = 0; j < nPoints; j++)
                if ((points[j] = JS.SV.ptValue(v.get(j))) == null && !allowNull)
                  this.invArg();
      ...
      Clazz_defineMethod(
        ...
        function (i, nMin, nMax, allowString) {
          ...
          while (n < nMax) {
            tok = this.tokAt(i);
            if (
              (haveBrace && tok == 1073742338) ||
              (haveSquare && tok == 268435521)
            )
              break;
            switch (tok) {
              case 268435504:
            ...
            i +=
              n == nMax && haveSquare && this.tokAt(i + 1) == 1073742338
                ? 2
                : 1;
          }
          if (
            (haveBrace && this.tokAt(i++) != 1073742338) ||
            (haveSquare && this.tokAt(i++) != 268435521) ||
            n < nMin ||
            n > nMax
          )
            this.invArg();
        ...
        function (i, bsAtoms, divideByCurrent) {
          switch (this.tokAt(i)) {
            case 7:
              ...
              var p4 = null;
              if (sv.size() == 0 || (p4 = JS.SV.pt4Value(sv.get(0))) == null)
                this.invArg();
              return JU.Quat.newP4(p4);
            case 1073741864:
              return this.chk
                ? null
                : this.vwr.getOrientation(
                    1073741864,
                    divideByCurrent ? 'best' : '',
                    bsAtoms,
                  );
            default:
      ...
      Clazz_defineMethod(c$, 'checkLength23', function () {
        this.iToken = this.slen;
        if (this.slen != 2 && this.slen != 3) this.bad();
        return this.slen;
      });
      Clazz_defineMethod(c$, 'checkLength34', function () {
        this.iToken = this.slen;
      ...
      Clazz_defineMethod(c$, 'getMadParameter', function () {
        var mad = 1;
        ...
        switch (itok) {
          ...
          case 3:
            ...
            mad = Float.isNaN(f)
              ? 2147483647
              : Clazz_doubleToInt(Math.floor(f * 1000 * 2));
            if (mad < 0) {
              this.restrictSelected(false, false);
              mad = -mad;
            }
        ...
        function (t, i) {
          switch (t.tok) {
            ...
            case 7:
              ...
              var pts = t.getList();
              for (var j = 0; j < pts.size(); j++)
                if ((pt = JS.SV.ptValue(pts.get(j))) != null) data.addLast(pt);
                else return null;

              return data;
          }
          if (i > 0)
            return this.vwr.ms.getAtomPointVector(this.atomExpressionAt(i));
          return null;
        },
        'JS.T,~N',
      );
        ...
        function (i) {
          ...
          return (
            ...
            (tok == 570425378 ||
              ...
              tok == 8 ||
              this.isPoint3f(i) ||
              ((tok == 4 || JS.T.tokAttr(tok, 1073741824)) &&
                JU.CU.getArgbFromString(this.st[i].value) != 0))
          );
        },
        '~N',
      );
            ...
            switch (this.getToken(index).tok) {
              ...
              case 7:
                ...
                if (rgb != null && rgb.length != 3)
                  pt = JU.P3.new3(rgb[0], rgb[1], rgb[2]);
                break;
              case 8:
      ...
      Clazz_defineMethod(
        ...
        function (i) {
          ...
          if ((n = JU.CU.getArgbFromString('[' + hex + ']')) == 0)
            this.error(4);
          return n;
        },
        '~N',
      ...
      Clazz_defineMethod(
        ...
        function (index, allowUnitCell, allowScale, allowFirst) {
          ...
          if (
            ...
            this.tokAt(this.iToken + 1) == 1814695966
          ) {
          ...
          if (this.tokAt(this.iToken + 1) == 1287653388)
            tickInfo.tickLabelFormats = this.stringParameterSet(
              this.iToken + 2,
            );
          ...
          if (allowFirst)
            if (this.tokAt(this.iToken + 1) == 1073741942)
              ...
              switch (mode) {
                ...
                case 9:
                  p4 = JU.P4.new4(
                    ...
                    0,
                    0,
                    -f * JU.PT.parseFloat(s.substring(2)),
                  );
                  break;
                case 12:
                  p4 = JU.P4.new4(
  ...
  Clazz_load(
    ...
    function () {
          ...
          while (true) {
            switch (mode) {
              ...
              case 0:
                if (
                  this.stopped ||
                  this.scriptManager.getScriptQueue().size() == 0
                ) {
                  mode = -2;
                  break;
                }
      ...
      Clazz_defineMethod(c$, 'runNextScript', function () {
        var queue = this.scriptManager.getScriptQueue();
        if (queue.size() == 0) {
          return false;
        }
        var scriptItem = this.scriptManager.getScriptItem(
          false,
        ...
        this.vwr.evalStringWaitStatusQueued(
          returnType,
          script,
          statusList,
          isQuiet,
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'compileExpressions', function () {
        var isScriptExpression =
          (this.tokCommand == 134222850 || this.tokCommand == 4124) &&
          this.tokAt(2) == 268435472;
        this.isEmbeddedExpression =
          ...
          (this.tokCommand != 0 &&
            ((this.tokCommand != 134320141 &&
              this.tokCommand != 102436 &&
              this.tokCommand != 364558 &&
              this.tokCommand != 102412) ||
              this.tokenCommand.intValue != 2147483647) &&
            this.tokCommand != 102409 &&
            !JS.T.tokAttr(this.tokCommand, 12288) &&
            (this.nTokens > 2 || !JS.T.tokAttr(this.tokCommand, 20480)));
        this.isMathExpressionCommand =
          this.tokCommand == 1073741824 ||
          isScriptExpression ||
          JS.T.tokAttr(this.tokCommand, 36864);
        var checkExpression =
          this.isEmbeddedExpression || JS.T.tokAttr(this.tokCommand, 12288);
        if (this.tokAt(1) == 1073742330 && JS.T.tokAttr(this.tokCommand, 12288))
        ...
        return size == 1 || !JS.T.tokAttr(this.tokCommand, 262144)
          ? true
          : this.error(0);
      });
      Clazz_defineMethod(c$, 'compileExpression', function () {
        ...
        switch (this.tokCommand) {
          ...
          case 1610625028:
            ...
            if (
              tok == 1086324742 &&
              !JS.T.tokAttr(this.tokAt(firstToken + 1), 268435456)
            )
              firstToken++;
        }
        ...
        while (this.moreTokens()) {
          if (this.isEmbeddedExpression) {
            while (!this.isExpressionNext()) {
              if (
                ...
                !(this.tokCommand == 134223363 && this.itokenInfix == 1)
              ) {
                ...
                if (t != null)
                  if (
                    (!this.isMathExpressionCommand &&
                      this.lastToken.tok != 12290) ||
                    ((this.lastToken.tok == 1073742336 ||
                      this.tokAt(this.itokenInfix + 1) == 268435472) &&
          ...
          if (!this.isMathExpressionCommand)
            this.addTokenToPostfixToken(
              (tokenBegin = JS.T.o(1073742325, 'implicitExpressionBegin')),
            );
          if (
            !this.clauseOr(
          ...
          if (this.moreTokens()) {
            if (
              this.tokCommand != 1275082241 &&
              this.tokCommand != 12291 &&
              !this.isEmbeddedExpression
            )
              return this.error(5);
        ...
        this.atokenInfix = this.ltokenPostfix.toArray(
          new Array(this.ltokenPostfix.size()),
        );
        return true;
      });
      Clazz_defineMethod(
        ...
        function (name) {
          ...
          return (
            !this.isStateScript &&
            (this.vwr.isFunction(name) ||
              this.htUserFunctions.containsKey(name))
          );
        },
        '~S',
      );
      Clazz_defineMethod(c$, 'isExpressionNext', function () {
        return (
          (this.tokPeekIs(1073742332) &&
            !(
              this.tokAt(this.itokenInfix + 1) == 4 &&
              this.tokAt(this.itokenInfix + 2) == 268435490
            )) ||
          (!this.isMathExpressionCommand && this.tokPeekIs(268435472))
        );
      });
      c$.tokenAttr = Clazz_defineMethod(
        c$,
        'tokenAttr',
        function (token, tok) {
      ...
      Clazz_defineMethod(c$, 'moreTokens', function () {
      ...
      Clazz_defineMethod(c$, 'tokPeek', function () {
        return this.itokenInfix >= this.atokenInfix.length
          ? 0
      ...
      Clazz_defineMethod(c$, 'intPeek', function () {
        return this.itokenInfix >= this.atokenInfix.length
          ? 2147483647
          : this.atokenInfix[this.itokenInfix].intValue;
      });
      Clazz_defineMethod(c$, 'valuePeek', function () {
        return this.moreTokens()
          ? this.atokenInfix[this.itokenInfix].value
          : '';
      });
      Clazz_defineMethod(c$, 'tokenNext', function () {
        return this.itokenInfix >= this.atokenInfix.length
          ? null
      ...
      Clazz_defineMethod(c$, 'returnToken', function () {
        this.itokenInfix--;
        return false;
      });
      Clazz_defineMethod(c$, 'getToken', function () {
        this.theValue =
          (this.theToken = this.tokenNext()) == null
            ? null
            : this.theToken.value;
        return this.theToken;
      });
      Clazz_defineMethod(c$, 'getNumericalToken', function () {
        return (
          this.getToken() != null &&
          (this.theToken.tok == 2 || this.theToken.tok == 3)
        );
      });
      Clazz_defineMethod(c$, 'floatValue', function () {
            ...
            for (var i = this.ltokenPostfix.size(); --i >= 0 && pcount >= 0; ) {
              switch ((tok = this.ltokenPostfix.get(i).tok)) {
                ...
                case 268435520:
                  ...
                  if (
                    pcount == 1 &&
                    (tok2 = this.ltokenPostfix.get(i - 1).tok) != 268435473 &&
                    tok2 != 268435521
                  ) {
      ...
      Clazz_defineMethod(c$, 'addNextToken', function () {
      ...
      Clazz_defineMethod(
        ...
        function (allowCommaAsOr) {
          ...
          var tok;
          while (
            (tok = this.tokPeek()) == 268435536 ||
            tok == 268435537 ||
            tok == 268435538 ||
            (allowCommaAsOr && tok == 268435504)
          ) {
            if (tok == 268435504 && !this.haveString)
              this.addSubstituteTokenIf(268435504, JS.T.tokenOr);
            else this.addNextToken();
            if (!this.clauseAnd()) return false;
            if (
              allowCommaAsOr &&
              (this.lastToken.tok == 1073742338 || this.lastToken.tok == 10)
            )
      ...
      Clazz_defineMethod(c$, 'clauseAnd', function () {
      ...
      Clazz_defineMethod(c$, 'clauseNot', function () {
      ...
      Clazz_defineMethod(c$, 'clausePrimitive', function () {
      ...
      Clazz_defineMethod(
        ...
        function (isImplicitExpression) {
          ...
          if (isHash) {
            ...
            if (!this.tokPeekIs(1073742338) && !this.clauseOr(false))
              return false;
            var n = 1;
          ...
          if (
            isCoordinate &&
            (isImplicitExpression || this.isEmbeddedExpression)
          ) {
      ...
      Clazz_defineMethod(
        ...
        function (allowNumeric) {
          var tok;
          if (
            (tok = this.tokAt(this.itokenInfix + 1)) == 268435520 ||
            (allowNumeric && tok == 1073742332)
          )
            return true;
          while (true) {
      ...
      Clazz_defineMethod(
        ...
        function (isWithin) {
          ...
          if (isWithin && distance == 3.4028235e38)
            switch (tok0) {
              case 12290:
                break;
              case 1094713350:
                  ...
                  case 1073742332:
                    ...
                    this.addTokenToPostfixToken(
                      JS.T.getTokenFromName(
                        distance == 3.4028235e38 ? 'plane' : 'coord',
                      ),
                    );
                }
      ...
      Clazz_defineMethod(c$, 'clauseSubstructure', function () {
        this.addNextToken();
        if (!this.addNextTokenIf(268435472)) return false;
      ...
      Clazz_defineMethod(c$, 'clauseItemSelector', function () {
        var tok;
        var nparen = 0;
      ...
      Clazz_defineMethod(
        ...
        function (isOptional) {
          ...
          if (
            JS.ScriptTokenParser.tokenAttr(tokenAtomProperty, 1086324736) &&
            tokenComparator.tok != 268435860 &&
            tokenComparator.tok != 268435862 &&
            tokenComparator.tok != 268435861
          )
            return this.errorStr(15, '== !=');
          if (this.tokPeek() == 268435520) {
            ...
            while (true) {
              ...
              this.addTokenToPostfixToken(
                tokenComparator.tok == 268435861 ? JS.T.tokenAnd : JS.T.tokenOr,
              );
            }
            this.getToken();
            this.addTokenToPostfixToken(JS.T.tokenRightParen);
      ...
      Clazz_defineMethod(
        ...
        function (haveToken, forceString) {
          ...
          if (
            !this.addSubstituteTokenIf(1073742332, JS.T.tokenExpressionBegin)
          ) {
          ...
          return (
            ...
            this.checkForItemSelector(true)
          );
        },
        '~B,~B',
      );
      ...
      Clazz_defineMethod(c$, 'clauseResidueSpec', function () {
        var tok = this.tokPeek();
        this.residueSpecCodeGenerated = false;
      ...
      Clazz_defineMethod(c$, 'clauseResNameSpec', function () {
        this.getToken();
        var tok = this.tokPeek();
        switch (this.theToken.tok) {
          case 268435633:
          ...
          case 268435520:
            var strSpec = '';
            while (this.getToken() != null && this.theToken.tok != 268435521)
              strSpec += this.theValue;

            if (this.theToken == null) return false;
            if (strSpec === '') return true;
            var pt;
            return strSpec.length > 0 &&
              (pt = strSpec.indexOf('*')) >= 0 &&
              pt != strSpec.length - 1
              ? this.error(14)
              : this.generateResidueSpecCode(
                  JS.T.o(1073742360, strSpec.toUpperCase()),
                );
          default:
      ...
      Clazz_defineMethod(c$, 'clauseSequenceSpec', function () {
      ...
      Clazz_defineMethod(
        ...
        function (tok) {
          ...
          return this.generateResidueSpecCode(
            JS.T.tv(1073742357, chain, 'spec_chain'),
          );
        },
        '~N',
      );
      Clazz_defineMethod(c$, 'clauseAlternateSpec', function () {
        this.tokenNext();
      ...
      Clazz_defineMethod(c$, 'clauseModelSpec', function () {
        this.getToken();
        switch (this.tokPeek()) {
          case 268435633:
            this.getToken();
      ...
      Clazz_defineMethod(c$, 'clauseAtomSpec', function () {
        ...
        return this.generateResidueSpecCode(
          JS.T.tv(
            1073742356,
            this.vwr.getJBR().lookupSpecialAtomID(atomSpec.toUpperCase()),
            atomSpec,
          ),
        );
      });
      c$.errorString = Clazz_defineMethod(
        ...
        function (iError, value, more, translated) {
          ...
          switch (iError) {
            ...
            case 14:
              msg = J.i18n.GT.$(
                'residue specification (ALA, AL?, A*) expected',
              );
              break;
            case 15:
      ...
      Clazz_defineMethod(c$, 'commandExpected', function () {
        this.ichToken = this.ichCurrentCommand;
        return this.error(2);
      });
      Clazz_defineMethod(
      ...
      Clazz_defineMethod(
        ...
        'errorIntStr2',
        function (iError, value, more) {
          var strError = JS.ScriptTokenParser.errorString(
            iError,
            value,
            more,
            true,
          );
          var strUntranslated = J.i18n.GT.getDoTranslate()
            ? JS.ScriptTokenParser.errorString(iError, value, more, false)
            : null;
          return this.errorStr2(strError, strUntranslated);
        },
        '~N,~S,~S',
      );
      Clazz_defineMethod(c$, 'isError', function () {
