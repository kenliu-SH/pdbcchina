(function (
  ...
  Clazz_load(
    null,
    'JM.Text',
    ['java.lang.Float', 'JU.PT', 'J.shape.Shape', 'JU.C', '$.Font', 'JV.JC'],
    function () {
      ...
      c$.newMeasure = Clazz_defineMethod(
        c$,
        'newMeasure',
      ...
      Clazz_defineMethod(c$, 'getFontMetrics', function () {
      ...
      Clazz_defineMethod(
        ...
        function (scale) {
          ...
          if (this.fontScale != 0 && this.font != null)
            this.setFont(
              this.vwr.gdata.getFont3DScaled(this.font, scale),
              true,
            );
        },
        '~N',
      );
      Clazz_defineMethod(c$, 'recalc', function () {
        if (this.image != null) {
      ...
      Clazz_defineMethod(
        ...
        function (scalePixelsPerMicron, imageFontScaling, isAbsolute, boxXY) {
          ...
          this.setWindow(
            this.vwr.gdata.width,
            this.vwr.gdata.height,
            scalePixelsPerMicron,
          );
          ...
          if (this.doFormatText) {
            ...
            if (
              ...
              this.barPixels = Clazz_floatToInt(
                ret[0] * (this.vwr.antialiased ? 2 : 1),
              );
            ...
            if (
              ...
              dy =
                -this.getPymolXYOffset(
                  ...
                  dh,
                  pixelsPerAngstrom,
                ) - Clazz_doubleToInt((this.textHeight + dh) / 2);
        ...
        function (scale) {
          ...
          if (this.valign == 3 || this.valign == 4) {
            var x =
              this.movableXPercent != 2147483647
                ? Clazz_doubleToInt(
                    (this.movableXPercent * this.windowWidth) / 100,
                  )
                : is3dEcho
                ? this.movableX
                : this.movableX * scale;
            ...
            xLeft = 5 * scale;
            xCenter = Clazz_doubleToInt(
              (this.windowWidth + this.barPixels) / 2,
            );
          ...
          switch (this.valign) {
            ...
            default:
              var y =
                this.movableYPercent != 2147483647
                  ? Clazz_doubleToInt(
                      (this.movableYPercent * this.windowHeight) / 100,
                    )
                  : is3dEcho
                  ? this.movableY
                  : this.movableY * scale;
              this.boxXY[1] =
                (is3dEcho ? y : this.windowHeight - y) + this.offsetY * scale;
          }
          if (this.align == 8)
            this.boxXY[1] -=
              (this.image != null
            ...
            this.boxXY[1] -= Clazz_doubleToInt(this.ascent / 2);
        },
        '~N',
      );
      c$.setBoxXY = Clazz_defineMethod(
        c$,
        'setBoxXY',
        ...
        function (str) {
          ...
          for (var i = 0; i < len; i++) {
            if (str.charAt(i) == '<') {
              if (
                i + 8 <= len &&
                (str.substring(i, i + 7).equals('<color ') ||
                  str.substring(i, i + 8).equals('</color>'))
              ) {
              ...
              if (
                i + 5 <= len &&
                ((s = str.substring(i, i + 5)).equals('<sub>') ||
                  s.equals('<sup>'))
              ) {
                i += 4;
                f = subscale;
              ...
              if (
                i + 6 <= len &&
                ((s = str.substring(i, i + 6)).equals('</sub>') ||
                  s.equals('</sup>'))
              ) {
                i += 5;
                f = 1;
      ...
      Clazz_defineMethod(
        ...
        function (s) {
          ...
          if (this.scalePixelsPerMicron > 0)
            s.append(' ' + 10000 / this.scalePixelsPerMicron);
        },
        'JU.SB',
      );
      Clazz_defineMethod(
      ...
      Clazz_defineMethod(
        ...
        function (isAntialiased, x, y, bsVisible) {
          if (
            this.hidden ||
            this.script == null ||
            (this.modelIndex >= 0 && !bsVisible.get(this.modelIndex))
          )
            return false;
          if (isAntialiased) {
            x <<= 1;
        ...
        function (propertyName, value, bsSelected) {
          if ('text' === propertyName) {
            ...
            if (this.currentObject != null) {
              ...
              for (
                var t, $t = this.objects.values().iterator();
                $t.hasNext() && ((t = $t.next()) || true);
          ...
          if ('font' === propertyName) {
            ...
            if (this.currentObject != null) {
              ...
              for (
                ...
                t.setFont(this.currentFont, true);
            }
            return;
          }
          ...
          if ('align' === propertyName) {
            ...
            if (this.currentObject != null) {
              if (!this.currentObject.setAlignmentLCR(align))
                JU.Logger.error('unrecognized align:' + align);
            } else if (this.isAll) {
              for (
                var obj, $obj = this.objects.values().iterator();
                $obj.hasNext() && ((obj = $obj.next()) || true);
          ...
          var isBackground;
          if (
            (isBackground = 'bgtranslucency' === propertyName) ||
            'translucency' === propertyName
          ) {
            var isTranslucent = 'translucent' === value;
            if (isBackground)
              this.currentBgTranslucentLevel = isTranslucent
                ? this.translucentLevel
                : 0;
            else
              this.currentTranslucentLevel = isTranslucent
                ? this.translucentLevel
                : 0;
            if (this.currentObject != null) {
              this.currentObject.setTranslucent(
                this.translucentLevel,
                isBackground,
              );
            } else if (this.isAll) {
  ...
  Clazz_load(
    ...
    function () {
        ...
        function (propertyName, value, bs) {
          ...
          if ('label' === propertyName) {
            var isPicked =
              this.isPickingMode() &&
              bs.cardinality() == 1 &&
              bs.nextSetBit(0) == this.lastPicked;
            this.setScaling();
            var tokens = null;
            ...
            if (Clazz_instanceOf(value, JU.Lst)) {
              ...
              var strLabel = value;
              tokens =
                strLabel == null || strLabel.length == 0
          ...
          if ('fontsize' === propertyName) {
            ...
            if (this.setDefaults) {
              ...
              for (
                ...
                f = JU.Font.getFont3D(
                  this.fids == null || i >= this.fids.length
                    ? this.fids[i]
                    : this.defaultFontId,
                );
                this.setFont(
                  i,
                  this.vwr.getFont3D(f.fontFace, f.fontStyle, fontsize).fid,
                );
              }
            }
            return;
          ...
          if ('offset' === propertyName) {
            if (Clazz_instanceOf(value, Integer)) {
              ...
              for (
                ...
                this.setPymolOffset(i, value);
            }
            return;
          }
          if ('align' === propertyName) {
            var type = value;
            var hAlignment = type.equalsIgnoreCase('right')
              ? 12
              : type.equalsIgnoreCase('center')
              ? 8
              : 4;
            if (this.setDefaults) {
              ...
              if (i < nstr && this.strings[i] != null) {
                ...
                if (atom.getGroup3(false).equals('UNK')) {
                  ...
                  if (strLabelPDB == null) {
                    ...
                    tokensPDB = JM.LabelToken.compile(
                      this.vwr,
                      strLabelPDB,
                      '\0',
                      null,
                ...
                this.strings[i] = JM.LabelToken.formatLabelAtomArray(
                  this.vwr,
                  atom,
                  tokens,
                  '\0',
          ...
          if (propertyName === 'deleteModelAtoms') {
            ...
            this.fids = JU.AU.deleteElements(
              this.fids,
              firstAtomDeleted,
              nAtomsDeleted,
            );
            ...
            this.offsets = JU.AU.deleteElements(
              this.offsets,
              firstAtomDeleted,
              nAtomsDeleted,
            );
            this.formats = JU.AU.deleteElements(
              this.formats,
              firstAtomDeleted,
              nAtomsDeleted,
            );
            this.strings = JU.AU.deleteElements(
              this.strings,
              firstAtomDeleted,
              nAtomsDeleted,
            );
      ...
      Clazz_defineMethod(c$, 'isPickingMode', function () {
      ...
      Clazz_defineMethod(
        ...
        function (colix, n) {
          ...
          if (this.bgcolixes == null || n > this.bgcolixes.length)
            this.bgcolixes = JU.AU.ensureLengthShort(this.bgcolixes, n);
          return n;
        },
        '~N,~N',
      );
      Clazz_defineMethod(
        ...
        function (labels, bsSelected) {
          ...
          for (
            ...
            this.setPymolLabel(i, labels.get(Integer.$valueOf(i)), null);
        },
        'java.util.Map,JU.BS',
      );
      Clazz_defineMethod(
        ...
        function (i, value) {
          ...
          if (text == null) {
            if (
              ...
              return;
            var fid =
              this.bsFontSet != null && this.bsFontSet.get(i)
                ? this.fids[i]
                : -1;
            ...
            text = JM.Text.newLabel(
              this.vwr,
              JU.Font.getFont3D(fid),
              this.strings[i],
              this.getColix2(i, a, false),
              this.getColix2(i, a, true),
              0,
      ...
      Clazz_defineMethod(c$, 'setScaling', function () {
        this.isActive = true;
        ...
        this.scalePixelsPerMicron = this.isScaled
          ? this.vwr.getScalePixelsPerAngstrom(false) * 10000
          : 0;
      });
      Clazz_defineMethod(
        c$,
        ...
        function (i, t, format) {
          ...
          this.addString(
            ...
            i,
            label,
            format == null ? JU.PT.rep(label, '%', '%%') : format,
          );
      ...
      Clazz_defineMethod(
        ...
        function (temp, strLabel, i, doAll) {
          ...
          var tokens = temp[0];
          if (tokens == null)
            tokens = temp[0] = JM.LabelToken.compile(
              this.vwr,
              strLabel,
              '\0',
              null,
          ...
          if (!doAll) return;
          if (this.defaultOffset != JV.JC.LABEL_DEFAULT_OFFSET)
      ...
      Clazz_defineMethod(
        ...
        function (atom, i, label, strLabel) {
          ...
          this.formats[i] =
            notNull && strLabel.indexOf('%{') >= 0 ? label : strLabel;
      ...
      Clazz_overrideMethod(
        ...
        function (property, index) {
          if (property.equals('font'))
            return JU.Font.getFont3D(this.defaultFontId);
        ...
        function (prevX, prevY, x, y, dragAction, bsVisible) {
          ...
          if (prevX == -2147483648) {
            ...
            if (iAtom >= 0) {
              ...
              this.pickedY = y;
              this.pickedOffset =
                this.offsets == null || this.pickedAtom >= this.offsets.length
      ...
      Clazz_defineMethod(
        ...
        function (x, y) {
          ...
          var atoms = this.ms.at;
          for (
            var entry, $entry = this.labelBoxes.entrySet().iterator();
            $entry.hasNext() && ((entry = $entry.next()) || true);

          ) {
            if (!atoms[entry.getKey().intValue()].isVisible(this.vf | 9))
              continue;
      ...
      Clazz_defineMethod(
        ...
        function (i, atom, isBg) {
          ...
          if (isBg) {
            colix =
              this.bgcolixes == null || i >= this.bgcolixes.length
                ? 0
                : this.bgcolixes[i];
          } else {
            colix =
              this.colixes == null || i >= this.colixes.length
                ? 0
                : this.colixes[i];
            colix = JU.C.getColixInherited(colix, atom.colixAtom);
            if (JU.C.isColixTranslucent(colix))
              colix = JU.C.getColixTranslucent3(colix, false, 0);
          }
          return colix;
        },
        '~N,JM.Atom,~B',
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'getSelected', function () {
        ...
        function (propertyName, value, bsAtoms) {
          ...
          if ('clearModelIndex' === propertyName) {
            for (var i = 0; i < this.measurementCount; i++)
              this.measurements.get(i).setModelIndex(0);
          ...
          if ('pending' === propertyName) {
            ...
            if (this.mPending.count > 1)
              this.vwr.setStatusMeasuring(
                'measurePending',
                this.mPending.count,
                J.shape.Measures.getMessage(this.mPending, false),
                this.mPending.value,
              );
            return;
          }
          var isRefresh;
          if (
            (isRefresh = 'refresh' === propertyName) ||
            'refreshTrajectories' === propertyName
          ) {
            for (var i = this.measurements.size(); --i >= 0; )
              if (
                (mt = this.measurements.get(i)) != null &&
          ...
          if ('maps' === propertyName) {
            ...
            if (
              md.isAll &&
              md.points.size() == 2 &&
              Clazz_instanceOf(md.points.get(0), JU.BS)
            ) {
              var type = JM.Measurement.nmrType(
                this.vwr.getDistanceUnits(md.strFormat),
              );
              switch (type) {
                case 2:
          ...
          if ('deleteAtoms' === propertyName) {
            for (var i = this.measurementCount; --i >= 0; ) {
              out: for (
                ...
                iatom >= 0;
                iatom = bsAtoms.nextSetBit(iatom + 1)
              ) {
          ...
          if ('hide' === propertyName) {
            if (Clazz_instanceOf(value, String)) {
              ...
              this.showHideM(
                new JM.Measurement().setPoints(this.ms, value, null, null),
                true,
              );
            }
            return;
      ...
      Clazz_defineMethod(
        ...
        function (vector) {
          ...
          return new JM.Measurement().setPoints(
            ...
            indices,
            points,
            this.tickInfo == null ? this.defaultTickInfo : this.tickInfo,
          );
        },
        'JU.Lst',
      );
      Clazz_overrideMethod(
        ...
        function (property, index) {
          ...
          if ('countPlusIndices'.equals(property))
            return index < this.measurementCount
              ? this.measurements.get(index).countPlusIndices
              : null;
          if ('stringValue'.equals(property))
            return index < this.measurementCount
              ? this.measurements.get(index).getString()
              : null;
          if ('pointInfo'.equals(property))
            return this.measurements
              .get(Clazz_doubleToInt(index / 10))
              .getLabel(index % 10, false, false);
      ...
      Clazz_defineMethod(
        ...
        function (colix) {
          ...
          for (var i = this.measurements.size(); --i >= 0; )
            if (
              (mt = this.measurements.get(i)) != null &&
              ((this.bsSelected != null && this.bsSelected.get(i)) ||
                (this.bsSelected == null && (colix == 0 || mt.colix == 0)))
            ) {
              mt.colix = colix;
          ...
          if (isDefault || JM.Measurement.isUnits(format)) {
            ...
            for (var i = this.measurements.size(); --i >= 0; )
              if (this.bsSelected == null || this.bsSelected.get(i))
                this.measurements
                  .get(i)
                  .formatMeasurementAs(format, null, false);
          }
        },
        '~S',
      );
      Clazz_defineMethod(
        ...
        function (isHide) {
          for (var i = this.measurements.size(); --i >= 0; )
            if (this.bsSelected == null || this.bsSelected.get(i))
              this.measurements.get(i).isHidden = isHide;
        },
        '~B',
      );
      Clazz_defineMethod(
      ...
      Clazz_defineMethod(
        ...
        function (m) {
          ...
          var i = this.find(m);
          var mt;
          if (i >= 0 && !(mt = this.measurements.get(i)).isHidden)
      ...
      Clazz_defineMethod(
        ...
        function (indices) {
          ...
          this.htMin = null;
          this.bsSelected = new JU.BS();
          var m = new JM.Measurement().setPoints(
            this.ms,
            indices,
            null,
      ...
      Clazz_defineMethod(
        ...
        function (m) {
          ...
          var i = this.find(m);
          if (i >= 0)
            this.defineAll(i, this.measurements.get(i), true, false, false);
          this.setIndices();
        },
        'JM.Measurement',
      );
          ...
          for (var i = 1; i <= nPoints; i++) {
            ...
            points.addLast(
              atomIndex >= 0
                ? this.ms.getAtoms(
                    1094715393,
                    Integer.$valueOf(atoms[atomIndex].getAtomNumber()),
                  )
                : m.getAtom(i),
            );
          }
      ...
      Clazz_defineMethod(
        ...
        'find',
        function (m) {
          return m.thisID == null
            ? JM.Measurement.find(this.measurements, m)
            : -1;
        },
        'JM.Measurement',
      );
      Clazz_defineMethod(c$, 'setIndices', function () {
        for (var i = 0; i < this.measurementCount; i++)
        ...
        function (md, m) {
          ...
          if (iThis >= 0) {
            if (this.tokAction == 12291) {
              ...
              this.measurements.get(iThis).isHidden =
                this.tokAction == 1073742334;
            }
      ...
      Clazz_defineMethod(
        ...
        function (val, m) {
          return !(
            (this.htMin != null && !m.isMin(this.htMin)) ||
            (this.radiusData != null &&
              !m.isInRange(
                this.radiusData,
                val == val ? val : m.getMeasurement(null),
              ))
          );
        },
        '~N,JM.Measurement',
      ...
      Clazz_defineMethod(
        ...
        function (i, m, doSelect) {
          ...
          var measureNew = new JM.Measurement().setM(
            this.ms,
            m,
            value,
            m.colix == 0 ? this.colix : m.colix,
            this.strFormat,
          ...
          this.vwr.setStatusMeasuring(
            'measureCompleted',
            this.measurementCount++,
            J.shape.Measures.getMessage(measureNew, false),
            measureNew.value,
          );
        },
        '~N,JM.Measurement,~B',
      );
      c$.getMessage = Clazz_defineMethod(
        c$,
        'getMessage',
        function (m, asBitSet) {
          var sb = new JU.SB();
      ...
      Clazz_defineMethod(
        ...
        function (md, id, tok) {
          ...
          for (var i = this.measurements.size(); --i >= 0; ) {
            ...
            if (
              m.thisID != null &&
              (m.thisID.equalsIgnoreCase(id) ||
                (isWild &&
                  JU.PT.isMatch(m.thisID.toUpperCase(), id, true, true)))
            )
              switch (tok) {
                case 266284:
                  m.setFromMD(md, true);
                ...
                case 1665140738:
                  ...
                  break;
                case 12291:
                  var msg = J.shape.Measures.getMessage(
      ...
      Clazz_defineMethod(
        ...
        function (isDefault) {
          for (var i = this.measurementCount; --i >= 0; )
            this.measurements.get(i).reformatDistanceIfSelected(isDefault);
        },
        '~B',
      );
      Clazz_defineMethod(c$, 'getAllInfo', function () {
        var info = new JU.Lst();
        for (var i = 0; i < this.measurementCount; i++) {
      ...
      Clazz_defineMethod(c$, 'getAllInfoAsString', function () {
      ...
      Clazz_defineMethod(
        ...
        function (index) {
          ...
          info.put(
            'type',
            count == 2 ? 'distance' : count == 3 ? 'angle' : 'dihedral',
          );
          ...
          for (var i = 1; i <= count; i++) {
            ...
            atomInfo.put(
              'atomno',
              Integer.$valueOf(
                atomIndex < 0 ? -1 : atoms[atomIndex].getAtomNumber(),
              ),
            );
            atomInfo.put(
              'info',
              atomIndex < 0 ? '<point>' : atoms[atomIndex].getInfo(),
            );
      ...
      Clazz_defineMethod(c$, 'setVisibilityInfo', function () {
  ...
  Clazz_load(
    ...
    function () {
        ...
        function (propertyName, value, bs) {
          if ('thisID' === propertyName) {
            ...
            if (target === '%SCALE') {
              ...
              if (this.currentObject == null && JU.PT.isWild(target))
          ...
          if ('text' === propertyName) {
            if (value.startsWith('%SCALE')) {
              ...
              if (
                this.scaleObject != null &&
                this.objects.get(this.scaleObject.target) === this.scaleObject
              )
            ...
            if (target !== 'none' && target !== 'all') {
              ...
              if (text == null) {
                ...
                if (this.currentColor != null)
                  text.colix = JU.C.getColixO(this.currentColor);
                if (this.currentBgColor != null)
                  text.bgcolix = JU.C.getColixO(this.currentBgColor);
                if (this.currentTranslucentLevel != 0)
                  text.setTranslucent(this.currentTranslucentLevel, false);
                if (this.currentBgTranslucentLevel != 0)
          ...
          if ('hidden' === propertyName) {
            ...
            if (this.currentObject != null) {
              ...
              for (
                ...
                if (
                  this.isAll ||
                  JU.PT.isMatch(t.target.toUpperCase(), this.thisID, true, true)
                )
                  t.hidden = isHidden;
            }
            return;
          ...
          if ('xyz' === propertyName) {
            if (this.currentObject != null) {
              ...
              if (this.currentObject.pymolOffset == null)
                this.currentObject.pymolOffset = Clazz_newFloatArray(
                  -1,
                  [-1, 2, 0, 0, 0, 0, 0],
                );
            }
      ...
      Clazz_overrideMethod(
        ...
        function (property, data) {
          if ('currentTarget' === property) {
            return (
              this.currentObject != null &&
              (data[0] = this.currentObject.target) != null
            );
          }
          if (property === '%SCALE') {
          ...
          if (property === 'checkID') {
            ...
            for (
              ...
              if (
                ...
                (isWild && JU.PT.isMatch(id.toUpperCase(), key, true, true))
              ) {
                data[1] = id;
                return true;
              }
      ...
      Clazz_overrideMethod(c$, 'getShapeDetail', function () {
        ...
        for (
          var e, $e = this.objects.entrySet().iterator();
          ...
          if (o == null) {
            ...
            info.put(
              'imageWidth',
              Integer.$valueOf(this.vwr.apiPlatform.getImageWidth(o)),
            );
            info.put(
              'imageHeight',
              Integer.$valueOf(this.vwr.apiPlatform.getImageHeight(o)),
            );
          }
          lst.put(name, info);
        }
      ...
      Clazz_defineStatics(c$, 'FONTFACE', 'Serif', 'FONTSIZE', 20, 'COLOR', 10);
    },
  );
  Clazz_declarePackage('J.shape');
  Clazz_load(
      ...
      Clazz_overrideMethod(
        ...
        function (propertyName, value, bsSelected) {
          ...
          if ('atomLabel' === propertyName) {
            ...
            if (this.atomFormats == null || this.atomFormats.length < count)
              this.atomFormats = new Array(count);
            for (
              var i = bsSelected.nextSetBit(0);
              i >= 0;
              i = bsSelected.nextSetBit(i + 1)
  ...
  Clazz_load(
    ...
    ['java.lang.Float', 'JM.Text'],
    function () {
      c$ = Clazz_declareType(J.render, 'TextRenderer');
      c$.render = Clazz_defineMethod(
        c$,
        'render',
        function (
          tm,
          ...
          if (
            ...
            return false;
          if (tm != null && text.valign == 4)
            J.render.TextRenderer.calcBarPixelsXYZ(tm, text, pTemp, false);
          text.setPosition(
            scalePixelsPerMicron,
            imageFontScaling,
            isAbsolute,
          ...
          if (text.image == null) {
            if (text.bgcolix != 0) {
              if (g3d.setC(text.bgcolix))
                J.render.TextRenderer.showBox(
                  g3d,
                  text.colix,
                  Clazz_floatToInt(text.boxX) -
                    (barPixels == 0 ? 0 : barPixels + 4),
                  Clazz_floatToInt(text.boxY) + text.boxYoff2 * 2,
                  text.z + 2,
                  text.zSlab,
                  Clazz_floatToInt(text.boxWidth) + barPixels,
                  Clazz_floatToInt(text.boxHeight),
                  text.fontScale,
                  !text.isEcho,
                );
            ...
            for (var i = 0; i < text.lines.length; i++) {
              ...
              g3d.drawString(
                text.lines[i],
                text.font,
                Clazz_floatToInt(temp[0]),
                Clazz_floatToInt(temp[1]),
                text.z,
                text.zSlab,
                text.bgcolix,
              );
            ...
            if (text.barPixels > 0) {
              J.render.TextRenderer.renderScale(
                g3d,
                text,
                temp,
                barPixels,
            ...
            g3d.drawImage(
              text.image,
              Clazz_floatToInt(text.boxX),
              Clazz_floatToInt(text.boxY),
              text.z,
              text.zSlab,
              text.bgcolix,
              Clazz_floatToInt(text.boxWidth),
              Clazz_floatToInt(text.boxHeight),
            );
          }
      ...
      c$.calcBarPixelsXYZ = Clazz_defineMethod(
        c$,
        'calcBarPixelsXYZ',
        function (tm, t, pTemp, andSet) {
          ...
          if (t.xyz != null) {
            ...
            if (barPixels > 0 && tm.perspectiveDepth) {
              ...
              barPixels = t.barPixelsXYZ = Clazz_floatToInt(
                (barPixels * t.barDistance) / d,
              );
            }
          }
          return barPixels;
      ...
      c$.renderScale = Clazz_defineMethod(
        c$,
        'renderScale',
        function (g3d, text, temp, barPixels, isAntialiased) {
          ...
          g3d.fillTextRect(
            x1,
            y - Clazz_doubleToInt((h * 2) / 2),
            z,
            text.zSlab,
            2 * ia,
            Clazz_doubleToInt((h * 2) / 2),
          );
          g3d.fillTextRect(
            x2,
            y - Clazz_doubleToInt((h * 2) / 2),
      ...
      c$.drawLineXYZ = Clazz_defineMethod(
        c$,
        'drawLineXYZ',
        function (
          g3d,
      ...
      c$.renderSimpleLabel = Clazz_defineMethod(
        c$,
        'renderSimpleLabel',
        function (
          g3d,
          ...
          g3d.drawString(
            strLabel,
            font,
            Clazz_floatToInt(x + 4),
            Clazz_floatToInt(y + 4 + ascent),
            z - 1,
            zSlab,
            bgcolix,
          );
      ...
      Clazz_defineStatics(c$, 'MODE_IS_ANTIALIASED', 4);
    },
  );
  Clazz_declarePackage('J.render');
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'render', function () {
        ...
        for (var i = labelStrings.length; --i >= 0; ) {
          ...
          if (
            this.bgcolix == 0 &&
            this.vwr.gdata.getColorArgbOrGray(this.labelColix) ==
              backgroundColor
          )
          ...
          this.boxXY =
            !this.isExport || this.vwr.creatingImage
              ? labels.getBox(i)
              : Clazz_newFloatArray(5, 0);
          if (this.boxXY == null)
            labels.putBox(i, (this.boxXY = Clazz_newFloatArray(5, 0)));
      ...
      Clazz_defineMethod(
        ...
        function (text, label) {
          var newText = false;
          var pointerColix =
            (this.pointer & 2) != 0 && this.bgcolix != 0
              ? this.bgcolix
              : this.labelColix;
          if (text != null) {
            ...
            if (isSimple) {
              ...
              J.render.TextRenderer.renderSimpleLabel(
                ...
                this.descent,
                pointerColix,
                this.doPointer == 0 ? 0 : this.vwr.getInt(553648147),
                this.mode,
              );
              return null;
            }
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'initRenderer', function () {
      ...
      Clazz_overrideMethod(c$, 'render', function () {
        ...
        for (var i = measures.measurementCount; --i >= 0; ) {
          ...
          if (
            !this.m.isVisible ||
            !this.m.$isValid ||
            ((this.count = this.m.count) == 1 && this.m.traceX == -2147483648)
          )
            continue;
          this.getPoints();
      ...
      Clazz_defineMethod(c$, 'getPoints', function () {
        ...
        function (i) {
          ...
          if (v == null) {
            ...
            if (this.vwr.tm.vibrationOn)
              this.vwr.tm.getVibrationPoint(v, pt, NaN);
            pt.sD = -1;
          }
      ...
      Clazz_defineMethod(
        ...
        function (renderLabel) {
          ...
          if (this.m.mad == 0) {
            ...
            this.dashDots =
              this.mad < 0 ? null : J.render.FontLineShapeRenderer.ndots;
          }
          switch (this.count) {
            case 1:
              this.drawLine(
        ...
        function (s, a, b) {
          ...
          if (this.m.text == null) {
            ...
            this.drawString(
              ...
              zLabel,
              radius,
              this.doJustify && (x - a.sX) * (y - a.sY) > 0,
              false,
              true,
      ...
      Clazz_defineMethod(
        ...
        function (s, a, b, c) {
          ...
          if (this.m.value > 175) {
            if (this.m.text == null) {
              var offset = Clazz_doubleToInt(
                Math.floor(5 * this.imageFontScaling),
              );
              this.g3d.setC(this.labelColix);
              this.drawString(
                b.sX + offset,
          ...
          if (this.m.isTainted()) {
            var radians = JU.Measure.computeAngle(
              this.p[0],
              this.p[1],
              this.p[2],
              this.vectorT2,
          ...
          var dotCount = Clazz_doubleToInt(
            Math.floor((this.m.renderAxis.angle / 6.283185307179586) * 64),
          );
          ...
          for (var i = dotCount; --i >= 0; ) {
            ...
            if (this.m.text == null) {
              ...
              this.drawString(
                ...
                false,
                false,
                this.doJustify ? b.sY : 2147483647,
                s,
              );
            } else {
      ...
      Clazz_defineMethod(
        ...
        function (s, a, b, c, d) {
          ...
          if (s == null) return;
          var zLabel = this.m.inFront
            ? Math.min(Math.min(Math.min(zA, zB), zC), zD)
            : Clazz_doubleToInt((zA + zB + zC + zD) / 4);
          if (zLabel < 1) zLabel = 1;
          radius /= 3;
          if (this.m.text == null) {
            this.g3d.setC(this.labelColix);
            this.drawString(
              Clazz_doubleToInt((a.sX + b.sX + c.sX + d.sX) / 4),
              Clazz_doubleToInt((a.sY + b.sY + c.sY + d.sY) / 4),
              zLabel,
              radius,
              false,
              false,
      ...
      Clazz_defineMethod(c$, 'renderPendingMeasurement', function () {
        try {
          this.getPoints();
        } catch (e) {
      ...
      Clazz_overrideMethod(
        ...
        function (x1, y1, z1, x2, y2, z2, mad) {
          var diameter = Clazz_floatToInt(
            mad >= 20 && this.exportType != 1
              ? this.vwr.tm.scaleToScreen(Clazz_doubleToInt((z1 + z2) / 2), mad)
              : mad,
          );
          if (
            this.dotsOrDashes &&
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'render', function () {
        ...
        this.sppm = this.vwr.getBoolean(603979845)
          ? this.vwr.getScalePixelsPerAngstrom(true) * 10000
          : 0;
        this.imageFontScaling = this.vwr.imageFontScaling;
        this.haveTranslucent = false;
        var alias = this.g3d.isAntialiased() ? 4 : 0;
        for (
          var t, $t = echo.objects.values().iterator();
          $t.hasNext() && ((t = $t.next()) || true);
      ...
      Clazz_defineMethod(
        ...
        function (t, alias) {
          ...
          if (t.valign == 4)
            J.render.TextRenderer.calcBarPixelsXYZ(this.tm, t, this.pt0i, true);
          if (t.pymolOffset != null)
            t.getPymolScreenOffset(
              t.xyz,
              this.pt0i,
              this.zSlab,
              this.pTemp,
          ...
          if (JU.C.renderPass2(t.bgcolix) || JU.C.renderPass2(t.colix))
      ...
      Clazz_defineMethod(
        ...
        'renderFrameTitle',
        function (frameTitle) {
          this.vwr.gdata.setFontBold(
            'arial',
            Clazz_floatToInt(24 * this.imageFontScaling),
          );
          var y = Clazz_doubleToInt(
            Math.floor(
              this.vwr.getScreenHeight() * (this.g3d.isAntialiased() ? 2 : 1) -
    ...
    function () {
            ...
            hover.specialLabel != null
              ...
              ? this.ms
                  ...
                  .formatLabel(
                    this.vwr,
                    atom,
                    hover.atomFormats[hover.atomIndex],
                    this.ptTemp,
                  )
              : hover.labelFormat != null
              ? this.ms
                  .getLabeler()
                  .formatLabel(
                    this.vwr,
                    atom,
                    this.fixLabel(atom, hover.labelFormat),
                    this.ptTemp,
                  )
              : null;
      ...
      Clazz_defineMethod(
        ...
        function (atom, label) {
          ...
          return this.ms.isJmolDataFrameForModel(atom.mi) && label.equals('%U')
            ? '%W'
            : label;
        },
        'JM.Atom,~S',
