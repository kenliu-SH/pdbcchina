(function (
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'readBoolean', function () {
        var ch = this.$in.readByteAsInt();
        if (ch < 0) throw new java.io.EOFException();
        return ch != 0;
      });
      Clazz_overrideMethod(c$, 'readByte', function () {
        var ch = this.$in.readByteAsInt();
        if (ch < 0) throw new java.io.EOFException();
        return ch;
      });
      Clazz_overrideMethod(c$, 'readUnsignedByte', function () {
        var ch = this.$in.readByteAsInt();
        if (ch < 0) throw new java.io.EOFException();
        return ch;
      });
      Clazz_overrideMethod(c$, 'readShort', function () {
      ...
      Clazz_defineMethod(c$, 'readUnsignedShort', function () {
        var ch1 = this.$in.readByteAsInt();
        var ch2 = this.$in.readByteAsInt();
        if ((ch1 | ch2) < 0) throw new java.io.EOFException();
        return (ch1 << 8) + (ch2 << 0);
      });
      Clazz_overrideMethod(c$, 'readChar', function () {
        var ch1 = this.$in.readByteAsInt();
        var ch2 = this.$in.readByteAsInt();
        if ((ch1 | ch2) < 0) throw new java.io.EOFException();
        return String.fromCharCode((ch1 << 8) + (ch2 << 0));
      });
      Clazz_overrideMethod(c$, 'readInt', function () {
        var ch1 = this.$in.readByteAsInt();
        var ch2 = this.$in.readByteAsInt();
      ...
      Clazz_overrideMethod(c$, 'readLong', function () {
      ...
      Clazz_overrideMethod(c$, 'readFloat', function () {
        return Float.intBitsToFloat(this.readInt());
      });
      Clazz_overrideMethod(c$, 'readDouble', function () {
        return Double.longBitsToDouble(this.readLong());
      });
      Clazz_overrideMethod(c$, 'readLine', function () {
      ...
      Clazz_overrideMethod(c$, 'readUTF', function () {
        return java.io.DataInputStream.readUTFBytes(this, -1);
      });
      c$.readUTFBytes = Clazz_defineMethod(
        c$,
        'readUTFBytes',
        function ($in, utflen) {
          ...
          if (Clazz_instanceOf($in, java.io.DataInputStream)) {
            ...
            if (dis.bytearr.length < utflen) {
              dis.bytearr = Clazz_newByteArray(
                isByteArray ? utflen : utflen * 2,
                0,
              );
  ...
  c$.bytesToFloat = Clazz_defineMethod(
    c$,
    'bytesToFloat',
  ...
  c$.bytesToShort = Clazz_defineMethod(
    c$,
    'bytesToShort',
    function (bytes, j, isBigEndian) {
      var n = isBigEndian
        ? (bytes[j + 1] & 0xff) | ((bytes[j] & 0xff) << 8)
        : (bytes[j++] & 0xff) | ((bytes[j++] & 0xff) << 8);
      return n > 0x7fff ? n - 0x10000 : n;
    },
    '~A,~N,~B',
  );
  c$.bytesToInt = Clazz_defineMethod(
    c$,
    'bytesToInt',
    function (bytes, j, isBigEndian) {
      var n = isBigEndian
  ...
  c$.intToSignedInt = Clazz_defineMethod(
    c$,
    'intToSignedInt',
    function (n) {
      {
  ...
  c$.intToFloat = Clazz_defineMethod(
    c$,
    'intToFloat',
    function (x) {
      {
        ...
        return (
          ((x & 0x80000000) == 0 ? 1 : -1) *
          o.shiftIEEE((x & 0x7fffff) | 0x800000, m - 149)
        );
      }
    },
    '~N',
  );
  c$.bytesToDoubleToFloat = Clazz_defineMethod(
    c$,
  ...
  Clazz_defineStatics(c$, 'fracIEEE', null);
  Clazz_declarePackage('JU');
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'getInputStream', function () {
        return this.bis;
      });
      Clazz_overrideMethod(
        c$,
      ...
      Clazz_overrideMethod(c$, 'readUInt8', function () {
        this.nBytes++;
        var b = this.stream.readUnsignedByte();
        if (this.out != null) this.out.writeByteAsInt(b);
        return b;
      });
      Clazz_defineMethod(c$, 'ioReadByte', function () {
      ...
      Clazz_overrideMethod(c$, 'readShort', function () {
        this.nBytes += 2;
        var n = this.isBigEndian
          ? this.ioReadShort()
          : (this.ioReadByte() & 0xff) | ((this.ioReadByte() & 0xff) << 8);
        {
          return n > 0x7fff ? n - 0x10000 : n;
        }
      });
      Clazz_defineMethod(c$, 'ioReadShort', function () {
        var b = this.stream.readShort();
        if (this.out != null) this.out.writeShort(b);
        return b;
      });
      Clazz_overrideMethod(c$, 'readIntLE', function () {
        this.nBytes += 4;
      ...
      Clazz_defineMethod(c$, 'ioReadInt', function () {
      ...
      Clazz_overrideMethod(c$, 'readUnsignedShort', function () {
        this.nBytes += 2;
      ...
      Clazz_overrideMethod(c$, 'readLong', function () {
        ...
        return this.isBigEndian
          ? this.ioReadLong()
          : (this.ioReadByte() & 0xff) |
              ((this.ioReadByte() & 0xff) << 8) |
              ((this.ioReadByte() & 0xff) << 16) |
              ((this.ioReadByte() & 0xff) << 24) |
              ((this.ioReadByte() & 0xff) << 32) |
              ((this.ioReadByte() & 0xff) << 40) |
              ((this.ioReadByte() & 0xff) << 48) |
              ((this.ioReadByte() & 0xff) << 54);
      });
      Clazz_defineMethod(c$, 'ioReadLong', function () {
        var b = this.stream.readLong();
        if (this.out != null) this.out.writeLong(b);
        return b;
      });
      Clazz_defineMethod(c$, 'readLEInt', function () {
      ...
      Clazz_overrideMethod(c$, 'getPosition', function () {
        return this.nBytes;
      });
      Clazz_overrideMethod(
        c$,
