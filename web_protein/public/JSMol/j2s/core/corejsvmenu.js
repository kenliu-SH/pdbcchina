...
*/
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(
        ...
        function (label) {
          if (label.startsWith('_'))
            ...
            label = JSV.common.JSVersion.VERSION;
      ...
      Clazz_defineMethod(c$, 'enableMenus', function () {
      ...
      Clazz_defineMethod(
        ...
        function (jsvp) {
          ...
          this.setItemEnabled(
            'Integration',
            this.pd != null && this.pd.getSpectrum().canIntegrate(),
          );
          this.setItemEnabled('Measurements', true);
          this.setItemEnabled(
            'Peaks',
            this.pd != null && this.pd.getSpectrum().is1D(),
          );
          this.setItemEnabled(
          ...
          this.setItemEnabled(
            'Toggle_Trans/Abs',
            isSingle && spec0.canConvertTransAbs(),
          );
          this.setItemEnabled(
            'Show_Overlay_Key',
            isOverlaid && this.pd.getNumberOfGraphSets() == 1,
          );
          this.setItemEnabled('Overlay_Offset...', isOverlaid);
          this.setItemEnabled(
            'JDXMenu',
            this.pd != null && spec0.canSaveAsJDX(),
          );
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_makeConstructor(c$, function () {
        Clazz_superConstructor(this, JSV.popup.JSVPopupResourceBundle, [
          null,
          null,
        ]);
      });
      ...
      Clazz_defineStatics(
        ...
        Clazz_newArray(-1, [
          ...
          Clazz_newArray(-1, [
            'Save_AsMenu',
            'Original... JDXMenu CML XML(AnIML)',
          ]),
          Clazz_newArray(-1, ['JDXMenu', 'XY DIF DIFDUP FIX PAC SQZ']),
          Clazz_newArray(-1, ['Export_AsMenu', 'PDF - JPG PNG SVG']),
          Clazz_newArray(-1, [
            'ShowMenu',
            'Show_Header Show_Source Show_Overlay_Key',
          ]),
          Clazz_newArray(-1, [
            'OptionsMenu',
          ...
          Clazz_newArray(-1, ['AboutMenu', 'VERSION']),
        ]),
        'structureContents',
        Clazz_newArray(-1, [
          Clazz_newArray(-1, ['Open_File...', 'load ?']),
          Clazz_newArray(-1, ['Open_URL...', 'load http://?']),
          Clazz_newArray(-1, ['Open_Simulation...', 'load $?']),
          Clazz_newArray(-1, ['Add_File...', 'load append ?']),
          Clazz_newArray(-1, ['Add_URL...', 'load append http://?']),
          Clazz_newArray(-1, [
            'Add_Simulation...',
            'load append $?; view "1HNMR"',
          ]),
          Clazz_newArray(-1, ['Close_All', 'close all']),
          Clazz_newArray(-1, ['Close_Views', 'close views']),
          Clazz_newArray(-1, ['Close Simulations', 'close simulations']),
          Clazz_newArray(-1, ['Show_Header', 'showProperties']),
          Clazz_newArray(-1, ['Show_Source', 'showSource']),
          Clazz_newArray(-1, ['Show_Overlay_Key...', 'showKey']),
          Clazz_newArray(-1, ['Next_Zoom', 'zoom next;showMenu']),
          Clazz_newArray(-1, ['Previous_Zoom', 'zoom prev;showMenu']),
          Clazz_newArray(-1, ['Reset_Zoom', 'zoom clear']),
          Clazz_newArray(-1, ['Reset_X_Scale', 'zoom out']),
          Clazz_newArray(-1, ['Set_X_Scale...', 'zoom']),
          Clazz_newArray(-1, ['Spectra...', 'view']),
          Clazz_newArray(-1, ['Overlay_Offset...', 'stackOffsetY']),
          Clazz_newArray(-1, ['Script...', 'script INLINE']),
          Clazz_newArray(-1, ['Properties', 'showProperties']),
          Clazz_newArray(-1, ['Toggle_X_Axis', 'XSCALEON toggle;showMenu']),
          Clazz_newArray(-1, ['Toggle_Y_Axis', 'YSCALEON toggle;showMenu']),
          Clazz_newArray(-1, ['Toggle_Grid', 'GRIDON toggle;showMenu']),
          Clazz_newArray(-1, [
            'Toggle_Coordinates',
            'COORDINATESON toggle;showMenu',
          ]),
          Clazz_newArray(-1, ['Reverse_Plot', 'REVERSEPLOT toggle;showMenu']),
          Clazz_newArray(-1, ['Measurements', 'SHOWMEASUREMENTS']),
          Clazz_newArray(-1, ['Peaks', 'SHOWPEAKLIST']),
          Clazz_newArray(-1, ['Integration', 'SHOWINTEGRATION']),
          Clazz_newArray(-1, ['Toggle_Trans/Abs', 'IRMODE TOGGLE']),
          Clazz_newArray(-1, ['Predicted_Solution_Colour', 'GETSOLUTIONCOLOR']),
          Clazz_newArray(-1, [
            'Fill_Solution_Colour_(all)',
            'GETSOLUTIONCOLOR fillall',
          ]),
          Clazz_newArray(-1, [
            'Fill_Solution_Colour_(none)',
            'GETSOLUTIONCOLOR fillallnone',
          ]),
          Clazz_newArray(-1, ['Print...', 'print']),
          Clazz_newArray(-1, ['Original...', 'write SOURCE']),
          Clazz_newArray(-1, ['CML', 'write CML']),
          Clazz_newArray(-1, ['XML(AnIML)', 'write XML']),
          Clazz_newArray(-1, ['XY', 'write XY']),
          Clazz_newArray(-1, ['DIF', 'write DIF']),
          Clazz_newArray(-1, ['DIFDUP', 'write DIFDUP']),
          Clazz_newArray(-1, ['FIX', 'write FIX']),
          Clazz_newArray(-1, ['PAC', 'write PAC']),
          Clazz_newArray(-1, ['SQZ', 'write SQZ']),
          Clazz_newArray(-1, ['JPG', 'write JPG']),
          Clazz_newArray(-1, ['SVG', 'write SVG']),
          Clazz_newArray(-1, ['PNG', 'write PNG']),
          Clazz_newArray(-1, ['PDF', 'write PDF']),
        ]),
      );
    },
  );
