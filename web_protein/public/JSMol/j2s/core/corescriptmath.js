(function (
    ...
    function () {
      ...
      Clazz_defineMethod(
        ...
        function (mp, op, args, tok) {
          switch (tok) {
            case 134218760:
              return args.length >= 1 && args[0].tok == 4
                ? mp.addXStr(
                    (args.length == 1
            ...
            case 134218250:
              return args.length == 1 && args[0].tok == 2
            ...
            case 1275068418:
              return this.evaluateArray(
                mp,
                args,
                tok == 1275068418 && op.tok == 268435665,
              );
            case 134217765:
              return mp.addXObj(
                this.vwr.sm.getParameter(
                  args.length == 0 ? -2147483648 : args[0].intValue,
                ),
              );
            case 134217731:
            case 134221850:
            ...
            case 1275082241:
            case 1275072526:
              return this.evaluateGetProperty(
                mp,
                args,
                tok,
                op.tok == 268435665,
            ...
            case 134218757:
            case 1237320707:
              return this.evaluateSubstructure(
                mp,
                args,
                tok,
                op.tok == 268435665,
              ...
              if (args[0].tok == 4) {
                ...
                if (xyzList.indexOf('x') < 0 && unitCell == null)
                  return mp.addXObj(
                    this.vwr
                      .getSymTemp()
                      .getSpaceGroupInfoObj(xyzList, null, true, false),
                  );
      ...
      Clazz_defineMethod(
        ...
        function (mp, args, isAtomProperty) {
              ...
              switch (args[0].tok) {
                case 7:
                  ...
                  for (var i = pts.length; --i >= 0; )
                    pts[i] = JS.SV.ptValue(points.get(i));
          ...
          if (bsAtoms != null) {
            ...
            if (
              iatom < 0 ||
              iatom >= this.vwr.ms.ac ||
              (isSpaceGroup && bsAtoms.cardinality() != 1)
            )
              return false;
            if (isSpaceGroup) {
              var lst = this.vwr.ms.generateCrystalClass(
                iatom,
          ...
          var pointGroup = this.vwr
            .getSymTemp()
            .setPointGroup(
              null,
              center,
              pts == null ? this.vwr.ms.at : pts,
              bsAtoms,
              false,
              distanceTolerance < 0
                ? this.vwr.getFloat(570425382)
                : distanceTolerance,
              linearTolerance < 0
                ? this.vwr.getFloat(570425384)
                : linearTolerance,
              bsAtoms == null ? pts.length : bsAtoms.cardinality(),
              true,
            );
          return mp.addXMap(
            pointGroup.getPointGroupInfo(-1, null, true, null, 0, 1),
          );
        },
          ...
          if (ucnew == null && !haveUC && tok0 != 8) {
            u =
              iatom < 0
                ...
                : this.vwr.ms.getUnitCell(this.vwr.ms.at[iatom].mi);
            ucnew =
              u == null
                ? Clazz_newArray(-1, [
                    JU.P3.new3(0, 0, 0),
            ...
            if (haveUC) {
              switch (uc.size()) {
                case 3:
                  ucnew[0] = new JU.P3();
                  for (var i = 0; i < 3; i++)
                    ucnew[i + 1] = JU.P3.newP(JS.SV.ptValue(uc.get(i)));

                  break;
                case 4:
                  for (var i = 0; i < 4; i++)
                    ucnew[i] = JU.P3.newP(JS.SV.ptValue(uc.get(i)));
              ...
              switch (lastParam) {
                case 3:
                  for (var i = 1; i < 4; i++)
                    (ucnew[i] = JU.P3.newP(JS.SV.ptValue(args[i]))).sub(
                      ucnew[0],
                    );
                ...
                case 1:
                  ...
                  if (l != null && l.size() == 3) {
                    for (var i = 0; i < 3; i++)
                      ucnew[i + 1] = JS.SV.ptValue(l.get(i));
            ...
            switch (args.length == 1 ? x1.tok : 0) {
              case 6:
                ...
                for (var i = 0, n = keys.length; i < n; i++)
                  if (map.get(keys[i]).getMap() == null) return false;
      ...
      Clazz_defineMethod(
        ...
        function (mp, args) {
          ...
          var key =
            (n == 5 || (n == 4 && !addBins)) && args[3].tok != 1073742334
              ? JS.SV.sValue(args[3])
              : null;
          var data;
          var maps = null;
          ...
          var nbins = Math.max(
            Clazz_doubleToInt(Math.floor((f1 - f0) / df + 0.01)),
            1,
          );
          ...
          for (var i = 0; i < nPoints; i++) {
            ...
            if (key != null) {
              ...
              map.put(
                '_binMax',
                JS.SV.newF(bin == nbins - 1 ? 3.4028235e38 : v2),
              );
            }
          }
          if (addBins) {
            ...
            for (var i = 0; i < nbins; i++)
              lst.addLast(Clazz_newFloatArray(-1, [f0 + df * i, array[i]]));
      ...
      Clazz_defineMethod(
        ...
        function (mp, args) {
          ...
          if (args.length == 2 && colorScheme.equalsIgnoreCase('TOHSL'))
            return mp.addXPt(
              JU.CU.rgbToHSL(
                JU.P3.newP(
                  args[1].tok == 8
                    ? JS.SV.ptValue(args[1])
                    : JU.CU.colorPtFromString(args[1].asString()),
                ),
                true,
              ),
            );
          ...
          if (
            args.length == 4 &&
            (args[3].tok == 1073742335 || args[3].tok == 1073742334)
          ) {
            var pt1 = JU.P3.newP(
              args[0].tok == 8
                ? JS.SV.ptValue(args[0])
                : JU.CU.colorPtFromString(args[0].asString()),
            );
            var pt2 = JU.P3.newP(
              args[1].tok == 8
                ? JS.SV.ptValue(args[1])
            ...
            for (var i = 0; i < n; i++) {
              sb.append(
                JU.Escape.escapeColor(
                  JU.CU.colorPtToFFRGB(usingHSL ? JU.CU.hslToRGB(pt1) : pt1),
                ),
              );
              pt1.add(vd);
            }
          ...
          var ce = isIsosurface
            ? null
            : this.vwr.cm.getColorEncoder(colorScheme);
          ...
          var getValue =
            value != 3.4028235e38 || (lo != 3.4028235e38 && hi == 3.4028235e38);
          ...
          if (getValue)
            return mp.addXPt(
              JU.CU.colorPtFromInt(
                ce.getArgb(hi == 3.4028235e38 ? lo : value),
                null,
              ),
            );
        ...
        function (mp, args) {
          ...
          try {
            if (isBonds) {
              ...
              var data = this.e
                .getSmilesExt()
                .getFlexFitList(bs1, bs2, smiles1, !isSmiles);
            ...
            if (isIsomer) {
              ...
              if (bs1 == null && bs2 == null) {
                var ret = this.vwr
                  .getSmilesMatcher()
                  .getRelationship(smiles1, smiles2)
                  .toUpperCase();
              ...
              var mf1 =
                bs1 == null
                  ? this.vwr
                      .getSmilesMatcher()
                      .getMolecularFormula(smiles1, false, false)
              ...
              var mf2 =
                bs2 == null
                  ? this.vwr
                      .getSmilesMatcher()
                      .getMolecularFormula(smiles2, false, false)
                  : JU.JmolMolecule.getMolecularFormulaAtoms(
                      this.vwr.ms.at,
                      bs2,
                      null,
              ...
              if (bs2 == null) {
                check =
                  this.vwr.getSmilesMatcher().areEqual(smiles2, smiles1) > 0;
              } else {
                smiles2 = this.e
                  .getSmilesExt()
                  .getSmilesMatches(
              ...
              if (!check) {
                ...
                if (
                  ...
                  if (
                    ...
                    smiles1 =
                      pt >= 0
                        ? '/strict/' +
                          smiles1.substring(0, pt) +
                          smiles1.substring(pt + 12)
                        : '/invertstereo strict/' + smiles1;
                    if (bs2 == null) {
                      check =
                        this.vwr.getSmilesMatcher().areEqual(smiles1, smiles2) >
                        0;
                    } else {
                      check =
                        this.e
                  ...
                  if (bs2 == null) {
                    check =
                      this.vwr
                        .getSmilesMatcher()
                        .areEqual('/nostereo/' + smiles2, smiles1) > 0;
                  } else {
                    var ret = this.e
                      .getSmilesExt()
                      .getSmilesMatches(
                ...
                if (isTautomer) {
                  ...
                  if (
                    inchi != null &&
                    inchi.equals(this.vwr.getInchi(bs2, null, null))
                  )
                    ret = 'TAUTOMERS';
                }
                return mp.addXStr(ret);
            ...
            if (isSmiles) {
              ...
              if (isSmiles || isSearch)
                sOpt = narg > (isStdDev ? 4 : 3) ? JS.SV.sValue(args[3]) : null;
              var hMaps =
                'H'.equalsIgnoreCase(sOpt) ||
                'allH'.equalsIgnoreCase(sOpt) ||
                'bestH'.equalsIgnoreCase(sOpt);
              var isPolyhedron =
                !hMaps &&
                ('polyhedra'.equalsIgnoreCase(sOpt) ||
              ...
              if (isPolyhedron) {
                ...
                ptsB = new JU.Lst();
                var allMaps =
                  'all'.equalsIgnoreCase(sOpt) || 'allH'.equalsIgnoreCase(sOpt);
                var bestMap =
                  'best'.equalsIgnoreCase(sOpt) ||
                  'bestH'.equalsIgnoreCase(sOpt);
                ...
                stddev = this.e
                  ...
                  .getSmilesCorrelation(
                    ...
                    null,
                    bestMap,
                    (isSmiles ? 1 : 2) | (!allMaps && !bestMap ? 8 : 0),
                  );
                if (isMap) {
                  ...
                  for (var i = 0, pt = 0; i < nMatch; i++) {
                    ...
                    ret.addLast(a);
                    for (var j = 0; j < nAtoms; j++, pt++)
                      a[j] = Clazz_newIntArray(-1, [
                        ptsA.get(j).i,
                        ptsB.get(pt).i,
                      ]);
                  }
            ...
            return isStdDev || Float.isNaN(stddev)
              ? mp.addXFloat(stddev)
              : mp.addXM4(m.round(1e-7));
          } catch (ex) {
            if (Clazz_exceptionOf(ex, Exception)) {
              this.e.evalError(
      ...
      Clazz_defineMethod(
        ...
        function (mp, args, tok, intValue) {
          ...
          switch (tok) {
            case 1275203608:
              ...
              if (intValue == 1275203608)
                atoms1 = JS.SV.getBitSet(mp.getX(), true);
              var data = Clazz_newArray(-1, [
                Integer.$valueOf(nv),
                smiles,
                atoms1,
              ]);
              if (!this.vwr.shm.getShapePropertyData(21, 'getCenters', data))
                data[1] = null;
            ...
            case 1228931587:
              ...
              for (
                ...
                for (var j = b.length; --j >= 0; )
                  if (atoms2.get(b[j].getOtherAtom(atoms[i]).i)) n++;
              ...
              JS.SV.newV(
                ...
                JM.BondSet.newBS(
                  ...
                  this.vwr.ms.getAtomIndices(
                    this.vwr.ms.getAtoms(1677721602, bsBonds),
                  ),
                ),
              ),
            );
          ...
          return mp.addXBs(
            this.vwr.ms.getAtomsConnected(min, max, order, atoms1),
          );
        },
      ...
      Clazz_defineMethod(
        ...
        function (mp, args) {
          ...
          if (i == args.length || !Clazz_instanceOf(args[i].value, JU.BS))
            return false;
        ...
        function (mp, args) {
              ...
              if (args[0].tok == 10)
                return mp.addXStr(
                  this.vwr.getModelFileData(
                    selected,
                    JS.SV.sValue(args[1]),
                    args.length == 3 && JS.SV.bValue(args[2]),
                  ),
                );
              break;
            case 4:
              ...
              var f = JU.Parser.parseFloatArrayFromMatchAndField(
                JS.SV.sValue(args[0]),
                null,
                0,
                0,
          ...
          if (selected.indexOf('data2d_') == 0) {
            ...
            if (args.length == 2 && args[1].tok == 2) {
              ...
              if (pt >= 0 && pt < f1.length)
                return mp.addXStr(JU.Escape.escapeFloatA(f1[pt], false));
              return mp.addXStr('');
            }
            return mp.addXStr(JU.Escape.escapeFloatAA(f1, false));
          }
          if (selected.endsWith('*'))
            return mp.addXList(this.vwr.getDataObj(selected, null, 0));
          if (selected.indexOf('property_') == 0) {
            var f1 = this.vwr.getDataObj(selected, null, 1);
            return f1 == null
              ? mp.addXStr('')
              : mp.addXStr(JU.Escape.escapeFloatA(f1, false));
          }
          var data = this.vwr.getDataObj(selected, null, -1);
          return mp.addXStr(
            data == null || data.length < 2 ? '' : '' + data[1],
          );
        },
        'JS.ScriptMathProcessor,~A',
      );
          ...
          try {
                  ...
                  switch (x2.tok) {
                    ...
                    case 8:
                      ...
                      if (returnAtom) {
                        ...
                        if (isAtomSet1) {
                          for (
                            var i = bs1.nextSetBit(0);
                            i >= 0;
                            i = bs1.nextSetBit(i + 1)
                          ) {
                            var d = isPoint2
                              ? atoms[i].distanceSquared(pt2)
                              : this.e
                                  .getBitsetProperty(
                                    bs2,
                                    list2,
                      ...
                      if (isAll) {
                        if (bs2 == null) {
                          ...
                          for (
                            var p = 0, i = bs1.nextSetBit(0);
                            i >= 0;
                            i = bs1.nextSetBit(i + 1), p++
                          )
                            data[p] = atoms[i].distance(pt2);

                          return mp.addXAF(data);
                        }
                        var data2 = Clazz_newFloatArray(
                          bs1.cardinality(),
                          bs2.cardinality(),
                          0,
                        );
                        for (
                          ...
                          for (
                            var q = 0, j = bs2.nextSetBit(0);
                            j >= 0;
                            j = bs2.nextSetBit(j + 1), q++
                          )
                      ...
                      if (isMinMax) {
                        var data = Clazz_newFloatArray(
                          isAtomSet1 ? bs1.cardinality() : list1.size(),
                          0,
                        );
                        if (isAtomSet1) {
                          for (
                            var i = bs1.nextSetBit(0), p = 0;
                            i >= 0;
                            i = bs1.nextSetBit(i + 1)
                          )
                            data[p++] = this.e
            ...
            if (isDist) {
              if (plane2 != null && x3 != null)
                f = JU.Measure.directedDistanceToPlane(
                  pt1,
                  plane2,
                  JS.SV.ptValue(x3),
                );
                ...
                f =
                  plane1 == null
                    ? plane2 == null
                      ? pt2.distance(pt1)
                      : JU.Measure.distanceToPlane(plane2, pt1)
                    : JU.Measure.distanceToPlane(plane1, pt2);
            } else {
              if (plane1 != null && plane2 != null) {
                ...
                if (plane1 != null)
                  pt1 = JU.P3.new3(plane1.x, plane1.y, plane1.z);
                else if (plane2 != null)
                  pt2 = JU.P3.new3(plane2.x, plane2.y, plane2.z);
                f = pt1.dot(pt2);
              }
            }
          } catch (e) {
      ...
      Clazz_defineMethod(
        ...
        function (mp, args) {
          ...
          if (args.length > 2) {
            ...
            return data == null
              ? false
              : mp.addXObj(JU.Escape.escapeHelical(type, tok, pta, ptb, data));
          }
          var bs = Clazz_instanceOf(args[0].value, JU.BS)
            ? args[0].value
            : this.vwr.ms.getAtoms(1094715412, new Integer(args[0].asInt()));
          switch (tok) {
            case 134217751:
            case 1073741854:
            case 1665140738:
            ...
            case 134217729:
              return mp.addXFloat(
                this.getHelixData(bs, 134217729).floatValue(),
              );
            case 135176:
            case 1745489939:
              return mp.addXObj(this.getHelixData(bs, tok));
      ...
      Clazz_defineMethod(
        ...
        function (bs, tokType) {
          ...
          return iAtom < 0
            ? 'null'
            : this.vwr.ms.at[iAtom].group.getHelixData(
                tokType,
      ...
      Clazz_defineMethod(
        ...
        function (mp, args) {
          ...
          var flags =
            args.length > 1 &&
            args[1].tok != 1073742335 &&
            args[1].tok != 1073742334 &&
            args[1].tok != 10
              ? JS.SV.sValue(args[1])
              : '';
          var isSequence =
            !isList && !isOff && sFind.equalsIgnoreCase('SEQUENCE');
              ...
              case 1:
                if (x1.value.startsWith('InChI=')) {
                  if (sFind.equalsIgnoreCase('SMILES')) {
                    return mp.addXStr(
                      this.vwr.getInchi(null, x1.value, 'SMILES' + flags),
                    );
                  }
                }
                isStr = true;
          ...
          var isChemical =
            !isList && !isStr && sFind.equalsIgnoreCase('CHEMICAL');
          ...
          var isInchiKey =
            isAtoms && !isList && sFind.equalsIgnoreCase('INCHIKEY');
          var isStructureMap =
            !isSmiles &&
            !isSMARTS &&
            tok0 == 10 &&
          ...
          try {
            if (isEquivalent) {
              switch (x1.tok) {
                ...
                case 8:
                  return mp.addXList(
                    this.vwr.getSymmetryEquivPoints(x1.value, sFind + flags),
                  );
                case 7:
                  var lst = new JU.Lst();
                  var l0 = x1.getList();
                  ...
                  return mp.addXList(
                    this.vwr.getSymmetryEquivPointList(lst, sFind + flags),
                  );
              }
            } else if (isInchi || isInchiKey) {
              if (isInchiKey) flags += ' key';
              return mp.addXStr(
                this.vwr.getInchi(JS.SV.getBitSet(x1, true), null, flags),
              );
            }
            if (isChemical) {
              ...
              var data =
                bsAtoms == null
                  ? JS.SV.sValue(x1)
                  : this.vwr.getOpenSmiles(bsAtoms);
              data = (
                data.length == 0
                  ? ''
                  : this.vwr.getChemicalInfo(data, flags.toLowerCase(), bsAtoms)
              ).trim();
              if (data.startsWith('InChI'))
                data = JU.PT.rep(
                  JU.PT.rep(data, 'InChI=', ''),
                  'InChIKey=',
                  '',
                );
            ...
            if (isSmiles || isSMARTS || isAtoms) {
              ...
              var bs2 =
                iPt < args.length && args[iPt].tok == 10
                  ? args[iPt++].value
                  : null;
              ...
              switch (x1.tok) {
                ...
                case 4:
                  ...
                  if (flags.equalsIgnoreCase('mf')) {
                    ret = this.vwr
                      .getSmilesMatcher()
                      .getMolecularFormula(smiles, isSMARTS, isON);
                  } else {
                    var pattern = flags;
                    ...
                    var justOne =
                      !asMap && (!allMappings || (!isSMARTS && !isChirality));
                    try {
                      ret = this.e
                        .getSmilesExt()
                        .getSmilesMatches(
                          pattern,
                          isList ? JS.SV.strListValue(x1) : smiles,
                          null,
                          null,
                          isSMARTS ? 2 : 1,
                          !asMap,
                ...
                case 10:
                  ...
                  if (sFind.equalsIgnoreCase('spacegroup')) {
                    return mp.addXObj(
                      this.vwr.findSpaceGroup(bs, null, null, false, false),
                    );
                  }
                  if (sFind.equalsIgnoreCase('crystalClass')) {
                    ...
                    return mp.addXList(
                      this.vwr.ms.generateCrystalClass(
                        n,
                        bsNew != null
                          ? this.vwr.ms.getAtomSetCenter(bsNew)
                          : argLast.tok == 10
                          ? this.vwr.ms.getAtomSetCenter(argLast.value)
                          : JS.SV.ptValue(argLast),
                      ),
                    );
                  }
                  if (isMF && flags.length != 0) {
                    return mp.addXBs(
                      JU.JmolMolecule.getBitSetForMF(this.vwr.ms.at, bs, flags),
                    );
                  }
                  if (isMF || isCF) {
                  ...
                  if (isSequence || isSeq) {
                    ...
                    return mp.addXStr(
                      this.vwr.getSmilesOpt(
                        ...
                        -1,
                        -1,
                        (isAll ? 3145728 | 5242880 | (isHH ? 9437184 : 0) : 0) |
                          (isSeq ? 34603008 : 1048576),
                        null,
                      ),
                    );
                  }
                  if (isStructureMap) {
                    ...
                    var itype =
                      key == null || key.equals('%i') || key.equals('number')
                        ? 'i'
                        : key.equals('%a') || key.equals('name')
                        ? 'a'
                        : key.equals('%D') || key.equals('index')
                        ? 'D'
                        : '?';
                    ...
                    if (bs.cardinality() != bs2.cardinality()) {
                      ...
                      try {
                        ...
                        if (m2.length > 0) {
                          ...
                          bsAll.or(bs2);
                          var names =
                            itype == '?' ? new Array(bsAll.length()) : null;
                          if (names != null)
                            names = this.e
                              .getCmdExt()
                              .getBitsetIdentFull(
                  ...
                  if (isSmiles || isSMARTS) {
                    sFind =
                      args.length > 1 && args[1].tok == 10
                        ? this.vwr.getSmilesOpt(args[1].value, 0, 0, 0, flags)
                        : flags;
                  }
                  ...
                  if (flags.indexOf('INCHI') >= 0) {
                    return mp.addXStr(
                      this.vwr.getInchi(bs, null, 'SMILES/' + flags),
                    );
                  }
                  if (flags.equals('MF')) {
                    smiles = this.e
                    ...
                    ret = this.vwr
                      .getSmilesMatcher()
                      .getMolecularFormula(smiles, false, isON);
                  } else if (asBonds) {
                    var map = this.vwr
                      .getSmilesMatcher()
                      .getCorrelationMaps(
                    ...
                    ret =
                      map.length > 0
                        ? this.vwr.ms.getDihedralMap(map[0])
                    ...
                    var smilesFlags =
                      (isSmiles ? (flags.indexOf('OPEN') >= 0 ? 5 : 1) : 2) |
                      (isON && sFind.length == 0 ? 22020096 : 0);
          ...
          if (isList || isPattern) {
            ...
            if (!isList) {
              return asMatch
                ? mp.addXStr(v.size() == 1 ? v.get(0) : '')
                : isReverse
                ? mp.addXBool(n == 1)
                : asMatch
                ? mp.addXStr(n == 0 ? '' : matcher.group())
      ...
      Clazz_defineMethod(
        ...
        function (mp, args, tok0, isAtomProperty) {
          ...
          var bsSelect =
            isAtomProperty && nargs == 1 && args[0].tok == 10
              ? args[0].value
              : null;
          var pname =
            bsSelect == null && nargs > 0 ? JS.SV.sValue(args[pt++]) : '';
            ...
            switch (x.tok) {
                ...
                if (name.startsWith('$')) {
                  ...
                  if (shapeID >= 0) {
                    ...
                    if (data[1] != null && !pname.equals('index')) {
                      ...
                      data[1] = this.vwr.shm.getShapePropertyIndex(
                        shapeID,
                        pname.intern(),
                        index,
                      );
                  ...
                  if (shapeID >= 0) {
                    ...
                    this.vwr.shm.getShapePropertyData(
                      shapeID,
                      pname.intern(),
                      data,
                    );
              ...
              case 7:
                if (isPivot) {
                  ...
                  for (var i = 0, n = lstx.size(); i < n; i++) {
                    ...
                    if (vlist == null)
                      map.put(key, (vlist = JS.SV.newV(7, new JU.Lst())));
              ...
              default:
                if (tok0 == 1275068725 && x.tok == 6) {
                  ...
                  var map0 = x.getMap();
                  for (
                    var e, $e = map0.entrySet().iterator();
                ...
                return mp.addXObj(
                  this.vwr.extractProperty(x, propertyName, -1),
                );
            }
            if (
              !lc.startsWith('bondinfo') &&
          ...
          if (propertyName.equalsIgnoreCase('fileContents') && nargs >= 2) {
            ...
            switch (args[pt].tok) {
              case 10:
                ...
                if (
                  propertyName.equalsIgnoreCase('bondInfo') &&
                  nargs > pt &&
                  args[pt].tok == 10
                )
                  propertyValue = Clazz_newArray(-1, [
                    propertyValue,
                    args[pt].value,
                  ]);
                break;
              case 6:
              case 4:
                if (this.vwr.checkPropertyParameter(propertyName))
                  propertyValue = args[pt++].value;
                break;
            }
          }
          ...
          var property = this.vwr.getProperty(
            null,
            propertyName,
            propertyValue,
          );
          ...
          return mp.addXObj(
            isJSON
              ? JS.SV.safeJSON('value', property)
              : JS.SV.isVariableType(property)
              ? property
              : JU.Escape.toReadable(propertyName, property),
          );
        },
        ...
        function (mp, intValue, args, isLabel) {
          ...
          return mp.addXObj(
            format == null
              ? ''
              : bs == null
              ? JS.SV.sprintf(JU.PT.formatCheck(format), x1)
              : this.e
                  .getCmdExt()
                  .getBitsetIdent(
                    bs,
          ...
          for (var i = 0, n = listIn.size(); i < n; i++) {
            ...
            switch (element.tok) {
              ...
              case 7:
                ...
                for (
                  var j = 0, n1 = Math.min(list.size(), formatList.size());
                  j < n1;
                  j++
                ) {
      ...
      Clazz_defineMethod(
        ...
        function (mp, tok, args) {
          ...
          switch (tok) {
            case 1275335685:
              return (
                (len == 2 && mp.addX(x1.pushPop(args[0], args[1]))) ||
                (len == 1 && mp.addX(x1.pushPop(null, args[0])))
              );
            case 1275334681:
              return (
                (len == 1 && mp.addX(x1.pushPop(args[0], null))) ||
          ...
          if (len == 2) {
            ...
            if (tok == 1275069441) {
              sList1 = isArray1
                ? JS.SV.strListValue(x1)
                : JU.PT.split(JS.SV.sValue(x1), '\n');
              sList2 =
                x2.tok == 7
                  ? JS.SV.strListValue(x2)
                  : JU.PT.split(JS.SV.sValue(x2), '\n');
              sList3 = new Array(
                (len = Math.max(sList1.length, sList2.length)),
              );
              for (var i = 0; i < len; i++)
                sList3[i] =
                  (i >= sList1.length ? '' : sList1[i]) +
                  tab +
            ...
            for (var i = 0, nl = l.size(); i < nl; i++) {
              ...
              if (isCSV) {
                ...
                while (true) {
                  ...
                  if (s == null) {
                    ...
                    line =
                      line.substring(0, last) +
                      line.substring(last).$replace(',', '\0');
                    break;
                  }
                  line =
                    line.substring(0, last) +
                    line.substring(last, next[0]).$replace(',', '\0') +
                    s +
              ...
              for (var j = 0, n = linaa.length; j < n; j++) {
                ...
                if (s.indexOf('.') < 0)
                  ...
                  try {
                    la.addLast(
                      JS.SV.getVariable(Float.$valueOf(Float.parseFloat(s))),
                    );
                    continue;
                  } catch (ee) {
                    if (Clazz_exceptionOf(ee, Exception)) {
          ...
          if (tok == 1275069446 && x2.tok == 4) {
            ...
            if (isScalar1) {
              ...
              for (var i = 0; i < len; i++)
                sb.append(i > 0 ? s : '').append(JS.SV.sValue(alist1.get(i)));
            }
            return mp.addXStr(sb.toString());
          }
          var scalar = null;
          ...
          for (var i = 0; i < len; i++) {
            if (isScalar2) b = scalar;
              ...
              b = JS.SV.getVariable(
                JS.SV.unescapePointOrBitsetAsVariable(sList2[i]),
              );
            ...
            if (!isScalar1) {
              if (isArray1) a = alist1.get(i);
                ...
                a = JS.SV.getVariable(
                  JS.SV.unescapePointOrBitsetAsVariable(sList1[i]),
                );
      ...
      Clazz_defineMethod(
        ...
        function (mp, args, isFile) {
          ...
          var async =
            this.vwr.async ||
            (args.length > 2 && args[args.length - 1].tok == 1073742335);
          var nBytesMax =
            args.length > 1 && args[1].tok == 2 ? args[1].asInt() : -1;
          var asJSON =
            args.length > 1 && args[1].asString().equalsIgnoreCase('JSON');
          if (asMap)
            return mp.addXMap(this.vwr.fm.getFileAsMap(file, null, false));
          ...
          var str = isFile
            ? this.vwr.fm.getFilePath(file, false, false)
            : this.vwr.getFileAsString4(
                file,
                nBytesMax,
                false,
                false,
          ...
          try {
            return asJSON
              ? mp.addXObj(this.vwr.parseJSON(str))
              : mp.addXStr(str);
          } catch (e) {
            if (Clazz_exceptionOf(e, Exception)) {
              return false;
        ...
        function (mp, args, tok) {
          ...
          switch (tok) {
            case 1745489939:
              ...
              var rangeMinMax = Clazz_newFloatArray(
                -1,
                ...
                switch (args[i].tok) {
                  ...
                  case 4:
                    ...
                    if (
                      ...
                      s.equalsIgnoreCase('vanderwaals')
                    )
                      vdw =
                        (i + 1 < args.length && args[i + 1].tok == 2
                          ? args[++i].asInt()
                          : 100) / 100;
              ...
              if (vdw != 3.4028235e38 && (nBitSets != 2 || nPoints != 2))
                return mp.addXStr('');
              rd =
                vdw == 3.4028235e38
                  ? new J.atomdata.RadiusData(rangeMinMax, 0, null, null)
              ...
              var obj = this.vwr
                .newMeasurementData(null, points)
                .set(
                  0,
                  null,
                  rd,
          ...
          switch (nPoints) {
            ...
            case 3:
              return mp.addXFloat(
                JU.Measure.computeAngleABC(pts[0], pts[1], pts[2], true),
              );
            case 4:
              return mp.addXFloat(
                JU.Measure.computeTorsion(pts[0], pts[1], pts[2], pts[3], true),
              );
          }
          return false;
        },
      ...
      Clazz_defineMethod(
        ...
        function (mp, args, tok) {
          if (
            (tok == 134219777 && args.length != 3 && args.length != 4) ||
            (tok == 134217763 &&
              args.length != 2 &&
              args.length != 3 &&
              args.length != 4) ||
            ...
            case 4:
              switch (tok) {
                ...
                case 134217763:
                  ...
                  if (plane2 != null) {
                    ...
                    norm = new JU.V3();
                    vTemp = new JU.V3();
                    pt1 = JU.Measure.getIntersection(
                      pt1,
                      vLine,
                      plane2,
                      pt3,
              ...
              switch (args[0].tok) {
                ...
                case 8:
                  ...
                  pt3 =
                    args.length > 2 && (args[2].tok == 10 || args[2].tok == 8)
                  ...
                  var vAB = new JU.V3();
                  var ptref =
                    args.length == 4 ? mp.ptValue(args[3], null) : null;
                  var nd = JU.Measure.getDirectedNormalThroughPoints(
                    pt1,
                    pt2,
                    pt3,
                    ptref,
        ...
        function (mp, args) {
          switch (args.length) {
            ...
            case 1:
              ...
              if (args[0].tok == 7) {
                ...
                switch (list.get(0).tok) {
                  ...
                  case 4:
                    ...
                    if (
                      !s.startsWith('{') ||
                      Clazz_instanceOf(JU.Escape.uP(s), String)
                    ) {
                      s = null;
                      break;
                    }
                    ...
                    for (var i = 0; i < len; i++) {
                      a.addLast(
                        JS.SV.getVariable(
                          JU.Escape.uP(JS.SV.sValue(list.get(i))),
                        ),
                      );
                    }
              ...
              return Clazz_instanceOf(pt, JU.P3)
                ? mp.addXPt(pt)
                : mp.addXStr('' + pt);
            case 2:
              var pt3;
      ...
      Clazz_defineMethod(
        ...
        function (mp, args) {
          ...
          var buttonArray =
            args.length > 1 && args[1].tok == 7
              ? JS.SV.strListValue(args[1])
              : null;
          var asButtons =
            buttonArray != null ||
            args.length == 1 ||
        ...
        function (mp, args, tok) {
          ...
          if (tok == 134221850) {
            if (
              nArgs > 1 &&
              args[nArgs - 1].tok == 4 &&
              args[nArgs - 1].value.equalsIgnoreCase('relative')
            ) {
              nArgs--;
              isRelative = true;
            }
          ...
          switch (nArgs) {
            ...
            case 2:
              if (tok == 134221850) {
                if (
                  args[0].tok == 7 &&
                  (args[1].tok == 7 || args[1].tok == 1073742335)
                )
                  break;
                if (
                  args[0].tok == 10 &&
                  (args[1].tok == 2 || args[1].tok == 10)
                )
                  break;
              }
              if (
                (pt0 = mp.ptValue(args[0], null)) == null ||
                (tok != 134221850 && args[1].tok == 8)
              )
                return false;
              break;
            case 3:
              ...
              for (var i = 0; i < 3; i++)
                if (args[i].tok != 8 && args[i].tok != 10) return false;
          ...
          switch (nArgs) {
            ...
            default:
              if (tok == 134221850 && args[0].tok == 7) {
                var data1 = this.e.getQuaternionArray(
                  args[0].getList(),
                  1073742001,
                );
              ...
              if (tok == 134217731)
                q = JU.Quat.newVA(JU.P3.new3(p4.x, p4.y, p4.z), p4.w);
              break;
            case 2:
              if (tok == 134221850) {
                if (args[0].tok == 7 && args[1].tok == 7) {
                  ...
                  var data2 = this.e.getQuaternionArray(
                    args[1].getList(),
                    1073742001,
                  );
                ...
                if (args[0].tok == 10 && args[1].tok == 10) {
                  var data1 = this.vwr.getAtomGroupQuaternions(
                    args[0].value,
                    2147483647,
                  );
                  var data2 = this.vwr.getAtomGroupQuaternions(
                    args[1].value,
                    2147483647,
                  );
                  qs = JU.Quat.div(data2, data1, nMax, isRelative);
              ...
              if (pt1 != null)
                q = JU.Quat.getQuaternionFrame(JU.P3.new3(0, 0, 0), pt0, pt1);
            ...
            case 3:
              if (args[0].tok == 9) {
                var pt =
                  args[2].tok == 8
                    ? args[2].value
                    : this.vwr.ms.getAtomSetCenter(args[2].value);
                return mp.addXStr(
                  JU.Escape.drawQuat(
                    JU.Quat.newP4(args[0].value),
                    'q',
                    JS.SV.sValue(args[1]),
                    pt,
                    1,
              ...
              for (var i = 0; i < 3; i++)
                pts[i] =
                  args[i].tok == 8
                    ? args[i].value
                    : this.vwr.ms.getAtomSetCenter(args[i].value);
            ...
            case 1:
              ...
              if (lst != null)
                for (var i = 0, n = lst.size(); i < n; i++)
                  if (JS.SV.areEqual(x1, lst.get(i))) return mp.addXInt(i + 1);

              break;
            default:
              for (var i = 0; i < args.length; i++)
                if (JS.SV.areEqual(x1, args[i])) return mp.addXInt(i + 1);
        ...
        function (mp, args) {
            ...
            for (var i = list.length; --i >= 0; )
              l[i] =
                sFind == null
                  ? JU.PT.clean(list[i])
                  : isAll
                  ? JU.PT.replaceAllCharacters(list[i], sFind, sReplace)
          ...
          return mp.addXStr(
            sFind == null
              ? JU.PT.clean(s)
              : isAll
              ? JU.PT.replaceAllCharacters(s, sFind, sReplace)
      ...
      Clazz_defineMethod(
        ...
        function (mp, args, tok) {
          if (
            ((tok == 134222350 || tok == 134238732) && args.length != 1) ||
            args.length == 0
          )
            return false;
          var s = JS.SV.sValue(args[0]);
            ...
            case 134218759:
              return args.length == 2
                ? s.equalsIgnoreCase('JSON') &&
                    mp.addXObj(this.vwr.parseJSON(JS.SV.sValue(args[1])))
                : mp.addXObj(this.vwr.evaluateExpressionAsVariable(s));
            case 134222850:
              var appID = args.length == 2 ? JS.SV.sValue(args[1]) : '.';
              if (!appID.equals('.'))
                sb.append(this.vwr.jsEval(appID + '\1' + s));
          ...
          s = sb.toString();
          var f;
          return Float.isNaN((f = JU.PT.parseFloatStrict(s)))
            ? mp.addXStr(s)
            : s.indexOf('.') >= 0
            ? mp.addXFloat(f)
            : mp.addXInt(JU.PT.parseInt(s));
        },
        'JS.ScriptMathProcessor,~A,~N',
      );
      Clazz_defineMethod(
      ...
      Clazz_defineMethod(
        ...
        function (mp, tok, args) {
          ...
          switch (args.length) {
            ...
            case 1:
              if (args[0].tok == 1073742335) {
                return mp.addX(
                  JS.SV.getVariable(JU.PT.getTokens(x.asString())),
                );
              }
              break;
            case 2:
          ...
          if (
            x.tok == 7 &&
            tok != 1275068932 &&
            (tok != 1275069447 || args.length == 2)
          ) {
            mp.addX(x);
            return this.evaluateList(mp, tok, args);
          }
          var s =
            (tok == 1275069447 && x.tok == 10) ||
            (tok == 1275068932 && x.tok == 7)
              ? null
              : JS.SV.sValue(x);
          switch (tok) {
            case 1275069447:
      ...
      Clazz_defineMethod(
        ...
        function (mp, args, tok, isSelector) {
          if (
            args.length == 0 ||
            (isSelector && (tok == 134218753 || args.length > 1))
          )
            return false;
          var objTarget =
            tok == 134218756 && !isSelector && args[0].tok == 134218756
              ? args[0].value
              : null;
          if (objTarget != null && args.length < 2) return false;
          var compileSearch =
            tok == 134218756 && !isSelector && args[0].tok == 10;
          var objPattern =
            args[0].tok == 134218753
              ? args[0].value
              : objTarget != null && args[1].tok == 134218753
              ? args[1].value
              : null;
            ...
            try {
              ...
              if (objTarget != null)
                return mp.addXBs(
                  this.vwr
                    .getSmilesMatcher()
                    .getSubstructureSet(objPattern, objTarget, 0, null, 2),
                );
              if (tok == 134218753) {
                return mp.addX(
                  JS.SV.newV(
                    134218753,
                    this.vwr.getSmilesMatcher().compileSmartsPattern(pattern),
                  ),
                );
              }
              var bsSelected = isSelector
                ? mp.getX().value
                : args.length == 2 && args[1].tok == 10
                ? args[1].value
                : this.vwr.getModelUndeletedAtomsBitSet(-1);
              bs = this.vwr
                .getSmilesMatcher()
                .getSubstructureSet(
                  objPattern == null ? pattern : objPattern,
                  this.vwr.ms.at,
                  this.vwr.ms.ac,
                  bsSelected,
                  tok == 134218757 ? 1 : 2,
      ...
      Clazz_defineMethod(
        ...
        function (mp, args, isProperty) {
          ...
          var isPoint = false;
          if (x1 != null && x1.tok != 10 && !(isPoint = x1.tok == 8))
            return false;
              ...
              JU.PT.trim(
                this.vwr
                  ...
                  .getSpaceGroupInfo(
                    this.vwr.ms,
                    null,
                    this.vwr.ms.at[bsAtoms.nextSetBit(0)].mi,
                    false,
                    null,
                  )
                  .get('symmetryInfo'),
            ...
            case 10:
              if (!isPoint) {
                ...
                bsAtoms = this.vwr.getModelUndeletedAtomsBitSet(
                  this.vwr.getModelForAtomIndex(bsAtoms.nextSetBit(0))
                    .modelIndex,
                );
              }
              break;
          ...
          if (invariant && iOp == -2147483648) {
            ...
            if (pt1 != null) {
              ...
              ret =
                sym == null
                  ? Clazz_newIntArray(0, 0)
                  : sym.getInvariantSymops(pt1, null);
          ...
          if (bsAtoms == null) {
            if (apt < narg && args[apt].tok == 10)
              (bsAtoms = new JU.BS()).or(args[apt].value);
            if (apt + 1 < narg && args[apt + 1].tok == 10)
              (bsAtoms == null ? (bsAtoms = new JU.BS()) : bsAtoms).or(
                args[apt + 1].value,
              );
          }
          var trans = null;
          if (narg > apt && args[apt].tok == 7) {
            ...
            trans = JU.P3.new3(
              JS.SV.fValue(a.get(0)),
              JS.SV.fValue(a.get(1)),
              JS.SV.fValue(a.get(2)),
            );
          } else if (narg > apt && args[apt].tok == 2) {
            JU.SimpleUnitCell.ijkToPoint3f(
              JS.SV.iValue(args[apt++]),
              (trans = new JU.P3()),
              0,
              0,
            );
          ...
          if (
            ...
            apt++;
          if (
            (pt2 = narg > apt ? mp.ptValue(args[apt], bsAtoms) : null) != null
          )
            apt++;
          ...
          var desc =
            narg == apt
              ? pt2 != null
                ...
                ? 'point'
                : 'matrix'
              : JS.SV.sValue(args[apt++]).toLowerCase();
        ...
        function (mp, args, isAtomProperty) {
          ...
          switch (tok == 4 ? (tok = JS.T.getTokFromName(withinStr)) : tok) {
            ...
            case 2:
              ...
              switch ((tok = args[1].tok)) {
                ...
                case 1073742334:
                  ...
                  if (
                    len > 2 &&
                    JS.SV.sValue(args[2]).equalsIgnoreCase('unitcell')
                  )
                    tok = 1814695966;
                ...
                case 4:
                  ...
                  if (s.startsWith('$'))
                    return mp.addXBs(
                      this.getAtomsNearSurface(distance, s.substring(1)),
                    );
            ...
            case 1073742328:
              return (
                len == 3 &&
                Clazz_instanceOf(args[1].value, JU.BS) &&
                Clazz_instanceOf(args[2].value, JU.BS) &&
                mp.addXBs(
                  this.vwr.getBranchBitSet(
                    args[2].value.nextSetBit(0),
                    args[1].value.nextSetBit(0),
                    true,
                  ),
                )
              );
          ...
          switch (len) {
            ...
            case 2:
              switch (tok) {
                ...
                case 1073742189:
                  return mp.addXBs(
                    this.vwr.ms.getAtoms(tok, JS.SV.sValue(args[1])),
                  );
                case 1094713349:
                case 1094713350:
                  return mp.addXBs(
                    this.vwr.ms.getAtoms(tok, JS.SV.ptValue(args[1])),
                  );
                case 1814695966:
                  var l = args[1].getList();
                  ...
                  oabc = new Array(4);
                  for (var i = 0; i < 4; i++) {
                    if ((oabc[i] = JS.SV.ptValue(l.get(i))) == null)
                      return false;
                  }
          ...
          switch (args[last].tok) {
            ...
            case 8:
              pt = args[last].value;
              if (JS.SV.sValue(args[1]).equalsIgnoreCase('hkl'))
                plane = this.e.getHklPlane(pt, NaN, null);
              break;
            case 7:
          ...
          if (tok == 1814695966) {
            ...
            return (
              (bs != null || pt != null) &&
              mp.addXObj(
                this.vwr.ms.getUnitCellPointsWithin(distance, bs, pt, asMap),
              )
            );
          }
          if (pt != null || pts1 != null) {
            if (args[last].tok == 7) {
              ...
              for (var i = ap3.length; --i >= 0; )
                ap3[i] = JS.SV.ptValue(sv.get(i));

              var ap31 = null;
              if (pts1 != null) {
                ap31 = new Array(pts1.size());
                for (var i = ap31.length; --i >= 0; )
                  ap31[i] = JS.SV.ptValue(pts1.get(i));
              }
              var ret = new Array(1);
              if (bs != null) {
              ...
              switch (
                J.bspt.PointIterator.withinDistPoints(
                  distance,
                  pt,
                  ap3,
                  ap31,
          ...
          if (tok == 1086324744)
            return mp.addXBs(
              this.vwr.ms.getSequenceBits(withinStr, bs, new JU.BS()),
            );
          ...
          if (isWithinGroup)
            return mp.addXBs(
              this.vwr.getGroupsWithin(Clazz_floatToInt(distance), bs),
            );
          if (isVdw) {
          ...
          var bsret = this.vwr.ms.getAtomsWithinRadius(
            distance,
            isAtomProperty ? bsLast : bs,
            isWithinModelSet,
            rd,
          ...
          switch (n) {
            ...
            case 1:
              ...
              if (type.equals('PNGJ')) {
                ...
                return asBytes
                  ? mp.addX(JS.SV.newV(15, new JU.BArray(o)))
                  : mp.addXMap(o);
              }
              if (JU.PT.isOneOf(type, ';ZIP;ZIPALL;JMOL;')) {
                ...
                if (asBytes)
                  return mp.addX(JS.SV.newV(15, new JU.BArray(bytes)));
      ...
      Clazz_defineMethod(
        ...
        function (distance, surfaceId) {
          ...
          if (this.e.getShapePropertyData(24, 'getVertices', data))
            return this.getAtomsNearPts(distance, data[1], data[2]);
      ...
      Clazz_defineMethod(c$, 'getPatternMatcher', function () {
        return this.pm == null
  ...
  Clazz_load(
    ...
    function () {
      ...
      c$.withinDistPoints = Clazz_defineMethod(
        c$,
        'withinDistPoints',
        function (distance, pt, ap3, ap31, bsSelected, ret) {
          ...
          if (pt != null && Float.isNaN(pt.x)) {
            ...
            for (var i = bsp.nextSetBit(0); i >= 0; i = bsp.nextSetBit(i + 1))
              pts.addLast(JU.P3.newP(pt3[i]));
