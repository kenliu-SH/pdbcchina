(function (
  ...
  Clazz_load(null, 'JS.Component', ['JU.CU'], function () {
    ...
    Clazz_defineMethod(c$, 'getParent', function () {
      return this.parent;
    });
    Clazz_defineMethod(
      c$,
    ...
    Clazz_defineMethod(c$, 'getText', function () {
      return this.text;
    });
    Clazz_defineMethod(c$, 'isEnabled', function () {
      return this.enabled;
    });
    Clazz_defineMethod(
      c$,
    ...
    Clazz_defineMethod(c$, 'isVisible', function () {
    ...
    Clazz_defineMethod(c$, 'getHeight', function () {
      return this.height;
    });
    Clazz_defineMethod(c$, 'getWidth', function () {
      return this.width;
    });
    Clazz_defineMethod(
      c$,
    ...
    Clazz_defineMethod(c$, 'getSubcomponentWidth', function () {
      return this.width;
    });
    Clazz_defineMethod(c$, 'getSubcomponentHeight', function () {
      return this.height;
    });
    Clazz_defineMethod(
      c$,
      ...
      function (defaultPercentW, defaultPercentH) {
        var width =
          this.renderWidth > 0 ? this.renderWidth : this.getSubcomponentWidth();
        var height =
          this.renderHeight > 0
            ? this.renderHeight
        ...
        return (
          (width > 0
            ? 'width:' + width + 'px;'
            : defaultPercentW > 0
            ? 'width:' + defaultPercentW + '%;'
            : '') +
          (height > 0
            ? 'height:' + height + 'px;'
            : defaultPercentH > 0
            ? 'height:' + defaultPercentH + '%;'
            : '') +
          (this.bgcolor == null
            ? ''
    ...
    Clazz_defineMethod(c$, 'repaint', function () {});
  });
  Clazz_declarePackage('JS');
  Clazz_load(['JS.Component'], 'JS.Container', ['JU.Lst'], function () {
    ...
    Clazz_defineMethod(c$, 'getComponentCount', function () {
      return this.list == null ? 0 : this.list.size();
    });
    Clazz_defineMethod(c$, 'getComponents', function () {
      if (this.cList == null) {
    ...
    Clazz_defineMethod(c$, 'removeAll', function () {
      if (this.list != null) {
        for (var i = this.list.size(); --i >= 0; )
          this.list.get(i).parent = null;
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'isSelected', function () {
      ...
      Clazz_overrideMethod(c$, 'getIcon', function () {
        return this.icon;
      });
      Clazz_overrideMethod(
        c$,
      ...
      Clazz_defineMethod(c$, 'getTopPopupMenu', function () {
      ...
      Clazz_overrideMethod(c$, 'getPopupMenu', function () {
        return null;
      });
      Clazz_defineMethod(c$, 'getMenuHTML', function () {
        var label =
          this.icon != null ? this.icon : this.text != null ? this.text : null;
        var s =
          label == null
            ? ''
            : '<li><a>' + label + '</a>' + this.htmlMenuOpener('ul');
        var n = this.getComponentCount();
        if (n > 0)
          for (var i = 0; i < n; i++) s += this.getComponent(i).toHTML();
      ...
      Clazz_defineMethod(c$, 'getHtmlDisabled', function () {
  ...
  Clazz_load(null, 'JS.ButtonGroup', ['JS.Component'], function () {
    ...
    Clazz_defineMethod(c$, 'getButtonCount', function () {
      return this.count;
    });
  });
  Clazz_declarePackage('JS');
  ...
  Clazz_defineMethod(
    ...
    function (id) {
      ...
      return (
        ...
        id +
        "' " +
        (this.colspan < 2 ? '' : "colspan='" + this.colspan + "' ") +
        style +
        '><span ' +
        this.c.getStyle(true) +
        '>' +
    ...
    Clazz_defineMethod(
      ...
      function (btn, c) {
        ...
        if (c.gridy >= this.nrows) {
          ...
          for (var i = g.length; --i >= this.nrows; )
            g[i] = new Array(this.ncols * 2 + 1);
  ...
  Clazz_load(null, 'JS.GridBagConstraints', ['JS.Insets'], function () {
    ...
    Clazz_defineStatics(c$, 'NONE', 0, 'CENTER', 10, 'WEST', 17, 'EAST', 13);
  });
  Clazz_declarePackage('JS');
  ...
  Clazz_load(['JS.AbstractButton'], 'JS.JButton', ['JU.SB'], function () {
    ...
    Clazz_overrideMethod(c$, 'toHTML', function () {
      var sb = new JU.SB();
      sb.append(
  ...
  Clazz_load(['JS.AbstractButton'], 'JS.JComboBox', ['JU.SB'], function () {
    ...
    Clazz_defineMethod(c$, 'getSelectedIndex', function () {
      return this.selectedIndex;
    });
    Clazz_defineMethod(c$, 'getSelectedItem', function () {
  ...
  Clazz_load(['JS.Container'], 'JS.JComponent', null, function () {
    ...
    Clazz_defineMethod(c$, 'getActionCommand', function () {
  ...
  Clazz_load(['JS.JComponent'], 'JS.JContentPane', ['JU.SB'], function () {
    ...
    Clazz_defineMethod(c$, 'toHTML', function () {
      var sb = new JU.SB();
      sb.append(
        "\n<div id='" +
          this.id +
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'getContentPane', function () {
      ...
      Clazz_defineMethod(c$, 'pack', function () {
        this.html = null;
      });
      Clazz_defineMethod(c$, 'validate', function () {
        this.html = null;
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_defineMethod(c$, 'dispose', function () {
        {
          {
      ...
      Clazz_overrideMethod(c$, 'repaint', function () {
        this.setDialog();
      });
      Clazz_defineMethod(c$, 'setDialog', function () {
      ...
      Clazz_overrideMethod(c$, 'toHTML', function () {
        ...
        sb.append(
          "\n<div id='" +
            this.id +
            "_title' class='JDialogTitle' style='width:100%;height:25px;padding:5px 5px 5px 5px;height:" +
            25 +
            "px'>" +
            "<span style='text-align:center;'>" +
            this.title +
            "</span><span style='position:absolute;text-align:right;right:1px;'>" +
            "<input type=button id='" +
            this.id +
      ...
      Clazz_defineMethod(c$, 'toFront', function () {
        {
          SwingController.setFront(this);
        }
      });
      Clazz_defineStatics(c$, 'headerHeight', 25);
    },
  );
  Clazz_declarePackage('JS');
  ...
  Clazz_load(['JS.JMenuItem'], 'JS.JMenu', null, function () {
    ...
    Clazz_defineMethod(c$, 'getItemCount', function () {
  ...
  Clazz_load(['JS.AbstractButton'], 'JS.JMenuItem', null, function () {
    ...
    Clazz_overrideMethod(c$, 'toHTML', function () {
      return (
        ...
        (this.text == null ? '' : '<a>' + this.htmlLabel() + '</a>') +
        '</li>'
      );
    });
    Clazz_overrideMethod(c$, 'getHtmlDisabled', function () {
      return ' class="ui-state-disabled"';
    });
    Clazz_defineMethod(c$, 'htmlLabel', function () {
      return this.btnType == 1
        ...
        : '<label><input id="' +
            ...
            (this.btnType == 3 ? 'r' : 'c') +
            'b" type="' +
            (this.btnType == 3 ? 'radio" name="' + this.htmlName : 'checkbox') +
            '" ' +
  ...
  Clazz_load(['JS.AbstractButton'], 'JS.JPopupMenu', null, function () {
    ...
    Clazz_defineMethod(c$, 'disposeMenu', function () {
      {
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineStatics(c$, 'HORIZONTAL_SPLIT', 1);
    },
  );
  Clazz_declarePackage('JS');
  Clazz_load(
    ...
    function () {
      ...
      Clazz_overrideMethod(c$, 'getSelectionModel', function () {
        return this;
      });
      Clazz_defineMethod(c$, 'getColumnModel', function () {
        return this;
      });
      Clazz_defineMethod(
        c$,
      ...
      Clazz_defineMethod(c$, 'clearSelection', function () {
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'getDocument', function () {
        return this;
      });
      Clazz_overrideMethod(
        c$,
  ...
  Clazz_defineStatics(c$, 'LEFT', 2, 'CENTER', 0, 'RIGHT', 4);
  Clazz_declarePackage('JS');
