(function (
  ...
  Clazz_load(
    ...
    function () {
      ...
      Clazz_defineMethod(c$, 'macro', function () {
        if (this.chk) return;
      ...
      Clazz_defineMethod(
        ...
        function (bs, label, tokenValue, useAtomMap, index, isExplicitlyAll) {
          return this.getBitsetIdentFull(
            bs,
            label,
            tokenValue,
            useAtomMap,
      ...
      Clazz_defineMethod(
        ...
        function (
          ...
          var indices =
            isAtoms || !useAtomMap ? null : tokenValue.associatedAtoms;
          var asIdentity = label == null || label.length == 0;
          var htValues =
            isAtoms || asIdentity ? null : JM.LabelToken.getBondLabelValues();
          var tokens = asIdentity
            ? null
            : isAtoms
            ? labeler.compile(this.vwr, label, '\0', null)
            : labeler.compile(this.vwr, label, '\1', htValues);
          var nmax = haveIndex ? 1 : bs.cardinality();
          var haveSout = sout != null;
          if (!haveSout) sout = new Array(nmax);
          var ptTemp = new JU.P3();
          for (
            var j = haveIndex ? index : bs.nextSetBit(0);
            j >= 0;
            j = bs.nextSetBit(j + 1)
          ) {
            var str;
            if (isAtoms) {
              if (asIdentity) str = modelSet.at[j].getInfo();
                ...
                str = labeler.formatLabelAtomArray(
                  this.vwr,
                  modelSet.at[j],
                  tokens,
                  '\0',
        ...
        function (i, sOptions, htParams) {
          ...
          if (lattice != null) {
            ...
            if (this.tokAt(i) == 1814695966) {
              ...
              if (
                fparams == null ||
                (fparams.length != 6 && fparams.length != 9)
              )
                this.invArg();
              sOptions.append(' unitcell [');
              for (var j = 0; j < fparams.length; j++)
            ...
            if (iGroup != -2147483648)
              htParams.put('spaceGroupIndex', Integer.$valueOf(iGroup));
            if (
              isEmptyLoad &&
              fparams == null &&
              spacegroup != null &&
              (iGroup = JU.PT.parseInt(spacegroup)) != -2147483648
            ) {
            }
          }
        ...
        function (i, htParams, sOptions) {
          switch (this.tokAt(i)) {
            case 1073741938:
              ...
              sOptions.append(
                ' FILL [' + oabc[0] + oabc[1] + oabc[2] + oabc[3] + ']',
              );
              break;
            case 1073742080:
              var f = NaN;
      ...
      Clazz_defineMethod(c$, 'cache', function () {
        ...
        switch (tok) {
          ...
          case 1073741882:
            ...
            if (!this.chk) {
              ...
              var nBytes = this.vwr.cacheFileByName(
                fileName,
                tok == 1275069441,
              );
              this.showString(
      ...
      Clazz_defineMethod(c$, 'calculate', function () {
        var isSurface = false;
        var asDSSP = false;
        var bs1 = null;
        var bs2 = null;
        ...
        if ((e.iToken = e.slen) >= 2) {
          ...
          switch (this.getToken(1).tok) {
            case 2:
              ...
              var cmd =
                "load append $ filter '2D';select visible;center selected";
            ...
            case 134217764:
              ...
              if (!this.chk)
                e.showString(
                  '' + this.vwr.findSpaceGroup(bs1, null, null, true, false),
                );
              return;
            case 1086324752:
              e.iToken = 1;
            ...
            case 1631586315:
              ...
              this.showString(
                J.i18n.GT.i(J.i18n.GT.$('{0} charges modified'), n),
              );
              return;
            case 1075838996:
              this.checkLength(2);
            ...
            case 1612709900:
              ...
              bs1 =
                this.slen == e.iToken + 1
                  ? null
                  : this.atomExpressionAt(e.iToken + 1);
              if (bs1 == null && itok == 528443) {
                bs1 = this.vwr.getAtomBitSet(
            ...
            case 1275068447:
              if (!this.chk) {
                if (this.tokAt(2) == 1275203608) {
                  ...
                  this.showString(
                    e.getShapePropertyData(21, 'symmetry', data) ? data[1] : '',
                  );
                } else {
                  bs1 =
            ...
            case 1639976963:
              bs1 =
                this.slen < 4 || this.isFloatParameter(3)
                  ? null
                ...
                case 1111490587:
                  ...
                  e.showString(
                    this.vwr
                      ...
                      .calculateDSSRStructure(this.vwr, bs1),
                  );
                  return;
                case 1073741915:
                  asDSSP = true;
                  version =
                    this.slen == e.iToken + 1
                      ? -1
                      : Clazz_floatToInt(this.floatParameter(++e.iToken));
                  break;
                case 0:
              ...
              if (!this.chk)
                this.showString(
                  this.vwr.calculateStructures(bs1, asDSSP, true, version),
                );
              return;
            case 659482:
              bs1 =
                e.iToken + 1 < this.slen
                  ? this.atomExpressionAt(++e.iToken)
                  : null;
              bs2 =
                e.iToken + 1 < this.slen
                  ? this.atomExpressionAt(++e.iToken)
              ...
              if (!this.chk) {
                ...
                if (n > 0) {
                  ...
                  e.setShapePropertyBs(
                    1,
                    'color',
                    Integer.$valueOf(0x0ffffff),
                    null,
                  );
                ...
                this.showString(
                  J.i18n.GT.i(J.i18n.GT.$('{0} struts added'), n),
                );
              }
              return;
            case 2097180:
            ...
            case 1111490575:
              ...
              this.checkLength(++e.iToken);
              if (!this.chk)
                this.vwr.calculateSurface(bs1, isFrom ? 3.4028235e38 : -1);
              return;
          }
        }
        e.errorStr2(
      ...
      Clazz_defineMethod(c$, 'capture', function () {
          ...
          case 4:
            ...
            if (lc.endsWith('.png')) {
              if (!lc.endsWith('0.png'))
                fileName =
                  fileName.substring(0, fileName.length - 4) + '0000.png';
              type = 'PNG';
            } else {
              type = 'GIF';
            }
              ...
              if (!looping)
                this.showString(
                  J.i18n.GT.o(
                    ...
                    Clazz_newArray(-1, ['ANIMATION MODE LOOP']),
                  ),
                );
              this.showString(
                J.i18n.GT.o(
                  J.i18n.GT.$('Animation delay based on: {0}'),
                  Clazz_newArray(-1, ['ANIMATION FPS ' + fps]),
                ),
              );
            }
        ...
        params.put(
          ...
          Long.$valueOf(
            endTime <= 0
              ? -1
              : System.currentTimeMillis() + Clazz_floatToLong(endTime * 1000),
          ),
        );
      ...
      Clazz_defineMethod(c$, 'centerAt', function () {
      ...
      Clazz_defineMethod(c$, 'compare', function () {
        var eval = this.e;
        ...
        var vQuatSets = null;
        eval.iToken = 0;
        var nSeconds = this.isFloatParameter(1)
        ...
        if (this.tokAt(1) == 4115) {
          ...
          if (eval.isArrayParameter(++eval.iToken)) {
            ...
            (tok = this.tokAt(eval.iToken)) != 1140850689 &&
            tok != 4115
          ) {
        ...
        var isToSubsetOfFrom =
          coordTo == null && bsTo != null && bs.equals(bsFrom);
        ...
        for (var i = eval.iToken + 1; i < this.slen; ++i) {
          switch (this.getToken(i).tok) {
            ...
            case 134218756:
              ...
              if (
                strSmiles.equalsIgnoreCase('polyhedra') ||
            ...
            case 1073742325:
              ...
              bsAtoms2 =
                coordTo == null && eval.isArrayParameter(eval.iToken + 1)
                  ? null
                  : tok == 10 || tok == 1073742325
                  ? this.atomExpressionAt(++eval.iToken)
                  : JU.BSUtil.copy(bsAtoms1);
              if (bsSubset != null) {
              ...
              vAtomSets.addLast(
                Clazz_newArray(-1, [
                  bsAtoms1,
                  bsAtoms2 == null ? coordTo : bsAtoms2,
                ]),
              );
            ...
            case 7:
              ...
              isQuaternion = true;
              data1 = eval.getQuaternionArray(
                eval.theToken.getList(),
                1073742001,
              );
              this.getToken(++i);
              data2 = eval.getQuaternionArray(
                eval.theToken.getList(),
                1073742001,
              );
        ...
        isAtoms =
          (!isQuaternion && strSmiles == null && !isPolyhedral) ||
          coordTo != null;
        if (isAtoms)
        ...
        if (isFrames) {
          ...
          for (
            var i = 0, iModel = bsModels.nextSetBit(0);
            iModel >= 0;
            iModel = bsModels.nextSetBit(iModel + 1), i++
          )
        ...
        for (
          var iFrame = 0, iModel = bsModels.nextSetBit(0);
          iFrame < bsFrames.length;
          iFrame++, iModel = bsModels.nextSetBit(iModel + 1)
        ) {
          ...
          if (!isCoords) {
            for (var i = 0; i < vAtomSets.size(); ++i) {
              ...
              if (isFrames)
                vAtomSets2.addLast(
                  (bss = Clazz_newArray(-1, [JU.BSUtil.copy(bss[0]), bss[1]])),
                );
              bss[0].and(bsFrom);
            }
          }
          ...
          if (isAtoms) {
            ...
            for (var i = 1; i <= n; i++) {
              ...
              if (
                !Clazz_instanceOf(aij, JM.Atom) ||
                !Clazz_instanceOf(bij, JM.Atom)
              )
                break;
              if (!isFrames)
                JU.Logger.info(
                  ' atom 1 ' + aij.getInfo() + '\tatom 2 ' + bij.getInfo(),
                );
            }
            q = JU.Measure.calculateQuaternionRotation(
              centerAndPoints,
              retStddev,
            );
            var r0 = Float.isNaN(retStddev[1])
              ? NaN
              : Math.round(retStddev[0] * 100) / 100;
            var r1 = Float.isNaN(retStddev[1])
              ? NaN
              : Math.round(retStddev[1] * 100) / 100;
            ...
            if (
              ...
              try {
                strSmiles = this.vwr.getSmilesOpt(
                  bsFrom,
                  -1,
                  -1,
                  'H'.equals(strSmiles) ? 4096 : 0,
                  null,
                );
              } catch (ex) {
                if (Clazz_exceptionOf(ex, Exception)) {
            ...
            if (Float.isNaN(stddev)) {
              this.showString(
                'structures do not match from ' + bsFrom + ' to ' + bsTo,
              );
              return;
            }
            if (doTranslate) {
          ...
          if (doTranslate) {
            if (translation == null)
              translation = JU.V3.newVsub(centerAndPoints[1][0], center);
            endDegrees = 1e10;
          }
          if (doRotate) {
          ...
          if (doRotate && doTranslate && nSeconds != 0) {
            ...
            var m4 = JS.ScriptMathProcessor.getMatrix4f(
              q.getMatrix(),
              translation,
            );
          ...
          if (
            ...
            throw new JS.ScriptInterruption(eval, 'compare', 1);
        }
      });
      Clazz_defineMethod(c$, 'configuration', function () {
        var bsAtoms = null;
        ...
        if (this.slen == 1) {
          ...
          if (this.isFloatParameter(1)) {
            ...
            if (this.chk) return;
            bsAtoms = this.vwr.ms.getConformation(
              this.vwr.am.cmi,
              n - 1,
              true,
              null,
            ...
            this.vwr.addStateScript(
              'configuration ' + JU.Escape.eBS(bsAtoms) + ' ' + n + ';',
              true,
              false,
            );
            bsAtoms = this.vwr.ms.getConformation(
      ...
      Clazz_defineMethod(c$, 'measure', function () {
        var eval = this.e;
        var id = null;
        var pt = 1;
        var colix = 0;
        ...
        switch (this.tokAt(1)) {
          case 134218756:
            ...
            try {
              maps = this.vwr
                .getSmilesMatcher()
                .getCorrelationMaps(smarts, atoms, ac, this.vwr.bsA(), 2);
            } catch (ex) {
              if (Clazz_exceptionOf(ex, Exception)) {
                eval.evalError(ex.getMessage(), null);
              } else {
              ...
              case 1073742001:
                if (!this.chk)
                  eval.showStringPrint(
                    this.vwr.getMeasurementInfoAsString(),
                    false,
                  );
                return;
              case 4:
        ...
        for (var i = 1; i < this.slen; ++i) {
          switch (this.getToken(i).tok) {
            ...
            case 1665140738:
            case 1073741917:
              mad = Clazz_floatToInt(
                (eval.theTok == 1665140738 ? 2000 : 1000) *
            ...
            case 3:
              ...
              break;
            case 12291:
              if (tokAction != 268435538 && tokAction != 1275082241)
                this.invArg();
              tokAction = 12291;
              break;
            case 4114:
            ...
            case 2:
              ...
              if (isAll) {
                ...
                atomIndex = this.vwr.ms.getFirstAtomIndexFromAtomNumber(
                  iParam,
            ...
            case 1648363544:
              ...
              if (nBitSets == 1) {
                ...
                bs2.and(
                  this.vwr.ms.getAtomsWithinRadius(5, bs, false, null, null),
                );
                points.addLast(bs2);
              }
              break;
        ...
        if (isRange) {
          if (rangeMinMax[1] < rangeMinMax[0]) {
            ...
            rangeMinMax[0] =
              rangeMinMax[1] == 3.4028235e38 ? 3.4028235e38 : -200;
          }
        }
        if (this.chk) return;
        ...
        if (
          ...
          if (rd == null)
            rd = new J.atomdata.RadiusData(rangeMinMax, 0, null, null);
          if (tickInfo != null) tickInfo.id = 'default';
          if (isRefreshID) {
            tokAction = 266284;
          } else if (
            target != null &&
            (property != null || strFormat != null) &&
            tokAction == 268435538
          ) {
            tokAction = 12290;
          }
          ...
          if (
            ...
            text = J.api.Interface.getInterface(
              'JM.Text',
              this.vwr,
              'script',
            ).newMeasure(this.vwr, font, colix);
          if (text != null) {
      ...
      Clazz_defineMethod(
        ...
        function (isFull) {
          ...
          this.showString(
            n + (n == 1 ? ' measure' : ' measures') + ' selected',
          );
        },
        '~B',
      );
      Clazz_defineMethod(
        ...
        function (index) {
            ...
            switch (this.getToken(i).tok) {
              ...
              case 1073742325:
                ...
                if (nAtomSets == 2) {
                  ...
                  for (var j = i; j < pt; j++)
                    if (
                      this.tokAt(j) == 1073741824 &&
                      this.paramAsStr(j).equals('_1')
                    ) {
                      expression2 = i;
                      break;
                    }
              ...
              case 1073742074:
                ...
                translucentLevel = this.getColorTrans(
                  eval,
                  i,
                  false,
                  colorArgb,
              ...
              case 1613238294:
                ...
                if ((bo = JU.Edge.getBondOrderFromString(cmd)) == 131071)
                  this.invArg();
                ...
                switch (bo) {
                  case 33:
                    switch (this.tokAt(i + 1)) {
                      case 3:
                        bo = JU.Edge.getPartialBondOrderFromFloatEncodedInt(
                          this.st[++i].intValue,
                        );
                        break;
                      case 2:
          ...
          if (expression2 > 0) {
            ...
            var bs0 = atomSets[0];
            for (
              var atom1 = bs0.nextSetBit(0);
              atom1 >= 0;
              atom1 = bs0.nextSetBit(atom1 + 1)
            ) {
              bs.set(atom1);
              result = this.vwr.makeConnections(
                distances[0],
                distances[1],
                bondOrder,
                operation,
                bs,
                this.atomExpressionAt(expression2),
                bsBonds,
                isBonds,
                false,
                0,
          ...
          if (isDelete) {
            if (report)
              eval.report(
                J.i18n.GT.i(J.i18n.GT.$('{0} connections deleted'), nModified),
                false,
              );
            return;
          }
          if (isColorOrRadius) {
            ...
            if (!Float.isNaN(radius))
              eval.setShapeSizeBs(1, Math.round(radius * 2000), null);
            this.finalizeObject(
              1,
              colorArgb[0],
              translucentLevel,
      ...
      Clazz_defineMethod(c$, 'console', function () {
        switch (this.getToken(1).tok) {
          case 1073742334:
      ...
      Clazz_defineMethod(c$, 'data', function () {
        var eval = this.e;
        var dataString = null;
        var dataLabel = null;
        ...
        switch ((eval.iToken = this.slen)) {
          ...
          case 2:
            ...
            if ((i = dataLabel.indexOf('@')) >= 0) {
              dataString =
                '' + eval.getParameter(dataLabel.substring(i + 1), 4, true);
              dataLabel = dataLabel.substring(0, i).trim();
            } else if (
              dataString == null &&
              (i = dataLabel.indexOf(' ')) >= 0
            ) {
        ...
        if (dataType.indexOf('ligand_') == 0) {
          this.vwr.setLigandModel(
            dataLabel.substring(7).toUpperCase() + '_data',
            dataString.trim(),
          );
          return;
        }
        ...
        if (
          dataType.indexOf('property_') == 0 &&
          !(tokens.length == 2 && tokens[1].equals('set'))
        ) {
          var bs = this.vwr.bsA();
          d[0] = dataType;
          var atomNumberField = isOneValue
            ? 0
            : this.vwr.getP('propertyAtomNumberField').intValue();
          var atomNumberFieldColumnCount = isOneValue
            ? 0
            : this.vwr.getP('propertyAtomNumberColumnCount').intValue();
          var propertyField = isOneValue
            ? -2147483648
            : this.vwr.getP('propertyDataField').intValue();
          var propertyFieldColumnCount = isOneValue
            ? 0
            : this.vwr.getP('propertyDataColumnCount').intValue();
      ...
      Clazz_defineMethod(c$, 'ellipsoid', function () {
        var eval = this.e;
        var mad = 0;
        var i = 1;
        var translucentLevel = 3.4028235e38;
              ...
              case 1611272194:
                ...
                switch (this.getToken(i + 1).tok) {
                  case 11:
                    ...
                    for (var im = 3; --im >= 0; )
                      m.getColumnV(im, (axes[im] = new JU.V3()));
                ...
                if (l != null) {
                  for (var k = 3; --k >= 0; ) {
                    ...
                    switch (v.tok) {
                      case 7:
                        axes[k] = JU.V3.new3(
                          JS.SV.fValue(v.getList().get(0)),
                          JS.SV.fValue(v.getList().get(1)),
                          JS.SV.fValue(v.getList().get(2)),
                        );
                        break;
                      case 8:
      ...
      Clazz_defineMethod(c$, 'image', function () {
        ...
        if (!this.chk)
          this.vwr.fm.loadImage(
            isClose ? '\1close' : fileName,
            '\1' + fileName + '\1' + (''.equals(id) || id == null ? null : id),
            false,
          );
      });
      Clazz_defineMethod(c$, 'invertSelected', function () {
        var e = this.e;
        var pt = null;
        var plane = null;
        var bs = null;
      ...
      Clazz_defineMethod(c$, 'mapProperty', function () {
        var bsFrom;
        var bsTo;
        var property1;
        var property2;
        ...
        while (true) {
          if (this.tokAt(1) == 1113589787) {
            ...
            bsFrom = this.atomExpressionAt(1);
            if (
              this.tokAt(++e.iToken) != 1073742336 ||
              !JS.T.tokAttr((tokProp1 = this.tokAt(++e.iToken)), 1077936128)
            )
              break;
            ...
            if (
              this.tokAt(++e.iToken) != 1073742336 ||
              !JS.T.tokAttr((tokProp2 = this.tokAt(++e.iToken)), 2048)
            )
              break;
            property2 = this.paramAsStr(e.iToken);
          }
          if (JS.T.tokAttr((tokKey = this.tokAt(e.iToken + 1)), 1077936128))
          ...
          if (
            JS.T.tokAttrOr(tokProp1, 1094713344, 1111490560) &&
            JS.T.tokAttrOr(tokProp2, 1094713344, 1111490560) &&
            JS.T.tokAttrOr(tokKey, 1094713344, 1111490560)
          ) {
            var data1 = this.getBitsetPropertyFloat(
              bsFrom,
              tokProp1 | 224,
              null,
              NaN,
            ...
            var data2 = this.getBitsetPropertyFloat(
              bsFrom,
              tokKey | 224,
              null,
              NaN,
            ...
            var data3 = this.getBitsetPropertyFloat(
              bsTo,
              tokKey | 224,
              null,
              NaN,
            ...
            var dataOut = Clazz_newFloatArray(
              isProperty ? this.vwr.ms.ac : data3.length,
              0,
            );
            bsOut = new JU.BS();
          ...
          if (bsOut == null) {
            ...
            for (var i = 0; i < data.length; i++)
              if (data[i].indexOf('null') < 0) sb.append(data[i]).appendC('\n');
      ...
      Clazz_defineMethod(c$, 'minimize', function () {
        var bsSelected = null;
            ...
            case 1073741894:
              ...
              if (!this.chk)
                this.vwr
                  ...
                  .setProperty(
                    'constraint',
                    Clazz_newArray(-1, [aList, Float.$valueOf(targetValue)]),
                  );
              return;
            case 1073741905:
        ...
        if (!this.chk)
          try {
            this.vwr.minimize(
              ...
              bsFixed,
              0,
              (addHydrogen ? 8 : 0) | (noRange ? 16 : 0) | (isSilent ? 1 : 0),
            );
          } catch (e1) {
      ...
      Clazz_defineMethod(c$, 'modulation', function () {
        var qtOffset = null;
        var eval = this.e;
        var mod = true;
        var isQ = false;
      ...
      Clazz_defineMethod(c$, 'mutate', function () {
        var i = this.e.iToken;
        var bs;
        var alphaType = null;
        var sequence = null;
        ...
        if (!this.chk && bs != null) {
          ...
          if (
            this.vwr.ms.isTrajectory(imodel) ||
            !this.vwr.ms.am[imodel].isBioModel
          )
            return;
        }
        ...
        if (isFile) {
          ...
          if (!isOneLetter && sequence.indexOf('-') >= 0) {
            ...
            if (
              isOneLetter ||
              sequence.length != 3 ||
              !this.vwr.getJBR().isKnownPDBGroup(sequence, 20)
            )
              sequence = this.vwr
                .getJBR()
        ...
        if (
          ...
          !this.vwr
            ...
            .mutate(bs, sequence, list, alphaType, phipsi)
        )
          this.invArg();
      });
      Clazz_defineMethod(c$, 'navigate', function () {
        var eval = this.e;
        if (this.slen == 1) {
          ...
          switch (this.getToken(i).tok) {
            ...
            case 1073742084:
              ...
              if (this.getToken(i + 1).tok == 1073742330) {
                ...
                var indexStart = Clazz_floatToInt(
                  this.isFloatParameter(i + 1) ? this.floatParameter(++i) : 0,
                );
                var indexEnd = Clazz_floatToInt(
                ...
                list.addLast(
                  Clazz_newArray(-1, [
                    ...
                    path,
                    theta,
                    Clazz_newIntArray(-1, [indexStart, indexEnd]),
                  ]),
                );
                continue;
              }
                ...
                if (!this.chk)
                  list.addLast(
                    Clazz_newArray(-1, [
                      ...
                      path,
                      theta,
                      Clazz_newIntArray(-1, [0, 2147483647]),
                    ]),
                  );
                continue;
              }
      ...
      Clazz_defineMethod(
        ...
        function (args) {
          ...
          var pt0 =
            isReturnOnly || tokCmd == 134221850 || tokCmd == 4138 ? 0 : 1;
          var filename = null;
          ...
          switch (tok) {
            ...
            case 1715472409:
              ...
              for (var i = 0; i < 3; i++) {
                switch (this.tokAt(e.iToken)) {
                  case 4:
                    propToks[i] = JS.T.getTokFromName(
                      e.getToken(e.iToken).value,
                    );
                    break;
                  default:
                ...
                if (
                  propToks[i] != 1715472409 &&
                  !JS.T.tokAttr(propToks[i], 1077936128)
                )
                  this.invArg();
            ...
            case 136314895:
              ...
              isDerivative =
                type.startsWith('deriv') || type.startsWith('diff');
              isSecondDerivative = isDerivative && type.indexOf('2') > 0;
              if (isDerivative) pt--;
              if (
                type.equalsIgnoreCase('helix') ||
                type.equalsIgnoreCase('axis')
              ) {
                isDraw = true;
                isDerivative = true;
                pt = -1;
          ...
          if (makeNewFrame) {
            ...
            var ptDataFrame = this.vwr.ms.getJmolDataFrameIndex(
              modelIndex,
              stateScript,
            );
          ...
          if (tok == 1715472409) {
            dataX = this.getBitsetPropertyFloat(
              bs,
              propToks[0] | 224,
              propToks[0] == 1715472409 ? props[0] : null,
              minXYZ == null ? NaN : minXYZ.x,
              maxXYZ == null ? NaN : maxXYZ.x,
            );
            propData[0] = props[0] + ' ' + JU.Escape.eAF(dataX);
            if (props[1] != null) {
              dataY = this.getBitsetPropertyFloat(
                bs,
                propToks[1] | 224,
                propToks[1] == 1715472409 ? props[1] : null,
                minXYZ == null ? NaN : minXYZ.y,
                maxXYZ == null ? NaN : maxXYZ.y,
              );
              propData[1] = props[1] + ' ' + JU.Escape.eAF(dataY);
            }
            if (props[2] != null) {
              dataZ = this.getBitsetPropertyFloat(
                bs,
                propToks[2] | 224,
                propToks[2] == 1715472409 ? props[2] : null,
                minXYZ == null ? NaN : minXYZ.z,
                maxXYZ == null ? NaN : maxXYZ.z,
              );
              propData[2] = props[2] + ' ' + JU.Escape.eAF(dataZ);
            }
            if (minXYZ == null)
              minXYZ = JU.P3.new3(
                this.getPlotMinMax(dataX, false, propToks[0]),
                this.getPlotMinMax(dataY, false, propToks[1]),
                this.getPlotMinMax(dataZ, false, propToks[2]),
              );
            if (maxXYZ == null)
              maxXYZ = JU.P3.new3(
                this.getPlotMinMax(dataX, true, propToks[0]),
                this.getPlotMinMax(dataY, true, propToks[1]),
                this.getPlotMinMax(dataZ, true, propToks[2]),
              );
          ...
          if (tokCmd == 134221856)
            return this.vwr.writeFileData(
              filename,
              'PLOT_' + type,
              modelIndex,
              parameters,
            );
          var data = type.equals('data')
          ...
          var isOK =
            data != null &&
            this.vwr.openStringInlineParamsAppend(data, null, true) == null;
          ...
          switch (tok) {
            default:
              script =
                'frame 0.0; frame last; reset;select visible;wireframe only;';
              radius = 10;
              break;
            case 1715472409:
          ...
          this.showString(
            'frame ' +
              this.vwr.getModelNumberDotted(modelCount - 1) +
              (type.length > 0
      ...
      Clazz_defineMethod(c$, 'polyhedra', function () {
        var eval = this.e;
          ...
          switch (this.getToken(i).tok) {
            ...
            case 1073741872:
              ...
              if (!this.chk)
                J.api.Interface.getInterface('JU.BZone', this.vwr, 'script')
                  .setViewer(this.vwr)
                  .createBZ(index, null, false, id, scale);
            ...
            case 134217751:
              ...
              propertyValue = Float.$valueOf(
                this.tokAt(++i) == 1073742334 ? 0 : this.e.floatParameter(i),
              );
              ok = true;
              break;
            case 536875009:
            ...
            case 7:
              ...
              i = eval.iToken;
              if (Clazz_instanceOf(points[0], JM.Atom))
                this.setShapeProperty(
                  21,
                  'model',
                  Integer.$valueOf(points[0].getModelIndex()),
                );
            ...
            case 3:
              ...
              propertyValue = Float.$valueOf(
                (radius = radius == 0 ? 0 : this.floatParameter(i)),
              );
              needsGenerating = true;
              break;
            case 1073742066:
            ...
            case 1073742170:
              ...
              if (eval.isAtomExpression(++i)) {
                propertyName =
                  needsGenerating || haveCenter ? 'to' : 'toBitSet';
            ...
            case 1073741886:
              ...
              if (needsGenerating && this.isFloatParameter(i + 1))
                this.setShapeProperty(
                  21,
                  'faceCenterOffset',
                  Float.$valueOf(this.floatParameter(++i)),
                );
              break;
            case 1073742044:
            case 1073741933:
            ...
            case 4:
              if (!eval.isColorParam(i)) {
                if (i != 1) this.invPO();
                id =
                  eval.theTok == 1073741974
                    ? this.stringParameter(++i)
        ...
        function (args) {
          ...
          if (args == null) {
            ...
            showOnly =
              ...
              this.vwr.fm.getPathForAllFiles().length > 0;
          } else {
            pt = pt0 = 0;
            isCommand = false;
            showOnly = !isCommand;
          ...
          if (
            ...
            isCommand &&
            this.slen > 1 &&
            this.tokAt(this.slen - 2) == 1073741848
          ) {
            ...
            case 134222850:
              ...
              while (val.equals('localpath') || val.equals('remotepath')) {
                if (val.equals('localpath'))
                  localPath = JS.SV.sValue(this.tokenAt(++pt, args));
            ...
            case 4:
              switch (tok) {
                case 4115:
                  var bsAtoms;
                  if (
                    (pt + 1 < argCount && args[++pt].tok == 1073742325) ||
                    args[pt].tok == 10
                  ) {
                    bsAtoms = eval.atomExpression(
                      args,
                      pt,
                      0,
                      true,
              ...
              if (tok == 4120 && pt < args.length) {
                var t = JS.T.getTokenFromName(
                  JS.SV.sValue(args[pt]).toLowerCase(),
                );
          ...
          if (pt0 < argCount) {
            ...
            if (val.equalsIgnoreCase('clipboard')) {
              ...
              if (
                JS.CmdExt.tokAtArray(pt + 1, args) == 2 &&
                JS.CmdExt.tokAtArray(pt + 2, args) == 2
              ) {
                width = JS.SV.iValue(this.tokenAt(++pt, args));
                if (width <= 0) this.invArg();
                height = JS.SV.iValue(this.tokenAt(++pt, args));
              ...
              if (JS.CmdExt.tokAtArray(pt + 1, args) == 2)
          ...
          switch (JS.CmdExt.tokAtArray(pt, args)) {
            ...
            case 4:
              ...
              if (
                fileName.equalsIgnoreCase('clipboard') ||
                !this.vwr.haveAccess(JV.Viewer.ACCESS.ALL)
              )
                fileName = null;
              break;
          ...
          if (isExport) {
            ...
            if (
              (!type.equals('Povray') && !type.equals('Idtf')) ||
              fullPath[0] == null
            )
          ...
          if (data == null) {
            ...
            if (data === 'MENU') {
              ...
              data = this.vwr.ms.getPointGroupAsString(
                this.vwr.bsA(),
                null,
                0,
                1.0,
              ...
              if (
                this.vwr.am.cmi >= 0 &&
                !selected.equals(
                  (bsModel = this.vwr.getModelUndeletedAtomsBitSet(
                    this.vwr.am.cmi,
                  )),
                )
              )
              ...
              if (tVar == null) {
                tVar = eval.getParameter(
                  JS.SV.sValue(this.tokenAt(isCommand ? 2 : 1, args)),
                  1073742190,
                  true,
                );
              }
              ...
              if (isCoord) {
                ...
                if (localPath != null || remotePath != null)
                  data = JV.FileManager.setScriptFileReferences(
                    data,
                    localPath,
                    remotePath,
                    null,
              ...
              if (fileName != null) {
                ...
                if (
                  (bytes = data = this.vwr.createZip(fileName, type, params)) ==
                  null
                )
                  eval.evalError('#CANCELED#', null);
              }
              ...
              if ((data = this.getIsosurfaceJvxl(29, data)) == null)
                this.error(31);
              type = 'XJVXL';
            } else if (data === 'ISOMESH') {
              if ((data = this.getIsosurfaceJvxl(24, data)) == null)
                this.error(31);
              type = 'PMESH';
            } else if (data === 'ISOMESHBIN') {
              if ((bytes = this.getIsosurfaceJvxl(24, 'ISOMESHBIN')) == null)
                this.error(31);
              type = 'PMB';
            } else if (data === 'ISOSURFACE' || data === 'MESH') {
              if (
                (data = this.getIsosurfaceJvxl(isContact ? 25 : 24, data)) ==
                null
              )
                this.error(31);
              ...
              if (!showOnly)
                this.showString(
                  this.getShapeProperty(isContact ? 25 : 24, 'jvxlFileInfo'),
                );
            } else {
          ...
          if (bytes != null && Clazz_instanceOf(bytes, String))
            return this.writeMsg(bytes);
          if (writeFileData)
            return this.writeMsg(
              this.vwr.writeFileData(fileName, type, 0, null),
            );
          ...
          if (Clazz_instanceOf(bytes, String) && quality == -2147483648)
      ...
      Clazz_defineMethod(
        ...
        function (tvar) {
          ...
          for (
            ...
            if (bytes == null) {
              var s = o.asString();
              bytes = s.startsWith(';base64,')
                ? JU.Base64.decodeBase64(s)
                : s.getBytes();
            }
      ...
      Clazz_defineMethod(c$, 'show', function () {
        var eval = this.e;
        var value = null;
        ...
        if (
          this.slen > 3 &&
          this.tokAt(this.slen - 3) == 268435632 &&
          this.tokAt(this.slen - 2) == 268435568
        ) {
          ...
          (filter = this.paramAsStr(this.slen - 1)).lastIndexOf('/') == 0
        ) {
          this.slen--;
          filterLen = 1;
        } else {
        ...
        var tok =
          Clazz_instanceOf(token, JS.SV) && token.tok != 1073741824
            ? 0
            : token.tok;
        if (tok == 4) {
        ...
        switch (tok) {
          ...
          case 1073741925:
            ...
            if (!this.chk) {
              ...
              if (Clazz_instanceOf(d, JS.SV))
                msg = this.vwr.getAnnotationInfo(
                  d,
                  eval.optParameterAsString(2),
                  1073741925,
                );
          ...
          case 1073741915:
            var version = 2;
            if (this.slen == 3)
              version = Clazz_floatToInt(this.floatParameter((len = 3) - 1));
          ...
          case 603983903:
            if (!this.chk && this.slen == 3) {
              msg =
                '' +
                this.vwr.getModelkitPropertySafely(eval.stringParameter(2));
              len = 3;
            }
            break;
          case 1275068433:
          ...
          case 134218757:
            this.checkLength(
              (tok == 1073741879 ||
              (tok == 134218757 && this.tokAt(2) == 1073742335)
                ? (len = 3)
                : 2) + filterLen,
            );
            if (this.chk) return;
            ...
            if (msg == null) {
              ...
              switch (tok) {
                ...
                case 1073741929:
                  if (msg.length > 0) {
                    this.vwr.fm.loadImage(
                      this.vwr.setLoadFormat('_' + msg, '2', false),
                      '\1' + msg,
                      false,
                    );
                    return;
          ...
          case 1296041985:
            ...
            var xyz =
              this.tokAt(2) == 4 || this.tokAt(2) == 12
                ? this.paramAsStr(2)
                : null;
            var pt1 = null;
            var pt2 = null;
            ...
            var type =
              eval.iToken > 1 && this.tokAt(eval.iToken + 1) == 4
                ? this.stringParameter(++eval.iToken)
                : null;
            ...
            if (!this.chk) {
              ...
              msg =
                o == null
                  ? ''
                  : Clazz_instanceOf(o, java.util.Map)
                  ? JS.SV.getVariable(o).asString()
                  : o.toString();
            }
            break;
          case 1648363544:
          ...
          case 553648178:
            ...
            break;
          case 536875070:
            msg = this.vwr.showTimeout(
              (len = this.slen) == 2 ? null : this.paramAsStr(2),
            );
            break;
          case 536870918:
          ...
          case 1073741828:
            msg = JU.Escape.eAP(
              this.vwr.getAdditionalHydrogens(null, null, 768),
            );
            break;
          case 1612709900:
          ...
          case 1073742158:
            ...
            if (filter != null && this.slen == 3) {
              ...
              if (!this.chk)
                msg = this.vwr.fm.getEmbeddedFileState(
                  this.paramAsStr(3),
                  true,
                  'state.spt',
                );
          ...
          case 1639976963:
            if ((len = this.slen) == 2) {
              if (!this.chk)
                msg = this.vwr.ms.getProteinStructureState(
                  this.vwr.bsA(),
                  134222350,
                );
              break;
          ...
          case 12289:
            if (!this.chk)
              msg = 'center ' + JU.Escape.eP(this.vwr.tm.fixedRotationCenter);
            break;
          case 135176:
          ...
          case 1228935687:
            ...
            break;
          case 4115:
            if (this.tokAt(2) == 1073742327 && (len = 3) > 0)
          ...
          case 1073877010:
            if (eval.optParameterAsString(2).equalsIgnoreCase('list')) {
              ...
              var ptMO =
                (len = this.slen) == 2 ? -2147483648 : this.intParameter(2);
          ...
          case 4129:
            if (!this.chk)
              msg = this.vwr.getOrientation(tok, null, null).toString();
            break;
          case 1073742077:
            len = 2;
            ...
            switch ((tok = this.tokAt(2))) {
              ...
              default:
                name = eval.optParameterAsString(2);
                msg = this.vwr
                  .getOrientation(1073742034, name, null)
                  .toString();
            }
            len = this.slen;
            break;
          ...
          case 1275068447:
            ...
            len = this.slen;
            if (!this.chk)
              msg = this.vwr.ms.getPointGroupAsString(
                this.vwr.bsA(),
                'show:' + typ,
                0,
                0,
          ...
          case 1665140738:
            ...
            break;
          case 1086324744:
            if ((len = this.slen) == 3 && this.tokAt(2) == 1073742334)
              tok = 1086324743;
          case 1073741863:
          case 1086326788:
          case 1073742120:
        ...
        if (msg != null) this.showString(this.filterShow(msg, filter));
          ...
          if (str.indexOf(' ') >= 0) this.showString(str);
            ...
            this.showString(
              str + ' = ' + eval.getParameter(str, 1073742190, true).escape(),
            );
        }
      });
      Clazz_defineMethod(c$, 'getCurrentModelFileAsString', function () {
      ...
      Clazz_defineMethod(c$, 'stereo', function () {
      ...
      Clazz_defineMethod(c$, 'struts', function () {
        var eval = this.e;
        var defOn =
          this.tokAt(1) == 1073742072 ||
          this.tokAt(1) == 1073742335 ||
          this.slen == 1;
        ...
        function (i, isModelkit) {
          ...
          switch (tok) {
            ...
            case 2097180:
              ...
              ucname =
                'surface' +
                Clazz_floatToInt(hkl.x) +
                Clazz_floatToInt(hkl.y) +
                Clazz_floatToInt(hkl.z);
              break;
            case 536875009:
            case 1073742163:
              pt =
                tok == 536875009
                  ? eval.getPointOrPlane(++i, 19)
            ...
            case 1073741824:
              ...
              if (JU.PT.isOneOf(ucname, ';parent;standard;primitive;')) {
                if (
                  newUC == null &&
                  this.vwr.getModelInfo('isprimitive') != null
                ) {
                  this.showString(
              ...
              if (newUC != null)
                eval.setModelCagePts(
                  -1,
                  this.vwr.getV0abc(-1, newUC),
                  '' + newUC,
                );
                  ...
                  if (isPrimitive || ucname.equals('reciprocal')) {
                    var scale =
                      this.slen == i + 1
                        ? 1
                        : this.tokAt(i + 1) == 2
                        ? this.intParameter(++i) * 3.141592653589793
                        : this.floatParameter(++i);
                    ucname =
                      (sym == null ? '' : sym.getSpaceGroupName() + ' ') +
                      ucname;
                    oabc =
                      sym == null
                        ? Clazz_newArray(-1, [
                    ...
                    if (stype == null)
                      stype = this.vwr.getSymmetryInfo(
                    ...
                    sym.toFromPrimitive(
                      true,
                      stype.length == 0 ? 'P' : stype.charAt(0),
                      oabc,
                      this.vwr
            ...
            case 1678381065:
              ...
              oabc = Clazz_newArray(-1, [
                o,
                JU.P3.new3(pt.x * 2, 0, 0),
                JU.P3.new3(0, pt.y * 2, 0),
                JU.P3.new3(0, 0, pt.z * 2),
              ]);
              pt = null;
              eval.iToken = i;
              break;
          ...
          if (icell != 2147483647) {
            ...
            if (unitCell != null) {
              ...
              if (!isReset) {
                ...
                for (
                  var j = bsAtoms.nextSetBit(0), k = 0;
                  j >= 0;
                  j = bsAtoms.nextSetBit(j + 1), k++
                ) {
          ...
          if (pt != null)
            JM.ModelSet.setUnitCellOffset(this.vwr.getCurrentUnitCell(), pt, 0);
          if (tickInfo != null) this.setShapeProperty(33, 'tickInfo', tickInfo);
          if (ucname != null)
            this.showString(
              ucname + (oabc == null ? '' : ' ' + JU.Escape.e(oabc)),
            );
        },
        '~N,~B',
      );
      Clazz_defineMethod(
        ...
        function (uc, hkl, plane) {
          ...
          cpts = JU.Measure.getPointsOnPlane(
            cpts.toArray(new Array(cpts.size())),
            p0,
          );
          var zero = new JU.P3();
          var amin = -179;
          ...
          for (var i = cpts.size(); --i >= 0; ) {
            ...
            if (
              ...
              (v != null &&
                (da = Math.abs(
                  JU.Measure.computeTorsion(v, zero, plane, pt, true),
                )) > -amin)
            )
              continue;
            if (v == null) {
      ...
      Clazz_defineMethod(c$, 'modelkit', function () {
        var i = 0;
        var tok = this.tokAt(1);
        switch (tok) {
          case 603984065:
          ...
          case 1073742334:
            if (
              this.slen == 2 &&
              this.vwr.getModelkitPropertySafely('exists') == null
            )
              return;
          case 0:
          case 1073742335:
        ...
        while ((tok = this.tokAt(++i)) != 0) {
            ...
            default:
              if (this.vwr.isModelKitOption('B', key)) {
                value = Boolean.$valueOf(
                  (tok = this.tokAt(++i)) == 0 || tok == 1073742335,
                );
                break;
              }
          ...
          if (
            !this.chk &&
            value != null &&
            (value = kit.setProperty(key, value)) != null &&
            key !== 'hidden' &&
            !kit.isHidden()
          )
            this.vwr.showString(
              'modelkit ' + key + ' = ' + value.toString(),
              false,
            );
        }
      });
      Clazz_defineMethod(c$, 'assign', function () {
        ...
        if (isBond) {
          ...
          (mode == 1140850689 && this.tokAt(i) == 4) ||
          mode == 1275069441
        ) {
        ...
        if (isAdd) {
          ...
          if (isAtom)
            pt =
              ++this.e.iToken < (isClick ? this.slen - 1 : this.slen)
        ...
        switch (mode) {
          case 1140850689:
            ...
            this.vwr
              .getModelkit(false)
              .cmdAssignAtom(index, pt, type, this.e.fullCommand, isClick);
            break;
          case 1677721602:
            this.vwr
              .getModelkit(false)
              .cmdAssignBond(index, (type + '-').charAt(0), this.e.fullCommand);
            break;
          case 4106:
            this.vwr
              .getModelkit(false)
          ...
          case 1275069441:
            ...
            if (this.e.doReport())
              this.e.report(
                J.i18n.GT.i(J.i18n.GT.$('{0} atoms added'), na),
                false,
              );
            break;
          case 12291:
            ...
            if (this.e.doReport())
              this.e.report(
                J.i18n.GT.i(J.i18n.GT.$('{0} atoms deleted'), nd),
                false,
              );
            break;
          case 4129:
            var nm = this.vwr
              .getModelkit(false)
              .cmdAssignMoveAtoms(bs, index, pt, true);
            if (this.e.doReport())
              this.e.report(
                J.i18n.GT.i(J.i18n.GT.$('{0} atoms moved'), nm),
                false,
              );
            break;
          case 134217764:
            ...
            if (isPacked) {
              ...
              if (this.e.doReport())
                this.e.report(
                  J.i18n.GT.i(J.i18n.GT.$('{0} atoms added'), n),
                  false,
                );
            }
            break;
      ...
      Clazz_defineMethod(
        ...
        function (iShape, type) {
          type =
            type === 'PMESH' || type === 'MESH'
              ? 'jvxlMeshX'
              : type === 'ISOMESH'
              ? 'pmesh'
              : type === 'ISOMESHBIN' || type === 'PMB'
              ? 'pmeshbin'
              : 'jvxlDataXml';
      ...
      Clazz_defineMethod(
        ...
        function (ptMO, isNBO) {
          ...
          if (n == null || n.intValue() == 0)
            this.setShapeProperty(iShape, 'init', Integer.$valueOf(modelIndex));
      ...
      Clazz_defineMethod(
        ...
        function (context) {
          ...
          var fiName =
            context == null ? this.e.scriptFileName : context.scriptFileName;
          return (
            '\n# ' +
            fuName +
            ' (file ' +
      ...
      c$.tokAtArray = Clazz_defineMethod(
        c$,
        'tokAtArray',
        function (i, args) {
        ...
        function (str, is3D) {
          ...
          if (!is3D) {
            ...
            for (var iLine = 0, pt = 0; iLine < nLines; pt = lines[iLine++]) {
              ...
              JU.PT.parseFloatArrayData(
                tokens,
                (data[iLine] = Clazz_newFloatArray(tokens.length, 0)),
              );
            }
            return data;
          }
          ...
          for (
            ...
            JU.PT.parseFloatArrayData(
              tokens,
              (data[iX][iY] = Clazz_newFloatArray(tokens.length, 0)),
            );
            if (++iY == nY) {
              iX++;
              iY = 0;
        ...
        function (bs, tok, property, min, max) {
          var odata =
            property == null || tok == 1111490843
              ...
              : this.vwr.getDataObj(property, bs, 1);
          if (odata == null || !JU.AU.isAF(odata))
            return bs == null ? null : Clazz_newFloatArray(bs.cardinality(), 0);
          var data = odata;
          if (!Float.isNaN(min))
            for (var i = 0; i < data.length; i++)
              if (data[i] < min) data[i] = NaN;

          if (!Float.isNaN(max))
            for (var i = 0; i < data.length; i++)
              if (data[i] > max) data[i] = NaN;

          return data;
        },
        'JU.BS,~N,~S,~N,~N',
      );
      Clazz_defineStatics(c$, 'ERROR_invalidArgument', 22);
    },
  );
})(
  Clazz,
