(function (a, m) {
  ...
  function l(g) {
    ...
    return 'function' === a || f.isWindow(g)
      ...
      : 'array' === a ||
        0 === v ||
        ('number' === typeof v && 0 < v && v - 1 in g);
  }
  function h(g, v, a) {
    if (f.isFunction(v))
      return f.grep(g, function (g, f) {
        return !!v.call(g, f, g) !== a;
      });
    if (v.nodeType)
  ...
  function s(g, v, a) {
    if (void 0 === a && 1 === g.nodeType)
      if (
        ((a = 'data-' + v.replace(Wc, '-$1').toLowerCase()),
        (a = g.getAttribute(a)),
        'string' === typeof a)
      ) {
        try {
    ...
    if (f.acceptData(g)) {
      ...
      if (
        ...
        if ('object' === typeof a || 'function' === typeof a)
          K ? (d[n] = f.extend(d[n], a)) : (d[n].data = f.extend(d[n].data, a));
        g = d[n];
  ...
  function c(g, a, p) {
    if (f.acceptData(g)) {
      ...
      if (k[d]) {
        if (a && (K = p ? k[d] : k[d].data)) {
          f.isArray(a)
            ? (a = a.concat(f.map(a, f.camelCase)))
            : a in K
            ? (a = [a])
            : ((a = f.camelCase(a)), (a = a in K ? [a] : a.split(' ')));
  ...
  function E(g, a) {
    var p,
      ...
      b = 0,
      c =
        typeof g.getElementsByTagName !== la
          ? g.getElementsByTagName(a || '*')
          : typeof g.querySelectorAll !== la
          ? g.querySelectorAll(a || '*')
          : void 0;
    if (!c) {
      c = [];
      for (p = g.childNodes || g; null != (K = p[b]); b++)
        !a || f.nodeName(K, a) ? c.push(K) : f.merge(c, E(K, a));
    }
  ...
  function Q(g, a) {
    for (var p, K = 0; null != (p = g[K]); K++)
      f._data(p, 'globalEval', !a || f._data(a[K], 'globalEval'));
  }
  function Fa(g, a) {
    if (1 === a.nodeType && f.hasData(g)) {
      ...
      if (k)
        for (p in (delete c.handle, (c.events = {}), k)) {
          K = 0;
          for (b = k[p].length; K < b; K++) f.event.add(a, p, k[p][K]);
        }
  ...
  function x(g, a, p, b, c) {
    ...
    for (var k = 0; 4 > a; a += 2)
      'margin' === p && (k += f.css(g, p + Qa[a], !0, c)),
        b
          ? ('content' === p && (k -= f.css(g, 'padding' + Qa[a], !0, c)),
            'margin' !== p &&
              (k -= f.css(g, 'border' + Qa[a] + 'Width', !0, c)))
          : ((k += f.css(g, 'padding' + Qa[a], !0, c)),
            'padding' !== p &&
              (k += f.css(g, 'border' + Qa[a] + 'Width', !0, c)));
    return k;
  }
  ...
  function L(g, a, p, b, f) {
    return new L.prototype.init(g, a, p, b, f);
  }
  function ga() {
    setTimeout(function () {
      Za = void 0;
  ...
  function O(g, a) {
    ...
    for (a = a ? 1 : 0; 4 > f; f += 2 - a)
      (p = Qa[f]), (b['margin' + p] = b['padding' + p] = g);
  ...
  function na(g, a, p, b) {
    var c;
    if (f.isArray(a))
      f.each(a, function (a, v) {
        p || ad.test(g)
          ? b(g, v)
          : na(g + '[' + ('object' === typeof v ? a : '') + ']', v, p, b);
      });
  ...
  f.extend({
    ...
    isPlainObject: function (g) {
      ...
      try {
        if (
          g.constructor &&
          !za.call(g, 'constructor') &&
          !za.call(g.constructor.prototype, 'isPrototypeOf')
        )
          return !1;
      } catch (p) {
        return !1;
      }
      if (w.ownLast) for (a in g) return za.call(g, a);
      for (a in g);
  ...
  var Pb = a,
    D = function (g, a, p, b) {
        ...
        if ((f = gd.exec(g)))
          if ((k = f[1]))
            ...
            if (
              ...
              return Ga.apply(p, a.getElementsByClassName(k)), p;
          }
        if (H.qsa && (!S || !S.test(g))) {
          c = f = M;
          k = a;
          ...
          if (n)
            try {
              return Ga.apply(p, k.querySelectorAll(n)), p;
            } catch (e) {
            } finally {
      ...
      a: {
        ...
        $a(g, c)(b, a, !X, p, (Qb.test(g) && ha(a.parentNode)) || a);
        r = p;
      }
      return r;
    },
    ...
    Sb = function (g, a) {
      for (var p = g.split('|'), b = g.length; b--; ) G.attrHandle[p[b]] = a;
    },
    pc = function (g, a) {
      var p = a && g,
        b =
          ...
          1 === g.nodeType &&
          1 === a.nodeType &&
          (~a.sourceIndex || ia) - (~g.sourceIndex || ia);
      if (b) return b;
    ...
    Tb = function (g, a, p) {
      ...
      return a.first
        ? function (a, p, v) {
            for (; (a = a[b]); ) if (1 === a.nodeType || f) return g(a, p, v);
          }
        : function (a, p, v) {
            var k,
              d,
            ...
            if (v)
              ...
              for (; (a = a[b]); )
                if (1 === a.nodeType || f) {
                  d = a[M] || (a[M] = {});
                  if ((k = d[b]) && k[0] === ca && k[1] === c)
                    return (n[2] = k[2]);
                  d[b] = n;
                  if ((n[2] = g(a, p, v))) return !0;
                }
          };
    },
    Ub = function (g) {
      ...
      return pa(function (c, k, d, n) {
        ...
        if (c) {
          if (f || g) {
            ...
            for (d = j.length; d--; )
              if ((r = j[d]) && -1 < (e = f ? Ua.call(c, r) : fa[d]))
                c[e] = !(k[e] = r);
          }
  ...
  try {
    Ga.apply((N = tc.call(W.childNodes)), W.childNodes),
  ...
  oa = D.setDocument = function (g) {
    ...
    G.find.TAG = H.getElementsByTagName
      ? function (g, a) {
    ...
    G.find.CLASS =
      H.getElementsByClassName &&
      function (g, a) {
        if (typeof a.getElementsByClassName !== T && X)
          return a.getElementsByClassName(g);
      };
    da = [];
    S = [];
    if ((H.qsa = lb.test(a.querySelectorAll)))
      qa(function (g) {
    ...
    (H.matchesSelector = lb.test(
      (La =
        ja.webkitMatchesSelector ||
        ja.mozMatchesSelector ||
        ja.oMatchesSelector ||
        ja.msMatchesSelector),
    )) &&
      qa(function (g) {
    ...
    sa =
      (g = lb.test(ja.compareDocumentPosition)) || lb.test(ja.contains)
        ? function (g, a) {
                ...
                !(
                  ...
                  (b.contains
                    ...
                    : g.compareDocumentPosition &&
                      g.compareDocumentPosition(v) & 16)
                )
              )
            );
          }
      ...
      ? function (g, b) {
          ...
          f =
            (g.ownerDocument || g) === (b.ownerDocument || b)
              ...
              : 1;
          return f & 1 ||
            (!H.sortDetached && b.compareDocumentPosition(g) === f)
            ? g === a || (g.ownerDocument === W && sa(W, g))
              ? -1
              : b === a || (b.ownerDocument === W && sa(W, b))
              ? 1
              : ra
              ? Ua.call(ra, g) - Ua.call(ra, b)
              : 0
            : f & 4
            ? -1
            : 1;
  ...
  D.matchesSelector = function (g, a) {
    ...
    a = a.replace(od, "='$1']");
    if (H.matchesSelector && X && (!da || !da.test(a)) && (!S || !S.test(a)))
      try {
        var b = La.call(g, a);
        if (
          b ||
    ...
    filter: {
      ...
      PSEUDO: function (g, a) {
        var b,
          f =
            G.pseudos[g] ||
            G.setFilters[g.toLowerCase()] ||
            D.error('unsupported pseudo: ' + g);
        return f[M]
          ? f(a)
          : 1 < f.length
          ? ((b = [g, g, '', a]),
            G.setFilters.hasOwnProperty(g.toLowerCase())
              ? pa(function (g, b) {
                  for (var p, c = f(g, a), k = c.length; k--; )
                    (p = Ua.call(g, c[k])), (g[p] = !(b[p] = c[k]));
                })
              : function (g) {
                  return f(g, 0, b);
                })
    ...
    pseudos: {
      not: pa(function (g) {
        ...
        return f[M]
          ? pa(function (g, a, b, p) {
              p = f(g, null, p, []);
              for (var v = g.length; v--; ) if ((b = p[v])) g[v] = !(a[v] = b);
            })
          : function (g, c, k) {
              a[0] = g;
              f(a, null, k, b);
    ...
    if (!k) {
      ...
      b = function (g, a, b, p, v) {
        ...
        if (d && fa !== h) {
          ...
          if (g) {
            if (0 < h) for (; fa--; ) !j[fa] && !q[fa] && (q[fa] = Y.call(p));
            q = Ta(q);
          }
          Ga.apply(p, q);
  ...
  f(function () {
    ...
    if (b) {
      ...
      if (
        typeof a.style.zoom !== la &&
        ((a.style.cssText =
          'border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1'),
        (w.inlineBlockNeedsLayout = 3 === a.offsetWidth))
      )
        b.style.zoom = 1;
      b.removeChild(g);
    }
  ...
  w.noCloneEvent = !0;
  Z.attachEvent &&
    (Z.attachEvent('onclick', function () {
      w.noCloneEvent = !1;
    }),
    Z.cloneNode(!0).click());
  if (null == w.deleteExpando) {
  ...
  for (Ab in {
    ...
    if (((Bb = 'on' + Ab), !(w[Ab + 'Bubbles'] = Bb in a)))
      Ac.setAttribute(Bb, 't'),
        (w[Ab + 'Bubbles'] = !1 === Ac.attributes[Bb].expando);
    ...
    add: function (a, b, c, k, d) {
      ...
      if ((r = f._data(a))) {
        ...
        if (!(q = r.handle))
          (q = r.handle =
            function (a) {
              return typeof f !== la && (!a || f.event.triggered !== a.type)
      ...
      if (m && (j = m.events)) {
        ...
        for (q = b.length; q--; )
          if (
            ...
            h &&
              !A.length &&
              ((!l.teardown || !1 === l.teardown.call(a, T, m.handle)) &&
                f.removeEvent(a, z, m.handle),
              delete j[z]);
  ...
  f.removeEvent = y.removeEventListener
    ...
    : function (a, b, f) {
        b = 'on' + b;
        a.detachEvent &&
          (typeof a[b] === la && (a[b] = null), a.detachEvent(b, f));
      };
  ...
  var mc =
    ...
    ac = B(y).appendChild(y.createElement('div'));
  ...
  f.extend({
    clone: function (a, b, c) {
      ...
      w.html5Clone || f.isXMLDoc(a) || !Dc.test('<' + a.nodeName + '>')
        ? (n = a.cloneNode(!0))
    ...
    buildFragment: function (a, b, c, k) {
      for (
        var d, n, e, r, h, q, l = a.length, j = B(b), A = [], z = 0;
        z < l;
        z++
      )
        if ((n = a[z]) || 0 === n)
  ...
  f.fn.extend({
    ...
    remove: function (a, b) {
      for (
        ...
        !b && 1 === c.nodeType && f.cleanData(E(c)),
          c.parentNode &&
            (b && f.contains(c.ownerDocument, c) && Q(E(c, 'script')),
            c.parentNode.removeChild(c));
      return this;
    },
    empty: function () {
      for (var a, b = 0; null != (a = this[b]); b++) {
        for (1 === a.nodeType && f.cleanData(E(a, !1)); a.firstChild; )
      ...
      return Va(
        ...
        function (a) {
          ...
          if (
            'string' === typeof a &&
            !Bd.test(a) &&
            (w.htmlSerialize || !Dc.test(a)) &&
            (w.leadingWhitespace || !$b.test(a)) &&
            !ka[(Fc.exec(a) || ['', ''])[1].toLowerCase()]
          ) {
            a = a.replace(Ec, '<$1></$2>');
            try {
              for (; b < c; b++)
                (g = this[b] || {}),
                  1 === g.nodeType &&
                    (f.cleanData(E(g, !1)), (g.innerHTML = a));
              g = 0;
            } catch (k) {}
          }
    ...
    domManip: function (a, b) {
      ...
      var c,
        ...
        j = a[0],
        A = f.isFunction(j);
      if (A || (1 < h && 'string' === typeof j && !w.checkClone && Cd.test(j)))
      ...
      if (
        ...
        for (k = d.length; e < h; e++)
          (c = n),
            e !== l &&
              ((c = f.clone(c, !0, !0)), k && f.merge(d, E(c, 'script'))),
            b.call(this[e], c, e);
        if (k) {
  ...
  w.clearCloneStyle = 'content-box' === ab.style.backgroundClip;
  ob = ab = null;
        ...
        return ma(
          ...
          c
            ? x(
                ...
                b,
                c,
                w.boxSizing() && 'border-box' === f.css(a, 'boxSizing', !1, k),
                k,
              )
            : 0,
        );
      ...
      function (a, b, c) {
        ...
        if (1 === a.nodeType && ('height' in b || 'width' in b))
          (c.overflow = [l.overflow, l.overflowX, l.overflowY]),
            ...
            'inline' === d &&
              'none' === f.css(a, 'float') &&
              (!w.inlineBlockNeedsLayout || 'inline' === h
  ...
  w.getSetAttribute = 't' !== qb.className;
  ...
  Lc = {
    set: function (a, b, c) {
      !1 === b
        ? f.removeAttr(a, c)
        : (Jb && Wa) || !hc.test(c)
        ? a.setAttribute((!Wa && f.propFix[c]) || c, c)
    ...
    toggleClass: function (a, b) {
      ...
      return 'boolean' === typeof b && 'string' === c
        ...
        : this.each(function () {
            if ('string' === c)
              for (
                var b, k = 0, d = f(this), n = a.match(xa) || [];
                (b = n[k++]);

              )
                d.hasClass(b) ? d.removeClass(b) : d.addClass(b);
            else if (c === la || 'boolean' === c)
  ...
  f.extend({
    ...
    ajaxSetup: function (a, b) {
      return b ? ya(ya(a, f.ajaxSettings), b) : ya(f.ajaxSettings, a);
    },
    ajaxPrefilter: kb(Oc),
    ajaxTransport: kb(Nb),
    ajax: function (a, b) {
      function c(a, b, g, k) {
        ...
        if (2 !== ea) {
          ...
          if (g) {
            p = j;
            for (
              var v = s, N, ia, F, B, E = p.contents, P = p.dataTypes;
              '*' === P[0];

            )
              P.shift(),
                void 0 === ia &&
                  (ia = p.mimeType || v.getResponseHeader('Content-Type'));
            if (ia)
              for (B in E)
                if (E[B] && E[B].test(ia)) {
                  P.unshift(B);
          ...
          a: {
            ...
            for (B = E.shift(); B; )
              if (
                (g.responseFields[B] && (ia[g.responseFields[B]] = N),
                !u && F && g.dataFilter && (N = g.dataFilter(N, g.dataType)),
                (u = B),
                (B = E.shift()))
              )
                if ('*' === B) B = u;
                  ...
                  if (!Y)
                    for (w in v)
                      if (
                        ((p = w.split(' ')),
                        p[1] === B && (Y = v[u + ' ' + p[0]] || v['* ' + p[0]]))
                      ) {
                        !0 === Y
                          ? (Y = v[w])
                          : !0 !== v[w] && ((B = p[0]), E.unshift(p[1]));
                        break;
                      }
                  if (!0 !== Y)
                    if (Y && g['throws']) N = Y(N);
          ...
          if (k)
            j.ifModified &&
              ((I = s.getResponseHeader('Last-Modified')) &&
                (f.lastModified[n] = I),
              (I = s.getResponseHeader('etag')) && (f.etag[n] = I)),
              204 === a || 'HEAD' === j.type
                ? (I = 'nocontent')
                : 304 === a
                ? (I = 'notmodified')
                : ((I = p.state), (d = p.data), (l = p.error), (k = !l));
      ...
      var k,
        ...
        s = {
          ...
          statusCode: function (a) {
            var b;
            if (a)
              if (2 > ea) for (b in a) m[b] = [m[b], a[b]];
      ...
      if (j.beforeSend && (!1 === j.beforeSend.call(A, s, j) || 2 === ea))
        return s.abort();
      ia = 'abort';
      for (d in {
        success: 1,
  ...
  f.fn.extend({
    offset: function (a) {
      ...
      if (d) {
        ...
        typeof c.getBoundingClientRect !== la &&
...
(function (a, m) {
  ...
  a._searchMol = function (b, c, d, e) {
    ...
    if (c && !(0 > h.indexOf('?') && h == b._thisJmolModel)) {
      ...
      null != b._viewSet &&
      null !=
        (l = a.View.__findView(b._viewSet, {
          chemID: h,
        }))
  ...
  a._binaryTypes =
    'mmtf .gz .bz2 .jpg .gif .png .zip .jmol .bin .smol .spartan .pmb .mrc .map .ccp4 .dn6 .delphi .omap .pse .dcd .uk/pdbe/densities/'.split(
      ' ',
    );
  ...
  a._getFileData = function (b, c, d) {
    ...
    if (t || j || (!l && !m) || (!c && s))
      ...
      h
        ? ((Q.type = 'POST'),
          (Q.url = b.split('?POST?')[0]),
          (Q.data = b.split('?POST?')[1]))
        : ((Q.type = 'GET'), (Q.url = b));
      c &&
        ((Q.success = function () {
        ...
        (d = new FileReader()),
          (d.onloadend = function (d) {
            if (d.target.readyState == FileReader.DONE) {
              ...
              'JSV' == b._viewType || j.endsWith('.jdx')
                ? a.Cache.put(j, d)
                : b._appletPanel.cachePut(j, d);
              (d = a._jsGetXY(b._canvas, c)) &&
                (!b._appletPanel.setStatusDragDropped ||
                  b._appletPanel.setStatusDragDropped(0, d[0], d[1], j)) &&
                b._appletPanel.openFileAsyncSpecial(j, 1);
            }
          }),
...
(function (a, m) {
  ...
  h._scriptEcho = function (a) {
    ...
    for (var j = '', h = a.length; 0 <= --h; )
      for (var l = a[h].length; 0 <= --l; )
        'scriptEcho' == a[h][l][1] && (j += a[h][l][3] + '\n');
    return j.replace(/ \| /g, '\n');
  };
  h._scriptMessage = function (a) {
    ...
    for (var j = '', h = a.length; 0 <= --h; )
      for (var l = a[h].length; 0 <= --l; )
        'scriptStatus' == a[h][l][1] && (j += a[h][l][3] + '\n');
    return j.replace(/ \| /g, '\n');
  };
  ...
  window['j2s.clazzloaded'] ||
    ...
    (function (a, m) {
      ...
      -1 != navigator.userAgent.indexOf('Safari') &&
        ...
        (q = j.indexOf('Version/')),
        -1 != q && ((j = j.substring(q + 8)), (Fa = 4 <= parseFloat(j))));
      ...
      (function (a, b) {
        ...
        b.loadClass = function (c, f, h, j, l) {
          ...
          if (
            !h &&
            ((I && c.lastIndexOf('.package') != c.length - 8) ||
              (0 != c.indexOf('java.') && !isClassDefined(da)))
          )
            La.push([c, f]),
              System.out.println(
            ...
            if (
              l &&
              f &&
              ((h = H(c)), !h || h.status >= x.STATUS_LOAD_COMPLETE)
            )
            ...
            if (l) {
              ...
              if (l.isPackage) {
                for (j = E.length; 0 <= --j && !E[j].isPackage; )
                  E[j + 1] = E[j];
                E[++j] = l;
              } else c && E.push(l);
              if (!c) {
              ...
              if (b.keepOnLoading) {
                ...
                if ((m = Ka(x.STATUS_KNOWN)))
                  ...
                  (m = E.shift()),
                    ...
                    m.musts.length ||
                    m.optionals.length
                      ? (Ja(d, m, !0), V(m, m.path, m.requiredBy, !1))
                      : ha && (ha = !1);
                ...
                if (!(q || 0 < h)) {
                  ...
                  if (f) f();
                    ...
                    b._checkLoad &&
                      (System.out.println(
                        "I think I'm done: SAEM call count: " + Q,
                      ),
                      a.showDuplicates(!0));
                  b.onGlobalLoaded();
                }
        ...
        b.showPending = function () {
          ...
          for (c in b._classPending) {
            var d = H(c);
            d
              ? (a.push(d), System.out.println(va('', '', d, '', 0)))
              : alert('No node for ' + c);
          }
          return a;
        };
          ...
          if (!a.name || a.status >= x.STATUS_LOAD_COMPLETE) Da(a);
            ...
            if (c) {
              ...
              if (
                ...
                (Ta(a.musts, x.STATUS_LOAD_COMPLETE) &&
                  Ta(a.optionals, x.STATUS_LOAD_COMPLETE))
              ) {
        ...
        var Ta = function (a, b) {
          ...
          $a = function (a, b) {
            for (var c = d.random, e = b.length; 0 <= --e; ) {
              ...
              if (
                f.name == a ||
                (f.random != c && ((f.random = c), (f = Ea(a, f))))
              )
                return f;
            }
            return null;
          ...
          oa = function (a, b) {
            if (a)
              for (var c = d.random, e = 0; e < a.length; e++) {
                ...
                if (
                  Aa(f, b) ||
                  (f.random != c && ((f.random = c), (f = Ca(f, b))))
                )
                  return f;
              }
            return null;
      ...
      C.consoleOutput = function (a, b) {
        ...
        if (C.linesCount > C.maxTotalLines) {
          for (var d = 0; d < C.linesCount - C.maxTotalLines; d++)
        ...
        for (
          ...
          var l = null;
          if (C.metLineBreak || 0 == C.linesCount || 1 > c.childNodes.length)
