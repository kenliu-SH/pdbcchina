...
export function requestGet(
  url: any,
  body: any = null,
  serverHomeIndex: any = 0,
) {
  return request(url, { method: 'GET', body }, null, serverHomeIndex);
}
export function requestDelete(url: any, body: any, serverHomeIndex: any = 0) {
  return request(url, { method: 'DELETE', body }, null, serverHomeIndex);
}
export function requestPost(url: any, body: any, serverHomeIndex = 0) {
  return request(url, { method: 'POST', body }, null, serverHomeIndex);
}
export function requestPatch(url: any, body: any, serverHomeIndex = 0) {
  return request(url, { method: 'PATCH', body }, null, serverHomeIndex);
}
export function requestPut(url: any, body: any, serverHomeIndex = 0) {
