  ...
  return (
    <div className="col-lg-9 col-md-8 col-sm-12 content-item">
      <div data-elastic-include="">
        ...
        <div>
          <p>
            The Application Programming Interface or APIs provide programmatic
            access to the PDB archive. Two main APIs that power the
          ...
          <ul style={{ paddingLeft: '40px' }}>
            <li>
              <b>Data API </b>serves to retrieve data when you know the PDB
              identifiers
            </li>
            <li>
              <b>Search API </b>serves to find out what identifiers match a
              certain search condition
            </li>
          </ul>
          <div></div>
          <p>
            <a href="https://groups.google.com/a/rcsb.org/g/api/about">
              Stay up-to-date with API developments by viewing (or subscribing)
              to the RCSB PDB API announcements Google group.
            </a>
          </p>
          ...
          <ul style={{ paddingLeft: '40px' }}>
            <li>
              <b>core_entry</b>: data that relates to a PDB entry or Computed
              Structure Model (CSM). Identified by an entry_id, which can be an
              alphanumeric PDB-ID or a CSM-ID that starts with AF_ or MA_
            </li>
            <li>
              <b>core_polymer_entity</b>: data for each polymeric molecular
              entity in an entry (e.g., protein, DNA, and RNA). Identified by
              entry ID and entity ID separated by a _ character, e.g. 3PQR_1
            </li>
            <li>
              <b>core_nonpolymer_entity</b>: data for each non-polymeric small
              chemical entity in an entry (e.g., enzyme cofactors, ligands,
              ions, etc). Identified by entry ID and entity ID separated by a _
              character
            </li>
            <li>
              <b>core_branched_entity</b>: data for branched molecules (e.g.,
              oligosaccharides). Identified by entry ID and entity ID separated
              by a _ character
            </li>
            <li>
              <b>core_assembly</b>: data for each biological assembly in an
              entry. Identified by entry ID and assembly ID separated by a _
              character
            </li>
            <li>
              <b>core_polymer_entity_instance</b>: an instance of a certain
              polymeric molecular entity, also known as chain. Identified by
              entry ID and asym ID separated by a _ character
            </li>
            <li>
              <b>core_chem_comp</b>: a chemical component. Identified by a
              unique alphanumeric code chem_comp_id
            </li>
          </ul>
          <div></div>
          <p>
          ...
          <p>
            ...
            level it is also possible to combine
          ...
          <p>
            This Search API example shows how to find
            <a
              href="https://search.rcsb.org/#search-example-15"
              target="_blank"
            >
              all PDB structures and CSMs for a given UniProtKB sequence
            </a>
          </p>
      ...
      <div className="item-info">
        ...
        <div>Last updated: 1/27/2023</div>
      </div>
    </div>
  );
};
