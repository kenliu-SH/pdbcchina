...
@Table({ tableName: "pdbx_feature_sequence_range", timestamps: false })
export class pdbxFeatureSequenceRange extends Model {
    ...
    @Column({ field: "seq_range_id", allowNull: true, type: DataType.STRING(10) })
    seqRangeId?: string;
