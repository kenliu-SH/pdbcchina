...
@Table({ tableName: "pdbx_missing_atom_nonpoly", timestamps: false })
export class pdbxMissingAtomNonpoly extends Model {
    ...
    @Column({ field: "atom_name", allowNull: true, type: DataType.STRING(10) })
    atomName?: string;
}
