...
@Table({ tableName: "pdbx_sequence_range", timestamps: false })
export class pdbxSequenceRange extends Model {
    ...
    @Column({ field: "seq_range_id", primaryKey: true, type: DataType.STRING(10) })
    @Index({ name: "primary_index", using: "BTREE", order: "ASC", unique: true })
    seqRangeId!: string;
