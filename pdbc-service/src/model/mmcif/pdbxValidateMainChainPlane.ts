...
@Table({ tableName: "pdbx_validate_main_chain_plane", timestamps: false })
export class pdbxValidateMainChainPlane extends Model {
    ...
    @Column({ field: "improper_torsion_angle", allowNull: true, type: DataType.FLOAT(12) })
    improperTorsionAngle?: number;
}
