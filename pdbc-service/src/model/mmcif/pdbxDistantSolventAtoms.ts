...
@Table({ tableName: "pdbx_distant_solvent_atoms", timestamps: false })
export class pdbxDistantSolventAtoms extends Model {
    ...
    @Column({ field: "neighbor_macromolecule_distance", allowNull: true, type: DataType.FLOAT(12) })
    neighborMacromoleculeDistance?: number;

    @Column({ field: "neighbor_ligand_distance", allowNull: true, type: DataType.FLOAT(12) })
    neighborLigandDistance?: number;
}
