...
@Table({ tableName: "em_map_depositor_info", timestamps: false })
export class emMapDepositorInfo extends Model {
    ...
    @Column({ field: "map_type", allowNull: true, type: DataType.STRING(10) })
    mapType?: string;
