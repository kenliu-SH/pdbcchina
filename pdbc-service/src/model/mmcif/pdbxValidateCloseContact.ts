...
@Table({ tableName: "pdbx_validate_close_contact", timestamps: false })
export class pdbxValidateCloseContact extends Model {
    ...
    @Column({ field: "symm_as_xyz_1", allowNull: true, type: DataType.STRING(80) })
    symmAsXyz_1?: string;

    @Column({ field: "symm_as_xyz_2", allowNull: true, type: DataType.STRING(80) })
    symmAsXyz_2?: string;
