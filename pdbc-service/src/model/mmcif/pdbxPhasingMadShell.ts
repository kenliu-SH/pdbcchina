...
@Table({ tableName: "pdbx_phasing_MAD_shell", timestamps: false })
export class pdbxPhasingMadShell extends Model {
    ...
    @Column({ field: "reflns_acentric", allowNull: true, type: DataType.FLOAT(12) })
