...
@Table({ tableName: "pdbx_val_angle", timestamps: false })
export class pdbxValAngle extends Model {
    ...
    @Column({ field: "auth_PDB_insert_id_3", allowNull: true, type: DataType.STRING(10) })
    authPdbInsertId_3?: string;
    ...
    @Column({ field: "label_asym_id_3", allowNull: true, type: DataType.STRING(10) })
    labelAsymId_3?: string;

    @Column({ field: "label_atom_id_3", allowNull: true, type: DataType.STRING(6) })
    labelAtomId_3?: string;

    @Column({ field: "label_comp_id_3", allowNull: true, type: DataType.STRING(10) })
    labelCompId_3?: string;

    @Column({ field: "label_seq_id_3", allowNull: true, type: DataType.INTEGER })
    labelSeqId_3?: number;
